...
FULL_SAVE_ITEMS_LIST = ['whiteline_pos', 
                        'whiteline_direct_pos', 
...
WL_SAVE_ITEMS_LIST = ['whiteline_pos', 
                      'whiteline_direct_pos',
                      'edge_pos',
                      'whiteline_fit_coef',
                      'edge_fit_coef']

WL_SELECTED_ITEMS_LIST = ['',
                          'whiteline_pos',
                          'whiteline_direct_pos',
                          'edge_pos',]
...
class xanes_analysis_gui():
    ...
    def build_gui(self):
        ...
        self.hs['L[0][x][3][0][4][3][0]_ana_config'][0, :50] = widgets.Checkbox(description='fit wl',
                                                                                description_tooltip="fit whiteline if it is checked",
                                                                                value =True,
                                                                                layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                indent = False,
                                                                                disabled=False)
        self.hs['L[0][x][3][0][4][3][0][0]_ana_config_fit_wl_checkbox'] = self.hs['L[0][x][3][0][4][3][0]_ana_config'][0, :50]
        self.hs['L[0][x][3][0][4][3][0]_ana_config'][0, 50:100] = widgets.Checkbox(description='fit edge',
                                                                                   description_tooltip='fit edge if it is checked',
                                                                                   value =True,
                                                                                   layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                   indent = False,
                                                                                   disabled=False)
        self.hs['L[0][x][3][0][4][3][0][1]_ana_config_fit_edge_checkbox'] = self.hs['L[0][x][3][0][4][3][0]_ana_config'][0, 50:100]
        self.hs['L[0][x][3][0][4][3][0]_ana_config'][0, 100:150] = widgets.Checkbox(description='filter spec',
                                                                                   description_tooltip='filter spec before fitting edge if it is checked',
                                                                                   value =True,
                                                                                   layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                   indent = False,
                                                                                   disabled=False)
        self.hs['L[0][x][3][0][4][3][0][2]_ana_config_filter_spec_checkbox'] = self.hs['L[0][x][3][0][4][3][0]_ana_config'][0, 100:150]
        self.hs['L[0][x][3][0][4][3][0]_ana_config'][0, 150:200] = widgets.Checkbox(description='find edge',
                                                                                   description_tooltip='find edge by derivative if it is checked',
                                                                                   value =True,
                                                                                   layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                   indent = False,
                                                                                   disabled=False)
        self.hs['L[0][x][3][0][4][3][0][3]_ana_config_find_edge_checkbox'] = self.hs['L[0][x][3][0][4][3][0]_ana_config'][0, 150:200]
        ...
        self.hs['L[0][x][3][0][4][2][0]_ana_edge'][0, 50:100] = widgets.Dropdown(description='optimizer',
                                                                            description_tooltip='use scipy.optimize or numpy.polyfit',
                                                                            options = ['scipy', 
                                                                                       'numpy'],
                                                                            value ='scipy',
                                                                            layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                            disabled=True)
        self.hs['L[0][x][3][0][4][2][0][0]_ana_edge_optimizer'] = self.hs['L[0][x][3][0][4][2][0]_ana_edge'][0, 50:100]
        self.hs['L[0][x][3][0][4][2][0]_ana_edge'][0, 100:150] = widgets.Dropdown(description='peak func',
                                                                                description_tooltip='peak fitting functions',
                                                                                options = EDGE_LINE_SHAPES,
                                                                                value ='lorentzian',
                                                                                layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                disabled=True)
        self.hs['L[0][x][3][0][4][2][0][1]_ana_edge_fit_func'] = self.hs['L[0][x][3][0][4][2][0]_ana_edge'][0, 100:150]
        self.hs['L[0][x][3][0][4][2][0]_ana_edge'][0, 150:200] = widgets.Checkbox(description='para bnd',
                                                                                value = False,
                                                                                description_tooltip = "if set boundaries to the peak fitting function's parameters",
                                                                                layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                disabled=True)
        self.hs['L[0][x][3][0][4][2][0][2]_ana_edge_fit_use_bnd'] = self.hs['L[0][x][3][0][4][2][0]_ana_edge'][0, 150:200]
        ...
        self.hs['L[0][x][3][0][4][1][0]_ana_save_setting_gridlayout'][0:6, 0:100] = \
            widgets.SelectMultiple(options=FULL_SAVE_ITEMS_LIST,
        ...
        self.hs['L[0][x][3][0][4][1][0]_ana_save_setting_gridlayout'][0:6, 100:200] = \
            widgets.SelectMultiple(options=FULL_SELECTED_ITEMS_LIST,
    ...
    def L0_x_3_0_1_0_0_analysis_energy_range_option_dropdown(self, a):
        ...
        self.hs['L[0][x][3][0][5][0]_analysis_run_text'].value ='please check your settings before run the analysis ...'
        if a['owner'].value == 'wl':
    ...
    def L0_x_3_0_1_0_1_analysis_energy_range_edge_eng_text(self, a):
        ...
        self.hs['L[0][x][3][0][5][0]_analysis_run_text'].description ='please check your settings before run the analysis ...'
        # self.parent_h.boxes_logic()
    ...
    def L0_x_3_0_1_1_0_analysis_energy_range_wl_fit_s_text(self, a):
        ...
        #     self.hs['L[0][x][3][0][5][0]_analysis_run_text'].value = 'The whiteline fitting energy starting point might be too low. Reset it to the edge energy.'
        ...
        #     self.hs['L[0][x][3][0][5][0]_analysis_run_text'].value = 'The whiteline fitting energy starting point might be too high. Reset it to 0.005keV lower than whiteline fitting energy ending point.'
        # else:
        #     self.hs['L[0][x][3][0][5][0]_analysis_run_text'].value ='please check your settings before run the analysis ...'
        self.hs['L[0][x][3][0][5][0]_analysis_run_text'].value ='please check your settings before run the analysis ...'
    ...
    def L0_x_3_0_1_1_1_analysis_energy_range_wl_fit_e_text(self, a):
        ...
        #     self.hs['L[0][x][3][0][5][0]_analysis_run_text'].value = 'The whiteline fitting energy ending point might be too low. Reset it to 0.005keV higher than whiteline fitting energy starting point.'
        # else:
        #     self.hs['L[0][x][3][0][5][0]_analysis_run_text'].value ='please check your settings before run the analysis ...'
        self.hs['L[0][x][3][0][5][0]_analysis_run_text'].value ='please check your settings before run the analysis ...'
    ...
    def L0_x_3_0_1_1_2_analysis_energy_range_edge0p5_fit_s_text(self, a):
        ...
        # if a['owner'].value > self.xanes_analysis_edge_eng:
        #     a['owner'].value = self.xanes_analysis_edge_eng
        #     self.hs['L[0][x][3][0][5][0]_analysis_run_text'].value = 'The edge-0.5 fitting energy starting point might be too high. Reset it to edge energy.'
        # else:
        #     self.hs['L[0][x][3][0][5][0]_analysis_run_text'].value ='please check your settings before run the analysis ...'
        self.hs['L[0][x][3][0][5][0]_analysis_run_text'].value ='please check your settings before run the analysis ...'
    ...
    def L0_x_3_0_1_1_3_analysis_energy_range_edge0p5_fit_e_text(self, a):
        ...
        # if a['owner'].value < self.xanes_analysis_edge_eng:
        #     a['owner'].value = self.xanes_analysis_edge_eng
        #     self.hs['L[0][x][3][0][5][0]_analysis_run_text'].value = 'The edge-0.5 fitting energy ending point might be too low. Reset it to edge energy.'
        # else:
        #     self.hs['L[0][x][3][0][5][0]_analysis_run_text'].value ='please check your settings before run the analysis ...'
        self.hs['L[0][x][3][0][5][0]_analysis_run_text'].value ='please check your settings before run the analysis ...'
    ...
    def L0_x_3_0_1_0_4_analysis_energy_range_confirm_button(self, a):
        if self.parent_h.xanes_analysis_type == 'wl':
            self.parent_h.xanes_analysis_wl_fit_eng_s = self.hs['L[0][x][3][0][1][1][0]_analysis_energy_range_wl_fit_s_text'].value
            self.parent_h.xanes_analysis_wl_fit_eng_e = self.hs['L[0][x][3][0][1][1][1]_analysis_energy_range_wl_fit_e_text'].value
            self.hs['L[0][x][3][0][4][1][0][0]_ana_save_setting_multiselection'].value = ['whiteline_direct_pos']
            self.hs['L[0][x][3][0][4][1][0][0]_ana_save_setting_multiselection'].options = WL_SAVE_ITEMS_LIST
            self.hs['L[0][x][3][0][4][1][0][1]_ana_save_setting_selection_text'].value = ['']
            self.hs['L[0][x][3][0][4][1][0][1]_ana_save_setting_selection_text'].options = WL_SELECTED_ITEMS_LIST
            self.analysis_saving_items = deepcopy(set(WL_SELECTED_ITEMS_LIST))
            ...
            self.parent_h.xanes_analysis_edge_0p5_fit_e = self.hs['L[0][x][3][0][1][1][3]_analysis_energy_range_edge0.5_fit_e_text'].value
            self.hs['L[0][x][3][0][4][1][0][0]_ana_save_setting_multiselection'].value = ['whiteline_direct_pos']
            self.hs['L[0][x][3][0][4][1][0][0]_ana_save_setting_multiselection'].options = FULL_SAVE_ITEMS_LIST
            self.hs['L[0][x][3][0][4][1][0][1]_ana_save_setting_selection_text'].value = ['']
            self.hs['L[0][x][3][0][4][1][0][1]_ana_save_setting_selection_text'].options = FULL_SELECTED_ITEMS_LIST
            self.analysis_saving_items = deepcopy(set(FULL_SELECTED_ITEMS_LIST))
            self.analysis_saving_items.remove('')
        ...
        # self.ana_use_flt_spec = self.hs['L[0][x][3][0][1][0][4]_analysis_filter_spec_checkbox'].value
    ...
    def L0_x_3_0_4_2_0_3_ana_edge_refine(self, a):
        self.ana_refine_edge = a['owner'].value
        if self.ana_refine_edge:
    ...
    def L0_x_3_0_4_2_0_1_ana_edge_fit_func(self, a):
        ...
        # if self.ana_wl_fit_func == "exponential":
        #     self.ana_wl_fit_func_arg_handles[0].description = 'amp'
        # elif self.ana_wl_fit_func == "powerlaw":
        #     pass
        # elif self.ana_wl_fit_func == "parabolic":
        #     pass
        # elif self.ana_wl_fit_func == 'gaussian':
        #     pass
        # elif self.ana_wl_fit_func == 'lorentzian':
        #     pass
        # elif self.ana_wl_fit_func == "damped_oscillator":
        #     pass
        # elif self.ana_wl_fit_func == "logistic":
        #     pass
        # elif self.ana_wl_fit_func == "students_t":
        #     pass
        # elif self.ana_wl_fit_func == "sine":
        #     pass
        # elif self.ana_wl_fit_func == "voigt":
        #     pass
        # elif self.ana_wl_fit_func == "split_lorentzian":
        #     pass
        # elif self.ana_wl_fit_func == "pvoigt":
        #     pass
        # elif self.ana_wl_fit_func == "moffat":
        #     pass
        # elif self.ana_wl_fit_func == "pearson7":
        #     pass
        # elif self.ana_wl_fit_func == "breit_wigner":
        #     pass
        # elif self.ana_wl_fit_func == "dho":
        #     pass
        # elif self.ana_wl_fit_func == "expgaussian":
        #     pass
        # elif self.ana_wl_fit_func == "donaich":
        #     pass
        # elif self.ana_wl_fit_func == "skewed_gaussian":
        #     pass
        # elif self.ana_wl_fit_func == "expsine":
        #     pass
        # elif self.ana_wl_fit_func == "step":
        #     pass
        # elif self.ana_wl_fit_func == "skewed_voigt":
        #     pass
        # elif self.ana_wl_fit_func == "rectangle":
        #     pass
    ...
    def L0_x_3_0_4_1_0_2_ana_save_setting_add_button_click(self, a):
        ...
        self.hs['L[0][x][3][0][4][1][0][1]_ana_save_setting_selection_text'].value = \
            list(self.analysis_saving_items)
    ...
    def L0_x_3_0_5_1_analysis_run_button(self, a):
        ...
        if self.parent_h.gui_name == 'xanes3D':
            ...
            code[ln] = f"    xanes3D_analysis_norm_fitting_order = f['/processed_XANES3D/proc_parameters/normalized_fitting_order'][()]"; ln += 1
            ...
            code[ln] = f"            if {self.ana_refine_edge}:"; ln += 1
            ...
            code[ln] = f"            xana.calc_direct_whiteline(xanes3D_analysis_wl_fit_eng_s, xanes3D_analysis_wl_fit_eng_e)"; ln += 1 
            code[ln] = f"            for jj in {self.analysis_saving_items}:"; ln += 1  
            code[ln] = f"                if jj == 'whiteline_pos':"; ln+=1
            code[ln] = f"                    _g12[jj][ii] = np.float32(xana.wl_pos)[:]"; ln += 1
            code[ln] = f"                if jj == 'whiteline_direct_pos':"; ln+=1
            code[ln] = f"                    _g12[jj][ii] = np.float32(xana.wl_pos_direct)[:]"; ln += 1
            code[ln] = f"                if jj == 'edge_pos':"; ln+=1
            code[ln] = f"                    _g12[jj][ii] = np.float32(xana.edge_pos)[:]"; ln += 1
            ...
            code[ln] = f"            xana.normalize_xanes(xanes3D_analysis_edge_eng, order=xanes3D_analysis_norm_fitting_order, save_pre_post=True)"; ln += 1
            code[ln] = f"            xana.fit_whiteline(xanes3D_analysis_wl_fit_eng_s, xanes3D_analysis_wl_fit_eng_e, '{self.ana_wl_optimizer}', **{wl_params})"; ln+=1
            code[ln] = f"            if {self.ana_refine_edge}:"; ln += 1
            code[ln] = f"                xana.fit_edge(xanes3D_analysis_edge_0p5_fit_s, xanes3D_analysis_edge_0p5_fit_e, '{self.ana_edge_optimizer}', **{edge_params})"; ln+=1
            ...
            code[ln] = f"                if jj == 'edge0.5_pos':"; ln+=1
            code[ln] = f"                    _g12[jj][ii] = np.float32(xana.edge_pos_0p5)[:]"; ln += 1
            code[ln] = f"                if jj == 'edge_pos':"; ln+=1
            code[ln] = f"                    _g12[jj][ii] = np.float32(xana.edge_pos)[:]"; ln += 1
            ...
            if sig == 0:
                self.hs['L[0][x][3][0][5][0]_analysis_run_text'].value = 'XANES3D analysis is done ...'
            else:
                self.hs['L[0][x][3][0][5][0]_analysis_run_text'].value = 'something wrong in analysis ...'
            ...
            code[ln] = f"    xanes2D_analysis_norm_fitting_order = f['/processed_XANES2D/proc_parameters/normalized_fitting_order'][()]"; ln+=1
            ...
            code[ln] = f"        xana.calc_direct_whiteline(xanes2D_analysis_wl_fit_eng_s, xanes2D_analysis_wl_fit_eng_e)"; ln += 1 
            code[ln] = f"        for jj in {self.analysis_saving_items}:"; ln += 1  
            code[ln] = f"            if jj == 'whiteline_pos':"; ln+=1
            code[ln] = f"                _g12[jj][:] = np.float32(xana.wl_pos)[:]"; ln += 1
            code[ln] = f"            if jj == 'whiteline_direct_pos':"; ln+=1
            code[ln] = f"                _g12[jj][:] = np.float32(xana.wl_pos_direct)[:]"; ln += 1
            code[ln] = f"            if jj == 'edge_pos':"; ln+=1
            code[ln] = f"                _g12[jj][:] = np.float32(xana.edge_pos)[:]"; ln += 1
            code[ln] = f"            if jj == 'edge_fit_coef':"; ln+=1
            ...
            code[ln] = f"        xana.normalize_xanes(xanes2D_analysis_edge_eng, order=xanes2D_analysis_norm_fitting_order, save_pre_post=True)"; ln+=1
            code[ln] = f"        xana.fit_whiteline(xanes2D_analysis_wl_fit_eng_s, xanes2D_analysis_wl_fit_eng_e, '{self.ana_wl_optimizer}', **{wl_params})"; ln+=1
            code[ln] = f"        if {self.ana_refine_edge}:"; ln += 1
            code[ln] = f"            xana.fit_edge(xanes2D_analysis_edge_0p5_fit_s, xanes2D_analysis_edge_0p5_fit_e, '{self.ana_edge_optimizer}', **{edge_params})"; ln+=1
            code[ln] = f"        xana.calc_direct_whiteline(xanes2D_analysis_wl_fit_eng_s, xanes2D_analysis_wl_fit_eng_e)"; ln+=1
            ...
            code[ln] = f"            if jj == 'edge0.5_pos':"; ln+=1
            code[ln] = f"                _g12[jj][:] = np.float32(xana.edge_pos_0p5)[:]"; ln += 1
            code[ln] = f"            if jj == 'edge_pos':"; ln+=1
            code[ln] = f"                _g12[jj][:] = np.float32(xana.edge_pos)[:]"; ln += 1
            code[ln] = f"            if jj == 'edge_jump_filter':"; ln+=1
            ...
            # print(4)
            if sig == 0:
                self.hs['L[0][x][3][0][5][0]_analysis_run_text'].value = 'XANES2D analysis is done ...'
            else:
                self.hs['L[0][x][3][0][5][0]_analysis_run_text'].value = 'somthing wrong in analysis ...'   
