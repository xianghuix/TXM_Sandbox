...
class xanes2D_regtools_gui():
    ...
    def build_gui(self):
        ...
        self.hs['L[0][1][3][0][0]_visualize_images_title_box'].children = get_handles(self.hs, 'L[0][1][3][0][0]_visualize_images_title_box', -1)
        ...
        self.hs['L[0][1][3][0][1]_visualization&comfirm_box'].children = get_handles(self.hs, 'L[0][1][3][0][1]_visualization&comfirm_box', -1)
        ...
        self.hs['L[0][1][3][0]_visualize_images_box'].children = get_handles(self.hs, 'L[0][1][3][0]_visualize_images_box', -1)
        ...
        self.hs['L[0][1][3][1][0]_analysis_title_box'].children = get_handles(self.hs, 'L[0][1][3][1][0]_analysis_title_box', -1)
        ...
        self.hs['L[0][1][3][1][1][0]_analysis_energy_range_box1'].children = get_handles(self.hs, 'L[0][1][3][1][1][0]_analysis_energy_range_box1', -1)
        ...
        self.hs['L[0][1][3][1][1][1]_analysis_energy_range_box2'].children = get_handles(self.hs, 'L[0][1][3][1][1][1]_analysis_energy_range_box2', -1)
        ...
        self.hs['L[0][1][3][1][1]_analysis_energy_range_box'].children = get_handles(self.hs, 'L[0][1][3][1][1]_analysis_energy_range_box', -1)
        ...
        self.hs['L[0][1][3][1][2]_analysis_energy_filter_box'].children = get_handles(self.hs, 'L[0][1][3][1][2]_analysis_energy_filter_box', -1)
        ...
        self.hs['L[0][1][3][1][3]_analysis_image_mask_box'].children = get_handles(self.hs, 'L[0][1][3][1][3]_analysis_image_mask_box', -1)
        ...
        self.hs['L[0][1][3][1][4]_analysis_run_box'].children = get_handles(self.hs, 'L[0][1][3][1][4]_analysis_run_box', -1)
        ...
        self.hs['L[0][1][3][1][5]_analysis_progress_box'].children = get_handles(self.hs, 'L[0][1][3][1][5]_analysis_progress_box', -1)
        ## ## ## ## ## define run analysis status -- end
        self.hs['L[0][1][3][1]_analysis_box'].children = get_handles(self.hs, 'L[0][1][3][1]_analysis_box', -1)
    ...
    def L0_1_3_1_1_0_0_analysis_energy_range_option_dropdown_change(self, a):
        ...
        if a['owner'].value == 'wl':
            ...
            self.hs['L[0][1][3][1][1][0][2]_analysis_energy_range_pre_edge_e_text'].value = -50
            self.hs['L[0][1][3][1][1][0][2]_analysis_energy_range_pre_edge_e_text'].min = -500
            layout = {'width':'19%', 'height':'100%', 'top':'15%', 'visibility':'visible'}
            self.hs['L[0][1][3][1][1][0][3]_analysis_energy_range_post_edge_s_text'].layout = layout
            self.hs['L[0][1][3][1][1][0][3]_analysis_energy_range_post_edge_s_text'].min = 0
            self.hs['L[0][1][3][1][1][0][3]_analysis_energy_range_post_edge_s_text'].value = 100
            self.hs['L[0][1][3][1][1][0][3]_analysis_energy_range_post_edge_s_text'].max = 500
