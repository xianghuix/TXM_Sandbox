...
class regtools():
    ...
    def _sort_absolute_shift(self, trialfn, shift_dict, optional_shift_dict=None):
        """
        ...
        ----------
        trialfn : str
            Path to the file where trial registration results are saved.
        shift_dict : dictionary
            Dictionary with the alignment pair index as keys and corresponding shifts
            as values.
        optional_shift_dict : dictionary or None, optional
        ...
        if optional_shift_dict is None:
            ...
            for key in shift_dict.keys():
                optional_shift_dict[key] = np.zeros(shift_dict[key].shape)
