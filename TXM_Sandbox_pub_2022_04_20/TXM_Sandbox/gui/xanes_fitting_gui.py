...
class xanes_fitting_gui():
    ...
    def build_gui(self):
        ...
        self.hs['FitEngRagOptn drpdn'] = widgets.Dropdown(description='analysis type',
        ...
        layout = {'width':'19%', 'height':'90%'}
        self.hs['FitEngRagPreEdgeEnd text'] = widgets.BoundedFloatText(description='pre edge e',
                                                                       description_tooltip='relative ending energy point (keV) of pre-edge from edge energy for background removal',
                                                                       value=-50, min=-500, max=0,
                                                                       step=0.5, disabled=True)
        self.hs['FitEngRagPreEdgeEnd text'].layout = layout
        layout = {'width':'19%', 'height':'90%'}
        self.hs['FitEngRagPostEdgeStr text'] = widgets.BoundedFloatText(description='post edge s',
        ...
        self.hs['FitEngRagOptn drpdn'].observe(self.fit_eng_rag_optn_drpdn, names='value')
        self.hs['FitEngRagEdgeEng text'].observe(self.fit_eng_rag_edge_eng_text_chg, names='value')
        self.hs['FitEngRagPreEdgeEnd text'].observe(self.fit_eng_rag_pre_edge_end_text_chg, names='value')
        self.hs['FitEngRagPostEdgeStr text'].observe(self.fit_eng_rag_post_edge_str_text_chg, names='value')
        self.hs['FitEngRagRow0 box'].children = [self.hs['FitEngRagOptn drpdn'],
        ...
        layout = {'width':'19%', 'height':'90%'}
        self.hs['FitEngRagWlFitStr text'] = widgets.BoundedFloatText(description='wl eng s',
        ...
        layout = {'width':'19%', 'height':'90%'}
        self.hs['FitEngRagWlFitEnd text'] = widgets.BoundedFloatText(description='wl eng e',
                                                                     ...
                                                                     value=0, min=0, max=50030,
                                                                     step=0.5, disabled=True)
        self.hs['FitEngRagWlFitEnd text'].layout = layout
        layout = {'width':'19%', 'height':'90%'}
        self.hs['FitEngRagEdge0.5Str text'] = widgets.BoundedFloatText(description='edge0.5 s',
        ...
        layout = {'width':'19%', 'height':'90%'}
        self.hs['FitEngRagEdge0.5End text'] = widgets.BoundedFloatText(description='edge0.5 e',
                                                                       description_tooltip='absolute energy starting point (keV) for edge-0.5 fitting. "edge0.5 s" and "edge0.5 e" shoudl be close to the foot and the peak locations on the ascendent edge of the spectra.',
                                                                       value=0, min=0, max=50030,
                                                                       step=0.5, disabled=True)
        ...
        self.hs['FitEngCmf btn'] = widgets.Button(description='Confirm', disabled=True,
        ...
        self.hs['FitEngRagWlFitStr text'].observe(self.fit_eng_rag_wl_fit_str_text_chg, names='value')
        self.hs['FitEngRagWlFitEnd text'].observe(self.fit_eng_rag_wl_fit_end_text_chg, names='value')
        self.hs['FitEngRagEdge0.5Str text'].observe(self.fit_eng_rag_edge50_fit_str_text_chg, names='value')
        self.hs['FitEngRagEdge0.5End text'].observe(self.fit_eng_rag_edge50_fit_end_text_chg, names='value')
        self.hs['FitEngCmf btn'].on_click(self.fit_eng_rag_cmf_btn_clk)
        self.hs['FitEngRagRow1 box'].children = [self.hs['FitEngRagWlFitStr text'],
                                                 self.hs['FitEngRagWlFitEnd text'],
                                                 self.hs['FitEngRagEdge0.5Str text'],
                                                 self.hs['FitEngRagEdge0.5End text'],
                                                 self.hs['FitEngCmf btn']]

        self.hs['FitEngRag box'].children = [self.hs['FitEngRagRow0 box'],
                                             self.hs['FitEngRagRow1 box']]
        ## ## ## ## ## define type of analysis and energy range -- end

        self.hs['FitEngConfig box'].children = [self.hs['FitTitle box'],
        ...
        fit_pars_GridspecLayout = widgets.GridspecLayout(8, 200,
        ...
        fit_pars_GridspecLayout[0, :39] = widgets.Checkbox(description='fit wl',
        ...
        fit_pars_GridspecLayout[0, 78:117] = widgets.Checkbox(description='filter spec',
        ...
        fit_pars_GridspecLayout[0, 117:156] = widgets.Checkbox(description='wl direct',
        ...
        fit_pars_GridspecLayout[0, 156:195] = widgets.Checkbox(description='edge 50% direct',
        ...
        fit_pars_GridspecLayout[1, :70] = widgets.FloatSlider(description='edge jump thres',
        ...
        fit_pars_GridspecLayout[1, 70:140] = widgets.FloatSlider(description='offset thres',
        ...
        fit_pars_GridspecLayout[1, 150:200] = widgets.BoundedIntText(description='binning fac',
        ...
        fit_pars_GridspecLayout[2, :20] = widgets.Checkbox(description='mask preview',
                                                           ...
                                                           value =0, indent=False, disabled=True)
        self.hs['FitItemConfigFitPrvw chbx'] = fit_pars_GridspecLayout[2, :20]

        fit_pars_GridspecLayout[3, :70] = widgets.IntSlider(description='xy slice',
        ...
        fit_pars_GridspecLayout[3, 80:90] = widgets.Button(description='calc masks', disabled=True,
                                                           description_tooltip='Calculate and preview the edge_jump and edge_offset filters',
                                                           layout = {'width':f'{0.1*(self.form_sz[1]-104)}px'})
        self.hs['FitItemConfigFitPrvwCal btn'] = fit_pars_GridspecLayout[3, 80:90]
        self.hs['FitItemConfigFitPrvwCal btn'].style.button_color = 'darkviolet'

        fit_pars_GridspecLayout[3, 110:120] = widgets.Button(description='EM it', disabled=True,
                                                             description_tooltip='Calculate and preview the edge_jump and edge_offset filters',
                                                             layout = {'width':f'{0.1*(self.form_sz[1]-104)}px'})
        self.hs['FitItemConfigFitPrvwEMIt btn'] = fit_pars_GridspecLayout[3, 110:120]
        self.hs['FitItemConfigFitPrvwEMIt btn'].style.button_color = 'darkviolet'

        fit_pars_GridspecLayout[3, 140:150] = widgets.Button(description='OM it', disabled=True,
                                                             description_tooltip='Calculate and preview the edge_jump and edge_offset filters',
                                                             layout = {'width':f'{0.1*(self.form_sz[1]-104)}px'})
        self.hs['FitItemConfigFitPrvwOMIt btn'] = fit_pars_GridspecLayout[3, 140:150]
        self.hs['FitItemConfigFitPrvwOMIt btn'].style.button_color = 'darkviolet'

        fit_pars_GridspecLayout[3, 170:180] = widgets.Button(description='EM&OM it', disabled=True,
                                                             description_tooltip='Calculate and preview the edge_jump and edge_offset filters',
                                                             layout = {'width':f'{0.1*(self.form_sz[1]-104)}px'})
        self.hs['FitItemConfigFitPrvwEMOMIt btn'] = fit_pars_GridspecLayout[3, 170:180]
        self.hs['FitItemConfigFitPrvwEMOMIt btn'].style.button_color = 'darkviolet'

        fit_pars_GridspecLayout[4, :40] = widgets.Checkbox(description='LCF',
                                                           description_tooltip='Linear Combination Fitting',
                                                           value=0, indent=False, disabled=True)
        self.hs['FitItemConfigLCF chbx'] = fit_pars_GridspecLayout[4, :40]

        fit_pars_GridspecLayout[4, 40:80] = widgets.Checkbox(description='Constr', value=1,
                                                             description_tooltip='Apply unity constraint in LCF',
                                                             indent=False, disabled=True)
        self.hs['FitItemConfigLCFCnst chbx'] = fit_pars_GridspecLayout[4, 40:80]

        fit_pars_GridspecLayout[5, :40] = widgets.BoundedIntText(description='# of spec', disabled=True,
                                                                 description_tooltip='total # of reference spectra for Linear Combination Fitting',
                                                                 value=2, min=2, max=5, step=1, indent=False,
                                                                 layout={'width':f'{0.19 * (self.form_sz[1] - 104)}px'})
        self.hs['FitItemConfigLCFNumSpec text'] = fit_pars_GridspecLayout[5, :40]

        fit_pars_GridspecLayout[6, 14:40] = SelectFilesButton(option='askopenfilename',
                                                              open_filetypes=(('text files', '*.txt'),),
                                                              layout={'left':f'{0.05*(self.form_sz[1] - 104)}px',
        ...
        fit_pars_GridspecLayout[6, 170:190] = widgets.Button(layout={'width':f'{0.1*(self.form_sz[1]-104)}px'},
                                                             description='Remove', disabled=True)
        ...
        self.hs['FitItemConfigCalEdge50%Dir chbx'].observe(self.fit_config_cal_edge50_dir_chbx_chg, names='value')
        self.hs['FitItemConfigEdgeJumpThres sldr'].observe(self.fit_config_fit_edge_jump_thres_sldr_chg, names='value')
        self.hs['FitItemConfigEdgeOfstThres sldr'].observe(self.fit_config_fit_edge_ofst_thres_sldr_chg, names='value')
        self.hs['FitItemConfigBinFac text'].observe(self.fit_config_bin_fac_text_chg, names='value')
        self.hs['FitItemConfigFitPrvw chbx'].observe(self.fit_config_mask_prvw_chbx_chg, names='value')
        self.hs['FitItemConfigFitPrvwSli sldr'].observe(self.fit_config_flt_prvw_sli_sldr_chg, names='value')
        self.hs['FitItemConfigFitPrvwCal btn'].on_click(self.fit_config_flt_prvw_calc_btn_clk)
        self.hs['FitItemConfigFitPrvwEMIt btn'].on_click(self.fit_config_flt_prvw_em_it_btn_clk)
        self.hs['FitItemConfigFitPrvwOMIt btn'].on_click(self.fit_config_flt_prvw_om_it_btn_clk)
        self.hs['FitItemConfigFitPrvwEMOMIt btn'].on_click(self.fit_config_flt_prvw_emom_it_btn_clk)
        self.hs['FitItemConfigLCF chbx'].observe(self.fit_config_lcf_chbx_chg, names='value')
        self.hs['FitItemConfigLCFCnst chbx'].observe(self.fit_config_lcf_cnst_chbx_chg, names='value')
        self.hs['FitItemConfigLCFNumSpec text'].observe(self.fit_config_num_spec_text_chg, names='value')
        self.hs['FitItemConfigLCFSelRef btn'].on_click(self.fit_config_sel_ref_btn_clk)
        self.hs['FitItemConfigLCFRef list'].observe(self.fit_config_ref_spec_list_chg, names='value')
        ...
        self.hs['FitItemConfig box'].children = [self.hs['FitItemConfigFitWl chbx'],
                                                 # self.hs['FitItemConfigFitEdge chbx'],
        ...
        fit_wl_pars_GridspecLayout = widgets.GridspecLayout(8, 200,
                                                            layout={"border":"3px solid #FFCC00",
        ...
        fit_wl_pars_GridspecLayout[0, :50] = widgets.Dropdown(description='optimizer', value ='numpy', isabled=True,
        ...
        fit_wl_pars_GridspecLayout[0, 50:100] = widgets.Dropdown(description='peak func', disabled=True,
                                                                 description_tooltip='peak fitting functions',
                                                                 options=[2, 3, 4], value=2,
                                                                 layout={'width':f'{0.3*self.form_sz[1]-98}px'})
        self.hs['FitConfigWlFunc drpdn'] = fit_wl_pars_GridspecLayout[0, 50:100]
        fit_wl_pars_GridspecLayout[0, 100:150] = widgets.Checkbox(description='para bnd', value = False, disabled=True,
        ...
        fit_wl_pars_GridspecLayout[1, 0:50] = widgets.BoundedFloatText(description='p0', value=0, min=-1e5, max=1e5,
                                                                       description_tooltip = "fitting function variable 0",
                                                                       layout={'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                       disabled=True)
        self.hs['FitConfigWlFitPars0 text'] = fit_wl_pars_GridspecLayout[1, 0:50]
        fit_wl_pars_GridspecLayout[1, 50:100] = widgets.BoundedFloatText(description='p1', value=0, min=-1e5, max=1e5,
                                                                         description_tooltip="fitting function variable 1",
                                                                         layout={'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                         disabled=True)
        self.hs['FitConfigWlFitPars1 text'] = fit_wl_pars_GridspecLayout[1, 50:100]
        fit_wl_pars_GridspecLayout[1, 100:150] = widgets.BoundedFloatText(description='p2', value=0, min=-1e5, max=1e5,
                                                                          description_tooltip = "fitting function variable 2",
                                                                          layout={'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                          disabled=True)
        self.hs['FitConfigWlFitPars2 text'] = fit_wl_pars_GridspecLayout[1, 100:150]
        fit_wl_pars_GridspecLayout[1, 150:200] = widgets.BoundedFloatText(description='p3', value=0, min=-1e5, max=1e5,
                                                                          description_tooltip="fitting function variable 3",
                                                                          layout={'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                          disabled=True)
        self.hs['FitConfigWlFitPars3 text'] = fit_wl_pars_GridspecLayout[1, 150:200]

        fit_wl_pars_GridspecLayout[2, 0:50] = widgets.BoundedFloatText(description='p4', value=0, min=-1e5, max=1e5,
                                                                       description_tooltip="fitting function variable 4",
                                                                       layout={'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                       disabled=True)
        self.hs['FitConfigWlFitPars4 text'] = fit_wl_pars_GridspecLayout[2, 0:50]
        fit_wl_pars_GridspecLayout[2, 50:100] = widgets.Dropdown(description='p5', value='linear', options=['linear'],
                                                                 description_tooltip="fitting function variable 5",
                                                                 layout={'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                 disabled=True)
        self.hs['FitConfigWlFitPars5 text'] = fit_wl_pars_GridspecLayout[2, 50:100]

        fit_wl_pars_GridspecLayout[3, 0:50] = widgets.Dropdown(description='jac', value='3-point', disabled=True,
                                                               options=['2-point', '3-point', 'cs'],
                                                               description_tooltip="",
                                                               layout={'width':f'{0.3*self.form_sz[1]-98}px'})
        self.hs['FitConfigWlFitJac drpdn'] = fit_wl_pars_GridspecLayout[3, 0:50]
        fit_wl_pars_GridspecLayout[3, 50:100] = widgets.Dropdown(description='method', value='trf', disabled=True,
                                                                 options=['trf', 'dogbox', 'lm'], description_tooltip="",
                                                                 layout={'width':f'{0.3*self.form_sz[1]-98}px'})
        self.hs['FitConfigWlFitMeth drpdn'] = fit_wl_pars_GridspecLayout[3, 50:100]
        fit_wl_pars_GridspecLayout[3, 100:150] = widgets.BoundedFloatText(description='ftol', value=1e-7, min=0, max=1e-3,
        ...
        fit_wl_pars_GridspecLayout[3, 150:200] = widgets.BoundedFloatText(description='xtol', value=1e-7, min=0, max=1e-3,
        ...
        fit_wl_pars_GridspecLayout[4, 0:50] = widgets.BoundedFloatText(description='gtol', value=1e-7, min=0, max=1e-3,
        ...
        fit_wl_pars_GridspecLayout[4, 50:100] = widgets.BoundedIntText(description='ufac', value=50, min=1, max=100,
        ...
        fit_wl_pars_GridspecLayout[5, 0:50] = widgets.BoundedFloatText(description='p0 lb', value=0, min=-1e5, max=1e5,
                                                                       description_tooltip="p0 lower bound",
                                                                       layout={'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                       disabled=True)
        self.hs['FitConfigWlFitPars0Lb text'] = fit_wl_pars_GridspecLayout[5, 0:50]
        fit_wl_pars_GridspecLayout[5, 50:100] = widgets.BoundedFloatText(description='p0 ub', value=0, min=-1e5, max=1e5,
                                                                         description_tooltip="p0 upper bound",
                                                                         layout={'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                         disabled=True)
        self.hs['FitConfigWlFitPars0Ub text'] = fit_wl_pars_GridspecLayout[5, 50:100]
        fit_wl_pars_GridspecLayout[5, 100:150] = widgets.BoundedFloatText(description='p1 lb', value=0, min=-1e5, max=1e5,
                                                                          description_tooltip="p1 lower bound",
                                                                          layout={'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                          disabled=True)
        self.hs['FitConfigWlFitPars1Lb text'] = fit_wl_pars_GridspecLayout[5, 100:150]
        fit_wl_pars_GridspecLayout[5, 150:200] = widgets.BoundedFloatText(description='p1 ub', value=0, min=-1e5, max=1e5,
                                                                          description_tooltip="p1 upper bound",
                                                                          layout={'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                          disabled=True)
        self.hs['FitConfigWlFitPars1Ub text'] = fit_wl_pars_GridspecLayout[5, 150:200]

        fit_wl_pars_GridspecLayout[6, 0:50] = widgets.BoundedFloatText(description='p2 lb', value=0, min=-1e5, max=1e5,
                                                                       description_tooltip="p2 lower bound",
                                                                       layout={'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                       disabled=True)
        self.hs['FitConfigWlFitPars2Lb text'] = fit_wl_pars_GridspecLayout[6, 0:50]
        fit_wl_pars_GridspecLayout[6, 50:100] = widgets.BoundedFloatText(description='p3 ub', value=0, min=-1e5, max=1e5,
                                                                         description_tooltip="p3 upper bound",
                                                                         layout={'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                         disabled=True)
        self.hs['FitConfigWlFitPars2Ub text'] = fit_wl_pars_GridspecLayout[6, 50:100]
        fit_wl_pars_GridspecLayout[6, 100:150] = widgets.BoundedFloatText(description='p4 lb', value=0, min=-1e5, max=1e5,
                                                                          description_tooltip="p4 lower bound",
                                                                          layout={'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                          disabled=True)
        self.hs['FitConfigWlFitPars3Lb text'] = fit_wl_pars_GridspecLayout[6, 100:150]
        fit_wl_pars_GridspecLayout[6, 150:200] = widgets.BoundedFloatText(description='p4 ub', value=0, min=-1e5, max=1e5,
                                                                          description_tooltip="p4 upper bound",
                                                                          layout={'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                          disabled=True)
        self.hs['FitConfigWlFitPars3Ub text'] = fit_wl_pars_GridspecLayout[6, 150:200]

        fit_wl_pars_GridspecLayout[7, 0:50] = widgets.BoundedFloatText(description='p5 lb', value=0, min=-1e5, max=1e5,
                                                                       description_tooltip="p5 lower bound",
                                                                       layout={'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                       disabled=True)
        self.hs['FitConfigWlFitPars4Lb text'] = fit_wl_pars_GridspecLayout[7, 0:50]
        fit_wl_pars_GridspecLayout[7, 50:100] = widgets.BoundedFloatText(description='p5 ub', value=0, min=-1e5, max=1e5,
                                                                         description_tooltip="p5 upper bound",
                                                                         layout={'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                         disabled=True)
        self.hs['FitConfigWlFitPars4Ub text'] = fit_wl_pars_GridspecLayout[7, 50:100]

        self.hs['FitConfigWlOptmzr drpdn'].observe(self.fit_config_wl_optmzr_drpdn_chg, names='value')
        self.hs['FitConfigWlFunc drpdn'].observe(self.fit_config_wl_func_drpdn_chg, names='value')
        self.hs['FitConfigWlFitUseBnd chbx'].observe(self.fit_config_wl_fit_bnd_chbx_chg, names='value')

        self.hs['FitConfigWlPars box'] = fit_wl_pars_GridspecLayout
        self.hs['FitConfigWlPars box'].children = [self.hs['FitConfigWlOptmzr drpdn'],
        ...
        fit_edge_pars_GridspecLayout = widgets.GridspecLayout(8, 200,
                                                              layout={"border":"3px solid #FFCC00",
                                                                      'width':f'{0.96*self.form_sz[1]-98}px',
                                                                      "height":f"{0.48*(self.form_sz[0]-128)}px",
                                                                      "align_items":"flex-start",
        ...
        fit_edge_pars_GridspecLayout[0, 0:50] = widgets.Dropdown(description='optimizer', value='numpy', disabled=True,
                                                                 description_tooltip='use scipy.optimize or numpy.polyfit',
                                                                 options=['scipy', 'numpy'],
                                                                 layout={'width':f'{0.3*self.form_sz[1]-98}px'})
        self.hs['FitConfigEdgeOptmzr drpdn'] = fit_edge_pars_GridspecLayout[0, 0:50]
        fit_edge_pars_GridspecLayout[0, 50:100] = widgets.Dropdown(description='fit func', disabled=True,
                                                                   description_tooltip='edge fitting functions',
                                                                   options=[2, 3, 4], value=3,
                                                                   layout={'width':f'{0.3*self.form_sz[1]-98}px'})
        self.hs['FitConfigEdgeFunc drpdn'] = fit_edge_pars_GridspecLayout[0, 50:100]
        fit_edge_pars_GridspecLayout[0, 100:150] = widgets.Checkbox(description='para bnd', value = False, disabled=True,
                                                                    description_tooltip = "if set boundaries to the peak fitting function's parameters",
                                                                    layout = {'width':f'{0.3*self.form_sz[1]-98}px'})
        self.hs['FitConfigEdgeFitUseBnd chbx'] = fit_edge_pars_GridspecLayout[0, 100:150]

        fit_edge_pars_GridspecLayout[1, 0:50] = widgets.BoundedFloatText(description='p0', value=0, min=-1e5, ma =1e5,
                                                                         description_tooltip="fitting function variable 0",
                                                                         layout={'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                         disabled=True)
        self.hs['FitConfigEdgeFitPars0 text'] = fit_edge_pars_GridspecLayout[1, 0:50]
        fit_edge_pars_GridspecLayout[1, 50:100] = widgets.BoundedFloatText(description='p1', value=0, min=-1e5, max=1e5,
                                                                           description_tooltip="fitting function variable 1",
                                                                           layout={'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                           disabled=True)
        self.hs['FitConfigEdgeFitPars1 text'] = fit_edge_pars_GridspecLayout[1, 50:100]
        fit_edge_pars_GridspecLayout[1, 100:150] = widgets.BoundedFloatText(description='p2', value=0, min=-1e5, max=1e5,
                                                                            description_tooltip="fitting function variable 2",
                                                                            layout={'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                            disabled=True)
        self.hs['FitConfigEdgeFitPars2 text'] = fit_edge_pars_GridspecLayout[1, 100:150]
        fit_edge_pars_GridspecLayout[1, 150:200] = widgets.BoundedFloatText(description='p3', value=0, min=-1e5, max=1e5,
                                                                            description_tooltip="fitting function variable 3",
                                                                            layout={'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                            disabled=True)
        self.hs['FitConfigEdgeFitPars3 text'] = fit_edge_pars_GridspecLayout[1, 150:200]

        fit_edge_pars_GridspecLayout[2, 0:50] = widgets.BoundedFloatText(description='p4', value=0, min=-1e5, max=1e5,
                                                                         description_tooltip="fitting function variable 4",
                                                                         layout={'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                         disabled=True)
        self.hs['FitConfigEdgeFitPars4 text'] = fit_edge_pars_GridspecLayout[2, 0:50]
        fit_edge_pars_GridspecLayout[2, 50:100] = widgets.Dropdown(description='p5', value='linear', options=['linear'],
                                                                   description_tooltip="fitting function variable 5",
                                                                   layout={'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                   disabled=True)
        self.hs['FitConfigEdgeFitPars5 text'] = fit_edge_pars_GridspecLayout[2, 50:100]

        fit_edge_pars_GridspecLayout[3, 0:50] = widgets.Dropdown(description='jac', value='3-point',
                                                                 options=['2-point', '3-point', 'cs'],
                                                                 description_tooltip = "",
                                                                 layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                 disabled=True)
        self.hs['FitConfigEdgeFitJac drpdn'] = fit_edge_pars_GridspecLayout[3, 0:50]
        fit_edge_pars_GridspecLayout[3, 50:100] = widgets.Dropdown(description='method', value='trf', disabled=True,
                                                                   options=['trf', 'dogbox', 'lm'],
                                                                   description_tooltip="",
                                                                   layout={'width':f'{0.3*self.form_sz[1]-98}px'})
        self.hs['FitConfigEdgeFitMeth drpdn'] = fit_edge_pars_GridspecLayout[3, 50:100]
        fit_edge_pars_GridspecLayout[3, 100:150] = widgets.BoundedFloatText(description='ftol', value=1e-7, min=0, max=1e-3,
                                                                            description_tooltip="function value change tolerance for terminating the optimization process",
                                                                            layout={'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                            disabled=True)
        self.hs['FitConfigEdgeFitFtol text'] = fit_edge_pars_GridspecLayout[3, 100:150]
        fit_edge_pars_GridspecLayout[3, 150:200] = widgets.BoundedFloatText(description='xtol', value=1e-7, min=0, max=1e-3,
                                                                            description_tooltip="function parameter change tolerance for terminating the optimization process",
                                                                            layout={'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                            disabled=True)
        self.hs['FitConfigEdgeFitXtol text'] = fit_edge_pars_GridspecLayout[3, 150:200]
        fit_edge_pars_GridspecLayout[4, 0:50] = widgets.BoundedFloatText(description='gtol', value=1e-7, min=0, max=1e-3,
                                                                         description_tooltip="function gradient change tolerance for terminating the optimization process",
                                                                         layout={'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                         disabled=True)
        self.hs['FitConfigEdgeFitGtol text'] = fit_edge_pars_GridspecLayout[4, 0:50]
        fit_edge_pars_GridspecLayout[4, 50:100] = widgets.BoundedIntText(description='ufac', value=50, min=1, max=100,
                                                                         description_tooltip="upsampling factor to energy points in peak fitting",
                                                                         layout={'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                         disabled=True)
        self.hs['FitConfigEdgeFitUfac text'] = fit_edge_pars_GridspecLayout[4, 50:100]

        fit_edge_pars_GridspecLayout[5, 0:50] = widgets.BoundedFloatText(description='p0 lb', value=0, min=-1e5, max=1e5,
                                                                         description_tooltip="p0 lower bound",
                                                                         layout={'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                         disabled=True)
        self.hs['FitConfigEdgeFitPars0Lb text'] = fit_edge_pars_GridspecLayout[5, 0:50]
        fit_edge_pars_GridspecLayout[5, 50:100] = widgets.BoundedFloatText(description='p0 ub', value=0, min=-1e5, max=1e5,
                                                                           description_tooltip="p0 upper bound",
                                                                           layout={'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                           disabled=True)
        self.hs['FitConfigEdgeFitPars0Ub text'] = fit_edge_pars_GridspecLayout[5, 50:100]
        fit_edge_pars_GridspecLayout[5, 100:150] = widgets.BoundedFloatText(description='p1 lb', value=0, min=-1e5, max=1e5,
                                                                            description_tooltip="p1 lower bound",
                                                                            layout={'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                            disabled=True)
        self.hs['FitConfigEdgeFitPars1Lb text'] = fit_edge_pars_GridspecLayout[5, 100:150]
        fit_edge_pars_GridspecLayout[5, 150:200] = widgets.BoundedFloatText(description='p1 ub', value=0, min=-1e5, max=1e5,
                                                                            description_tooltip="p1 upper bound",
                                                                            layout={'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                            disabled=True)
        self.hs['FitConfigEdgeFitPars1Ub text'] = fit_edge_pars_GridspecLayout[5, 150:200]

        fit_edge_pars_GridspecLayout[6, 0:50] = widgets.BoundedFloatText(description='p2 lb', value=0, min=-1e5, max=1e5,
                                                                         description_tooltip="p2 lower bound",
                                                                         layout={'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                         disabled=True)
        self.hs['FitConfigEdgeFitPars2Lb text'] = fit_edge_pars_GridspecLayout[6, 0:50]
        fit_edge_pars_GridspecLayout[6, 50:100] = widgets.BoundedFloatText(description='p3 ub', value=0, min=-1e5, max=1e5,
                                                                           description_tooltip="p3 upper bound",
                                                                           layout={'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                           disabled=True)
        self.hs['FitConfigEdgeFitPars2Ub text'] = fit_edge_pars_GridspecLayout[6, 50:100]
        fit_edge_pars_GridspecLayout[6, 100:150] = widgets.BoundedFloatText(description='p4 lb', value=0, min=-1e5, max=1e5,
                                                                            description_tooltip="p4 lower bound",
                                                                            layout={'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                            disabled=True)
        self.hs['FitConfigEdgeFitPars3Lb text'] = fit_edge_pars_GridspecLayout[6, 100:150]
        fit_edge_pars_GridspecLayout[6, 150:200] = widgets.BoundedFloatText(description='p4 ub', value=0, min=-1e5, max=1e5,
                                                                            description_tooltip="p4 upper bound",
                                                                            layout={'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                            disabled=True)
        self.hs['FitConfigEdgeFitPars3Ub text'] = fit_edge_pars_GridspecLayout[6, 150:200]

        fit_edge_pars_GridspecLayout[7, 0:50] = widgets.BoundedFloatText(description='p5 lb', value=0, min=-1e5, max=1e5,
                                                                         description_tooltip="p5 lower bound",
                                                                         layout={'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                         disabled=True)
        self.hs['FitConfigEdgeFitPars4Lb text'] = fit_edge_pars_GridspecLayout[7, 0:50]
        fit_edge_pars_GridspecLayout[7, 50:100] = widgets.BoundedFloatText(description='p5 ub', value=0, min=-1e5, max=1e5,
                                                                           description_tooltip="p5 upper bound",
                                                                           layout={'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                           disabled=True)
        self.hs['FitConfigEdgeFitPars4Ub text'] = fit_edge_pars_GridspecLayout[7, 50:100]

        self.hs['FitConfigEdgeOptmzr drpdn'].observe(self.fit_config_edge_optmzr_drpdn_chg, names='value')
        self.hs['FitConfigEdgeFunc drpdn'].observe(self.fit_config_edge_func_drpdn_chg, names='value')
        self.hs['FitConfigEdgeFitUseBnd chbx'].observe(self.fit_config_edge_fit_bnd_chbx_chg, names='value')

        self.hs['FitConfigEdgePars box'] = fit_edge_pars_GridspecLayout
        self.hs['FitConfigEdgePars box'].children = [self.hs['FitConfigEdgeOptmzr drpdn'],
        ...
        fit_sav_setting_GridLayout = widgets.GridspecLayout(8, 200,
                                                            layout={"border":"3px solid #FFCC00",
                                                                    "width":f"{0.96*self.form_sz[1]-98}px",
                                                                    "height":f"{0.48*(self.form_sz[0]-128)}px",
                                                                    "align_items":"flex-start",
                                                                    "justify_items":"flex-start"})
        fit_sav_setting_GridLayout[0:6, 0:100] = widgets.SelectMultiple(options=FULL_SAVE_ITEM_OPTIONS, value=['wl_fit_coef'],
                                                                        layout={"width":f"{0.5*self.form_sz[1]-98}px",
                                                                                "height":f"{0.4*(self.form_sz[0]-128)}px"},
                                                                        rows=10, description='Aval Items', disabled=True)
        self.hs['FitSavSetting mulsel'] = fit_sav_setting_GridLayout[0:6, 0:100]

        fit_sav_setting_GridLayout[0:6, 100:200] = widgets.SelectMultiple(options=FULL_SAVE_DEFAULT,
                                                                          value=['wl_peak_height_dir',],
                                                                          layout = {"width":f"{0.5*self.form_sz[1]-98}px",
                                                                                    "height":f"{0.4*(self.form_sz[0]-128)}px"},
                                                                          description='Selected:', disabled=True)
        self.hs['FitSavSettingSel mulsel'] = fit_sav_setting_GridLayout[0:6, 100:200]

        fit_sav_setting_GridLayout[7:8, 40:60] = widgets.Button(description='==>', disabled=True,
        ...
        self.hs['FitSavSettingAdd btn'].style.button_color = \
            'darkviolet'
        fit_sav_setting_GridLayout[7:8, 140:160] = widgets.Button(description='<==', disabled=True,
        ...
        self.hs['FitSavSetting box'].children = [self.hs['FitSavSetting mulsel'],
                                                 self.hs['FitSavSettingSel mulsel'],
                                                 self.hs['FitSavSettingAdd btn'],
                                                 self.hs['FitSavSettingRm btn']]
        ## ## ## ## ## ## define saving setting -- end

        self.hs['FitItem tab'].children = [self.hs['FitItemConfig box'],
        ...
        self.hs['FitRun text'] = widgets.Text(description='please check your settings before run the analysis .. ',
                                              disabled=True)
        ...
        self.hs['FitRun box'].children = [self.hs['FitRun text'],
                                          self.hs['FitRun btn']]
        ...
        self.hs['FitPrgr bar'] = widgets.IntProgress(value=0, min=0, max=10, step=1, description='Completing:',
        ...
        self.hs['Fitting form'].children = [self.hs['FitEngConfig box'],
                                            self.hs['FitItem tab'],
                                            self.hs['FitRun box'],
                                            self.hs['FitPrgr box']]
        ...
        def compound_logic():
            if self.fit_wl_pos:
                if self.fit_wl_optimizer == 'scipy':
                    ...
                    self.hs['FitConfigWlFunc drpdn'].options = PEAK_LINE_SHAPES
                    self.hs['FitConfigWlFunc drpdn'].description = 'peak func'
                    self.hs['FitConfigWlFunc drpdn'].description_tooltip = 'peak fitting functions'
                    ...
                    self.hs['FitConfigWlFunc drpdn'].description_tooltip = 'order of polynominal fitting function'
            ...
            if self.fit_edge50_pos:
                if self.fit_edge_optimizer == 'scipy':
                    ...
                    self.hs['FitConfigEdgeFunc drpdn'].options = EDGE_LINE_SHAPES
                    self.hs['FitConfigEdgeFunc drpdn'].description = 'peak func'
                    self.hs['FitConfigEdgeFunc drpdn'].description_tooltip = 'peak fitting functions'
                    ...
                    self.hs['FitConfigEdgeFunc drpdn'].description_tooltip = 'order of polynominal fitting function'

            if (not self.hs['FitItemConfigCalWlDir chbx'].value) and (not self.hs['FitItemConfigFitWl chbx'].value):
                self.hs['FitItemConfigFitWl chbx'].value = True

        if not (self.parent_h.xanes_file_configured & self.parent_h.xanes_reg_stack_done):
            boxes = ['FitEngRag box']
            enable_disable_boxes(self.hs, boxes, disabled=True, level=-1)
        else:
            boxes = ['FitEngRag box']
    ...
    def bundle_fit_var_handles(self):
        ...
        self.fit_wl_optimizer_arg_handles = [self.hs['FitConfigWlFitJac drpdn'],
                                             self.hs['FitConfigWlFitMeth drpdn'],
                                             self.hs['FitConfigWlFitFtol text'],
                                             self.hs['FitConfigWlFitXtol text'],
                                             self.hs['FitConfigWlFitGtol text'],
        ...
        self.fit_wl_fit_func_bnd_handles = [self.hs['FitConfigWlFitPars0Lb text'],
                                            self.hs['FitConfigWlFitPars0Ub text'],
                                            self.hs['FitConfigWlFitPars1Lb text'],
                                            self.hs['FitConfigWlFitPars1Ub text'],
                                            self.hs['FitConfigWlFitPars2Lb text'],
        ...
        self.fit_edge_fit_func_arg_handles = [self.hs['FitConfigEdgeFitPars0 text'],
                                              self.hs['FitConfigEdgeFitPars1 text'],
                                              self.hs['FitConfigEdgeFitPars2 text'],
                                              self.hs['FitConfigEdgeFitPars3 text'],
                                              self.hs['FitConfigEdgeFitPars4 text'],
        ...
        self.fit_edge_optimizer_arg_handles = [self.hs['FitConfigEdgeFitJac drpdn'],
                                               self.hs['FitConfigEdgeFitMeth drpdn'],
                                               self.hs['FitConfigEdgeFitFtol text'],
                                               self.hs['FitConfigEdgeFitXtol text'],
                                               self.hs['FitConfigEdgeFitGtol text'],
        ...
        self.fit_edge_fit_func_bnd_handles = [self.hs['FitConfigEdgeFitPars0Lb text'],
                                              self.hs['FitConfigEdgeFitPars0Ub text'],
                                              self.hs['FitConfigEdgeFitPars1Lb text'],
                                              self.hs['FitConfigEdgeFitPars1Ub text'],
                                              self.hs['FitConfigEdgeFitPars2Lb text'],
    ...
    def set_save_items(self):
        if self.parent_h.xanes_fit_type == 'wl':
            ...
            if self.find_wl_pos_dir:
                options.add('wl_pos_dir')
                selects.add('wl_pos_dir')

            self.hs['FitSavSetting mulsel'].options = list(sorted(options))
            self.hs['FitSavSetting mulsel'].value = ['wl_pos_dir']
    ...
    def set_xanes_analysis_eng_bounds(self):
        ...
        if self.parent_h.xanes_fit_wl_fit_eng_e > self.parent_h.xanes_fit_eng_list.max():
            ...
            self.parent_h.xanes_fit_wl_fit_eng_e = self.parent_h.xanes_fit_eng_list[int(eng_list_len/2)]
        if self.parent_h.xanes_fit_wl_fit_eng_s < self.parent_h.xanes_fit_eng_list.min():
            ...
            self.parent_h.xanes_fit_wl_fit_eng_s = self.parent_h.xanes_fit_eng_list[int(eng_list_len/2)] - 1
        ...
        if self.hs['FitEngRagOptn drpdn'].value == 'full':
            if ((self.parent_h.xanes_fit_edge_eng > self.parent_h.xanes_fit_eng_list.max()) or
                ...
                self.parent_h.xanes_fit_edge_eng = self.parent_h.xanes_fit_eng_list[int(eng_list_len/2)]
            if self.parent_h.xanes_fit_edge_0p5_fit_e > self.parent_h.xanes_fit_eng_list.max():
                ...
                self.parent_h.xanes_fit_edge_0p5_fit_e = self.parent_h.xanes_fit_eng_list[int(eng_list_len/2)]
            if self.parent_h.xanes_fit_edge_0p5_fit_s < self.parent_h.xanes_fit_eng_list.min():
                ...
                self.parent_h.xanes_fit_edge_0p5_fit_s = self.parent_h.xanes_fit_eng_list[int(eng_list_len/2)] - 1
            self.hs['FitEngRagEdgeEng text'].min = 0
            self.hs['FitEngRagEdgeEng text'].max = self.parent_h.xanes_fit_eng_list.max()
            self.hs['FitEngRagEdgeEng text'].min = self.parent_h.xanes_fit_eng_list.min()
            ...
            self.hs['FitEngRagEdge0.5End text'].max = self.parent_h.xanes_fit_eng_list.max()
            self.hs['FitEngRagEdge0.5End text'].min = self.parent_h.xanes_fit_eng_list.min()
    ...
    def fit_eng_rag_optn_drpdn(self, a):
        ...
        self.hs['FitEngRagEdge0.5End text'].value = self.parent_h.xanes_fit_edge_0p5_fit_e
        self.hs['FitEngRagEdge0.5Str text'].value = self.parent_h.xanes_fit_edge_0p5_fit_s
        ...
        if a['owner'].value == 'wl':
            ...
            layout = {'width': '19%', 'height': '100%', 'top': '15%', 'visibility': 'visible'}
            self.hs['FitEngRagPreEdgeEnd text'].layout = layout
            self.hs['FitEngRagPreEdgeEnd text'].max = 0
            self.hs['FitEngRagPreEdgeEnd text'].value = -50
            self.hs['FitEngRagPreEdgeEnd text'].min = -500
            layout = {'width': '19%', 'height': '100%', 'top': '15%', 'visibility': 'visible'}
            self.hs['FitEngRagPostEdgeStr text'].layout = layout
            self.hs['FitEngRagPostEdgeStr text'].min = 0
            self.hs['FitEngRagPostEdgeStr text'].value = 100
            self.hs['FitEngRagPostEdgeStr text'].max = 500
    ...
    def fit_eng_rag_cmf_btn_clk(self, a):
        ...
        if self.parent_h.xanes_fit_type == 'wl':
            ...
            self.hs['FitSavSetting mulsel'].options = WL_SAVE_ITEM_OPTIONS
            self.hs['FitSavSettingSel mulsel'].value = ['']
            self.hs['FitSavSettingSel mulsel'].options = WL_SAVE_DEFAULT
            ...
            self.hs['FitSavSetting mulsel'].value = ['centroid_of_eng']
            self.hs['FitSavSetting mulsel'].options = FULL_SAVE_ITEM_OPTIONS
            self.hs['FitSavSettingSel mulsel'].value = ['']
            self.hs['FitSavSettingSel mulsel'].options = FULL_SAVE_DEFAULT
    ...
    def fit_config_mask_prvw_chbx_chg(self, a):
        if a['owner'].value:
            ...
            if self.parent_h.gui_name == 'xanes3D':
                self.hs['FitItemConfigFitPrvwSli sldr'].max = self.parent_h.xanes_fit_data_shape[2]-1
                self.hs['FitItemConfigFitPrvwSli sldr'].disabled = False
    ...
    def fit_config_sel_ref_btn_clk(self, a):
        if len(self.hs['FitItemConfigLCFRef list'].options) < self.fit_lcf_ref_num:
            if len(a.files[0]) != 0:
                ...
                self.hs['FitItemConfigLCFRef list'].options = self.fit_lcf_ref_spec['fname']
                update_json_content(self.global_h.GUI_cfg_file, {'xanes_ref_d':os.path.dirname(os.path.abspath(a.files[0]))})
                self.hs['FitItemConfigLCFSelRef btn'].initialdir = os.path.dirname(
    ...
    def fit_config_wl_func_drpdn_chg(self, a):
        ...
        if self.fit_wl_optimizer == 'scipy':
            for ii in sorted(PEAK_FIT_PARAM_DICT[self.fit_wl_fit_func].keys()):
                ...
                self.fit_wl_fit_func_arg_handles[ii].description = PEAK_FIT_PARAM_DICT[self.fit_wl_fit_func][ii][0]
                self.fit_wl_fit_func_arg_handles[ii].value = PEAK_FIT_PARAM_DICT[self.fit_wl_fit_func][ii][1]
                self.fit_wl_fit_func_arg_handles[ii].description_tooltip = PEAK_FIT_PARAM_DICT[self.fit_wl_fit_func][ii][2]
    ...
    def fit_config_edge_func_drpdn_chg(self, a):
        ...
        if self.fit_edge_optimizer == 'scipy':
            for ii in sorted(PEAK_FIT_PARAM_DICT[self.fit_edge_fit_func].keys()):
                ...
                self.fit_edge_fit_func_arg_handles[ii].description = PEAK_FIT_PARAM_DICT[self.fit_edge_fit_func][ii][0]
                self.fit_edge_fit_func_arg_handles[ii].value = PEAK_FIT_PARAM_DICT[self.fit_edge_fit_func][ii][1]
                self.fit_edge_fit_func_arg_handles[ii].description_tooltip = PEAK_FIT_PARAM_DICT[self.fit_edge_fit_func][ii][2]
    ...
    def fit_sav_setting_rm_btn_clk(self, a):
        self.analysis_saving_items = set(self.hs['FitSavSettingSel mulsel'].options)
        for ii in self.hs['FitSavSettingSel mulsel'].value:
            if ii != '':
    ...
    def fit_run_btn_clk(self, a):
        ...
        if self.parent_h.gui_name == 'xanes3D':
            ...
            code[ln] = f"    xanes3D_analysis_data_shape = np.int32(np.round(f['/processed_XANES3D/proc_parameters/data_shape'][:]/{self.fit_img_bin_fac}))"; ln += 1
