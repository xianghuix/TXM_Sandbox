...
from .gui_components import (SelectFilesButton, NumpyArrayEncoder, enable_disable_boxes,
                             gen_external_py_script, fiji_viewer_state,
                             fiji_viewer_on, fiji_viewer_off, update_json_content,
...
class xanes3D_tools_gui():
    def __init__(self, parent_h, form_sz=[650, 740]):
        ...
        self.xanes_config = {"filepath config":{"xanes3D_raw_3D_h5_top_dir":self.xanes_raw_3D_h5_top_dir,
		       ...
		       "indeices config":{"select_scan_id_start_text_min":0,
                                  ...
                                  "xanes3D_indices_configured":self.xanes_data_configured
                                  },
		       ...
		       "run registration":{"xanes3D_reg_done":self.xanes_reg_trial_done
                                   },
               ...
               "align 3D recon":{"xanes3D_alignment_done":self.xanes_reg_stack_done,
    ...
    def update_xanes3D_config(self):
        self.xanes_config = {"filepath config": dict(xanes3D_raw_3D_h5_top_dir=self.xanes_raw_3D_h5_top_dir,
                   ...
                   'SelScanIdStart drpdn'].options, select_scan_id_start_text_val=self.hs[
                   'SelScanIdStart drpdn'].value, select_scan_id_end_text_options=self.hs[
                   'SelScanIdEnd drpdn'].options, select_scan_id_end_text_val=self.hs[
                   'SelScanIdEnd drpdn'].value, fixed_scan_id_slider_options=self.hs[
                   'FixedScanId drpdn'].options, fixed_scan_id_slider_val=self.hs[
                   'FixedScanId drpdn'].value,
                                       ...
                                       xanes3D_fixed_sli_id_set=self.xanes_fixed_sli_id_set,
                                       xanes3D_indices_configured=self.xanes_data_configured),
                             'roi config':{'3D_roi_x_slider_min':self.hs['3DRoiX sldr'].min,
                             ...
                             'registration config': dict(
                                 ...
                                 xanes3D_reg_params_configured=self.xanes_reg_params_configured),
                             "run registration": dict(xanes3D_reg_done=self.xanes_reg_trial_done),
                             "review registration": dict(
                                 ...
                                 alignment_best_match=self.xanes_review_shift_dict),
                             "align 3D recon": dict(xanes3D_alignment_done=self.xanes_reg_stack_done,
                                                    xanes3D_analysis_edge_eng=self.xanes_fit_edge_eng,
                                                    xanes3D_analysis_wl_fit_eng_s=self.xanes_fit_wl_fit_eng_s,
                                                    xanes3D_analysis_wl_fit_eng_e=self.xanes_fit_wl_fit_eng_e,
                                                    xanes3D_analysis_pre_edge_e=self.xanes_fit_pre_edge_e,
    ...
    def set_xanes3D_variables(self):
        ...
        self.xanes_data_configured= self.xanes_config["indeices config"]["xanes3D_indices_configured"]
        ...
        self.xanes_reg_trial_done = self.xanes_config["run registration"]["xanes3D_reg_done"]
        ...
        self.xanes_reg_stack_done = self.xanes_config["align 3D recon"]["xanes3D_alignment_done"]
    ...
    def set_xanes3D_handles(self):
        ...
        self.hs['SelScanIdStart drpdn'].value = self.xanes_config["indeices config"]["select_scan_id_start_text_val"]
        self.hs['SelScanIdEnd drpdn'].value = self.xanes_config["indeices config"]["select_scan_id_end_text_val"]

        self.hs['FixedScanId drpdn'].options = self.xanes_config["indeices config"]["fixed_scan_id_slider_options"]
        self.hs['FixedScanId drpdn'].value = self.xanes_config["indeices config"]["fixed_scan_id_slider_val"]
        self.hs['FixedSliId sldr'].max = self.xanes_config["indeices config"]["fixed_sli_id_slider_max"]
        self.hs['FixedSliId sldr'].min = self.xanes_config["indeices config"]["fixed_sli_id_slider_min"]
        self.hs['FixedSliId sldr'].value = self.xanes_config["indeices config"]["fixed_sli_id_slider_val"]

        self.hs['3DRoiX sldr'].max = self.xanes_config["roi config"]["3D_roi_x_slider_max"]
        self.hs['3DRoiX sldr'].min = self.xanes_config["roi config"]["3D_roi_x_slider_min"]
        self.hs['3DRoiX sldr'].value = self.xanes_config["roi config"]["3D_roi_x_slider_val"]
        self.hs['3DRoiY sldr'].max = self.xanes_config["roi config"]["3D_roi_y_slider_max"]
        self.hs['3DRoiY sldr'].min = self.xanes_config["roi config"]["3D_roi_y_slider_min"]
        self.hs['3DRoiY sldr'].value = self.xanes_config["roi config"]["3D_roi_y_slider_val"]
        self.hs['3DRoiZ sldr'].max = self.xanes_config["roi config"]["3D_roi_z_slider_max"]
        self.hs['3DRoiZ sldr'].min = self.xanes_config["roi config"]["3D_roi_z_slider_min"]
        self.hs['3DRoiZ sldr'].value = self.xanes_config["roi config"]["3D_roi_z_slider_val"]

        self.hs['MaskThres sldr'].max = self.xanes_config["registration config"]["mask_thres_slider_max"]
        self.hs['MaskThres sldr'].min = self.xanes_config["registration config"]["mask_thres_slider_min"]
        self.hs['MaskThres sldr'].value = self.xanes_config["registration config"]["mask_thres_slider_val"]
        self.hs['MaskDilation sldr'].max = self.xanes_config["registration config"]["mask_dilation_slider_max"]
        self.hs['MaskDilation sldr'].min = self.xanes_config["registration config"]["mask_dilation_slider_min"]
        self.hs['MaskDilation sldr'].value = self.xanes_config["registration config"]["mask_dilation_slider_val"]
        self.hs['SliSrch sldr'].max = self.xanes_config["registration config"]["sli_search_slider_max"]
        self.hs['SliSrch sldr'].min = self.xanes_config["registration config"]["sli_search_slider_min"]
        self.hs['SliSrch sldr'].value = self.xanes_config["registration config"]["sli_search_slider_val"]
        self.hs['ChunkSz sldr'].max = self.xanes_config["registration config"]["chunk_sz_slider_max"]
        self.hs['ChunkSz sldr'].min = self.xanes_config["registration config"]["chunk_sz_slider_min"]
        self.hs['ChunkSz sldr'].value = self.xanes_config["registration config"]["chunk_sz_slider_val"]

        self.hs['RegMethod drpdn'].value = self.xanes_config["registration config"]["xanes3D_reg_method"]
        self.hs['RefMode drpdn'].value = self.xanes_config["registration config"]["xanes3D_reg_ref_mode"]
        self.hs['MRTVLevel text'].value = self.xanes_config["registration config"]["xanes3D_reg_mrtv_level"]
        self.hs['MRTVWz text'].value = self.xanes_config["registration config"]["xanes3D_reg_mrtv_width"]
        self.hs['MRTVSubpixelSrchWz text'].value = self.xanes_config["registration config"]["xanes3D_reg_mrtv_subpixel_width"]
        self.hs['MRTVKernelWz text'].value = self.xanes_config["registration config"]["xanes3D_reg_mrtv_subpixel_kernel"]

        self.hs['ReadAlign chbx'].value = self.xanes_config["review registration"]["read_alignment_checkbox"]
        self.hs['RegPair sldr'].max = self.xanes_config["review registration"]["reg_pair_slider_max"]
        self.hs['RegPair sldr'].min = self.xanes_config["review registration"]["reg_pair_slider_min"]
        self.hs['RegPair sldr'].value = self.xanes_config["review registration"]["reg_pair_slider_val"]
    ...
    def boxes_logic(self):
        def xanes3D_compound_logic():
            ...
            if self.xanes_reg_review_done:
                if self.hs['AlignReconOptnSli chbx'].value:
                    boxes = ['AlignReconOptnSliStart text',
            ...
            if self.xanes_reg_stack_done | (self.xanes_fit_option == 'Do Analysis'):
                if self.xanes_visualization_viewer_option == 'fiji':
                    boxes = ['VisImgViewAlign box',
                             'VisSpecView box']
                    enable_disable_boxes(self.hs, boxes, disabled=False, level=-1)
        ...
        if self.xanes_fit_option in ['Do New Reg', 'Read Config File']:
            if not self.xanes_file_configured:
                ...
                enable_disable_boxes(self.hs, boxes, disabled=False, level=-1)
                boxes = ['FitEngRag box']
                enable_disable_boxes(self.xanes_fit_gui_h.hs, boxes, disabled=False, level=-1)
                boxes = ['FitItemConfig box']
                enable_disable_boxes(self.xanes_fit_gui_h.hs, boxes, disabled=True, level=-1)
            ...
            if self.xanes_reg_file_set & self.xanes_file_configured:
                ...
                boxes = ['FitEngRag box',
                         'FitItemConfig box']
                enable_disable_boxes(self.xanes_fit_gui_h.hs, boxes, disabled=True, level=-1)
                self.hs['SelFile&PathCfm text'].value = 'Please specify and confirm the aligned xanes3D file ...'
        self.lock_message_text_boxes()
        xanes3D_compound_logic()
    ...
    def build_gui(self):
        ...
        layout = {'border':'3px solid #8855AA', 'width':f'{self.form_sz[1]-base_wz_os}px',
                  'height':f'{0.32*(self.form_sz[0]-136)}px'}
        ...
        self.hs['SelRawH5Path btn'] = SelectFilesButton(option='askdirectory',
        ...
        self.hs['SelReconPath text'] = widgets.Text(value='Choose recon top directory ...', 
                                                    description='', disabled=True)
        layout = {'width':'66%', 'display':'inline_flex'}
        self.hs['SelReconPath text'].layout = layout
        self.hs['SelReconPath btn'] = SelectFilesButton(option='askdirectory',
                                                        text_h=self.hs['SelReconPath text'])
        layout = {'width':'15%'}
        ...
        self.hs['SelRecon box'].children = [self.hs['SelReconPath text'],
        ...
        self.hs['SelSavTrial text'] = widgets.Text(value='Save trial registration as ...', 
                                                   description='', disabled=True)
        layout = {'width':'66%', 'display':'inline_flex'}
        self.hs['SelSavTrial text'].layout = layout
        self.hs['SelSavTrial btn'] = SelectFilesButton(option='asksaveasfilename',
                                                       text_h=self.hs['SelSavTrial text'])
        ...
        self.hs['SelSavTrial box'].children = [self.hs['SelSavTrial text'],
        ...
        self.hs['SelFile&PathCfm text'] = widgets.Text(value='Save trial registration, or go directly review registration ...', description='', disabled=True)
        layout = {'width':'66%'}
        ...
        self.hs['SelFile&PathCfm btn'].on_click(self.CfmSelFilePath_btn_clk)
        layout = {'width':'15%'}
        self.hs['SelFile&PathCfm btn'].layout = layout

        self.hs['File&PathOptn drpdn'] = widgets.Dropdown(value='Do New Reg',
                                                          options=['Do New Reg',
                                                                   # 'Read Reg File',
                                                                   'Read Config File',
                                                                   'Reg By Shift',
        ...
        self.hs['File&PathOptn drpdn'].observe(self.FilePathOptn_drpdn_chg, names='value')
        ...
        layout = {'justify-content':'center', 'align-items':'center','align-contents':'center',
                  'border':'3px solid #FFCC00', 'width':f'{self.form_sz[1] - base_wz_os - ex_ws_os}px',
                  'height':f'{0.07*(self.form_sz[0]-136)}px'}
        self.hs['ConfigDataTitle box'] = widgets.HBox()
        self.hs['ConfigDataTitle box'].layout = layout
        self.hs['ConfigDataTitle label'] = widgets.HTML('<span style="color:red; font-size: 150%; font-weight: bold; background-color:rgb(135,206,250);">' + 'Config Scan & Slice Indices' + '</span>')
        ...
        self.hs['SelScanIdStart drpdn'] = widgets.Dropdown(value=0, options=[0], description='scan_id start', disabled=True)
        layout = {'width':'40%'}
        self.hs['SelScanIdStart drpdn'].layout = layout
        self.hs['SelScanIdEnd drpdn'] = widgets.Dropdown(value=0, options=[0], description='scan_id end', disabled=True)
        layout = {'width':'40%'}
        self.hs['SelScanIdEnd drpdn'].layout = layout

        self.hs['SelScanIdStart drpdn'].observe(self.SelScanIdStart_drpdn_chg, names='value')
        self.hs['SelScanIdEnd drpdn'].observe(self.SelScanIdEnd_drpdn_chg, names='value')
        self.hs['ScanIdRange box'].children = [self.hs['SelScanIdStart drpdn'],
        ...
        self.hs['FixedScanId drpdn'] = widgets.Dropdown(value=0, options=[0], description='fixed scan id', disabled=True)
        layout = {'width':'40%'}
        self.hs['FixedScanId drpdn'].layout = layout
        self.hs['FixedSliId sldr'] = widgets.IntSlider(value=0, description='fixed sli id',
        ...
        self.hs['FixedScanId box'].children = [self.hs['FixedScanId drpdn'],
        ...
        self.hs['FijiRawImgPrev chbx'] = widgets.Checkbox(value=False, description='fiji view', disabled=True)
        layout = {'width':'40%'}
        ...
        self.hs['ConfigDataCfm text'] = widgets.Text(value='Confirm setting once you are done ...', description='', disabled=True)
        layout = {'width':'66%'}
        self.hs['ConfigDataCfm text'].layout = layout
        self.hs['ConfigDataCfm btn'] = widgets.Button(description='Confirm', disabled=True,
        ...
        self.hs['ConfigDataCfm btn'].on_click(self.CfmConfigData_btn_clk)
        self.hs['ConfigDataCfm box'].children = [self.hs['ConfigDataCfm text'],
                                                 self.hs['ConfigDataCfm btn']]

        self.hs['ConfigData box'].children = [self.hs['ConfigDataTitle box'],
        ...
        self.hs["DataInfo text"] = widgets.Textarea(value='Data Info', placeholder='Data Info', description='Data Info',
                                                    disabled=True)
        ...
        layout = {'border':'3px solid #FFCC00', 'width':f'{self.form_sz[1] - base_wz_os - 3*ex_ws_os}px',
                  'height':f'{0.21*(self.form_sz[0]-136)}px'}
        self.hs['3DRoiX sldr'] = widgets.IntRangeSlider(value=[10, 40], min=1, max=50, step=1, description='x range:',
                                                        disabled=True, continuous_update=False, orientation='horizontal',
                                                        readout=True, readout_format='d')
        self.hs['3DRoiX sldr'].layout = layout
        self.hs['3DRoiY sldr'] = widgets.IntRangeSlider(value=[10, 40], min=1, max=50, step=1, description='y range:',
                                                        disabled=True, continuous_update=False, orientation='horizontal',
                                                        readout=True, readout_format='d')
        self.hs['3DRoiY sldr'].layout = layout
        self.hs['3DRoiZ sldr'] = widgets.IntRangeSlider(value=[10, 40], min=1, max=50, step=1, description='z range:',
                                                        disabled=True, continuous_update=False, orientation='horizontal',
                                                        readout=True, readout_format='d')
        self.hs['3DRoiZ sldr'].layout = layout
        self.hs['3DRoiZ sldr'].add_traits(mylower=traitlets.traitlets.Any(self.hs['3DRoiZ sldr'].lower))
        self.hs['3DRoiZ sldr'].add_traits(myupper=traitlets.traitlets.Any(self.hs['3DRoiZ sldr'].upper))
        ...
        self.hs['3DRoiDefine box'].children = [self.hs['3DRoiX sldr'],
                                               self.hs['3DRoiY sldr'],
                                               self.hs['3DRoiZ sldr']]
        ...
        self.hs['3DRoiCfm text'] = widgets.Text(description='', value='Please confirm after ROI is set ...',
                                                disabled=True)
        self.hs['3DRoiCfm text'].layout = layout
        layout = {'width':'15%', 'height':'90%'}
        self.hs['3DRoiCfm btn'] = widgets.Button(description='Confirm', disabled=True,
        ...
        self.hs['3DRoiCfm btn'].on_click(self.CfmRoi3D_btn_clk)
        self.hs['3DRoiCfm box'].children = [self.hs['3DRoiCfm text'],
                                            self.hs['3DRoiCfm btn']]

        self.hs['3DRoi box'].children = [self.hs['3DRoiTitle box'],
        ...
        self.hs['FijiMaskViewer chbx'] = widgets.Checkbox(value=False, disabled=True, description='preview',
                                                          indent=False)
        layout = {'width':'19%', 'height':'90%'}
        self.hs['FijiMaskViewer chbx'].layout = layout
        self.hs['ChunkSz chbx'] = widgets.Checkbox(value=True, disabled=True, description='use chunk')
        layout = {'width':'19%', 'height':'90%'}
        self.hs['ChunkSz chbx'].layout = layout
        self.hs['ChunkSz sldr'] = widgets.IntSlider(value=7, disabled=True,
                                                    description='chunk size',
                                                    continuous_update=False)
        layout = {'width':'29%', 'height':'90%'}
        self.hs['ChunkSz sldr'].layout = layout
        self.hs['SliSrch sldr'] = widgets.IntSlider(value=10, disabled=True,
        ...
        self.hs['UseMask chbx'] = widgets.Checkbox(value=False, disabled=True, description='use mask',
                                                   display='flex', indent=False)
        layout = {'width':'15%', 'flex-direction':'row', 'height':'90%'}
        self.hs['UseMask chbx'].layout = layout
        self.hs['MaskThres sldr'] = widgets.FloatSlider(value=False, disabled=True, description='mask thres',
                                                        readout_format='.5f', min=-1., max=10., step=1e-5,
                                                        continuous_update=False)
        ...
        self.hs['MaskOptn box'].children = [self.hs['UseMask chbx'],
        ...
        self.hs['RegMethod drpdn'] = widgets.Dropdown(value='MRTV', description='reg method', disabled=True,
        ...
        self.hs['RefMode drpdn'] = widgets.Dropdown(value='single', options=['single', 'neighbor', 'average'],
                                                    description='ref mode', disabled=True,
        ...
        self.hs['RegOptn box'].children = [self.hs['RegMethod drpdn'],
        ...
        self.hs['MRTVLevel text'] = widgets.BoundedIntText(value=4, min=1, max=10, step=1, description='level',
                                                           description_tooltip='level: multi-resolution level',
                                                           disabled=True)
        layout = {'width':'19%'}
        self.hs['MRTVLevel text'].layout = layout

        self.hs['MRTVWz text'] = widgets.BoundedIntText(value=8, min=2, max=20, step=2, description='width',
        ...
        self.hs['MRTVSubpixelSrch drpdn'] = widgets.Dropdown(value='analytical', disabled=True,
                                                             options=['analytical', 'fitting'], description='subpxl srch',
                                                             description_tooltip='subpxl srch: subpixel TV minization option')
        layout = {'width': '19%'}
        self.hs['MRTVSubpixelSrch drpdn'].layout = layout

        self.hs['MRTVSubpixelSrchWz text'] = widgets.BoundedIntText(value=3, min=2, max=20, step=0.1,
                                                                    description='subpxl wz', disabled=True,
                                                                    description_tooltip='subpxl wz: final sub-pixel fitting points')
        layout = {'width':'19%'}
        self.hs['MRTVSubpixelSrchWz text'].layout = layout

        self.hs['MRTVKernelWz text'] = widgets.BoundedFloatText(value=1.5, min=0.1, max=20, step=0.1,
        ...
        self.hs['MRTVOptn box'].children = [self.hs['MRTVLevel text'],
                                            self.hs['MRTVWz text'],
        ...
        layout = {'width':'70%', 'height':'90%'}
        self.hs['ConfigRegParamsCfm text'] = widgets.Text(description='', disabled=True,
                                                          value='Confirm the roi once you define the ROI ...')
        self.hs['ConfigRegParamsCfm text'].layout = layout
        layout = {'width':'15%', 'height':'90%'}
        self.hs['ConfigRegParamsCfm btn'] = widgets.Button(description='Confirm', disabled=True,
                                                           description_tooltip='Confirm the roi once you define the ROI ...')
        self.hs['ConfigRegParamsCfm btn'].style.button_color = 'darkviolet'
        self.hs['ConfigRegParamsCfm btn'].layout = layout

        self.hs['ConfigRegParamsCfm btn'].on_click(self.CfmConfigRegParams_btn_clk)
        self.hs['ConfigRegParamsCfm box'].children = [self.hs['ConfigRegParamsCfm text'],
        ...
        self.hs['RunRegTitle text'] = widgets.HTML('<span style="color:red; font-size: 150%; font-weight: bold; background-color:rgb(135,206,250);">' + 'Run Registration' + '</span>')
        ...
        layout = {'width':'70%', 'height':'90%'}
        self.hs['RunRegCfm text'] = widgets.Text(description='', disabled=True,
                                                 value='run registration once you are ready ...')
        self.hs['RunRegCfm text'].layout = layout
        layout = {'width':'15%', 'height':'90%'}
        self.hs['RunRegCfm btn'] = widgets.Button(description='Run Reg', disabled=True,
        ...
        self.hs['RunRegCfm btn'].on_click(self.CfmRunReg_btn_clk)
        self.hs['RunRegCfm box'].children = [self.hs['RunRegCfm text'],
        ...
        self.hs['RunRegPrgr bar'] = widgets.IntProgress(value=0, min=0, max=10, step=1, description='Completing:',
        ...
        self.hs['RegSetting form'].children = [self.hs['3DRoi box'],
        ...
        self.hs['RevRegRltTitle text'] = widgets.HTML('<span style="color:red; font-size: 150%; font-weight: bold; background-color:rgb(135,206,250);">' + 'Review Registration Results' + '</span>')
        ...
        self.hs['ReadAlign chbx'] = widgets.Checkbox(description='read alignment', value=False, disabled=True)
        ...
        layout = {'width':'15%', 'height':'90%'}
        self.hs['RegPairBad btn'] = widgets.Button(description='Bad', description_tooltip='Bad reg', disabled=True)
        ...
        self.hs['CorrXShift text'] = widgets.FloatText(value=0, disabled=True, min=-100, max=100, step=0.5,
                                                       description='x shift')
        self.hs['CorrXShift text'].layout = layout
        layout = {'width':'28%', 'height':'90%'}
        self.hs['CorrYShift text'] = widgets.FloatText(value=0, disabled=True, min=-100, max=100, step=0.5,
                                                       description='y shift')
        self.hs['CorrYShift text'].layout = layout
        layout = {'width':'27.5%', 'height':'90%'}
        self.hs['CorrZShift text'] = widgets.IntText(value=0, disabled=True, min=1, max=100, step=1,
                                                     description='z shift')
        self.hs['CorrZShift text'].layout = layout
        layout = {'width':'15%', 'height':'90%'}
        self.hs['CorrShftRecord btn'] = widgets.Button(disabled=True, description='Record')
        ...
        self.hs['CorrShft box'].children = [self.hs['CorrXShift text'],
        ...
        self.hs['RevRegRltCfm text'] = widgets.Text(description='', disabled=True,
                                                    value='Confirm after you finish reg review ...')
        self.hs['RevRegRltCfm text'].layout = layout
        layout = {'width':'15%', 'height':'90%'}
        self.hs['RevRegRltCfm btn'] = widgets.Button(description='Confirm', disabled=True,
        ...
        self.hs['RevRegRltCfm btn'].on_click(self.CfmRevRegRlt_btn_clk)
        self.hs['RevRegRltCfm box'].children = [self.hs['RevRegRltCfm text'],
        ...
        self.hs['AlignReconOptnSli chbx'] = widgets.Checkbox(description='new z range', value =False, disabled=True,
        ...
        self.hs['AlignReconOptnSliStart text'] = widgets.BoundedIntText(description='', value=0, min=0, max=10, disabled=True,
        ...
        self.hs['AlignReconOptnSliRange sldr'] = widgets.IntRangeSlider(description='z range', value=0, min=0, max=10, disabled=True,
                                                                        description_tooltip='In the case of reading and reviewing a registration file, you need to define slice start and end.',
                                                                        continuous_update=False)
        self.hs['AlignReconOptnSliRange sldr'].layout = layout
        layout = {'width':'10%', 'height':'90%'}
        self.hs['AlignReconOptnSliEnd text'] = widgets.BoundedIntText(description='', value=0, min=0, max=10, disabled=True,
                                                                      description_tooltip='In the case of reading and reviewing a registration file, you need to define slice start and end.')
        self.hs['AlignReconOptnSliEnd text'].layout = layout

        self.hs['AlignReconOptnSli chbx'].observe(self.AlignReconOptnSli_chbx_chg, names='value')
        self.hs['AlignReconOptnSliStart text'].observe(self.AlignReconOptnSliStart_text_chg, names='value')
        self.hs['AlignReconOptnSliEnd text'].observe(self.AlignReconOptnSliEnd_text_chg, names='value')
        self.hs['AlignReconOptnSliRange sldr'].observe(self.AlignReconOptnSliRange_sldr_chg, names='value')
        self.hs['AlignReconOptnSliRegion box'].children = [self.hs['AlignReconOptnSli chbx'],
        ...
        layout = {'width':'85%', 'height':'90%'}
        self.hs['AlignReconCfm text'] = widgets.Text(description='', disabled=True, value='Confirm to proceed alignment ...')
        self.hs['AlignReconCfm text'].layout = layout
        layout = {'width':'15%', 'height':'90%'}
        self.hs['AlignReconCfm btn'] = widgets.Button(description='Align', disabled=True,
        ...
        self.hs['AlignReconCfm btn'].on_click(self.CfmAlignRecon_btn_clk)
        self.hs['AlignReconCfm box'].children = [self.hs['AlignReconCfm text'],
        ...
        layout = {'width':'100%', 'height':'90%'}
        self.hs['AlignReconPrgr bar'] = widgets.IntProgress(value=0, min=0, max=10, step=1,
                                                            description='Completing:', orientation='horizontal',
                                                            bar_style='info') # 'success', 'info', 'warning', 'danger' or ''
        self.hs['AlignReconPrgr bar'].layout = layout
        
        self.hs['AlignReconPrgr box'].children = [self.hs['AlignReconPrgr bar']]

        self.hs['AlignRecon box'].children = [self.hs['AlignReconTitle box'],
        ...
        layout = {'border':'3px solid #FFCC00', 'width':f'{1*self.form_sz[1] - base_wz_os - ex_ws_os}px',
                  'height':f'{0.07*(self.form_sz[0]-136)}px'}
        self.hs['VisImgViewerOptn box'] = widgets.HBox()
        self.hs['VisImgViewerOptn box'].layout = layout
        layout = {'width':'80%', 'height':'90%'}
        self.hs['VisImgViewerOptn tgbtn'] = widgets.ToggleButtons(description='viewer options', disabled=True,
                                                                  description_tooltip='napari: provides better image preview functions; fiji: provides quick spectrum inspection functions',
                                                                  options=['fiji', 'napari'], value ='fiji')
        self.hs['VisImgViewerOptn tgbtn'].layout = layout
        layout = {'width':'20%', 'height':'90%'}
        self.hs['VisImgViewAlignOptn drpdn'] = widgets.Dropdown(description='view option',
                                                                ...
                                                                value ='x-y-E', disabled=True)
        self.hs['VisImgViewAlignOptn drpdn'].layout = layout
        
        self.hs['VisImgViewerOptn tgbtn'].observe(self.VisImgViewerOptn_tgbtn_clk, names='value')
        self.hs['VisImgViewAlignOptn drpdn'].observe(self.VisImgViewAlignOptn_drpdn_clk, names='value')
        self.hs['VisImgViewerOptn box'].children = [self.hs['VisImgViewerOptn tgbtn'],
        ...
        layout = {'width':'20%', 'height':'90%'}
        self.hs['VisImgViewAlignEng text'] = widgets.FloatText(value=0, description='E', disabled=True)
        self.hs['VisImgViewAlignEng text'].layout = layout

        self.hs['VisImgViewAlign4thDim sldr'].observe(self.VisImgViewAlign4thDim_sldr_chg, names='value')
        self.hs['VisImgViewAlignSli sldr'].observe(self.VisImgViewAlignSli_sldr_chg, names='value')
        ...
        layout = {'width':'70%', 'height':'90%'}
        self.hs['VisSpecView text'] = widgets.Text(description='', disabled=True,
                                                   value='visualize spectrum in roi ...')
        self.hs['VisSpecView text'].layout = layout
        layout = {'width':'15%', 'height':'90%', 'left':'-8%'}
        self.hs['VisSpecViewMemMnt chbx'] = widgets.Checkbox(description='mem use', value=False, disabled=True,
                                                             description_tooltip='Check on this to monitor memmory usage')
        self.hs['VisSpecViewMemMnt chbx'].layout = layout
        layout = {'width':'15%', 'height':'90%'}
        self.hs['VisSpecViewInRoi btn'] = widgets.Button(description='spec in roi', disabled=True,
        ...
        self.hs['VisSpecViewMemMnt chbx'].observe(self.VisSpecViewMemMnt_chbx_chg, names='value')
        self.hs['VisSpecViewInRoi btn'].on_click(self.VisSpecViewInRoi_btn_clk)
        self.hs['VisSpecView box'].children = [self.hs['VisSpecViewMemMnt chbx'],
    ...
    def SelSavTrial_btn_clk(self, a):
        if self.xanes_fit_option == 'Do New Reg':
            ...
            if len(a.files[0]) != 0:
                ...
                self.hs['SelSavTrial btn'].initialdir = os.path.dirname(os.path.abspath(a.files[0]))
                self.hs['SelSavTrial btn'].initialfile = os.path.basename(a.files[0])
                self.hs['SelSavTrial text'].value='Existing Registration File is Read ...'
                update_json_content(self.global_h.GUI_cfg_file, {'cwd': os.path.dirname(os.path.abspath(a.files[0]))})
                self.xanes_save_trial_set = False
    ...
    def FilePathOptn_drpdn_chg(self, a):
        ...
        if self.xanes_fit_option == 'Do New Reg':
            ...
            self.hs['SelSavTrial btn'].open_filetypes = (('json files', '*.json'), ('text files', '*.txt'))
            self.hs['SelSavTrial text'].value='Save Existing Configuration File ...'
            self.xanes_save_trial_set = False
            self.xanes_reg_file_set = False
            self.xanes_config_file_set = False
    ...
    def CfmSelFilePath_btn_clk(self, a):
        if not self.xanes_file_configured:
            if self.xanes_fit_option == 'Do New Reg':
                if not self.xanes_raw_h5_path_set:
                    self.hs['SelFile&PathCfm text'].value = 'Please specifiy raw h5 file location ...'
                    self.set_state('config file')
                elif not self.xanes_recon_path_set:
                    self.hs['SelFile&PathCfm text'].value = 'Please specifiy recon top directory location ...'
                    self.set_state('config file')
                elif not self.xanes_save_trial_set:
                    self.hs['SelFile&PathCfm text'].value = 'Please specifiy where to save trial reg result ...'
                    self.set_state('config file')
                else:
                    ...
                    if n:
                        ...
                        self.hs['SelScanIdStart drpdn'].options = self.xanes_available_raw_ids
                        self.hs['SelScanIdStart drpdn'].value = self.xanes_available_raw_ids[0]
                        self.hs['SelScanIdEnd drpdn'].options = self.xanes_available_raw_ids
                        self.hs['SelScanIdEnd drpdn'].value = self.xanes_available_raw_ids[-1]
                ...
                if not self.xanes_config_file_set:
                    ...
                    if self.xanes_reg_review_done:
                        ...
                        self.hs['SelFile&PathCfm text'].value = 'To use this option, a config up to reg review is needed ...'
            elif self.xanes_fit_option == 'Do Analysis':
                if not self.xanes_reg_file_set:
                    self.hs['SelFile&PathCfm text'].value = 'Please specifiy where to read the aligned data ...'
                    self.set_state('config file')
                else:
                    self.xanes_file_configured = True
                    self.xanes_data_configured= False
    ...
    def SelScanIdStart_drpdn_chg(self, a):
        self.xanes_scan_id_s = self.xanes_available_raw_ids.index(
            a['owner'].value)
        self.hs['SelScanIdEnd drpdn'].options = \
            self.xanes_available_raw_ids[self.xanes_scan_id_s:]
        self.hs['SelScanIdEnd drpdn'].value = \
            self.hs['SelScanIdEnd drpdn'].options[-1]
        self.hs['FixedScanId drpdn'].options = \
            self.hs['SelScanIdEnd drpdn'].options
        self.hs['FixedScanId drpdn'].value = \
            self.hs['FixedScanId drpdn'].options[0]
    ...
    def CfmConfigData_btn_clk(self, a):
        if not self.xanes_data_configured:
            if self.xanes_fit_option == 'Do New Reg':
                ...
                self.xanes_reg_best_match_filename = os.path.splitext(self.xanes_save_trial_reg_config_filename)[0].replace('config', 'reg_best_match') + '.json'
            if not self.xanes_data_configured:
                self.hs['3DRoiX sldr'].max = self.global_h.xanes3D_fiji_windows['xanes3D_virtural_stack_preview_viewer']['ip'].getWidth()
                self.hs['3DRoiX sldr'].min = 0
                self.hs['3DRoiY sldr'].max = self.global_h.xanes3D_fiji_windows['xanes3D_virtural_stack_preview_viewer']['ip'].getHeight()
    ...
    def RoiX3D_sldr_chg(self, a):
        ...
        if (not data_state) | (not viewer_state):
            fiji_viewer_on(self.global_h, self, viewer_name='xanes3D_virtural_stack_preview_viewer')
        self.global_h.xanes3D_fiji_windows['xanes3D_virtural_stack_preview_viewer']['ip'].setRoi(self.hs['3DRoiX sldr'].value[0],
    ...
    def CfmRoi3D_btn_clk(self, a):
        ...
        if not self.xanes_roi_configured:
            self.xanes_roi = [self.hs['3DRoiY sldr'].value[0],
            ...
            self.hs['SliSrch sldr'].max = min(abs(self.hs['3DRoiZ sldr'].value[1]-self.xanes_fixed_sli_id),
    ...
    def CfmConfigRegParams_btn_clk(self, a):
    ...
    def CorrShftRecord_btn_clk(self, a):
        ...
        if self.xanes_reg_method == 'SR':
            shift[best_match][0, 2] = shift[best_match][0, 2] - self.xanes_manual_xshift
            shift[best_match][1, 2] = shift[best_match][1, 2] - self.xanes_manual_yshift
            self.xanes_review_shift_dict["{}".format(self.xanes_alignment_pair_id)] = [best_match - self.xanes_reg_sli_search_half_width, shift]
        else:
    ...
    def CfmRevRegRlt_btn_clk(self, a):
    ...
    def CfmAlignRecon_btn_clk(self, a):
        if not self.xanes_reg_trial_done:
            if self.hs['AlignReconOptnSli chbx'].value:
    ...
    def VisSpecViewInRoi_btn_clk(self, a):
        ...
        self.hs['VisSpecView text'].value = 'drag the roi box to check the spectrum at different locations ...'
        self.boxes_logic()
