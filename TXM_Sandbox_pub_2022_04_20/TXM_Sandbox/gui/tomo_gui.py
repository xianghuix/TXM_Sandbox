...
class tomo_recon_gui():
    ...
    def build_gui(self):
        ...
        self.hs["AutoRefColStart text"].observe(self.AutoRefColStart_text_chg, names='value')
        self.hs["AutoRefColEnd text"].observe(self.AutoRefColEnd_text_chg, names='value')
        ...
        self.hs["CenOffsetRange sldr"].observe(self.CenOffsetRange_sldr_chg, names="value")
        ...
        self.hs["VolSliPrev sldr"].observe(self.VolSliPrev_sldr_chg, names="value")
        self.hs["VolSliViewerClose btn"].on_click(self.VolSliViewerClose_btn_clk)
        ...
        self.hs["FilterConfigLeftAddTo btn"].on_click(self.FilterConfigLeftAddTo_btn_clk)
        self.hs["FilterConfigLeftPar00 text"].observe(self.FilterConfigLeftPar00_text_chg,
                                                      names="value")
        self.hs["FilterConfigLeftPar01 text"].observe(self.FilterConfigLeftPar01_text_chg,
                                                      names="value")
        self.hs["FilterConfigLeftPar02 text"].observe(self.FilterConfigLeftPar02_text_chg,
                                                      names="value")
        self.hs["FilterConfigLeftPar03 text"].observe(self.FilterConfigLeftPar03_text_chg,
                                                      names="value")
        self.hs["FilterConfigLeftPar04 text"].observe(self.FilterConfigLeftPar04_text_chg,
                                                      names="value")
        self.hs["FilterConfigLeftPar05 text"].observe(self.FilterConfigLeftPar05_text_chg,
                                                      names="value")
        self.hs["FilterConfigLeftPar06 text"].observe(self.FilterConfigLeftPar06_text_chg,
                                                      names="value")
        self.hs["FilterConfigLeftPar07 text"].observe(self.FilterConfigLeftPar07_text_chg,
                                                      names="value")
        self.hs["FilterConfigLeftPar08 text"].observe(self.FilterConfigLeftPar08_text_chg,
                                                      names="value")
        self.hs["FilterConfigLeftPar09 text"].observe(self.FilterConfigLeftPar09_text_chg,
                                                      names="value")
        self.hs["FilterConfigLeftPar10 text"].observe(self.FilterConfigLeftPar10_text_chg,
                                                      names="value")
        self.hs["FilterConfigLeftPar11 text"].observe(self.FilterConfigLeftPar11_text_chg,
                                                      names="value")
    ...
    def VolSliPrev_sldr_chg(self, a):
        pass
    ...
    def Recon_btn_clk(self, a):
        if self.tomo_recon_type == "Trial Cent":
            ...
            if sig == 0:
                ...
                print(f"{sig}: Something runs wrong during the reconstruction. It might be due to Jupyter kernel being died. Please restart the kernel.")
        elif self.tomo_recon_type == "Vol Recon":
