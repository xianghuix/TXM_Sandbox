...
class xanes2D_tools_gui():
    def __init__(self, parent_h, form_sz=[650, 740]):
        ...
        self.xanes_reg_trial_done = False
        self.xanes_reg_review_done = False
        self.xanes_reg_stack_done = False
        ...
        self.xanes_config = {"filepath config": {"xanes2D_file_raw_h5_filename": self.xanes_file_raw_h5_filename,
                             ...
                             "run registration": {"xanes2D_reg_done": self.xanes_reg_trial_done},
                             "review registration": {
                             ...
                             "align 2D recon": {"xanes2D_alignment_done": self.xanes_reg_stack_done,
    ...
    def update_xanes2D_config(self):
        ...
        self.xanes_config = {"filepath config": {"xanes2D_file_raw_h5_filename": self.xanes_file_raw_h5_filename,
                             ...
                             "data_config": {"xanes2D_config_is_raw": self.xanes_config_is_raw,
                                             ...
                                             "xanes2D_config_raw_img_readed": self.xanes_config_raw_img_readed,
                                             "xanes2D_data_configured": self.xanes_data_configured},
                             "roi_config": {"2D_roi_x_slider_min": self.hs['2DRoiX sldr'].min,
    ...
    def set_xanes2D_variables(self):
        ...
        self.xanes_reg_trial_done = self.xanes_config["run registration"]["xanes2D_reg_done"]
        ...
        self.xanes_reg_stack_done = self.xanes_config["align 2D recon"]["xanes2D_alignment_done"]
    ...
    def set_xanes2D_handles(self):
        ...
        self.hs['2DRoiX sldr'].max = self.xanes_config["roi_config"]["2D_roi_x_slider_max"]
        self.hs['2DRoiX sldr'].min = self.xanes_config["roi_config"]["2D_roi_x_slider_min"]
        self.hs['2DRoiX sldr'].value = self.xanes_config["roi_config"]["2D_roi_x_slider_val"]
        self.hs['2DRoiY sldr'].max = self.xanes_config["roi_config"]["2D_roi_y_slider_max"]
        self.hs['2DRoiY sldr'].min = self.xanes_config["roi_config"]["2D_roi_y_slider_min"]
        self.hs['2DRoiY sldr'].value = self.xanes_config["roi_config"]["2D_roi_y_slider_val"]
        ...
        self.hs['MrtvSubpixelSrchWz text'].value = self.xanes_config["registration_config"][
            "xanes2D_regparams_mrtv_subpixel_width"]
        self.hs['MRTVKernelWz text'].value = self.xanes_config["registration_config"][
            "xanes2D_regparams_mrtv_subpixel_kernel"]
        ...
        self.hs['RegPair sldr'].value = self.xanes_config["review registration"][
            "reg_pair_slider_val"]
        self.hs['XShift text'].value = self.xanes_config["review registration"]["xshift_text_val"]
        self.hs['YShift text'].value = self.xanes_config["review registration"]["yshift_text_val"]

        self.xanes_fit_gui_h.hs['FitEngRagOptn drpdn'].value = \
            self.xanes_config["align 2D recon"]["xanes2D_analysis_type"]
        self.xanes_fit_gui_h.hs['FitEngRagEdgeEng text'].value = \
            self.xanes_config["align 2D recon"]["xanes2D_analysis_edge_eng"]
        self.xanes_fit_gui_h.hs['FitEngRagPreEdgeEnd text'].value = \
            self.xanes_config["align 2D recon"]["xanes2D_analysis_pre_edge_e"]
        self.xanes_fit_gui_h.hs['FitEngRagPostEdgeStr text'].value = \
            self.xanes_config["align 2D recon"]["xanes2D_analysis_post_edge_s"]
        self.xanes_fit_gui_h.hs['FitEngRagWlFitStr text'].value = \
            self.xanes_config["align 2D recon"]["xanes2D_analysis_wl_fit_eng_s"]
        self.xanes_fit_gui_h.hs['FitEngRagWlFitEnd text'].value = \
    ...
    def set_state(self, on_stage):
        """
        set GUI states
        :param on_stage: string in ['config file', 'config data', 'config roi',
                                    'config reg params', 'run reg', 'rev reg',
                                    'align stack', 'preview stack']
        :return: None
        """
        if on_stage == 'config file':
            self.xanes_file_configured = False
            self.xanes_data_configured = False
            self.xanes_roi_configured = False
            self.xanes_reg_params_configured = False
            ...
            self.xanes_fit_eng_configured = False
            self.xanes_review_read_alignment_option = False
        elif on_stage == 'config reg params':
            self.xanes_file_configured = True
            self.xanes_data_configured = True
            ...
            self.xanes_fit_eng_configured = False
            self.xanes_review_read_alignment_option = False
        elif on_stage == 'rev reg':
            self.xanes_file_configured = True
            self.xanes_data_configured = True
            self.xanes_roi_configured = True
            self.xanes_reg_params_configured = True
            self.xanes_reg_trial_done = True
            self.xanes_reg_review_done = False
            self.xanes_reg_stack_done = False
            self.xanes_fit_eng_configured = False
            self.xanes_review_read_alignment_option = False
        elif on_stage == 'align stack':
            self.xanes_file_configured = True
            self.xanes_data_configured = True
            self.xanes_roi_configured = True
            self.xanes_reg_params_configured = True
            ...
            self.xanes_reg_trial_done = True
            self.xanes_reg_review_done = True
            self.xanes_reg_stack_done = True
            self.xanes_fit_eng_configured = False
            self.xanes_review_read_alignment_option = False
    ...
    def boxes_logic(self):
        def xanes2D_compound_logic():
            if self.xanes_file_analysis_option == 'Reg By Shift':
                ...
                if (self.xanes_reg_trial_done and (not self.xanes_reg_file_readed) and
                        self.hs['ReadAlign chbx'].value):
                    boxes = ['RegPair box',
                             'CorrSht box']
                    enable_disable_boxes(self.hs, boxes, disabled=True, level=-1)
                    self.hs['ReadAlign btn'].disabled = False
                elif (self.xanes_reg_trial_done and
            ...
            if self.hs['RegMethod drpdn'].value in ['MPC', 'SR', 'PC']:
                ...
                self.hs['MrtvSubpixelSrchWz text'].disabled = False
                self.hs['MRTVKernelWz text'].disabled = False
            ...
            if self.hs['MrtvSubpixelSrch drpdn'].value == 'analytical':
                self.hs['MrtvSubpixelSrchWz text'].disabled = True
            else:
                self.hs['MrtvSubpixelSrchWz text'].disabled = False
        ...
        if self.xanes_file_analysis_option in ['Do New Reg', 'Read Config File']:
            if not self.xanes_file_configured:
                ...
                enable_disable_boxes(self.hs, boxes, disabled=False, level=-1)
                  ...
                  (self.xanes_roi_configured & self.xanes_reg_params_configured) &
                  (self.xanes_reg_trial_done & (not self.xanes_reg_review_done))):
                boxes = ['AlignImg box',
                         'VisImg box']
                enable_disable_boxes(self.hs, boxes, disabled=True, level=-1)
                boxes = ['Fitting form']
                ...
                enable_disable_boxes(self.hs, boxes, disabled=False, level=-1)
                  ...
                  (self.xanes_roi_configured & self.xanes_reg_params_configured) &
                  (self.xanes_reg_trial_done & self.xanes_reg_review_done) &
                  (not self.xanes_reg_stack_done)):
                boxes = ['VisImg box', ]
                enable_disable_boxes(self.hs, boxes, disabled=True, level=-1)
                boxes = ['Fitting form']
                enable_disable_boxes(self.xanes_fit_gui_h.hs,
                ...
                enable_disable_boxes(self.hs, boxes, disabled=False, level=-1)
                  ...
                  (self.xanes_roi_configured & self.xanes_reg_params_configured) &
                  (self.xanes_reg_trial_done & self.xanes_reg_review_done) &
                  (self.xanes_reg_stack_done) & (not self.xanes_fit_eng_configured)):
                boxes = ['ConfigData box',
                         '2DRoi box',
                         'ConfigRegParams box',
                         'RunReg box',
                ...
                enable_disable_boxes(self.xanes_fit_gui_h.hs,
                  ...
                  (self.xanes_roi_configured & self.xanes_reg_params_configured) &
                  (self.xanes_reg_trial_done & self.xanes_reg_review_done) &
                  (self.xanes_reg_stack_done & self.xanes_fit_eng_configured)):
                boxes = ['ConfigData box',
                         '2DRoi box',
                         'ConfigRegParams box',
                         'RunReg box',
            ...
            if not self.xanes_file_configured:
                ...
                enable_disable_boxes(self.xanes_fit_gui_h.hs,
                  ...
                  (self.xanes_reg_review_done & (not self.xanes_reg_stack_done))):
                boxes = ['2DRoi box',
                         'ReadAlignFile box',
                         'AlignImg box']
                enable_disable_boxes(self.hs, boxes, disabled=False, level=-1)
                ...
                enable_disable_boxes(self.xanes_fit_gui_h.hs,
                  ...
                  (self.xanes_reg_review_done & self.xanes_reg_stack_done) &
    ...
    def build_gui(self):
        ...
        base_wz_os = 92
        ex_ws_os = 6
        layout = {'border': '3px solid #8855AA', 'width': f'{self.form_sz[1] - base_wz_os}px',
        ...
        self.hs['SelRawH5Path text'] = widgets.Text(value='Choose raw h5 directory ...',
                                                    description='', disabled=True)
        layout = {'width': '66%', 'display': 'inline_flex'}
        self.hs['SelRawH5Path text'].layout = layout
        self.hs['SelRawH5Path btn'] = SelectFilesButton(option='askopenfilename',
        ...
        self.hs['SelRaw box'].children = [self.hs['SelRawH5Path text'],
        ...
        self.hs['SelSaveTrial text'] = widgets.Text(value='Save trial registration as ...',
                                                    description='', disabled=True)
        layout = {'width': '66%', 'display': 'inline_flex'}
        self.hs['SelSaveTrial text'].layout = layout
        self.hs['SelSaveTrial btn'] = SelectFilesButton(option='asksaveasfilename',
        ...
        self.hs['SelSaveTrial box'].children = [self.hs['SelSaveTrial text'],
        ...
        self.hs['CfmFile&Path text'] = widgets.Text(value='Save trial registration, or go directly review registration ...', 
                                                    description='', disabled=True)
        layout = {'width': '66%'}
        self.hs['CfmFile&Path text'].layout = layout
        self.hs['CfmFile&Path btn'] = widgets.Button(description='Confirm',
        ...
        self.hs['FilePathOptions drpdn'] = widgets.Dropdown(value='Do New Reg',
                                                             options=['Do New Reg',
                                                                      'Read Config File',
                                                                      'Reg By Shift',
                                                                      'Do Analysis'],
        ...
        self.hs['FilePathOptions drpdn'].observe(self.FilePathOptions_drpdn_chg, names='value')
        self.hs['SelFile&PathComfirm box'].children = [self.hs['CfmFile&Path text'],
        ...
        self.hs['IsRaw chbx'] = widgets.Checkbox(value=True, description='Is Raw',
        ...
        layout = {'width': '20%'}
        self.hs['NormScale text'] = widgets.BoundedFloatText(value=1, min=1e-10,
                                                             max=100, step=0.1,
        ...
        self.hs['ConfigDataLoadImg btn'] = widgets.Button(description='Load Images',
                                                          disabled=True)
        ...
        self.hs['EngPointsRange sldr'] = widgets.IntRangeSlider(value=0,
                                                                description='eng points range',
                                                                disabled=True, continuous_update=False)
        layout = {'width': '55%'}
        self.hs['EngPointsRange sldr'].layout = layout
        self.hs['EngStart text'] = widgets.BoundedFloatText(value=0, min=1e3,
                                                            max=5e4, step=0.1,
                                                            description='eng s (eV)', disabled=True)
        layout = {'width': '20%'}
        self.hs['EngStart text'].layout = layout
        self.hs['EngEnd text'] = widgets.BoundedFloatText(value=0, min=1e3,
                                                          max=5e4, step=0.1,
                                                          description='eng e (eV)', disabled=True)
        layout = {'width': '20%'}
        self.hs['EngEnd text'].layout = layout

        self.hs['EngPointsRange sldr'].observe(self.EngPointsRange_slider_chg, names='value')
        self.hs['EngRange box'].children = [self.hs['EngPointsRange sldr'],
        ...
        self.hs['FijiRawImgPrev chbx'] = widgets.Checkbox(value=False, description='fiji view',
                                                          disabled=True, indent=False)
        layout = {'width': '20%'}
        self.hs['FijiRawImgPrev chbx'].layout = layout
        self.hs['FijiEngId sldr'] = widgets.IntSlider(value=False, description='img #',
                                                      disabled=True, min=0,
                                                      continuous_update=False)
        layout = {'width': '60.6%'}
        self.hs['FijiEngId sldr'].layout = layout
        self.hs['FijiClose btn'] = widgets.Button(description='close all fiji viewers', disabled=True)
        layout = {'width': '15%'}
        self.hs['FijiClose btn'].layout = layout

        self.hs['FijiRawImgPrev chbx'].observe(self.FijiRawImgPrev_chbx_chg, names='value')
        self.hs['FijiEngId sldr'].observe(self.FijiEngId_sldr_chg, names='value')
        self.hs['FijiClose btn'].on_click(self.FijiClose_btn_clk)
        self.hs['Fiji box'].children = [self.hs['FijiRawImgPrev chbx'],
        ...
        self.hs['CfmConfigData text'] = widgets.Text(value='Cfm setting once you are done ...',
                                                     description='', disabled=True)
        layout = {'width': '81.0%'}
        self.hs['CfmConfigData text'].layout = layout
        self.hs['CfmConfigData btn'] = widgets.Button(description='Confirm',
        ...
        self.hs['ConfigDataCfm box'].children = [self.hs['CfmConfigData text'],
                                                 self.hs['CfmConfigData btn']]
        ## ## ## ## ## confirm data configuration -- end
        self.hs['ConfigData box'].children = [self.hs['DataPrepOptions box'],
        ...
        self.hs["DataInfo text"] = widgets.Textarea(value='Data Info',
        ...
        self.hs['DataConfig&Info tab'].children = [self.hs['ConfigData box'],
        ...
        self.hs['2DRoiY sldr'] = widgets.IntRangeSlider(value=[10, 40], min=1,
                                                        max=50, step=1,
                                                        description='y range:',
                                                        disabled=True,
                                                        continuous_update=False,
        ...
        self.hs['2DRoiDefine box'].children = [self.hs['2DRoiX sldr'],
                                               self.hs['2DRoiY sldr']]
        ## ## ## ## ## define roi -- end
        ...
        self.hs['CfmRoi text'] = widgets.Text(description='', value='Please confirm after ROI is set ...',
                                              disabled=True)
        self.hs['CfmRoi text'].layout = layout
        layout = {'width': '15%', 'height': '90%'}
        self.hs['CfmRoi btn'] = widgets.Button(description='Confirm',
        ...
        self.hs['2DRoiCfm box'].children = [self.hs['CfmRoi text'],
                                            self.hs['CfmRoi btn']]
        ## ## ## ## ## confirm roi -- end

        self.hs['2DRoi box'].children = [self.hs['2DRoiTitle box'],
        ...
        self.hs['FijiMaskViewer chbx'] = widgets.Checkbox(value=False, disabled=True,
                                                          description='preview', indent=False)
        layout = {'width': '19%'}
        self.hs['FijiMaskViewer chbx'].layout = layout
        self.hs['UseChunk chbx'] = widgets.Checkbox(value=True, disabled=True,
                                                    description='use anchor', indent=False)
        layout = {'width': '19%'}
        self.hs['UseChunk chbx'].layout = layout
        self.hs['AnchorId sldr'] = widgets.IntSlider(value=1, min=1, disabled=True,
                                                     description='anchor id',
                                                     continuous_update=False)
        layout = {'width': '29%'}
        self.hs['AnchorId sldr'].layout = layout
        self.hs['ChunkSz sldr'] = widgets.IntSlider(value=7, min=1, disabled=True,
                                                    description='chunk size',
                                                    continuous_update=False)
        layout = {'width': '29%'}
        self.hs['ChunkSz sldr'].layout = layout

        self.hs['FijiMaskViewer chbx'].observe(self.FijiMaskViewer_chbx_chg, names='value')
        ...
        self.hs['Fiji&Anchor box'].children = [self.hs['FijiMaskViewer chbx'],
        ...
        self.hs['UseMask chbx'] = widgets.Checkbox(value=False, disabled=True,
                                                   description='use mask',
                                                   indent=False)
        layout = {'width': '19%', 'flex-direction': 'row'}
        self.hs['UseMask chbx'].layout = layout
        self.hs['MaskThres sldr'] = widgets.FloatSlider(value=False, disabled=True,
                                                        description='mask thres',
                                                        readout_format='.5f',
                                                        min=-1., max=1., step=1e-5,
                                                        indent=False,
                                                        continuous_update=False)
        layout = {'width': '29%'}
        self.hs['MaskThres sldr'].layout = layout
        self.hs['MaskDilation sldr'] = widgets.IntSlider(value=False, disabled=True,
        ...
        self.hs['MaskOptions box'].children = [self.hs['UseMask chbx'],
        ...
        self.hs['UseSmooth chbx'] = widgets.Checkbox(value=False, disabled=True,
        ...
        self.hs['SmoothSigma text'] = widgets.BoundedFloatText(value=5, min=0, max=30,
        ...
        self.hs['RegMethod drpdn'] = widgets.Dropdown(value='MRTV',
        ...
        self.hs['RefMode drpdn'] = widgets.Dropdown(value='single',
        ...
        self.hs['SliSrch&ChunkSz box'].children = [self.hs['UseSmooth chbx'],
        ...
        self.hs['MrtvLevel text'] = widgets.BoundedIntText(value=4, min=1, max=10,
                                                           step=1, description='level',
                                                           description_tooltip='level: multi-resolution level',
                                                           disabled=True)
        layout = {'width': '19%'}
        self.hs['MrtvLevel text'].layout = layout

        self.hs['MrtvWz text'] = widgets.BoundedIntText(value=8, min=2, max=20,
        ...
        self.hs['MrtvSubpixelSrch drpdn'] = widgets.Dropdown(value='analytical',
        ...
        self.hs['MrtvSubpixelSrchWz text'] = widgets.BoundedIntText(value=3, min=2, max=20,
                                                                    step=0.1, description='subpxl wz',
                                                                    description_tooltip='subpxl wz: final sub-pixel fitting points',
                                                                    disabled=True)
        layout = {'width': '19%'}
        self.hs['MrtvSubpixelSrchWz text'].layout = layout

        self.hs['MRTVKernelWz text'] = widgets.BoundedFloatText(value=1.5, min=0.1, max=20,
                                                                step=0.1, description='kernel wz',
                                                                description_tooltip='us factor: upsampling factor for subpixel search',
                                                                disabled=True)
        layout = {'width': '19%'}
        self.hs['MRTVKernelWz text'].layout = layout
        ...
        self.hs['MrtvSubpixelSrchWz text'].observe(self.MRTVSubpixelSrchWz_text_chg, names='value')
        self.hs['MRTVKernelWz text'].observe(self.MrtvKernelWz_text_chg, names='value')
        self.hs['MrtvSubpixelSrch drpdn'].observe(self.MrtvSubpixelSrch_drpdn_chg, names='value')
        self.hs['MrtvOptions box'].children = [self.hs['MrtvLevel text'],
                                               self.hs['MrtvWz text'],
                                               self.hs['MrtvSubpixelSrchWz text'],
                                               self.hs['MRTVKernelWz text'],
        ...
        layout = {'width': '70%', 'height': '90%'}
        self.hs['CfmRegParams text'] = widgets.Text(description='',
                                                    value='Confirm the roi once you define the ROI ...',
                                                    disabled=True)
        self.hs['CfmRegParams text'].layout = layout
        layout = {'width': '15%', 'height': '90%'}
        self.hs['CfmRegParams btn'] = widgets.Button(description='Confirm',
                                                     description_tooltip='Confirm the roi once you define the ROI ...',
                                                     disabled=True)
        ...
        self.hs['ConfigRegParamsCfm box'].children = [self.hs['CfmRegParams text'],
                                                      self.hs['CfmRegParams btn']]
        ## ## ## ## ## confirm reg settings -- end

        self.hs['ConfigRegParams box'].children = [self.hs['ConfigRegParamsTitle box'],
        ...
        layout = {'width': '70%', 'height': '90%'}
        self.hs['RunReg text'] = widgets.Text(description='',
                                              value='run registration once you are ready ...',
                                              disabled=True)
        self.hs['RunReg text'].layout = layout
        layout = {'width': '15%', 'height': '90%'}
        self.hs['RunReg btn'] = widgets.Button(description='Run Reg',
        ...
        self.hs['RunReg btn'].on_click(self.CfmRunReg_btn_clk)
        ...
        self.hs['RunRegProgress bar'] = widgets.IntProgress(value=0, min=0, max=10,
                                                            step=1, description='Completing:',
        ...
        layout = {'width': '70%', 'height': '90%'}
        self.hs['ReadAlign chbx'] = widgets.Checkbox(description='read alignment',
        ...
        self.hs['ReadAlignFile box'].children = [self.hs['ReadAlign chbx'],
        ...
        layout = {'width': '70%', 'height': '90%'}
        self.hs['RegPair sldr'] = widgets.IntSlider(value=False, disabled=True,
        ...
        self.hs['RegPair box'].children = [self.hs['RegPair sldr'],
        ...
        self.hs['XShift text'] = widgets.FloatText(value=0, disabled=True,
                                                   min=-100, max=100, step=0.5,
                                                   description='x shift')
        self.hs['XShift text'].layout = layout
        layout = {'width': '30%', 'height': '90%'}
        self.hs['YShift text'] = widgets.FloatText(value=0, disabled=True,
                                                   min=-100, max=100, step=0.5,
                                                   description='y shift')
        ...
        self.hs['CorrSht box'].children = [self.hs['XShift text'],
                                                self.hs['YShift text'],
                                                self.hs['Record btn']]
        ## ## ## ## ## zshift box -- end
        ...
        self.hs['RevRegRltCfm box'].children = [self.hs['CfmRevRlt text'],
                                                    self.hs['CfmRevRlt btn']]
        ## ## ## ## ## confirm review results box -- end

        self.hs['RevRegRlt box'].children = [self.hs['RevRegRltTitle box'],
        ...
        layout = {'width': '70%', 'height': '90%'}
        self.hs['AlignImg text'] = widgets.Text(description='',
                                                value='Confirm to proceed alignment ...',
                                                disabled=True)
        self.hs['AlignImg text'].layout = layout
        layout = {'width': '15%', 'height': '90%'}
        self.hs['AlignImg btn'] = widgets.Button(description='Align',
        ...
        self.hs['AlignImgCfm box'].children = [self.hs['AlignImg text'],
        ...
        layout = {'width': '100%', 'height': '90%'}
        self.hs['AlignPrgs bar'] = widgets.IntProgress(value=0, min=0, max=10,
                                                       step=1, description='Completing:',
                                                       bar_style='info', orientation='horizontal')
        ...
        self.hs['AlignImg box'].children = [self.hs['AlignImgTitle box'],
        ...
        self.hs['Vis sldr'] = widgets.IntSlider(description='eng #', min=1,
                                                max=10, disabled=True,
                                                continuous_update=False)
        self.hs['Vis sldr'].layout = layout
        layout = {'width': '10%', 'height': '90%'}
        self.hs['VisEng text'] = widgets.FloatText(description='', value=0,
                                                   disabled=True)
        ...
        layout = {'width': '15%', 'height': '90%'}
        self.hs['SpecInRoi btn'] = widgets.Button(description='spec in roi',
                                                  description_tooltip='This will perform xanes2D alignment according to your configurations ...',
                                                  disabled=True)
        ...
        self.hs['Vis&Cfm box'].children = [self.hs['Vis sldr'],
                                           self.hs['VisEng text'],
                                           self.hs['VisR&C chbx'],
                                           self.hs['SpecInRoi btn']]
        ## ## ## ## ## define visualization&confirm -- end

        self.hs['VisImg box'].children = [self.hs['VisImgTitle box'],
                                          self.hs['Vis&Cfm box']]

        ## ## ## ## define functional widgets in each sub-tab - visualizaton TAB -- end
        self.hs['Reg&Rev form'].children = [self.hs['RevRegRlt box'],
    ...
    def SelSaveTrial_btn_clk(self, a):
        if self.xanes_file_analysis_option == 'Do New Reg':
            ...
            if len(a.files[0]) != 0:
                ...
                self.hs[
                    'SelSaveTrial text'].value = f'{self.xanes_file_save_trial_reg_config_filename} is Read ...'
                update_json_content(self.global_h.GUI_cfg_file, {'cwd': os.path.dirname(os.path.abspath(a.files[0]))})
                self.xanes_file_save_trial_set = False
                self.xanes_file_reg_file_set = False
        ...
        if self.xanes_file_analysis_option == 'Do New Reg':
            ...
            if not self.xanes_file_config_file_set:
                ...
                if self.xanes_data_configured:
                    ...
                    self.xanes_fit_eng_list = self.xanes_config_eng_list[self.xanes_eng_id_s:self.xanes_eng_id_e + 1]
            ...
            if not self.xanes_file_config_file_set:
                ...
                if self.xanes_reg_review_done:
                    ...
                    self.xanes_file_configured = False
                    self.hs[
                        'CfmFile&Path text'].value = 'To use this option, a config up to reg review is needed ...'
        elif self.xanes_file_analysis_option == 'Do Analysis':
    ...
    def ConfigDataLoadImg_btn_clk(self, a):
        ...
        self.hs['EngPointsRange sldr'].max = self.xanes_config_eng_list.shape[0] - 1
    ...
    def CfmConfigData_btn_clk(self, a):
        if not self.xanes_data_configured:
            self.xanes_config_is_raw = self.hs['IsRaw chbx'].value
            self.xanes_config_img_scalar = self.hs['NormScale text'].value
            self.xanes_eng_id_s = self.hs['EngPointsRange sldr'].value[0]
            self.xanes_eng_id_e = self.hs['EngPointsRange sldr'].value[1]
    ...
    def CfmRoi_btn_clk(self, a):
        ...
        if not self.xanes_roi_configured:
            ...
            self.xanes_reg_mask = (self.xanes_img[0,
                                   ...
                                   self.xanes_reg_roi[2]:self.xanes_reg_roi[3]] >
                                   0).astype(np.int8)
            self.set_state('config reg params')
            self.update_xanes2D_config()
    ...
    def MRTVSubpixelSrchWz_text_chg(self, a):
        self.xanes_reg_mrtv_subpixel_wz = a['owner'].value
        self.set_state('config reg params')
        self.boxes_logic()

    def MrtvKernelWz_text_chg(self, a):
    ...
    def MrtvSubpixelSrch_drpdn_chg(self, a):
        if a['owner'].value == 'analytical':
            self.hs['MrtvSubpixelSrchWz text'].value = 3
        else:
            self.hs['MrtvSubpixelSrchWz text'].value = 5
        self.set_state('config reg params')
        self.boxes_logic()
    ...
    def CfmRegParams_btn_clk(self, a):
        ...
        if viewer_state:
            fiji_viewer_off(self.global_h, self, viewer_name='xanes2D_mask_viewer')
        self.hs['FijiMaskViewer chbx'].value = False
        if not self.xanes_reg_params_configured:
            ...
            self.xanes_reg_mrtv_subpixel_kernel = self.hs['MRTVKernelWz text'].value
            self.xanes_reg_mrtv_subpixel_wz = self.hs['MrtvSubpixelSrchWz text'].value
            if self.hs['MrtvSubpixelSrch drpdn'].value == 'analytical':
            ...
            if self.xanes_reg_use_mask:
                ...
                if self.xanes_reg_use_smooth_img:
                    ...
                    self.xanes_img_roi[:] = self.xanes_img[self.xanes_eng_id_s:self.xanes_eng_id_e + 1,
                                            self.xanes_reg_roi[0]:self.xanes_reg_roi[1],
                                            self.xanes_reg_roi[2]:self.xanes_reg_roi[3]]
            self.set_state('run reg')
            self.update_xanes2D_config()
            json.dump(self.xanes_config, open(self.xanes_file_save_trial_reg_config_filename, 'w'), cls=NumpyArrayEncoder)
        self.boxes_logic()

    def CfmRunReg_btn_clk(self, a):
        if not self.xanes_reg_trial_done:
            ...
            if sig == 0:
                ...
                self.hs['RunReg text'].value = 'Something went wrong during XANES2D registration'
                print(f"{sig}: Jupyter kernel might be died. Please restart the kernel.")
                self.set_state('run reg')
        self.boxes_logic()
    ...
    def RegPair_sldr_chg(self, a):
        ...
        with h5py.File(self.xanes_save_trial_reg_filename, 'r') as f:
            self.xanes_review_aligned_img_original[:] = f['/trial_registration/trial_reg_results/{0}/trial_reg_img{0}'.format(
    ...
    def CfmRevRlt_btn_clk(self, a):
        if not self.xanes_reg_review_done:
    ...
    def AlignImg_btn_clk(self, a):
        if not self.xanes_reg_stack_done:
            tmp_file = os.path.join(self.global_h.tmp_dir, 'xanes2D_tmp.h5')
            tmp_dict = {}
            for key in self.xanes_review_shift_dict.keys():
                tmp_dict[key] = self.xanes_review_shift_dict[key]
            code = {}
            ln = 0
            code[ln] = f"from numpy import array";
            ln += 1
