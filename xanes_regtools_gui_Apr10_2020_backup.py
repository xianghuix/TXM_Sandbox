...
class xanes_regtools_gui():
    def __init__(self, form_sz=[650, 740]):
        ...
        self.xanes2D_raw_h5_set = False
        self.xanes2D_save_trial_set = False
        self.xanes2D_reg_file_set = False
        self.xanes2D_config_file_set = False
        self.xanes2D_config_alternative_flat_set = False
        self.xanes2D_raw_img_readed = False
        self.xanes2D_anchor_idx_set = False
        ...
        self.xanes2D_analysis_option = 'Do New Reg'
        self.xanes2D_raw_h5_filename = None
        self.xanes2D_save_trial_reg_filename = None
        self.xanes2D_save_trial_reg_config_filename = None
        self.xanes2D_alternative_flat_filename = None
        self.xanes2D_reg_best_match_filename = None

        self.xanes2D_reg_use_anchor = True
        ...
        self.xanes2D_aligned_data = None
        self.xanes2D_alignment_best_shift = {}

        self.xanes2D_analysis_option = 'Do New Reg'
        self.xanes2D_eng_id_s = None
        self.xanes2D_eng_id_e = None
    ...
    def fiji_viewer_state(self, viewer_name='xanes3D_virtural_stack_preview_viewer'):
        if viewer_name == 'xanes3D_virtural_stack_preview_viewer':
            ...
            if (self.xanes2D_img is None):
                data_state = False
            # elif ((self.xanes2D_img.shape != (self.xanes3D_roi[5]-self.xanes3D_roi[4]+1,
            #                                 self.xanes3D_roi[1]-self.xanes3D_roi[0],
            #                                 self.xanes3D_roi[3]-self.xanes3D_roi[2])) |
            #       (self.xanes3D_mask.shape != (self.xanes3D_roi[1]-self.xanes3D_roi[0],
            #                                     self.xanes3D_roi[3]-self.xanes3D_roi[2]))):
    ...
    def boxes_logic(self, tab='3D_XANES'):
        def xanes2D_compound_logic():
            if self.xanes2D_raw_img_readed:
                boxes = ['eng_range_box',
                         'fiji_box',
            ...
            if self.hs['L[0][1][0][1][1][0][0]_is_raw_checkbox'].value:
                # self.hs['L[0][1][0][1][1][0][1]_is_refine_checkbox'].value = False
                self.hs['L[0][1][0][1][1][0][1]_is_refine_checkbox'].disabled = True
                # self.hs['L[0][1][0][1][1][1][0]_use_alternative_flat_checkbox'].value = False
                self.hs['L[0][1][0][1][1][1][0]_use_alternative_flat_checkbox'].disabled = False
                # self.hs['L[0][1][0][1][1][1][1]_smooth_flat_checkbox'].value = False
            ...
            if self.hs['L[0][1][1][1][1][1]_anchor_checkbox'].value:
        ...
        if tab == '3D_XANES':
            ...
            if self.xanes3D_analysis_option == 'Do New Reg':
                if not self.xanes2D_filepath_configured:
                    boxes = ['2D_roi_box',
                             'config_reg_params_box',
                             'run_reg_box',
                             'review_reg_results_box',
                    ...
                    self.enable_disable_boxes(boxes, disabled=True, level=-1)
                    self.lock_message_text_boxes()
                elif self.xanes2D_filepath_configured & (not self.xanes2D_data_configured):
                    boxes = ['2D_roi_box',
                             'config_reg_params_box',
                             'run_reg_box',
                             'review_reg_results_box',
                             ...
                             'config_data_box']
                    self.enable_disable_boxes(boxes, disabled=True, level=-1)
                    boxes = ['data_preprocessing_options_box0',
                             'data_preprocessing_options_box2']
                    self.enable_disable_boxes(boxes, disabled=False, level=-1)
                    xanes2D_compound_logic()
                    self.lock_message_text_boxes()
                elif ((self.xanes2D_filepath_configured & self.xanes2D_data_configured) &
    ...
    def gui_layout(self):
        ...
        self.hs['L[0][1][0][1][1][0][2]_norm_scale_text'] = widgets.FloatText(value=1, description='Norm Scale', disabled=True)
        layout = {'width':'30%'}
        ...
        layout = {'width':'30%'}
        self.hs['L[0][1][0][1][1][1][2]_smooth_flat_sigma_text'] = widgets.FloatText(value=False, description='smooth sigma', disabled=True)
        ...
        layout = {'width':'15%'}
        self.hs['L[0][1][0][1][1][2][2]_config_data_load_images_button'] = widgets.Button(description='Load Images')
        ...
        self.hs['L[0][1][0][1][2][1]_eng_s_text'] = widgets.FloatText(value=0, description='eng s (keV)', disabled=True)
        layout = {'width':'20%'}
        self.hs['L[0][1][0][1][2][1]_eng_s_text'].layout = layout
        self.hs['L[0][1][0][1][2][2]_eng_e_text'] = widgets.FloatText(value=0, description='eng e (keV)', disabled=True)
        layout = {'width':'20%'}
        ...
        self.hs['L[0][1][1][0][1][1]_2D_roi_y_slider'].observe(self.L0_1_1_0_1_1_2D_roi_x_slider_change, names='value')
        ## ## ## ## ## define roi -- end
        ...
        self.hs['L[0][1][1][1][1][1]_anchor_checkbox'] = widgets.Checkbox(value=True,
                                                                          disabled=True,
                                                                          description='use anchor')
        layout = {'width':'25%'}
        self.hs['L[0][1][1][1][1][1]_anchor_checkbox'].layout = layout
        ...
        self.hs['L[0][1][1][1][1][1]_anchor_checkbox'].observe(self.L0_1_1_1_1_1_anchor_checkbox_change, names='value')
        ...
        self.hs['L[0][1][1][1][3][1]_smooth_sigma_text'] = widgets.IntText(value=5,
                                                                           disabled=True,
    ...
    def L0_2_1_1_2_1_mask_thres_slider_change(self, a):
        ...
        self.xanes3D_fiji_windows['xanes3D_mask_viewer']['ip'].setImage(ij.convert().convert(ij.dataset().create(ij.py.to_java(self.xanes3D_img*self.xanes3D_mask)), ImagePlusClass))
        self.xanes3D_fiji_windows['xanes3D_mask_viewer']['ip'].setSlice(self.xanes3D_fixed_sli_id-self.xanes3D_roi[4])
        ij.py.run_macro("""run("Enhance Contrast", "saturated=0.35")""")
        self.boxes_logic(tab='3D_XANES')
    ...
    def L0_1_0_0_1_0_select_raw_h5_path_button_click(self, a):
        if len(a.files[0]) != 0:
            self.xanes2D_raw_h5_filename = os.path.abspath(a.files[0])
    ...
    def L0_1_0_0_3_0_select_save_trial_button_click(self, a):
        if self.xanes2D_analysis_option == 'Do New Reg':
            if len(a.files[0]) != 0:
                b = ''
                t = (time.strptime(time.asctime()))
                for ii in range(6):
                    b +=str(t[ii]).zfill(2)+'-'
                self.xanes2D_save_trial_reg_filename = os.path.abspath(a.files[0]).split('.')[0]+'_'+b.strip('-')+'.h5'
                self.xanes2D_save_trial_reg_config_filename = os.path.abspath(a.files[0]).split('.')[0]+'_config_'+b.strip('-')+'.json'
                self.hs['L[0][1][0][0][2][0]_select_save_trial_button'].initialdir = os.path.dirname(os.path.abspath(a.files[0]))
                self.hs['L[0][1][0][0][2][0]_select_save_trial_button'].initialfile = os.path.basename(a.files[0])
                self.xanes2D_save_trial_set = True
                self.xanes2D_reg_file_set = False
                self.xanes2D_config_file_set = False
            else:
            ...
            self.xanes2D_filepath_configured = False
            self.hs['L[0][1][0][0][3][1]_confirm_file&path_text'].value = 'Please comfirm your change ...'
        elif self.xanes2D_analysis_option == 'Read Config File':
            if len(a.files[0]) != 0:
                self.xanes2D_save_trial_reg_config_filename_original = a.files[0]
                b = ''
                t = (time.strptime(time.asctime()))
                for ii in range(6):
                    b +=str(t[ii]).zfill(2)+'-'
                self.xanes2D_save_trial_reg_config_filename = os.path.abspath(a.files[0]).split('config')[0]+'config_'+b.strip('-')+'.json'
                self.hs['L[0][1][0][0][2][0]_select_save_trial_button'].initialdir = os.path.dirname(os.path.abspath(a.files[0]))
                self.hs['L[0][1][0][0][2][0]_select_save_trial_button'].initialfile = os.path.basename(a.files[0])
                self.hs['L[0][1][0][0][2][1]_select_save_trial_text'].value='Configuration File is Read ...'
                self.xanes2D_save_trial_set = False
                self.xanes2D_reg_file_set = False
                self.xanes2D_config_file_set = True
            else:
            ...
            if len(a.files[0]) != 0:
                ...
                self.xanes2D_save_trial_set = False
                self.xanes2D_reg_file_set = True
                self.xanes2D_config_file_set = False
            else:
    ...
    def L0_1_0_0_3_2_file_path_options_dropdown_change(self,a ):
        self.xanes2D_analysis_option = a['owner'].value
        self.xanes2D_filepath_configured = False
        if self.xanes2D_analysis_option == 'Do New Reg':
        ...
        #     self.xanes2D_config_file_set = False
        #     self.hs['L[0][1][2][0][1][1]_read_alignment_checkbox'].value = False
        #     self.hs['L[0][1][2][0][1][0]_read_alignment_button'].text_h = self.hs['L[0][1][2][0][4][0]_confirm_review_results_text']
        elif self.xanes3D_analysis_option == 'Read Config File':
            self.hs['L[0][1][0][0][1][0]_select_raw_h5_path_button'].disabled = True
            self.hs['L[0][1][0][0][2][0]_select_save_trial_button'].option = 'askopenfilename'
    ...
    def L0_1_0_0_4_0_confirm_file_path_button_click(self, a):
        if self.xanes3D_analysis_option == 'Do New Reg':
            if not self.xanes2D_raw_h5_set:
                self.hs['L[0][1][0][0][3][1]_confirm_file&path_text'].value = 'Please specifiy raw h5 file ...'
                self.xanes2D_filepath_configured = False
            elif not self.xanes2D_save_trial_set:
                self.hs['L[0][1][0][0][3][1]_confirm_file&path_text'].value = 'Please specifiy where to save trial reg result ...'
                self.xanes2D_filepath_configured = False
            else:
                f = h5py.File(self.xanes2D_raw_h5_filename, 'r')
                self.eng_list = f['X_eng'][()]
                f.close()
                self.hs['L[0][1][0][1][2][0]_eng_points_range_slider'].value = (0,1)
                self.hs['L[0][1][0][1][2][0]_eng_points_range_slider'].min = 0
                self.hs['L[0][1][0][1][2][0]_eng_points_range_slider'].max = self.eng_list.shape[0]-1
                self.hs['L[0][1][0][1][2][1]_eng_s_text'].value = self.eng_list[0]
                self.hs['L[0][1][0][1][2][2]_eng_e_text'].value = self.eng_list[1]
                ...
                self.xanes2D_reg_best_match_filename = os.path.splitext(self.xanes2D_save_trial_reg_config_filename)[0].replace('config', 'reg_best_match') + '.json'
                self.xanes2D_filepath_configured = True
        elif self.xanes2D_analysis_option == 'Read Config File':
            if not self.xanes2D_config_file_set:
                ...
                if self.xanes2D_alignment_done:
                    f = h5py.File(self.xanes3D_save_trial_reg_filename, 'r')
                    self.xanes2D_analysis_data_shape = f['/registration_results/reg_results/registered_xanes3D'].shape
                    self.xanes2D_analysis_eng_list = f['/trial_registration/trial_reg_parameters/eng_list'][:]
                    ...
                    f.close()
                    self.xanes2D_reg_best_match_filename = os.path.splitext(self.xanes3D_save_trial_reg_config_filename)[0].replace('config', 'reg_best_match') + '.json'
                    self.determine_element()
                    self.determine_fitting_energy_range()
                #     self.hs['L[0][2][3][0][1][0]_visualize_view_alignment_option_dropdown'].value = 'x-y-E'
                #     self.hs['L[0][2][3][0][1][3]_visualize_view_alignment_slice_slider'].description = 'E'
                ...
                # self.hs['L[0][2][0][0][4][1]_confirm_file&path_text'].value = 'XANES3D file config is done ...'
        elif self.xanes2D_analysis_option == 'Do Analysis':
            if not self.xanes2D_reg_file_set:
                ...
                self.xanes2D_alignment_done = False
                self.xanes2D_analysis_eng_configured = False
                f = h5py.File(self.xanes2D_save_trial_reg_filename, 'r')
                self.xanes2D_analysis_data_shape = f['/registration_results/reg_results/registered_xanes3D'].shape
                self.xanes2D_analysis_eng_list = f['/trial_registration/trial_reg_parameters/eng_list'][:]
                self.xanes2D_scan_id_s = f['/trial_registration/trial_reg_parameters/scan_ids'][0]
                self.xanes2D_scan_id_e = f['/trial_registration/trial_reg_parameters/scan_ids'][-1]
    ...
    def L0_1_0_1_1_2_1_alternative_flat_file_button_click(self, a):
        if len(a.files) != 0:
            self.xanes2D_alternative_flat_filename = a.files[0]
            self.hs['L[0][1][0][1][1][2][0]_alternative_flat_file_text'].value = self.xanes2D_alternative_flat_filename
        ...
        if self.xanes2D_config_is_raw:
            if self.xanes2D_config_use_alternative_flat:
                if self.xanes2D_config_alternative_flat_set:
                    f1 = h5py.File(self.xanes2D_raw_h5_filename, 'r')
                    f2 = h5py.File(self.xanes2D_alternative_flat_filename, 'r')
                    ...
                    self.xanes2D_raw_img_readed = True
                else:
    ...
    def L0_1_0_1_2_0_eng_points_range_slider_change(self, a):
        ...
        self.hs['L[0][1][0][1][2][1]_eng_s_text'].value = self.eng_list[a['owner'].value[0]]
        self.hs['L[0][1][0][1][2][2]_eng_e_text'].value = self.eng_list[a['owner'].value[1]]
    ...
    def L0_1_0_1_3_2_fiji_eng_id_slider(self, a):
        ...
        if not viewer_state:
            self.fiji_viewer_on(viewer_name='xanes2D_raw_img_viewer')
        if not data_state:
            self.hs['L[0][1][0][1][4][1]_confirm_config_indices_text'].value = 'xanes2D_img is not defined yet.'
        else:
            self.xanes2D_fiji_windows['xanes2D_raw_img_viewer']['ip'].setSlice(a['owner'].value+self.xanes2D_eng_id_s)
            self.hs['L[0][1][0][1][2][1]_eng_s_text'].value = self.eng_list[a['owner'].value+self.xanes2D_eng_id_s]
        self.boxes_logic(tab='2D_XANES')
    ...
    def L0_1_0_1_4_0_confirm_config_data_button_click(self, a):
        ...
        self.hs['L[0][1][1][0][1][0]_2D_roi_x_slider'].value = (10, self.xanes2D_img.shape[2]-10)

        self.hs['L[0][1][1][0][1][1]_2D_roi_y_slider'].max = self.xanes2D_img.shape[1]
        self.hs['L[0][1][1][0][1][0]_2D_roi_x_slider'].min = 0
        self.hs['L[0][1][1][0][1][1]_2D_roi_y_slider'].value = (10, self.xanes2D_img.shape[1]-10)
    ...
    def L0_1_1_0_1_1_2D_roi_x_slider_change(self, a):
        self.xanes2D_roi_configured = False
    ...
    def L0_1_1_1_1_1_anchor_checkbox_change(self, a):
        self.xanes2D_reg_use_anchor = a['owner'].value
        self.xanes2D_reg_params_configured = False
        self.boxes_logic(tab='2D_XANES')
    ...
    def L0_1_1_1_1_2_anchor_id_slider_change(self, a):
        ...
        self.xanes2D_reg_params_configured = False
        self.xanes2D_anchor_idx_set = True
        self.boxes_logic(tab='2D_XANES')
    ...
    def L0_1_1_1_2_1_mask_thres_slider_change(self, a):
        ...
        if self.xanes2D_reg_use_smooth_img:
            self.xanes2D_reg_mask[:] = skm.binary_dilation(((gaussian_filter(self.xanes2D_img[self.xanes2D_reg_anchor_idx,
                                                           ...
                                                           np.ones([self.xanes3D_reg_mask_dilation_width,
                                                                    self.xanes3D_reg_mask_dilation_width]))[:]
            self.xanes2D_fiji_windows['xanes2D_mask_viewer']['ip'].setImage(ij.convert().convert(ij.dataset().create(ij.py.to_java(gaussian_filter(self.xanes2D_img[self.xanes2D_reg_roi[0]:self.xanes2D_reg_roi[1],
                                                                                                                                                                    self.xanes2D_reg_roi[2]:self.xanes2D_reg_roi[3]],
            ...
            self.xanes2D_reg_mask[:] = skm.binary_dilation(((self.xanes2D_img[self.xanes2D_reg_anchor_idx,
                                                           ...
                                                           np.ones([self.xanes3D_reg_mask_dilation_width,
                                                                    self.xanes3D_reg_mask_dilation_width]))[:]
            self.xanes2D_fiji_windows['xanes2D_mask_viewer']['ip'].setImage(ij.convert().convert(ij.dataset().create(ij.py.to_java(self.xanes2D_img[self.xanes2D_reg_roi[0]:self.xanes2D_reg_roi[1],
                                                                                                                                                    self.xanes2D_reg_roi[2]:self.xanes2D_reg_roi[3]]*
    ...
    def L0_1_1_1_2_2_mask_dilation_slider_change(self, a):
        ...
        if self.xanes2D_reg_use_smooth_img:
            ...
            self.xanes2D_fiji_windows['xanes2D_mask_viewer']['ip'].setImage(ij.convert().convert(ij.dataset().create(ij.py.to_java(self.xanes2D_img[self.xanes2D_reg_roi[0]:self.xanes2D_reg_roi[1],
                                                                                                 ...
                                                                                                 ImagePlusClass))
        self.xanes2D_fiji_windows['xanes2D_mask_viewer']['ip'].setSlice(self.xanes2D_reg_anchor_idx)
        # self.xanes2D_reg_mask[:] = skm.binary_dilation(((self.xanes2D_img[self.xanes2D_reg_roi[0]:self.xanes2D_reg_roi[1],
        #                                                                   self.xanes2D_reg_roi[2]:self.xanes2D_reg_roi[3]] >
        #                                                  self.xanes2D_reg_use_mask).astype(np.int8)),
        #                                                np.ones([self.xanes3D_reg_mask_dilation_width,
        #                                                         self.xanes3D_reg_mask_dilation_width]))[:]
    ...
    def L0_1_1_1_3_1_smooth_sigma_text_change(self, a):
        ...
        self.xanes2D_fiji_windows['xanes2D_mask_viewer']['ip'].setSlice(self.xanes2D_reg_anchor_idx)
        # if self.xanes2D_reg_use_mask:
        #     self.xanes2D_reg_mask[:] = skm.binary_dilation(((gaussian_filter(self.xanes2D_img[self.xanes2D_reg_roi[0]:self.xanes2D_reg_roi[1],
        #                                                                                       self.xanes2D_reg_roi[2]:self.xanes2D_reg_roi[3]], self.xanes2D_reg_smooth_img_sigma) >
        #                                                      self.xanes2D_reg_use_mask).astype(np.int8)),
        #                                                    np.ones([self.xanes3D_reg_mask_dilation_width,
        #                                                             self.xanes3D_reg_mask_dilation_width]))[:]
    ...
    def L0_1_1_1_5_1_confirm_reg_params_button_click(self, a):
        self.xanes2D_reg_use_anchor = self.hs['L[0][1][1][1][1][1]_anchor_checkbox'].value
        ...
        if self.xanes2D_reg_use_mask:
            if self.xanes2D_reg_use_smooth_img:
                self.xanes2D_img = gaussian_filter(self.xanes2D_img[:,
                                                                    self.xanes2D_reg_roi[0]:self.xanes2D_reg_roi[1],
                                                                    self.xanes2D_reg_roi[2]:self.xanes2D_reg_roi[3]],
                                                   self.xanes2D_reg_smooth_img_sigma)
                self.xanes2D_reg_mask[:] = skm.binary_dilation(((gaussian_filter(self.xanes2D_img[self.xanes2D_reg_anchor_idx,
                ...
                self.xanes2D_img = self.xanes2D_img[:,
                                                    self.xanes2D_reg_roi[0]:self.xanes2D_reg_roi[1],
                                                    self.xanes2D_reg_roi[2]:self.xanes2D_reg_roi[3]]
                self.xanes2D_reg_mask[:] = skm.binary_dilation(((self.xanes2D_img[self.xanes2D_reg_anchor_idx,
                                                                                  self.xanes2D_reg_roi[0]:self.xanes2D_reg_roi[1],
    ...
    def L0_1_1_2_1_0_run_reg_button_click(self, a):
        reg = xr.regtools(method=self.xanes2D_reg_method, mode='TRANSLATION')
        reg.set_mask(self.xanes2D_reg_mask)
        if self.xanes2D_reg_use_anchor:
            reg.cal_set_anchor(self.xanes2D_eng_id_s, self.xanes2D_eng_id_e, self.xanes2D_reg_anchor_idx)
        # reg.set_saving(save_path=fn.parents[0], fn='aligned_' + fn.name)
        reg.set_moving_data(self.xanes2D_img)
        # reg.set_raw_data_info(**{'X_eng': eng[img_s:img_e], 'roi': roi, 'mask': mask})
        reg.reg_xanes2D_chunk(overlap_ratio=0.3, method=self.xanes2D_reg_method, ref_mode=self.xanes2D_reg_ref_mode)
        # if self.xanes2D_reg_use_smooth_img:
