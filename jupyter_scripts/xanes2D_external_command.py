...
with h5py.File('/media/Disk2/data/Zhi/2D_trial_reg_multipos_2D_xanes_scan2_id_61393_repeat_00_pos_02_2020-09-21-19-42-02.h5', 'r+') as f:
    ...
    if xanes2D_analysis_type == 'wl':
        _g12 = {}
        for jj in {'edge_pos_fit', 'edge0.5_pos_direct', 'edge_jump_filter', 'whiteline_peak_height_direct', 'whiteline_pos_fit', 'post_edge_sd', 'pre_edge_mean', 'pre_edge_sd', 'edge0.5_pos_fit', 'whiteline_pos_direct', 'weighted_eng', 'edge_pos_direct', 'centroid_of_eng_relative_to_wl', 'normalized_spectrum', 'weighted_attenuation', 'edge_offset_filter', 'post_edge_mean', 'centroid_of_eng'}:
            if jj in ['pre_edge_fit_coef', 'post_edge_fit_coef', 'whiteline_fit_coef']:
                _g12[jj] = g12.create_dataset(jj, shape=(list(len([1.0, 7730.0, 1.0])) + list(xanes2D_analysis_data_shape[1:])), dtype=np.float32)
        ...
        xana.fit_whiteline(xanes2D_analysis_wl_fit_eng_s, xanes2D_analysis_wl_fit_eng_e, 'scipy', **{'model': 'lorentzian', 'fvars': [1.0, 7730.0, 1.0], 'bnds': None, 'jac': '3-point', 'method': 'trf', 'ftol': 1e-07, 'xtol': 1e-07, 'gtol': 1e-07, 'ufac': 50})
        if True:
        ...
        if ('edge0.5_pos_fit' in {'edge_pos_fit', 'edge0.5_pos_direct', 'edge_jump_filter', 'whiteline_peak_height_direct', 'whiteline_pos_fit', 'post_edge_sd', 'pre_edge_mean', 'pre_edge_sd', 'edge0.5_pos_fit', 'whiteline_pos_direct', 'weighted_eng', 'edge_pos_direct', 'centroid_of_eng_relative_to_wl', 'normalized_spectrum', 'weighted_attenuation', 'edge_offset_filter', 'post_edge_mean', 'centroid_of_eng'}) and ('edge_pos_fit' in {'edge_pos_fit', 'edge0.5_pos_direct', 'edge_jump_filter', 'whiteline_peak_height_direct', 'whiteline_pos_fit', 'post_edge_sd', 'pre_edge_mean', 'pre_edge_sd', 'edge0.5_pos_fit', 'whiteline_pos_direct', 'weighted_eng', 'edge_pos_direct', 'centroid_of_eng_relative_to_wl', 'normalized_spectrum', 'weighted_attenuation', 'edge_offset_filter', 'post_edge_mean', 'centroid_of_eng'}):
        ...
        elif ('edge0.5_pos_fit' in {'edge_pos_fit', 'edge0.5_pos_direct', 'edge_jump_filter', 'whiteline_peak_height_direct', 'whiteline_pos_fit', 'post_edge_sd', 'pre_edge_mean', 'pre_edge_sd', 'edge0.5_pos_fit', 'whiteline_pos_direct', 'weighted_eng', 'edge_pos_direct', 'centroid_of_eng_relative_to_wl', 'normalized_spectrum', 'weighted_attenuation', 'edge_offset_filter', 'post_edge_mean', 'centroid_of_eng'}) and not ('edge_pos_fit' in {'edge_pos_fit', 'edge0.5_pos_direct', 'edge_jump_filter', 'whiteline_peak_height_direct', 'whiteline_pos_fit', 'post_edge_sd', 'pre_edge_mean', 'pre_edge_sd', 'edge0.5_pos_fit', 'whiteline_pos_direct', 'weighted_eng', 'edge_pos_direct', 'centroid_of_eng_relative_to_wl', 'normalized_spectrum', 'weighted_attenuation', 'edge_offset_filter', 'post_edge_mean', 'centroid_of_eng'}):
            xana.fit_edge(xanes2D_analysis_edge_0p5_fit_s, xanes2D_analysis_edge_0p5_fit_e, 'numpy', **{'order': 3, 'ufac': 50, 'flt_spec': False})
        elif not ('edge0.5_pos_fit' in {'edge_pos_fit', 'edge0.5_pos_direct', 'edge_jump_filter', 'whiteline_peak_height_direct', 'whiteline_pos_fit', 'post_edge_sd', 'pre_edge_mean', 'pre_edge_sd', 'edge0.5_pos_fit', 'whiteline_pos_direct', 'weighted_eng', 'edge_pos_direct', 'centroid_of_eng_relative_to_wl', 'normalized_spectrum', 'weighted_attenuation', 'edge_offset_filter', 'post_edge_mean', 'centroid_of_eng'}) and ('edge_pos_fit' in {'edge_pos_fit', 'edge0.5_pos_direct', 'edge_jump_filter', 'whiteline_peak_height_direct', 'whiteline_pos_fit', 'post_edge_sd', 'pre_edge_mean', 'pre_edge_sd', 'edge0.5_pos_fit', 'whiteline_pos_direct', 'weighted_eng', 'edge_pos_direct', 'centroid_of_eng_relative_to_wl', 'normalized_spectrum', 'weighted_attenuation', 'edge_offset_filter', 'post_edge_mean', 'centroid_of_eng'}):
            tem = deepcopy({'order': 3, 'ufac': 50, 'flt_spec': False})
            tem['cal_deriv'] = False
            xana.fit_edge_0p5(xanes2D_analysis_edge_0p5_fit_s, xanes2D_analysis_edge_0p5_fit_e, 'numpy', **tem)
        if 'edge_pos_direct' in {'edge_pos_fit', 'edge0.5_pos_direct', 'edge_jump_filter', 'whiteline_peak_height_direct', 'whiteline_pos_fit', 'post_edge_sd', 'pre_edge_mean', 'pre_edge_sd', 'edge0.5_pos_fit', 'whiteline_pos_direct', 'weighted_eng', 'edge_pos_direct', 'centroid_of_eng_relative_to_wl', 'normalized_spectrum', 'weighted_attenuation', 'edge_offset_filter', 'post_edge_mean', 'centroid_of_eng'}:
        ...
        if 'whiteline_pos_fit' in {'edge_pos_fit', 'edge0.5_pos_direct', 'edge_jump_filter', 'whiteline_peak_height_direct', 'whiteline_pos_fit', 'post_edge_sd', 'pre_edge_mean', 'pre_edge_sd', 'edge0.5_pos_fit', 'whiteline_pos_direct', 'weighted_eng', 'edge_pos_direct', 'centroid_of_eng_relative_to_wl', 'normalized_spectrum', 'weighted_attenuation', 'edge_offset_filter', 'post_edge_mean', 'centroid_of_eng'}:
            xana.fit_whiteline(xanes2D_analysis_wl_fit_eng_s, xanes2D_analysis_wl_fit_eng_e, 'scipy', **{'model': 'lorentzian', 'fvars': [1.0, 7730.0, 1.0], 'bnds': None, 'jac': '3-point', 'method': 'trf', 'ftol': 1e-07, 'xtol': 1e-07, 'gtol': 1e-07, 'ufac': 50})
        if 'whiteline_pos_direct' in {'edge_pos_fit', 'edge0.5_pos_direct', 'edge_jump_filter', 'whiteline_peak_height_direct', 'whiteline_pos_fit', 'post_edge_sd', 'pre_edge_mean', 'pre_edge_sd', 'edge0.5_pos_fit', 'whiteline_pos_direct', 'weighted_eng', 'edge_pos_direct', 'centroid_of_eng_relative_to_wl', 'normalized_spectrum', 'weighted_attenuation', 'edge_offset_filter', 'post_edge_mean', 'centroid_of_eng'}:
            xana.calc_whiteline_direct(xanes2D_analysis_wl_fit_eng_s, xanes2D_analysis_wl_fit_eng_e)
        if 'whiteline_peak_height_direct' in {'edge_pos_fit', 'edge0.5_pos_direct', 'edge_jump_filter', 'whiteline_peak_height_direct', 'whiteline_pos_fit', 'post_edge_sd', 'pre_edge_mean', 'pre_edge_sd', 'edge0.5_pos_fit', 'whiteline_pos_direct', 'weighted_eng', 'edge_pos_direct', 'centroid_of_eng_relative_to_wl', 'normalized_spectrum', 'weighted_attenuation', 'edge_offset_filter', 'post_edge_mean', 'centroid_of_eng'}:
            xana.calc_direct_whiteline_peak_height(xanes2D_analysis_wl_fit_eng_s, xanes2D_analysis_wl_fit_eng_e)
        if ('centroid_of_eng' or 'centroid_of_eng_relative_to_wl' or 'weighted_attenuation' or 'weighted_eng') in {'edge_pos_fit', 'edge0.5_pos_direct', 'edge_jump_filter', 'whiteline_peak_height_direct', 'whiteline_pos_fit', 'post_edge_sd', 'pre_edge_mean', 'pre_edge_sd', 'edge0.5_pos_fit', 'whiteline_pos_direct', 'weighted_eng', 'edge_pos_direct', 'centroid_of_eng_relative_to_wl', 'normalized_spectrum', 'weighted_attenuation', 'edge_offset_filter', 'post_edge_mean', 'centroid_of_eng'}:
