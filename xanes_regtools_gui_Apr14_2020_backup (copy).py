...
class xanes_regtools_gui():
    ...
    def L0_1_0_0_3_0_select_save_trial_button_click(self, a):
        if self.xanes2D_file_analysis_option == 'Do New Reg':
            if len(a.files[0]) != 0:
                ...
                # for ii in range(6):
                #     b +=str(t[ii]).zfill(2)+'-'
                # self.xanes2D_file_save_trial_reg_filename = os.path.abspath(a.files[0]).split('.')[0]+'_'+b.strip('-')+'.h5'
    ...
    def L0_1_1_2_1_0_run_reg_button_click(self, a):
        ...
        self.xanes2D_review_aligned_img_original = np.asarray(self.xanes2D_img_roi[0])
        self.xanes2D_review_aligned_img = np.asarray(self.xanes2D_img_roi[0])
        self.xanes2D_review_fixed_img = np.asarray(self.xanes2D_img_roi[0])
        self.xanes2D_review_shift_dict = {}
        f = h5py.File(self.xanes2D_file_save_trial_reg_filename, 'r')
    ...
    def L0_1_2_0_3_2_record_button_click(self, a):
        ...
        f.close()
        self.xanes2D_review_shift_dict["{}".format(self.xanes2D_review_alignment_pair_id)] = [shift[0]+self.xanes2D_manual_yshift,
