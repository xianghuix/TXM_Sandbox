...
class io_config_gui():
    ...
    def boxes_logics(self):
        if self.hs['L[0][3][0][0][0]_io_option_checkbox'].value:
    ...
    def build_gui(self):
        ...
        ## ## ## ## reader option -- start
        self.hs['L[0][3][0][0]_io_option_box'] = create_widget('VBox', {'border':'3px solid #8855AA', 'width':f'{self.form_sz[1]-94}px', 'height':f'{0.08*(self.form_sz[0]-136)}px'})
        self.hs['L[0][3][0][0][0]_io_option_checkbox'] = create_widget('Checkbox', {'width':f'{0.23*(self.form_sz[1]-94)}px', 'height':f'{0.06*(self.form_sz[0]-136)}px'},
        ...
        self.hs['L[0][3][0][1]_io_user_spec_box'] = create_widget('VBox', {'border':'3px solid #8855AA', 'width':f'{self.form_sz[1]-94}px', 'height':f'{0.33*(self.form_sz[0]-136)}px'})
        ...
        self.hs['L[0][3][0][1][0][1]_io_spec_tomo_reader_btn'] = grid_user_reader_hs[0, 68:83]
        self.hs['L[0][3][0][1][0][1]_io_spec_tomo_reader_btn'].description = 'Tomo Reader' 
        ...
        self.hs['L[0][3][0][1][0][3]_io_spec_xanes2D_reader_btn'] = grid_user_reader_hs[1, 68:83]
        self.hs['L[0][3][0][1][0][3]_io_spec_xanes2D_reader_btn'].description = 'XANES2D Reader' 
        ...
        self.hs['L[0][3][0][1][0][5]_io_spec_xanes3D_reader_btn'] = grid_user_reader_hs[2, 68:83]
        self.hs['L[0][3][0][1][0][5]_io_spec_xanes3D_reader_btn'].description = 'XANES3D Reader' 
        
        self.hs['L[0][3][0][1][0][1]_io_spec_tomo_reader_btn'].on_click(self.L0_3_0_1_0_1_io_spec_tomo_reader_btn_click)
        self.hs['L[0][3][0][1][0][3]_io_spec_xanes2D_reader_btn'].on_click(self.L0_3_0_1_0_3_io_spec_xanes2D_reader_btn_click)
        self.hs['L[0][3][0][1][0][5]_io_spec_xanes3D_reader_btn'].on_click(self.L0_3_0_1_0_5_io_spec_xanes3D_reader_btn_click)
        ...
        self.hs['L[0][3][0][2]_fn_pattern_box'] = create_widget('VBox', {'border':'3px solid #FFCC00', 'width':f'{self.form_sz[1]-94}px', 'height':f'{self.form_sz[0]-136}px'})
        
        ## ## ## ## default file patterns -- start
        self.hs['L[0][3][0][2][0]_fn_def_patt_box'] = create_widget('VBox', {'border':'3px solid #8855AA', 'width':f'{self.form_sz[1]-100}px', 'height':f'{0.31*(self.form_sz[0]-136)}px'})
        ...
        grid_fn_pattern_hs = GridspecLayout(6, 100,
                                            layout = {"border":"3px solid #FFCC00",
                                                      ...
                                                      "align_items":"flex-start",
                                                      "justify_items":"flex-start"})
        self.hs['L[0][3][0][2][0][0]_fn_def_edit_box'] = grid_fn_pattern_hs
        ...
        self.hs['L[0][3][0][2][0][0][0]_fn_def_patt_html'] = grid_fn_pattern_hs[0, 38:70]
        ...
        self.hs['L[0][3][0][2][0][0][1]_fn_tomo_def_raw_patt_text'] = grid_fn_pattern_hs[1, :50]
        ...
        self.hs['L[0][3][0][2][0][0][2]_fn_xanes2D_def_raw_patt_text'] = grid_fn_pattern_hs[1, 50:]
        ...
        self.hs['L[0][3][0][2][0][0][3]_fn_xanes3D_def_tomo_raw_patt_text'] = grid_fn_pattern_hs[2, :50]
        ...
        self.hs['L[0][3][0][2][0][0][4]_fn_xanes3D_def_tomo_recon_dir_patt_text'] = grid_fn_pattern_hs[2, 50:]
        ...
        self.hs['L[0][3][0][2][0][0][5]_fn_xanes3D_def_tomo_recon_fn_patt_text'] = grid_fn_pattern_hs[3, :50]
        ...
        self.hs['L[0][3][0][2][0][0][6]_fn_def_patt_confirm_btn'] = grid_fn_pattern_hs[5, 44:60]
        self.hs['L[0][3][0][2][0][0][6]_fn_def_patt_confirm_btn'].style.button_color = 'darkviolet'
        self.hs['L[0][3][0][2][0][0][6]_fn_def_patt_confirm_btn'].on_click(self.L0_3_2_0_0_6_fn_def_patt_confirm_btn_click)
        
        self.hs['L[0][3][0][2][0][0]_fn_def_edit_box'].children = get_handles(self.hs, 'L[0][3][0][2][0][0]_fn_def_edit_box', -1)
        
        self.hs['L[0][3][0][2][0]_fn_def_patt_box'].children = get_handles(self.hs, 'L[0][3][0][2][0]_file_default_pattern_box', -1)
        ## ## ## ## default file patterns -- end
        
        self.hs['L[0][3][0][2]_fn_pattern_box'].children = get_handles(self.hs, 'L[0][3][0][2]_file_pattern_box', -1)
        ...
        self.hs['L[0][3][1][3][0]_io_confirm_btn'] = grid_confirm_hs[0, 44:60]
        self.hs['L[0][3][1][3][0]_io_confirm_btn'].style.button_color = 'darkviolet'
        
        self.hs['L[0][3][1][3][0]_io_confirm_btn'].on_click(self.L0_3_1_3_0_io_confirm_btn_click)
    ...
    def L0_3_1_3_0_io_confirm_btn_click(self, a):
        save_io_config(self)
    ...
    def L0_3_0_1_0_1_io_spec_tomo_reader_btn_click(self, a):
        if len(a.files[0]) != 0:
    ...
    def L0_3_0_1_0_3_io_spec_xanes2D_reader_btn_click(self, a):
        if len(a.files[0]) != 0:
    ...
    def L0_3_2_0_0_6_fn_def_patt_confirm_btn_click(self, a):
        save_io_config(self)
        with open(self.global_h.io_data_struc_tomo_cfg_file, 'r') as f:
            self.global_h.io_tomo_cfg = json.load(f)
