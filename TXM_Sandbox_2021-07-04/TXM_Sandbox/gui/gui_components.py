...
from ..utils.tomo_recon_tools import TOMO_RECON_PARAM_DICT
    ...
    try:
        with h5py.File(fn, 'r') as f:
            if scan_type == 'tomo':
                ...
                data_info['img_dim'] = f[cfg['structured_h5_reader']['io_data_info']['item00_path']].shape
                data_info['magnification'] = f[cfg['structured_h5_reader']['io_data_info']['item01_path']][()]
                data_info['pixel size'] = f[cfg['structured_h5_reader']['io_data_info']['item02_path']][()]
                data_info['eng_len'] = f[cfg['structured_h5_reader']['io_data_info']['item03_path']].shape[0]
                data_info['eng_min'] = np.min(f[cfg['structured_h5_reader']['io_data_info']['item03_path']])
                data_info['eng_max'] = np.max(f[cfg['structured_h5_reader']['io_data_info']['item03_path']])
                data_info['note'] = f[cfg['structured_h5_reader']['io_data_info']['item04_path']][()]
                data_info['scan time'] = datetime.fromtimestamp(f[cfg['structured_h5_reader']['io_data_info']['item05_path']][()]).strftime("%m/%d/%Y, %H:%M:%S")
...
def determine_fitting_energy_range(xanes_element):
    ...
    return (xanes_analysis_edge_eng, xanes_analysis_wl_fit_eng_s,
            ...
            xanes_analysis_edge_0p5_fit_e) or None
    ...
    try:
        if viewer_name == 'all':
            ...
            if viewer_state:
                ...
                elif viewer_name.split('_')[0] == 'xanes3D':
                ...
                elif viewer_name.split('_')[0] == 'tomo':
                    global_h.tomo_fiji_windows[viewer_name]['ip'].close()
                    global_h.tomo_fiji_windows[viewer_name]['ip'] = None
                    global_h.tomo_fiji_windows[viewer_name]['fiji_id'] = None
    except:
    ...
    if viewer_name == 'xanes3D_virtural_stack_preview_viewer':
        ...
        if not viewer_state:
            gui_h.fn0 = gui_h.xanes_recon_3D_tiff_temp.format(
                gui_h.xanes_available_raw_ids[gui_h.xanes_fixed_scan_id-gui_h.xanes_scan_id_s],
            ...
            global_h.xanes3D_fiji_windows['xanes3D_virtural_stack_preview_viewer']['ip'].setSlice(gui_h.xanes_fixed_sli_id-
                                                                                      gui_h.xanes_available_sli_file_ids[0])
            global_h.xanes3D_fiji_windows['xanes3D_virtural_stack_preview_viewer']['ip'].setTitle(viewer_name)
        ...
        if not viewer_state:
            ...
            for ii in range(gui_h.xanes_roi[4], gui_h.xanes_roi[5]+1):
                fn = gui_h.xanes_recon_3D_tiff_temp.format(
                    gui_h.xanes_available_raw_ids[gui_h.xanes_fixed_scan_id-gui_h.xanes_scan_id_s], str(ii).zfill(5))
                gui_h.xanes_img_roi[cnt, ...] = tifffile.imread(fn)[gui_h.xanes_roi[0]:gui_h.xanes_roi[1],
            ...
            global_h.xanes3D_fiji_windows['xanes3D_mask_viewer']['ip'].setSlice(gui_h.xanes_fixed_sli_id-gui_h.xanes_roi[4])
            global_h.xanes3D_fiji_windows['xanes3D_mask_viewer']['ip'].setTitle(viewer_name)
        else:
            global_h.xanes3D_fiji_windows['xanes3D_mask_viewer']['ip'].setSlice(gui_h.xanes_fixed_sli_id-gui_h.xanes_roi[4])
        ...
        if not viewer_state:
            ...
            global_h.xanes3D_fiji_windows['xanes3D_review_viewer']['ip'].setTitle(viewer_name)
    elif viewer_name == 'xanes3D_review_manual_viewer':
        data_state, viewer_state = fiji_viewer_state(global_h, gui_h,
                                                     viewer_name='xanes3D_review_manual_viewer')
        if not viewer_state:
            global_h.ijui.show(global_h.ij.py.to_java(gui_h.xanes_review_aligned_img - gui_h.trial_reg_fixed))
            global_h.ij.py.run_macro("""run("Enhance Contrast", "saturated=0.35")""")
            ...
            global_h.xanes3D_fiji_windows['xanes3D_review_manual_viewer']['ip'].setTitle(viewer_name)
        ...
        if not data_state:
            with h5py.File(gui_h.xanes_save_trial_reg_filename, 'r') as f:
                if gui_h.hs['L[0][2][2][2][3][1]_visualize_view_alignment_option_dropdown'].value == 'x-y-E':
                    ...
                    gui_h.xanes_aligned_data = f['/registration_results/reg_results/registered_xanes3D'][:, gui_h.hs['L[0][2][2][2][1][2]_visualize_view_alignment_4th_dim_slider'].value, :, :]
        ...
        if not viewer_state:
            ...
            global_h.xanes3D_fiji_windows['xanes3D_analysis_viewer']['ip'].setSlice(gui_h.hs['L[0][2][2][2][1][3]_visualize_view_alignment_slice_slider'].value)
            gui_h.hs['L[0][2][2][2][1][1]_visualize_alignment_eng_text'].value = gui_h.xanes_fit_eng_list[gui_h.hs['L[0][2][2][2][1][3]_visualize_view_alignment_slice_slider'].value]
        ...
        if data_state:
            if not viewer_state:
                ...
                global_h.xanes3D_fiji_windows[viewer_name]['ip'].setTitle(viewer_name)
        ...
        if data_state:
            if not viewer_state:
                global_h.ijui.show(global_h.ij.py.to_java(gui_h.edge_jump_mask*gui_h.spec[int(gui_h.spec.shape[0]/2)]))
                global_h.ij.py.run_macro("""run("Enhance Contrast", "saturated=0.35")""")
                global_h.xanes3D_fiji_windows[viewer_name]['ip'] = global_h.WindowManager.getCurrentImage()
                global_h.xanes3D_fiji_windows[viewer_name]['fiji_id'] = global_h.WindowManager.getIDList()[-1]
                global_h.xanes3D_fiji_windows[viewer_name]['ip'].setTitle(viewer_name)
        ...
        if not viewer_state:
            ...
            global_h.xanes2D_fiji_windows['xanes2D_raw_img_viewer']['ip'].setTitle(viewer_name)
    elif viewer_name == 'xanes2D_mask_viewer':
        data_state, viewer_state = fiji_viewer_state(global_h, gui_h,
                                                     viewer_name='xanes2D_mask_viewer')
        if not viewer_state:
            global_h.ijui.show(global_h.ij.py.to_java(gui_h.xanes_img[gui_h.xanes_eng_id_s:gui_h.xanes_eng_id_e+1,
            ...
            global_h.xanes2D_fiji_windows['xanes2D_mask_viewer']['ip'].setTitle(viewer_name)
    elif viewer_name == 'xanes2D_review_viewer':
        data_state, viewer_state = fiji_viewer_state(global_h, gui_h,
                                                     viewer_name='xanes2D_review_viewer')
        if not viewer_state:
            global_h.ijui.show(global_h.ij.py.to_java(gui_h.xanes_review_aligned_img - gui_h.xanes_review_fixed_img))
            global_h.ij.py.run_macro("""run("Enhance Contrast", "saturated=0.35")""")
            ...
            global_h.xanes2D_fiji_windows['xanes2D_review_viewer']['ip'].setTitle(viewer_name)
        ...
        if not viewer_state:
            ...
            global_h.xanes2D_fiji_windows['xanes2D_analysis_viewer']['ip'].setTitle(viewer_name)
        ...
        if data_state:
            if not viewer_state:
                ...
                global_h.xanes2D_fiji_windows[viewer_name]['ip'].setTitle(viewer_name)
        ...
        if not viewer_state:
            ...
            global_h.ij.py.run_macro("""run("Enhance Contrast", "saturated=0.35")""")
            global_h.tomo_fiji_windows[viewer_name]['ip'] = global_h.WindowManager.getCurrentImage()
            global_h.tomo_fiji_windows[viewer_name]['fiji_id'] = global_h.WindowManager.getIDList()[-1]
            global_h.tomo_fiji_windows[viewer_name]['ip'].setSlice(0)
            global_h.tomo_fiji_windows[viewer_name]['ip'].setTitle(viewer_name)
        ...
        data_state, viewer_state = fiji_viewer_state(global_h, gui_h,
                                                     viewer_name=viewer_name)
        if not viewer_state:
            recon_dir = os.path.join(gui_h.tomo_recon_top_dir,
...
def fiji_viewer_state(global_h, gui_h, viewer_name='xanes3D_virtural_stack_preview_viewer'):
    if viewer_name == 'xanes3D_virtural_stack_preview_viewer':
        ...
        if (gui_h.xanes_reg_mask is None):
            data_state = False
        elif (gui_h.xanes_reg_mask.shape != (gui_h.xanes_roi[1]-gui_h.xanes_roi[0],
        ...
        if gui_h.xanes_img_roi is None:
            data_state = False
        elif (gui_h.xanes_img_roi.shape != (gui_h.xanes_roi[5]-gui_h.xanes_roi[4]+1,
        ...
        if gui_h.xanes_review_aligned_img is None:
            data_state = False
        elif (gui_h.xanes_review_aligned_img != (gui_h.xanes_roi[1]-gui_h.xanes_roi[0],
                                                   gui_h.xanes_roi[3]-gui_h.xanes_roi[2])):
            data_state = False
        else:
            data_state = True
        ...
        if (gui_h.xanes_aligned_data is None):
            ...
            with h5py.File(gui_h.xanes_save_trial_reg_filename, 'r') as f:
                ...
                if gui_h.hs['L[0][2][2][2][3][1]_visualize_view_alignment_option_dropdown'].value == 'x-y-E':
                    if (data_shape[0], data_shape[2], data_shape[3]) != gui_h.xanes_aligned_data.shape:
                        data_state = False
                    else:
                        data_state = True
                elif gui_h.hs['L[0][2][2][2][3][1]_visualize_view_alignment_option_dropdown'].value == 'y-z-E':
                    if (data_shape[0], data_shape[1], data_shape[2]) != gui_h.xanes_aligned_data.shape:
                        data_state = False
                    else:
                        data_state = True
                elif gui_h.hs['L[0][2][2][2][3][1]_visualize_view_alignment_option_dropdown'].value == 'z-x-E':
                    if (data_shape[0], data_shape[1], data_shape[3]) != gui_h.xanes_aligned_data.shape:
                        data_state = False
                    else:
                        data_state = True
                elif gui_h.hs['L[0][2][2][2][3][1]_visualize_view_alignment_option_dropdown'].value == 'x-y-z':
                    if (data_shape[1], data_shape[2], data_shape[3]) != gui_h.xanes_aligned_data.shape:
                        data_state = False
                    else:
                        data_state = True
                else:
        ...
        if global_h.WindowManager.getIDList() is None:
            viewer_state = False
        elif not global_h.xanes2D_fiji_windows[viewer_name]['fiji_id'] in global_h.WindowManager.getIDList():
            viewer_state = False
        else:
            viewer_state = True
    elif viewer_name == 'xanes2D_mask_viewer':
        ...
        if global_h.WindowManager.getIDList() is None:
            viewer_state = False
        elif not global_h.tomo_fiji_windows[viewer_name]['fiji_id'] in global_h.WindowManager.getIDList():
            viewer_state = False
        else:
            viewer_state = True
    elif viewer_name == 'tomo_cen_review_viewer':
...
def restart(gui_h, dtype='2D_XANES'):
    if dtype == '2D_XANES':
        ...
        gui_h.hs['L[0][1][0][0][1][0]_select_raw_h5_path_btn'].description = 'XANES2D File'
        gui_h.hs['L[0][1][0][0][2][0]_select_save_trial_btn'].description = 'Save Reg File'
        gui_h.hs['L[0][1][0][0][1][0]_select_raw_h5_path_btn'].style.button_color = "orange"
        gui_h.hs['L[0][1][0][0][2][0]_select_save_trial_btn'].style.button_color = "orange"
        ...
        gui_h.hs['L[0][1][0][0][2][0]_select_save_trial_btn'].initialfile = '2D_trial_reg.h5'
        ...
        gui_h.xanes_fit_gui_h.hs['L[0][x][3][1][0][1][0]_fit_config_edge_jump_thres_slider'].value = 1
        gui_h.xanes_fit_gui_h.hs['L[0][x][3][1][0][1][1]_fit_config_edge_offset_thres_slider'].value = 1
        gui_h.xanes_fit_gui_h.hs['L[0][x][3][1][0][2][0]_fit_config_flt_prev_checkbox'].value = 0
        ...
        gui_h.hs['L[0][2][0][0][1][0]_select_raw_h5_path_btn'].description = "Raw h5 Dir"
        gui_h.hs['L[0][2][0][0][2][0]_select_recon_path_btn'].description = "Recon Top Dir"
        gui_h.hs['L[0][2][0][0][3][0]_select_save_trial_btn'].description = "Save Reg File"
        gui_h.hs['L[0][2][0][0][1][0]_select_raw_h5_path_btn'].style.button_color = "orange"
        gui_h.hs['L[0][2][0][0][2][0]_select_recon_path_btn'].style.button_color = "orange"
        gui_h.hs['L[0][2][0][0][3][0]_select_save_trial_btn'].style.button_color = "orange"
        fiji_viewer_off(gui_h.global_h, gui_h, viewer_name='all')
        ...
        gui_h.hs['L[0][2][0][0][3][0]_select_save_trial_btn'].initialfile = '3D_trial_reg.h5'
        ...
        gui_h.hs["L[0][0][0][0][1][0]_select_raw_h5_top_dir_btn"].description = "Raw Top Dir"
        gui_h.hs["L[0][0][0][0][2][0]_select_save_recon_dir_btn"].description = "Save Rec File"
        # gui_h.hs["L[0][0][0][0][3][0]_select_save_data_center_dir_btn"].description = "Save Data_Center"
        gui_h.hs["L[0][0][0][0][4][0]_select_save_debug_dir_btn"].description = "Save Debug Dir"
        gui_h.hs["L[0][0][0][0][4][2]_save_debug_checkbox"].value = False
        gui_h.hs["L[0][0][0][0][1][0]_select_raw_h5_top_dir_btn"].style.button_color = "orange"
        gui_h.hs["L[0][0][0][0][2][0]_select_save_recon_dir_btn"].style.button_color = "orange"
        # gui_h.hs["L[0][0][0][0][3][0]_select_save_data_center_dir_btn"].style.button_color = "orange"
        gui_h.hs["L[0][0][0][0][4][0]_select_save_debug_dir_btn"].style.button_color = "orange"
        ...
        gui_h.hs["L[0][0][0][1][0][1][1][3]_alt_dark_file_btn"].style.button_color = "orange"
        gui_h.hs["L[0][0][0][1][0][1][1][1]_alt_flat_file_btn"].description = "Alt Flat File"
        gui_h.hs["L[0][0][0][1][0][1][1][3]_alt_dark_file_btn"].description = "Alt Dark File"

        gui_h.hs["L[0][0][0][1][0][1][2][0]_use_fake_flat_checkbox"].value = False
        gui_h.hs["L[0][0][0][1][0][1][2][1]_fake_flat_val_text"].value = 10000
        gui_h.hs["L[0][0][0][1][0][1][2][2]_use_fake_dark_checkbox"].value = False
        gui_h.hs["L[0][0][0][1][0][1][2][3]_fake_dark_val_text"].value = 100

        gui_h.hs["L[0][0][0][1][0][1][4][0]_rm_zinger_checkbox"].value = False
        gui_h.hs["L[0][0][0][1][0][1][4][2]_use_mask_checkbox"].value = True
        gui_h.hs["L[0][0][0][1][0][1][4][3]_mask_ratio_text"].value = 1
        gui_h.hs["L[0][0][0][1][0][1][4][1]_zinger_level_text"].value = 500

        gui_h.hs["L[0][0][0][1][0][1][5][4]_auto_detect_checkbox"].value = False
        gui_h.hs["L[0][0][0][1][0][1][5][0]_is_wedge_checkbox"].value = False
        gui_h.hs["L[0][0][0][1][0][1][5][5]_auto_thres_text"].value = 0.1
        gui_h.hs["L[0][0][0][1][0][1][6][2]_auto_ref_fn_btn"].style.button_color = "orange"
        ...
        gui_h.analysis_saving_items = set(FULL_SAVE_DEFAULT)
...
def read_config_from_reg_file(gui_h, dtype='2D_XANES'):
    if dtype == '2D_XANES':
        ...
        with h5py.File(gui_h.xanes_save_trial_reg_filename, 'r') as f:
            ...
            gui_h.xanes_recon_3D_top_dir = f['/trial_registration/data_directory_info/recon_top_dir'][()]
            gui_h.xanes_fixed_scan_id = int(f['/trial_registration/trial_reg_parameters/fixed_scan_id'][()])
            gui_h.xanes_fixed_sli_id = int(f['/trial_registration/trial_reg_parameters/fixed_slice'][()])
            gui_h.xanes_roi = f['/trial_registration/trial_reg_parameters/slice_roi'][:].tolist()
            gui_h.xanes_scan_id_s = int(f['/trial_registration/trial_reg_parameters/scan_ids'][0])
            gui_h.xanes_scan_id_e = int(f['/trial_registration/trial_reg_parameters/scan_ids'][-1])
            gui_h.xanes_reg_sli_search_half_width = int(f['/trial_registration/trial_reg_parameters/sli_search_half_range'][()])
            gui_h.xanes_reg_method = f['/trial_registration/trial_reg_parameters/reg_method'][()]
            gui_h.xanes_reg_ref_mode = f['/trial_registration/trial_reg_parameters/reg_ref_mode'][()]
            gui_h.xanes_reg_use_smooth_img = bool(f['/trial_registration/trial_reg_parameters/use_smooth_img'][()])
            gui_h.xanes_reg_smooth_sigma = int(f['/trial_registration/trial_reg_parameters/img_smooth_sigma'][()])
            gui_h.xanes_reg_use_chunk = bool(f['/trial_registration/trial_reg_parameters/use_chunk'][()])
            gui_h.xanes_reg_chunk_sz = int(f['/trial_registration/trial_reg_parameters/chunk_sz'][()])
            gui_h.xanes_reg_use_mask = bool(f['/trial_registration/trial_reg_parameters/use_mask'][()])
            gui_h.xanes_alignment_pairs = f['/trial_registration/trial_reg_parameters/alignment_pairs'][:]
...
def save_io_config(gui_h):
    ...
    io_data_structure_tomo['use_h5_reader'] = gui_h.hs['L[0][3][0][0][0]_io_option_checkbox'].value
    ...
    io_data_structure_tomo['structured_h5_reader']['io_data_structure']['data_path'] = gui_h.hs['L[0][3][1][0][0][0]_io_tomo_img_text'].value
    io_data_structure_tomo['structured_h5_reader']['io_data_structure']['flat_path'] = gui_h.hs['L[0][3][1][0][0][1]_io_tomo_flat_text'].value
    io_data_structure_tomo['structured_h5_reader']['io_data_structure']['dark_path'] = gui_h.hs['L[0][3][1][0][0][2]_io_tomo_dark_text'].value
    io_data_structure_tomo['structured_h5_reader']['io_data_structure']['theta_path'] = gui_h.hs['L[0][3][1][0][0][3]_io_tomo_theta_text'].value

    io_data_structure_tomo['structured_h5_reader']['io_data_info']['item00_path'] = gui_h.hs['L[0][3][1][0][1][0]_io_tomo_info0_text'].value
    io_data_structure_tomo['structured_h5_reader']['io_data_info']['item01_path'] = gui_h.hs['L[0][3][1][0][1][1]_io_tomo_info1_text'].value
    io_data_structure_tomo['structured_h5_reader']['io_data_info']['item02_path'] = gui_h.hs['L[0][3][1][0][1][2]_io_tomo_info2_text'].value
    io_data_structure_tomo['structured_h5_reader']['io_data_info']['item03_path'] = gui_h.hs['L[0][3][1][0][1][3]_io_tomo_info3_text'].value

    io_data_structure_tomo['structured_h5_reader']['io_data_info']['item04_path'] = gui_h.hs['L[0][3][1][0][1][4]_io_tomo_info4_text'].value
    io_data_structure_tomo['structured_h5_reader']['io_data_info']['item05_path'] = gui_h.hs['L[0][3][1][0][1][5]_io_tomo_info5_text'].value
    io_data_structure_tomo['structured_h5_reader']['io_data_info']['item06_path'] = gui_h.hs['L[0][3][1][0][1][6]_io_tomo_info6_text'].value
    io_data_structure_tomo['structured_h5_reader']['io_data_info']['item07_path'] = gui_h.hs['L[0][3][1][0][1][7]_io_tomo_info7_text'].value

    io_data_structure_tomo['tomo_raw_fn_template'] = gui_h.hs['L[0][3][0][2][0][0][1]_fn_tomo_def_raw_patt_text'].value

    io_data_structure_tomo['customized_reader'] = {}
    io_data_structure_tomo['customized_reader']['user_tomo_reader'] = gui_h.hs['L[0][3][0][1][0][0]_io_spec_tomo_reader_text'].value

    io_data_structure_xanes2D = {}
    io_data_structure_xanes2D['use_h5_reader'] = gui_h.hs['L[0][3][0][0][0]_io_option_checkbox'].value
    ...
    io_data_structure_xanes2D['structured_h5_reader']['io_data_structure']['data_path'] = gui_h.hs['L[0][3][1][1][0][0]_io_xanes2D_img_text'].value
    io_data_structure_xanes2D['structured_h5_reader']['io_data_structure']['flat_path'] = gui_h.hs['L[0][3][1][1][0][1]_io_xanes2D_flat_text'].value
    io_data_structure_xanes2D['structured_h5_reader']['io_data_structure']['dark_path'] = gui_h.hs['L[0][3][1][1][0][2]_io_xanes2D_dark_text'].value
    io_data_structure_xanes2D['structured_h5_reader']['io_data_structure']['eng_path'] = gui_h.hs['L[0][3][1][1][0][3]_io_xanes2D_eng_text'].value

    io_data_structure_xanes2D['structured_h5_reader']['io_data_info']['item00_path'] = gui_h.hs['L[0][3][1][1][1][0]_io_xanes2D_info0_text'].value
    io_data_structure_xanes2D['structured_h5_reader']['io_data_info']['item01_path'] = gui_h.hs['L[0][3][1][1][1][1]_io_xanes2D_info1_text'].value
    io_data_structure_xanes2D['structured_h5_reader']['io_data_info']['item02_path'] = gui_h.hs['L[0][3][1][1][1][2]_io_xanes2D_info2_text'].value
    io_data_structure_xanes2D['structured_h5_reader']['io_data_info']['item03_path'] = gui_h.hs['L[0][3][1][1][1][3]_io_xanes2D_info3_text'].value

    io_data_structure_xanes2D['structured_h5_reader']['io_data_info']['item04_path'] = gui_h.hs['L[0][3][1][1][1][4]_io_xanes2D_info4_text'].value
    io_data_structure_xanes2D['structured_h5_reader']['io_data_info']['item05_path'] = gui_h.hs['L[0][3][1][1][1][5]_io_xanes2D_info5_text'].value
    io_data_structure_xanes2D['structured_h5_reader']['io_data_info']['item06_path'] = gui_h.hs['L[0][3][1][1][1][6]_io_xanes2D_info6_text'].value
    io_data_structure_xanes2D['structured_h5_reader']['io_data_info']['item07_path'] = gui_h.hs['L[0][3][1][1][1][7]_io_xanes2D_info7_text'].value

    io_data_structure_xanes2D['xanes2D_raw_fn_template'] = gui_h.hs['L[0][3][0][2][0][0][2]_fn_xanes2D_def_raw_patt_text'].value

    io_data_structure_xanes2D['customized_reader'] = {}
    io_data_structure_xanes2D['customized_reader']['user_xanes2D_reader'] = gui_h.hs['L[0][3][0][1][0][2]_io_spec_xanes2D_reader_text'].value

    io_data_structure_xanes3D = {}
    io_data_structure_xanes3D['use_h5_reader'] = gui_h.hs['L[0][3][0][0][0]_io_option_checkbox'].value
    ...
    io_data_structure_xanes3D['structured_h5_reader']['io_data_structure']['data_path'] = gui_h.hs['L[0][3][1][2][0][0]_io_xanes3D_img_text'].value
    io_data_structure_xanes3D['structured_h5_reader']['io_data_structure']['flat_path'] = gui_h.hs['L[0][3][1][2][0][1]_io_xanes3D_flat_text'].value
    io_data_structure_xanes3D['structured_h5_reader']['io_data_structure']['dark_path'] = gui_h.hs['L[0][3][1][2][0][2]_io_xanes3D_dark_text'].value
    io_data_structure_xanes3D['structured_h5_reader']['io_data_structure']['eng_path'] = gui_h.hs['L[0][3][1][2][0][3]_io_xanes3D_eng_text'].value

    io_data_structure_xanes3D['structured_h5_reader']['io_data_info']['item00_path'] = gui_h.hs['L[0][3][1][2][1][0]_io_xanes3D_info0_text'].value
    io_data_structure_xanes3D['structured_h5_reader']['io_data_info']['item01_path'] = gui_h.hs['L[0][3][1][2][1][1]_io_xanes3D_info1_text'].value
    io_data_structure_xanes3D['structured_h5_reader']['io_data_info']['item02_path'] = gui_h.hs['L[0][3][1][2][1][2]_io_xanes3D_info2_text'].value
    io_data_structure_xanes3D['structured_h5_reader']['io_data_info']['item03_path'] = gui_h.hs['L[0][3][1][2][1][3]_io_xanes3D_info3_text'].value

    io_data_structure_xanes3D['structured_h5_reader']['io_data_info']['item04_path'] = gui_h.hs['L[0][3][1][2][1][4]_io_xanes3D_info4_text'].value
    io_data_structure_xanes3D['structured_h5_reader']['io_data_info']['item05_path'] = gui_h.hs['L[0][3][1][2][1][5]_io_xanes3D_info5_text'].value
    io_data_structure_xanes3D['structured_h5_reader']['io_data_info']['item06_path'] = gui_h.hs['L[0][3][1][2][1][6]_io_xanes3D_info6_text'].value
    io_data_structure_xanes3D['structured_h5_reader']['io_data_info']['item07_path'] = gui_h.hs['L[0][3][1][2][1][7]_io_xanes3D_info7_text'].value

    io_data_structure_xanes3D['tomo_raw_fn_template'] = gui_h.hs['L[0][3][0][2][0][0][3]_fn_xanes3D_def_tomo_raw_patt_text'].value
    io_data_structure_xanes3D['xanes3D_recon_dir_template'] = gui_h.hs['L[0][3][0][2][0][0][4]_fn_xanes3D_def_tomo_recon_dir_patt_text'].value
    io_data_structure_xanes3D['xanes3D_recon_fn_template'] = gui_h.hs['L[0][3][0][2][0][0][5]_fn_xanes3D_def_tomo_recon_fn_patt_text'].value

    io_data_structure_xanes3D['customized_reader'] = {}
    io_data_structure_xanes3D['customized_reader']['user_xanes3D_reader'] = gui_h.hs['L[0][3][0][1][0][4]_io_spec_xanes3D_reader_text'].value



    # def L0_3_0_1_0_5_io_spec_xanes3D_reader_btn_click(self, a):
    #     if len(a.files[0]) != 0:
    #         gui_h.hs['L[0][3][0][1][0][4]_io_spec_xanes3D_reader_text'].value = a.files[0]
...
def set_io_config(gui_h, cfg_dict, cfg_type='tomo'):
    if cfg_type == 'tomo':
        gui_h.hs['L[0][3][1][0][0][0]_io_tomo_img_text'].value = cfg_dict['structured_h5_reader']['io_data_structure']['data_path']
        gui_h.hs['L[0][3][1][0][0][1]_io_tomo_flat_text'].value = cfg_dict['structured_h5_reader']['io_data_structure']['flat_path']
        gui_h.hs['L[0][3][1][0][0][2]_io_tomo_dark_text'].value = cfg_dict['structured_h5_reader']['io_data_structure']['dark_path']
        gui_h.hs['L[0][3][1][0][0][3]_io_tomo_theta_text'].value = cfg_dict['structured_h5_reader']['io_data_structure']['theta_path']

        gui_h.hs['L[0][3][1][0][1][0]_io_tomo_info0_text'].value = cfg_dict['structured_h5_reader']['io_data_info']['item00_path']
        gui_h.hs['L[0][3][1][0][1][1]_io_tomo_info1_text'].value = cfg_dict['structured_h5_reader']['io_data_info']['item01_path']
        gui_h.hs['L[0][3][1][0][1][2]_io_tomo_info2_text'].value = cfg_dict['structured_h5_reader']['io_data_info']['item02_path']
        gui_h.hs['L[0][3][1][0][1][3]_io_tomo_info3_text'].value = cfg_dict['structured_h5_reader']['io_data_info']['item03_path']

        gui_h.hs['L[0][3][1][0][1][4]_io_tomo_info4_text'].value = cfg_dict['structured_h5_reader']['io_data_info']['item04_path']
        gui_h.hs['L[0][3][1][0][1][5]_io_tomo_info5_text'].value = cfg_dict['structured_h5_reader']['io_data_info']['item05_path']
        gui_h.hs['L[0][3][1][0][1][6]_io_tomo_info6_text'].value = cfg_dict['structured_h5_reader']['io_data_info']['item06_path']
        gui_h.hs['L[0][3][1][0][1][7]_io_tomo_info7_text'].value = cfg_dict['structured_h5_reader']['io_data_info']['item07_path']

        gui_h.hs['L[0][3][0][2][0][0][1]_fn_tomo_def_raw_patt_text'].value = cfg_dict['tomo_raw_fn_template']

        gui_h.hs['L[0][3][0][1][0][0]_io_spec_tomo_reader_text'].value = cfg_dict['customized_reader']['user_tomo_reader']
    elif cfg_type == 'xanes2D':
        gui_h.hs['L[0][3][1][1][0][0]_io_xanes2D_img_text'].value = cfg_dict['structured_h5_reader']['io_data_structure']['data_path']
        gui_h.hs['L[0][3][1][1][0][1]_io_xanes2D_flat_text'].value = cfg_dict['structured_h5_reader']['io_data_structure']['flat_path']
        gui_h.hs['L[0][3][1][1][0][2]_io_xanes2D_dark_text'].value = cfg_dict['structured_h5_reader']['io_data_structure']['dark_path']
        gui_h.hs['L[0][3][1][1][0][3]_io_xanes2D_eng_text'].value = cfg_dict['structured_h5_reader']['io_data_structure']['eng_path']

        gui_h.hs['L[0][3][1][1][1][0]_io_xanes2D_info0_text'].value = cfg_dict['structured_h5_reader']['io_data_info']['item00_path']
        gui_h.hs['L[0][3][1][1][1][1]_io_xanes2D_info1_text'].value = cfg_dict['structured_h5_reader']['io_data_info']['item01_path']
        gui_h.hs['L[0][3][1][1][1][2]_io_xanes2D_info2_text'].value = cfg_dict['structured_h5_reader']['io_data_info']['item02_path']
        gui_h.hs['L[0][3][1][1][1][3]_io_xanes2D_info3_text'].value = cfg_dict['structured_h5_reader']['io_data_info']['item03_path']

        gui_h.hs['L[0][3][1][1][1][4]_io_xanes2D_info4_text'].value = cfg_dict['structured_h5_reader']['io_data_info']['item04_path']
        gui_h.hs['L[0][3][1][1][1][5]_io_xanes2D_info5_text'].value = cfg_dict['structured_h5_reader']['io_data_info']['item05_path']
        gui_h.hs['L[0][3][1][1][1][6]_io_xanes2D_info6_text'].value = cfg_dict['structured_h5_reader']['io_data_info']['item06_path']
        gui_h.hs['L[0][3][1][1][1][7]_io_xanes2D_info7_text'].value = cfg_dict['structured_h5_reader']['io_data_info']['item07_path']

        gui_h.hs['L[0][3][0][2][0][0][2]_fn_xanes2D_def_raw_patt_text'].value = cfg_dict['xanes2D_raw_fn_template']

        gui_h.hs['L[0][3][0][1][0][2]_io_spec_xanes2D_reader_text'].value = cfg_dict['customized_reader']['user_xanes2D_reader']
    elif cfg_type == 'xanes3D':
        gui_h.hs['L[0][3][1][2][0][0]_io_xanes3D_img_text'].value = cfg_dict['structured_h5_reader']['io_data_structure']['data_path']
        gui_h.hs['L[0][3][1][2][0][1]_io_xanes3D_flat_text'].value = cfg_dict['structured_h5_reader']['io_data_structure']['flat_path']
        gui_h.hs['L[0][3][1][2][0][2]_io_xanes3D_dark_text'].value = cfg_dict['structured_h5_reader']['io_data_structure']['dark_path']
        gui_h.hs['L[0][3][1][2][0][3]_io_xanes3D_eng_text'].value = cfg_dict['structured_h5_reader']['io_data_structure']['eng_path']

        gui_h.hs['L[0][3][1][2][1][0]_io_xanes3D_info0_text'].value = cfg_dict['structured_h5_reader']['io_data_info']['item00_path']
        gui_h.hs['L[0][3][1][2][1][1]_io_xanes3D_info1_text'].value = cfg_dict['structured_h5_reader']['io_data_info']['item01_path']
        gui_h.hs['L[0][3][1][2][1][2]_io_xanes3D_info2_text'].value = cfg_dict['structured_h5_reader']['io_data_info']['item02_path']
        gui_h.hs['L[0][3][1][2][1][3]_io_xanes3D_info3_text'].value = cfg_dict['structured_h5_reader']['io_data_info']['item03_path']

        gui_h.hs['L[0][3][1][2][1][4]_io_xanes3D_info4_text'].value = cfg_dict['structured_h5_reader']['io_data_info']['item04_path']
        gui_h.hs['L[0][3][1][2][1][5]_io_xanes3D_info5_text'].value = cfg_dict['structured_h5_reader']['io_data_info']['item05_path']
        gui_h.hs['L[0][3][1][2][1][6]_io_xanes3D_info6_text'].value = cfg_dict['structured_h5_reader']['io_data_info']['item06_path']
        gui_h.hs['L[0][3][1][2][1][7]_io_xanes3D_info7_text'].value = cfg_dict['structured_h5_reader']['io_data_info']['item07_path']

        gui_h.hs['L[0][3][0][2][0][0][3]_fn_xanes3D_def_tomo_raw_patt_text'].value = cfg_dict['tomo_raw_fn_template']
        gui_h.hs['L[0][3][0][2][0][0][4]_fn_xanes3D_def_tomo_recon_dir_patt_text'].value = cfg_dict['xanes3D_recon_dir_template']
        gui_h.hs['L[0][3][0][2][0][0][5]_fn_xanes3D_def_tomo_recon_fn_patt_text'].value = cfg_dict['xanes3D_recon_fn_template']
        gui_h.hs['L[0][3][0][1][0][4]_io_spec_xanes3D_reader_text'].value = cfg_dict['customized_reader']['user_xanes3D_reader']
...
def load_io_config(main_gui_h):
    ...
    try:
        ...
        set_io_config(main_gui_h.io_config_gui, IO_XANES2D_CFG_DEFAULT, cfg_type='xanes2D')
    try:
        ...
        set_io_config(main_gui_h.io_config_gui, IO_XANES3D_CFG_DEFAULT, cfg_type='xanes3D')
