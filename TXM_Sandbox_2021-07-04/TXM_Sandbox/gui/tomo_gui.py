...
ALG_PARAM_DICT = OrderedDict({"gridrec":{0: ["filter_name", ["parzen", 'shepp', 'cosine', 'hann', 'hamming', 'ramlak', 'butterworth', 'none'], "filter_name: filter that is used in frequency space", str]},
                              "sirt":{3: ["num_gridx", 1280, "num_gridx: number of the reconstructed slice image along x direction", int],
                                      4: ["num_gridy", 1280, "num_gridy: number of the reconstructed slice image along y direction", int],
                                      5: ["num_iter", 10, "num_iter: number of reconstruction iterations", int]},
                              "tv":{3: ["num_gridx", 1280, "num_gridx: number of the reconstructed slice image along x direction", int],
                                    4: ["num_gridy", 1280, "num_gridy: number of the reconstructed slice image along y direction", int],
                                    5: ["num_iter", 10, "num_iter: number of reconstruction iterations", int],
                                    6: ["reg_par", 0.1, "reg_par: relaxation factor in tv regulation", int]},
                              "mlem":{3: ["num_gridx", 1280, "num_gridx: number of the reconstructed slice image along x direction", int],
                                      4: ["num_gridy", 1280, "num_gridy: number of the reconstructed slice image along y direction", int],
                                      5: ["num_iter", 10, "num_iter: number of reconstruction iterations", int]},
                              "astra":{0: ["method", ["EM_CUDA"], "method: astra reconstruction methods", str],
                                       1: ["proj_type", ["cuda"], "proj_type: projection calculation options used in astra", str],
                                       2: ["extra_options", ["MinConstraint"], "extra_options: extra constraints used in the reconstructions. you need to set p03 for a MinConstraint level", str],
                                       3: ["extra_options_param", -0.1, "extra_options_param: parameter used together with extra_options", np.float32],
...
class tomo_recon_gui():
    ...
    def build_gui(self):
        ...
        self.hs["L[0][0][0][0][1][0]_select_raw_h5_top_dir_btn"] = SelectFilesButton(option="askdirectory",
                                                                                        text_h=self.hs["L[0][0][0][0][1][1]_select_raw_h5_top_dir_text"])
        self.hs["L[0][0][0][0][1][0]_select_raw_h5_top_dir_btn"].description = "Raw Top Dir"
        self.hs["L[0][0][0][0][1][0]_select_raw_h5_top_dir_btn"].description_tooltip = "Select the top directory in which the raw h5 files are located."
        layout = {"width":"15%"}
        self.hs["L[0][0][0][0][1][0]_select_raw_h5_top_dir_btn"].layout = layout
        self.hs["L[0][0][0][0][1][0]_select_raw_h5_top_dir_btn"].on_click(self.L0_0_0_0_1_0_select_raw_h5_top_dir_btn_click)
        ...
        self.hs["L[0][0][0][0][2][1]_select_save_recon_dir_text"] = widgets.Text(value="Select top directory where data_center directory will be created...",
                                                                                 description="", disabled=True)
        layout = {"width":"66%", "display":"inline_flex"}
        self.hs["L[0][0][0][0][2][1]_select_save_recon_dir_text"].layout = layout
        self.hs["L[0][0][0][0][2][0]_select_save_recon_dir_btn"] = SelectFilesButton(option="askdirectory",
                                                                                     text_h=self.hs["L[0][0][0][0][2][1]_select_save_recon_dir_text"])
        self.hs["L[0][0][0][0][2][0]_select_save_recon_dir_btn"].description = "Save Rec File"
        self.hs["L[0][0][0][0][2][0]_select_save_recon_dir_btn"].disabled = False
        layout = {"width":"15%"}
        self.hs["L[0][0][0][0][2][0]_select_save_recon_dir_btn"].layout = layout
        self.hs["L[0][0][0][0][2][0]_select_save_recon_dir_btn"].on_click(self.L0_0_0_0_2_0_select_save_recon_dir_btn_click)
        ...
        self.hs["L[0][0][0][0][4][0]_select_save_debug_dir_btn"] = SelectFilesButton(option="askdirectory",
                                                                                        text_h=self.hs["L[0][0][0][0][4][1]_select_save_debug_dir_text"])
        self.hs["L[0][0][0][0][4][0]_select_save_debug_dir_btn"].description = "Save Debug Dir"
        self.hs["L[0][0][0][0][4][0]_select_save_debug_dir_btn"].disabled = True
        layout = {"width":"15%"}
        self.hs["L[0][0][0][0][4][0]_select_save_debug_dir_btn"].layout = layout
        ...
        self.hs["L[0][0][0][0][4][0]_select_save_debug_dir_btn"].on_click(self.L0_0_0_0_4_0_select_save_debug_dir_btn_click)
        ...
        self.hs["L[0][0][0][0][5][0]_confirm_file&path_btn"] = widgets.Button(description="Confirm",
                                                                                 tooltip="Confirm: Confirm after you finish file configuration")
        self.hs["L[0][0][0][0][5][0]_confirm_file&path_btn"].style.button_color = "darkviolet"
        self.hs["L[0][0][0][0][5][0]_confirm_file&path_btn"].on_click(self.L0_0_0_0_5_0_confirm_file_path_btn_click)
        layout = {"width":"15%"}
        self.hs["L[0][0][0][0][5][0]_confirm_file&path_btn"].layout = layout

        self.hs["L[0][0][0][0][5][2]_file_path_options_dropdown"] = widgets.Dropdown(value="Trial Cent",
                                                                                     options=["Trial Cent",
                                                                                              "Vol Recon"],
                                                                                     description="",
        ...
        self.hs["L[0][0][0][0][5][2]_file_path_options_dropdown"].observe(self.L0_0_0_0_5_2_recon_option_dropdown_change, names="value")
        ...
        self.hs["L[0][0][0][1]_data_tab"].set_title(1, "Alg Config")
        ...
        self.hs["L[0][0][0][1][0][1][0][4]_cen_list_btn"] = SelectFilesButton(option="askopenfilename",
                                                                                 **{"open_filetypes": (("json files", "*.json"), )})
        layout = {"width":"15%", "height":"85%", "visibility":"hidden"}
        self.hs["L[0][0][0][1][0][1][0][4]_cen_list_btn"].layout = layout
        self.hs["L[0][0][0][1][0][1][0][4]_cen_list_btn"].disabled = True
        ...
        self.hs["L[0][0][0][1][0][1][0][4]_cen_list_btn"].on_click(self.L0_0_0_1_0_1_0_4_read_cen_list_btn_click)
        ...
        layout = {"width":"15%"}
        self.hs["L[0][0][0][1][0][1][1][1]_alt_flat_file_btn"] = SelectFilesButton(option="askopenfilename",
                                                                                    **{"open_filetypes": (("h5 files", "*.h5"),)})
        self.hs["L[0][0][0][1][0][1][1][1]_alt_flat_file_btn"].description = "Alt Flat File"
        self.hs["L[0][0][0][1][0][1][1][1]_alt_flat_file_btn"].disabled = True
        self.hs["L[0][0][0][1][0][1][1][1]_alt_flat_file_btn"].layout = layout
        ...
        self.hs["L[0][0][0][1][0][1][1][3]_alt_dark_file_btn"] = SelectFilesButton(option="askopenfilename",
                                                                                    **{"open_filetypes": (("h5 files", "*.h5"),)})
        self.hs["L[0][0][0][1][0][1][1][3]_alt_dark_file_btn"].description = "Alt Dark File"
        self.hs["L[0][0][0][1][0][1][1][3]_alt_dark_file_btn"].disabled = True
        self.hs["L[0][0][0][1][0][1][1][3]_alt_dark_file_btn"].layout = layout
        ...
        self.hs["L[0][0][0][1][0][1][1][1]_alt_flat_file_btn"].observe(self.L0_0_0_1_0_1_1_1_alt_flat_file_btn_change, names="value")
        self.hs["L[0][0][0][1][0][1][1][2]_use_alt_dark_checkbox"].observe(self.L0_0_0_1_0_1_1_2_use_alt_dark_checkbox_change, names="value")
        self.hs["L[0][0][0][1][0][1][1][3]_alt_dark_file_btn"].observe(self.L0_0_0_1_0_1_1_3_alt_dark_file_btn_change, names="value")
        ...
        self.hs["L[0][0][0][1][0][1][5][5]_auto_thres_text"] = widgets.BoundedFloatText(value=0.2,
                                                                                        min=0,
                                                                                        max=1,
        ...
        layout = {"width":"15%"}
        self.hs["L[0][0][0][1][0][1][6][2]_auto_ref_fn_btn"] = SelectFilesButton(option="askopenfilename",
                                                                                    **{"open_filetypes": (("h5 files", "*.h5"),)})
        self.hs["L[0][0][0][1][0][1][6][2]_auto_ref_fn_btn"].layout = layout
        self.hs["L[0][0][0][1][0][1][6][2]_auto_ref_fn_btn"].disabled = True
        ...
        self.hs["L[0][0][0][1][0][1][6][2]_auto_ref_fn_btn"].on_click(self.L0_0_1_0_0_1_1_2_auto_ref_fn_btn_change)
        ...
        layout = {"width":"20%"}
        self.hs["L[0][0][0][1][3][0][3][2]_raw_proj_viewer_close_btn"] = widgets.Button(description="Close/Confirm",
                                                                                    description_tooltip = 'Optional confrimation of roi (slices and columns) definition',
                                                                                    disabled=True)
        self.hs["L[0][0][0][1][3][0][3][2]_raw_proj_viewer_close_btn"].layout = layout
        self.hs["L[0][0][0][1][3][0][3][2]_raw_proj_viewer_close_btn"].style.button_color = 'darkviolet'
        ...
        self.hs["L[0][0][0][1][3][0][3][2]_raw_proj_viewer_close_btn"].on_click(self.L0_0_0_1_3_0_3_2_raw_proj_viewer_close_btn_click)
        ...
        layout = {"width":"20%"}
        self.hs["L[0][0][0][1][3][0][0][1]_cen_offset_confirm_btn"] = widgets.Button(description="Confirm",
                                                                                    description_tooltip = 'Optional confrimation of the rough center',
                                                                                    disabled=True)
        self.hs["L[0][0][0][1][3][0][0][1]_cen_offset_confirm_btn"].layout = layout
        self.hs["L[0][0][0][1][3][0][0][1]_cen_offset_confirm_btn"].style.button_color = 'darkviolet'
        layout = {"width":"20%"}
        self.hs["L[0][0][0][1][3][0][0][2]_cen_viewer_close_btn"] = widgets.Button(description="Close",
                                                                                    description_tooltip = 'Optional close the viewer window',
                                                                                    disabled=True)
        self.hs["L[0][0][0][1][3][0][0][2]_cen_viewer_close_btn"].layout = layout
        self.hs["L[0][0][0][1][3][0][0][2]_cen_viewer_close_btn"].style.button_color = 'darkviolet'
        ...
        self.hs["L[0][0][0][1][3][0][0][1]_cen_offset_confirm_btn"].on_click(self.L0_0_0_1_3_0_0_1_cen_offset_confirm_btn_click)
        self.hs["L[0][0][0][1][3][0][0][2]_cen_viewer_close_btn"].on_click(self.L0_0_0_1_3_0_0_2_cen_viewer_close_btn_click)
        ...
        layout = {"width":"20%"}
        self.hs["L[0][0][0][1][3][0][1][1]_trial_cen_confirm_btn"] = widgets.Button(description="Confirm",
                                                                                    description_tooltip = 'Optional confrimation of the rough center',
                                                                                    disabled=True)
        self.hs["L[0][0][0][1][3][0][1][1]_trial_cen_confirm_btn"].layout = layout
        self.hs["L[0][0][0][1][3][0][1][1]_trial_cen_confirm_btn"].style.button_color = 'darkviolet'
        layout = {"width":"20%"}
        self.hs["L[0][0][0][1][3][0][1][2]_trial_cen_viewer_close_btn"] = widgets.Button(description="Close",
                                                                                    description_tooltip = 'Optional close the viewer window',
                                                                                    disabled=True)
        self.hs["L[0][0][0][1][3][0][1][2]_trial_cen_viewer_close_btn"].layout = layout
        self.hs["L[0][0][0][1][3][0][1][2]_trial_cen_viewer_close_btn"].style.button_color = 'darkviolet'

        self.hs["L[0][0][0][1][3][0][1][0]_trial_cen_slider"].observe(self.L0_0_0_1_3_0_1_0_trial_cen_slider_change, names="value")
        self.hs["L[0][0][0][1][3][0][1][1]_trial_cen_confirm_btn"].on_click(self.L0_0_0_1_3_0_1_1_trial_cen_confirm_btn_click)
        self.hs["L[0][0][0][1][3][0][1][2]_trial_cen_viewer_close_btn"].on_click(self.L0_0_0_1_3_0_1_2_trial_cen_viewer_close_btn_click)
        ...
        layout = {"width":"20%"}
        self.hs["L[0][0][0][1][3][0][2][1]_vol_sli_viewer_close_btn"] = widgets.Button(description="Close",
                                                                                    description_tooltip = 'Optional confrimation of the rough center',
                                                                                    disabled=True)
        self.hs["L[0][0][0][1][3][0][2][1]_vol_sli_viewer_close_btn"].layout = layout
        self.hs["L[0][0][0][1][3][0][2][1]_vol_sli_viewer_close_btn"].style.button_color = 'darkviolet'

        self.hs["L[0][0][0][1][3][0][2][0]_vol_sli_slider"].observe(self.L0_0_0_1_3_0_2_0_vol_sli_slider_change, names="value")
        self.hs["L[0][0][0][1][3][0][2][1]_vol_sli_viewer_close_btn"].on_click(self.L0_0_0_1_3_0_2_1_vol_sli_viewer_close_btn_click)
        ...
        self.hs["L[0][0][1][0][0][1][0][1]_filter_config_left_box_==>_btn"] = self.hs["L[0][0][1][0][0][1]_filter_config_box"][0, :100][0, 16:19]
        ...
        self.hs["L[0][0][1][0][0][1][0][1]_filter_config_left_box_==>_btn"].on_click(self.L0_0_1_0_0_1_0_1_filter_config_box_left_box_move_btn_change)
        ...
        self.hs["L[0][0][1][0][0][1][1][1]_filter_config_right_box_mv_up_btn"] = self.hs["L[0][0][1][0][0][1]_filter_config_box"][0, 100:][1, 9]
        ...
        self.hs["L[0][0][1][0][0][1][1][2]_filter_config_right_box_mv_dn_btn"] = self.hs["L[0][0][1][0][0][1]_filter_config_box"][0, 100:][2, 9]
        ...
        self.hs["L[0][0][1][0][0][1][1][3]_filter_config_right_box_rm_btn"] = self.hs["L[0][0][1][0][0][1]_filter_config_box"][0, 100:][3, 9]
        ...
        self.hs["L[0][0][1][0][0][1][1][4]_filter_config_right_box_finish_btn"] = self.hs["L[0][0][1][0][0][1]_filter_config_box"][0, 100:][4, 9]
        ...
        self.hs["L[0][0][1][0][0][1][1][1]_filter_config_right_box_mv_up_btn"].on_click(self.L0_0_1_0_0_1_1_1_filter_config_box_right_box_move_up_btn_change)
        self.hs["L[0][0][1][0][0][1][1][2]_filter_config_right_box_mv_dn_btn"].on_click(self.L0_0_1_0_0_1_1_2_filter_config_box_right_box_move_dn_btn_change)
        self.hs["L[0][0][1][0][0][1][1][3]_filter_config_right_box_rm_btn"].on_click(self.L0_0_1_0_0_1_1_3_filter_config_box_right_box_remove_btn_change)
        self.hs["L[0][0][1][0][0][1][1][4]_filter_config_right_box_finish_btn"].on_click(self.L0_0_1_0_0_1_1_4_filter_config_box_right_box_finish_btn_change)
        ...
        self.hs["L[0][0][1][0][0][1][3]_filter_config_box_confirm_btn"] = self.hs["L[0][0][1][0][0][1]_filter_config_box"][1, 141:171]
        self.hs["L[0][0][1][0][0][1][3]_filter_config_box_confirm_btn"].on_click(self.L0_0_1_0_0_1_3_filter_config_box_confirm_btn)
        ...
        layout = {"justify-content":"center", "align-items":"center","align-contents":"center","border":"3px solid #FFCC00", "height":f"{0.06*(self.form_sz[0]-136)}px"}
        ...
        self.hs["L[0][0][1][0][1][1][1]_recon_btn"] = widgets.Button(description="Recon",
                                                                            disabled=True)
        self.hs["L[0][0][1][0][1][1][1]_recon_btn"].style.button_color = "darkviolet"
        self.hs["L[0][0][1][0][1][1][1]_recon_btn"].layout = layout
        self.hs["L[0][0][1][0][1][1]_recon_box"].children = get_handles(self.hs, "L[0][0][1][0][1][1]_recon_box", -1)
        self.hs["L[0][0][1][0][1][1][1]_recon_btn"].on_click(self.L0_0_1_0_1_1_1_recon_btn_click)
        ...
        layout = {"width": "95%", "height": "90%"}
        self.hs["L[0][0][1][1][0]_recon_config_summ_text"] = widgets.Textarea(value='Recon Config Info',
                                                                              placeholder='Recon Config Info',
                                                                              description='Recon Config Info',
                                                                              disabled=True)
        self.hs["L[0][0][1][1][0]_recon_config_summ_text"].layout = layout
        ## ## ## ## ## config filter&recon text -- start
        self.hs["L[0][0][1][1]_recon_config_summary_tab"].children = get_handles(self.hs,
                                                                                 "L[0][0][1][1]_recon_config_summary_tab",
                                                                                 -1)
        ## ## ## ## config filter&recon tab -- end
        ...
        self.hs["L[0][0][0][0][1][0]_select_raw_h5_top_dir_btn"].initialdir = self.global_h.cwd
        self.hs["L[0][0][0][0][2][0]_select_save_recon_dir_btn"].initialdir = self.global_h.cwd
        self.hs["L[0][0][0][0][4][0]_select_save_debug_dir_btn"].initialdir = self.global_h.cwd
        self.hs["L[0][0][0][1][0][1][1][1]_alt_flat_file_btn"].initialdir = self.global_h.cwd
        self.hs["L[0][0][0][1][0][1][1][3]_alt_dark_file_btn"].initialdir = self.global_h.cwd
    ...
    def boxes_logic(self):
        ...
        if not self.tomo_filepath_configured:
            ...
            boxes = ["L[0][0][0][1][0]_data_config_tab",
                     ...
                     "L[0][0][1][0][0][1][0][1]_filter_config_left_box_==>_btn",
                     "L[0][0][1][0][0][1][1]_filter_config_right_box",
                     "L[0][0][1][0][0][1][3]_filter_config_box_confirm_btn"]
    ...
    def cal_set_srch_win(self):
        if self.data_info is None:
            ...
            if self.data_info:
                if self.hs["L[0][0][0][1][0][1][0][2]_cen_win_left_text"].value >= (
                        self.data_info["img_dim"][2] - self.hs['L[0][0][0][1][0][1][0][3]_cen_win_wz_text'].value - 1):
                    self.hs["L[0][0][0][1][0][1][0][2]_cen_win_left_text"].value = 0
                    self.hs["L[0][0][0][1][0][1][0][2]_cen_win_left_text"].max = self.data_info["img_dim"][2] - self.hs[
                        'L[0][0][0][1][0][1][0][3]_cen_win_wz_text'].value - 1
                    self.hs["L[0][0][0][1][0][1][0][2]_cen_win_left_text"].value = int(
            ...
            if data_info:
                ...
                self.hs["L[0][0][0][0][5][1]_confirm_file&path_text"].value = "Cannot open the file..."
    ...
    def tomo_compound_logic(self):
        if self.tomo_recon_type == "Trial Cent":
            ...
            if self.tomo_raw_data_top_dir_set & self.tomo_recon_path_set:
                ...
                self.hs["L[0][0][0][1][0][1][3][0]_sli_start_text"].disabled = False
                self.hs["L[0][0][0][1][0][1][3][1]_sli_end_text"].disabled = False
                self.hs["L[0][0][0][1][0][1][0][5]_use_config_checkbox"].value = True
                self.hs["L[0][0][0][1][0][1][0][5]_use_config_checkbox"].disabled = True
                self.hs["L[0][0][0][1][0][1][3][2]_col_start_text"].disabled = True
                self.hs["L[0][0][0][1][0][1][3][3]_col_end_text"].disabled = True
            self.tomo_use_read_config = True

        if self.tomo_filepath_configured:
            if self.tomo_use_alt_flat:
                self.hs["L[0][0][0][1][0][1][1][1]_alt_flat_file_btn"].disabled = False
            else:
                self.hs["L[0][0][0][1][0][1][1][1]_alt_flat_file_btn"].disabled = True
            ...
            if self.tomo_use_alt_dark:
                self.hs["L[0][0][0][1][0][1][1][3]_alt_dark_file_btn"].disabled = False
            else:
                self.hs["L[0][0][0][1][0][1][1][3]_alt_dark_file_btn"].disabled = True
            ...
            if self.tomo_is_wedge:
                ...
                if self.tomo_use_wedge_ang_auto_det:
                    ...
                    self.hs["L[0][0][0][1][0][1][6][2]_auto_ref_fn_btn"].disabled = False
    ...
    def set_widgets_from_rec_param(self, recon_param_dict):
        ...
        self.hs["L[0][0][1][0][0][1][0][0]_filter_config_left_box_filter_list"].value = a[0]
    ...
    def L0_0_0_0_1_0_select_raw_h5_top_dir_btn_click(self, a):
        ...
        if len(a.files[0]) != 0:
            ...
            self.tomo_raw_data_file_template = os.path.join(self.tomo_raw_data_top_dir, self.global_h.io_tomo_cfg['tomo_raw_fn_template'])
            b = ''
            ...
            self.hs["L[0][0][0][0][1][0]_select_raw_h5_top_dir_btn"].initialdir = os.path.abspath(a.files[0])
            self.hs["L[0][0][0][0][2][0]_select_save_recon_dir_btn"].initialdir = os.path.abspath(a.files[0])
            # self.hs["L[0][0][0][0][3][0]_select_save_data_center_dir_btn"].initialdir = os.path.abspath(a.files[0])
            self.hs["L[0][0][0][0][4][0]_select_save_debug_dir_btn"].initialdir = os.path.abspath(a.files[0])
            self.hs['L[0][0][0][1][0][1][0][4]_cen_list_btn'].initialdir = os.path.abspath(a.files[0])
            self.hs['L[0][0][0][1][0][1][1][1]_alt_flat_file_btn'].initialdir = os.path.abspath(a.files[0])
            self.hs['L[0][0][0][1][0][1][1][3]_alt_dark_file_btn'].initialdir = os.path.abspath(a.files[0])
            self.hs['L[0][0][0][1][0][1][6][2]_auto_ref_fn_btn'].initialdir = os.path.abspath(a.files[0])
    ...
    def L0_0_0_0_4_2_save_debug_checkbox_change(self, a):
        ...
        if a["owner"].value:
            ...
            self.hs["L[0][0][0][0][4][0]_select_save_debug_dir_btn"].disabled = False
            self.hs["L[0][0][0][0][4][1]_select_save_debug_dir_text"].value = "Select top directory where debug dir will be created..."
            self.hs["L[0][0][0][0][4][0]_select_save_debug_dir_btn"].style.button_color = "orange"
        else:
            self.tomo_use_debug = False
            self.hs["L[0][0][0][0][4][0]_select_save_debug_dir_btn"].disabled = True
    ...
    def L0_0_0_0_5_2_recon_option_dropdown_change(self, a):
        ...
        if self.tomo_recon_type == "Trial Cent":
            ...
            # self.hs["L[0][0][0][0][3][0]_select_save_data_center_dir_btn"].disabled = False
            self.hs["L[0][0][0][0][2][0]_select_save_recon_dir_btn"].disabled = True
            # self.hs["L[0][0][0][0][3][0]_select_save_data_center_dir_btn"].style.button_color = "orange"
            self.hs["L[0][0][0][0][2][0]_select_save_recon_dir_btn"].style.button_color = "orange"

            self.hs["L[0][0][0][0][2][0]_select_save_recon_dir_btn"].disabled = False
            self.hs["L[0][0][0][0][2][0]_select_save_recon_dir_btn"].style.button_color = "orange"
            self.hs["L[0][0][0][0][2][1]_select_save_recon_dir_text"].value = "Select top directory where data_center directory will be created..."

            self.hs["L[0][0][0][1][0][1][0][5]_use_config_checkbox"].value = False
            self.tomo_use_read_config = False
        elif self.tomo_recon_type == "Vol Recon":
            # self.hs["L[0][0][0][0][3][0]_select_save_data_center_dir_btn"].disabled = True
            self.hs["L[0][0][0][0][2][0]_select_save_recon_dir_btn"].disabled = False
            # self.hs["L[0][0][0][0][3][0]_select_save_data_center_dir_btn"].style.button_color = "orange"
            self.hs["L[0][0][0][0][2][0]_select_save_recon_dir_btn"].style.button_color = "orange"
            self.hs["L[0][0][0][0][2][1]_select_save_recon_dir_text"].value = "Select top directory where recon subdirectories will be created..."
    ...
    def L0_0_0_0_5_0_confirm_file_path_btn_click(self, a):
        if self.tomo_recon_type == "Trial Cent":
            ...
            if (self.tomo_raw_data_top_dir_set & self.tomo_recon_path_set):
                self.tomo_available_raw_idx = check_file_availability(self.tomo_raw_data_top_dir, scan_id=None, signature=self.global_h.io_tomo_cfg['tomo_raw_fn_template'], return_idx=True)
                if len(self.tomo_available_raw_idx) == 0:
                    print('No data file available in {self.tomo_raw_data_top_dir} with filename pattern of {self.global_h.io_tomo_cfg["tomo_raw_fn_template"]}')
                    self.tomo_filepath_configured = False
                    return
                else:
                    self.hs["L[0][0][0][1][0][1][0][0]_scan_id_dropdown"].options = self.tomo_available_raw_idx
    ...
    def L0_0_0_1_0_1_0_0_scan_id_dropdown_change(self, a):
        ...
        if self.data_info:
            if self.tomo_recon_type == 'Trial Cent':
                ...
                if self.hs["L[0][0][0][1][0][1][3][1]_sli_end_text"].value > (self.data_info["img_dim"][1] - 1):
                    self.hs["L[0][0][0][1][0][1][3][1]_sli_end_text"].value = (self.data_info["img_dim"][1] - 1)
                self.hs["L[0][0][0][1][0][1][3][1]_sli_end_text"].max = self.data_info["img_dim"][1] - 1
                if self.hs["L[0][0][0][1][0][1][3][0]_sli_start_text"].value > (self.data_info["img_dim"][1] - 2):
                    self.hs["L[0][0][0][1][0][1][3][0]_sli_start_text"].value = (self.data_info["img_dim"][1] - 2)
                self.hs["L[0][0][0][1][0][1][3][0]_sli_start_text"].max = self.data_info["img_dim"][1] - 2
                if self.hs["L[0][0][0][1][0][1][3][2]_col_start_text"].value > (self.data_info["img_dim"][2]-2):
                    self.hs["L[0][0][0][1][0][1][3][2]_col_start_text"].value = (self.data_info["img_dim"][2]-2)
                self.hs["L[0][0][0][1][0][1][3][2]_col_start_text"].max = self.data_info["img_dim"][2]-1
                if self.hs["L[0][0][0][1][0][1][3][3]_col_end_text"].value > (self.data_info["img_dim"][2]-1):
                    self.hs["L[0][0][0][1][0][1][3][3]_col_end_text"].value = self.data_info["img_dim"][2]-1
                self.hs["L[0][0][0][1][0][1][3][3]_col_end_text"].max = self.data_info["img_dim"][2]-1
    ...
    def L0_0_0_1_0_1_3_0_sli_start_text_change(self, a):
        if self.tomo_recon_type == 'Trial Cent':
            if (a["owner"].value+20)>self.hs["L[0][0][0][1][0][1][3][1]_sli_end_text"].max:
                self.hs["L[0][0][0][1][0][1][3][1]_sli_end_text"].value = self.hs["L[0][0][0][1][0][1][3][1]_sli_end_text"].max
            else:
    ...
    def L0_0_0_1_3_0_0_1_cen_offset_confirm_btn_click(self, a):
        ...
        self.hs["L[0][0][0][1][0][1][0][3]_cen_win_wz_text"].value = 80
    ...
    def L0_0_1_0_0_2_2_recon_margin_sz_text_change(self, a):
        if 2*a['owner'].value > self.hs['L[0][0][1][0][0][2][1]_recon_chunk_sz_text'].value:
            a['owner'].value = int(self.hs['L[0][0][1][0][0][2][1]_recon_chunk_sz_text'].value/2) - 1
    ...
    def L0_0_1_0_0_1_3_filter_config_box_confirm_btn(self, a):
        ...
        if self.tomo_recon_type == "Trial Cent":
            ...
            self.hs["L[0][0][1][1][0]_recon_config_summ_text"].value = info
        else:
            info = "file_params:{} \n\n" + \
                   "recon_config:{} \n\n" + \
                   "flt_params:{} \n\n" + \
    ...
    def L0_0_1_0_1_1_1_recon_btn_click(self, a):
        if self.tomo_recon_type == "Trial Cent":
            code = {}
            ln = 0
            code[ln] = f"from collections import OrderedDict";ln += 1
            code[ln] = f"from TXM_Sandbox.TXM_Sandbox.utils.tomo_recon_tools import run_engine";ln += 1
            code[ln] = f"from TXM_Sandbox.TXM_Sandbox.utils.io import data_reader, tomo_h5_reader, data_info, tomo_h5_info";ln += 1
            code[ln] = f"params = {self.tomo_recon_param_dict}";ln += 1
            code[ln] = f"if {self.global_h.io_tomo_cfg['use_h5_reader']}:";ln += 1
            code[ln] = f"    params['file_params']['reader'] = data_reader(tomo_h5_reader)";ln += 1
            code[ln] = f"    params['file_params']['info_reader'] = data_info(tomo_h5_info)";ln += 1
            code[ln] = f"else:";ln += 1
            code[ln] = f"    from TXM_Sandbox.TXM_Sandbox.external.user_io import user_tomo_reader, user_tomo_info_reader";ln += 1
            code[ln] = f"    self.reader = data_reader(user_tomo_reader)";ln += 1
            code[ln] = f"    self.info_reader = data_info(user_tomo_info_reader)";ln += 1
            code[ln] = f"run_engine(**params)";ln += 1
