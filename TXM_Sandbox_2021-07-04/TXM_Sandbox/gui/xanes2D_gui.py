...
class xanes2D_tools_gui():
    def __init__(self, parent_h, form_sz=[650, 740]):
        ...
        self.xanes_fit_external_command_name = os.path.join(os.path.abspath(os.path.curdir),
                                                            'xanes2D_fit_external_command.py')
        self.xanes_reg_external_command_name = os.path.join(os.path.abspath(os.path.curdir),
                                                            'xanes2D_reg_external_command.py')
        self.xanes_align_external_command_name = os.path.join(os.path.abspath(os.path.curdir),
                                                              'xanes2D_align_external_command.py')
        ...
        self.xanes_config = {"filepath config": {"xanes2D_file_raw_h5_filename": self.xanes_file_raw_h5_filename,
                             ...
                             "data_config": {"xanes2D_config_is_raw": self.xanes_config_is_raw,
                             ...
                             "align 2D recon": {"xanes2D_alignment_done": self.xanes_alignment_done,
    ...
    def update_xanes2D_config(self):
        ...
        self.xanes_config = {"filepath config": {"xanes2D_file_raw_h5_filename": self.xanes_file_raw_h5_filename,
                             ...
                             "data_config": {"xanes2D_config_is_raw": self.xanes_config_is_raw,
                                             ...
                                             "xanes2D_config_fiji_view_on": self.hs[
                                                 'L[0][1][0][1][3][0]_fiji_raw_img_preview_checkbox'].value,
                                             "xanes2D_config_img_num": self.hs[
                                                 'L[0][1][0][1][3][2]_fiji_eng_id_slider'].value,
                                             "xanes2D_config_norm_scale_text_min": self.hs[
                                                 'L[0][1][0][1][1][1][1]_norm_scale_text'].min,
                                             "xanes2D_config_norm_scale_text_val": self.hs[
                                                 'L[0][1][0][1][1][1][1]_norm_scale_text'].value,
                                             "xanes2D_config_norm_scale_text_max": self.hs[
                                                 'L[0][1][0][1][1][1][1]_norm_scale_text'].max,
                                             # "xanes2D_config_smooth_flat_sigma_text.min": self.hs[
                                             #     'L[0][1][0][1][1][1][2]_smooth_flat_sigma_text'].min,
                                             # "xanes2D_config_smooth_flat_sigma_text.val": self.hs[
                                             #     'L[0][1][0][1][1][1][2]_smooth_flat_sigma_text'].value,
                                             # "xanes2D_config_smooth_flat_sigma_text.max": self.hs[
                                             #     'L[0][1][0][1][1][1][2]_smooth_flat_sigma_text'].max,
                                             "xanes2D_config_eng_points_range_slider_min": self.hs[
                                                 'L[0][1][0][1][2][0]_eng_points_range_slider'].min,
                                             "xanes2D_config_eng_points_range_slider_val": self.hs[
                                                 'L[0][1][0][1][2][0]_eng_points_range_slider'].value,
                                             "xanes2D_config_eng_points_range_slider_max": self.hs[
                                                 'L[0][1][0][1][2][0]_eng_points_range_slider'].max,
                                             "xanes2D_config_eng_s_text_min": self.hs[
                                                 'L[0][1][0][1][2][1]_eng_s_text'].min,
                                             "xanes2D_config_eng_s_text_val": self.hs[
                                                 'L[0][1][0][1][2][1]_eng_s_text'].value,
                                             "xanes2D_config_eng_s_text_max": self.hs[
                                                 'L[0][1][0][1][2][1]_eng_s_text'].max,
                                             "xanes2D_config_eng_e_text_min": self.hs[
                                                 'L[0][1][0][1][2][2]_eng_e_text'].min,
                                             "xanes2D_config_eng_e_text_val": self.hs[
                                                 'L[0][1][0][1][2][2]_eng_e_text'].value,
                                             "xanes2D_config_eng_e_text_max": self.hs[
                                                 'L[0][1][0][1][2][2]_eng_e_text'].max,
                                             "xanes2D_config_fiji_eng_id_slider_min": self.hs[
                                                 'L[0][1][0][1][3][2]_fiji_eng_id_slider'].min,
                                             "xanes2D_config_fiji_eng_id_slider_val": self.hs[
                                                 'L[0][1][0][1][3][2]_fiji_eng_id_slider'].value,
                                             "xanes2D_config_fiji_eng_id_slider_max": self.hs[
                                                 'L[0][1][0][1][3][2]_fiji_eng_id_slider'].max,
                                             "xanes2D_config_raw_img_readed": self.xanes_config_raw_img_readed,
                                             "xanes2D_data_configured": self.xanes_data_configured},
                             "roi_config": {"2D_roi_x_slider_min": self.hs['L[0][1][1][0][1][0]_2D_roi_x_slider'].min,
                                            ...
                                            "2D_roi": list(self.xanes_reg_roi),
                                            "xanes2D_roi_configured": self.xanes_roi_configured},
                             "registration_config": {"xanes2D_regparams_fiji_viewer": self.hs[
                                 'L[0][1][1][1][1][0]_fiji_mask_viewer_checkbox'].value,
                                                     "xanes2D_regparams_use_chunk": self.hs[
                                                         'L[0][1][1][1][1][1]_use_chunk_checkbox'].value,
                                                     "xanes2D_regparams_anchor_id": self.hs[
                                                         'L[0][1][1][1][1][2]_anchor_id_slider'].value,
                                                     "xanes2D_regparams_use_mask": self.hs[
                                                         'L[0][1][1][1][2][0]_use_mask_checkbox'].value,
                                                     "xanes2D_regparams_mask_thres": self.hs[
                                                         'L[0][1][1][1][2][1]_mask_thres_slider'].value,
                                                     "xanes2D_regparams_mask_dilation": self.hs[
                                                         'L[0][1][1][1][2][2]_mask_dilation_slider'].value,
                                                     "xanes2D_regparams_use_smooth_img": self.hs[
                                                         'L[0][1][1][1][3][0]_use_smooth_checkbox'].value,
                                                     "xanes2D_regparams_smooth_sigma": self.hs[
                                                         'L[0][1][1][1][3][1]_smooth_sigma_text'].value,
                                                     "xanes2D_regparams_chunk_sz": self.hs[
                                                         'L[0][1][1][1][1][3]_chunk_sz_slider'].value,
                                                     "xanes2D_regparams_reg_method": self.hs[
                                                         'L[0][1][1][1][3][2]_reg_method_dropdown'].value,
                                                     "xanes2D_regparams_ref_mode": self.hs[
                                                         'L[0][1][1][1][3][3]_ref_mode_dropdown'].value,
                                                     "xanes2D_regparams_anchor_id_slider_min": self.hs[
                                                         'L[0][1][1][1][1][2]_anchor_id_slider'].min,
                                                     "xanes2D_regparams_anchor_id_slider_val": self.hs[
                                                         'L[0][1][1][1][1][2]_anchor_id_slider'].value,
                                                     "xanes2D_regparams_anchor_id_slider_max": self.hs[
                                                         'L[0][1][1][1][1][2]_anchor_id_slider'].max,
                                                     "xanes2D_regparams_mask_thres_slider_min": self.hs[
                                                         'L[0][1][1][1][2][1]_mask_thres_slider'].min,
                                                     "xanes2D_regparams_mask_thres_slider_val": self.hs[
                                                         'L[0][1][1][1][2][1]_mask_thres_slider'].value,
                                                     "xanes2D_regparams_mask_thres_slider_max": self.hs[
                                                         'L[0][1][1][1][2][1]_mask_thres_slider'].max,
                                                     "xanes2D_regparams_mask_dilation_slider.min": self.hs[
                                                         'L[0][1][1][1][2][2]_mask_dilation_slider'].min,
                                                     "xanes2D_regparams_mask_dilation_slider.val": self.hs[
                                                         'L[0][1][1][1][2][2]_mask_dilation_slider'].value,
                                                     "xanes2D_regparams_mask_dilation_slider.max": self.hs[
                                                         'L[0][1][1][1][2][2]_mask_dilation_slider'].max,
                                                     "xanes2D_regparams_smooth_sigma_text.min": self.hs[
                                                         'L[0][1][1][1][3][1]_smooth_sigma_text'].min,
                                                     "xanes2D_regparams_smooth_sigma_text.val": self.hs[
                                                         'L[0][1][1][1][3][1]_smooth_sigma_text'].value,
                                                     "xanes2D_regparams_smooth_sigma_text.max": self.hs[
                                                         'L[0][1][1][1][3][1]_smooth_sigma_text'].max,
                                                     "xanes2D_regparams_chunk_sz_slider.min": self.hs[
                                                         'L[0][1][1][1][1][3]_chunk_sz_slider'].min,
                                                     "xanes2D_regparams_chunk_sz_slider.val": self.hs[
                                                         'L[0][1][1][1][1][3]_chunk_sz_slider'].value,
                                                     "xanes2D_regparams_chunk_sz_slider.max": self.hs[
                                                         'L[0][1][1][1][1][3]_chunk_sz_slider'].max,
                                                     ...
                                                     "xanes2D_regparams_ref_mode_dropdown_options": self.hs[
                                                         'L[0][1][1][1][3][3]_ref_mode_dropdown'].options,
                                                     "xanes2D_regparams_mrtv_level": self.hs[
                                                         'L[0][1][1][1][4][0]_mrtv_level_text'].value,
                                                     "xanes2D_regparams_mrtv_width": self.hs[
                                                         'L[0][1][1][1][4][1]_mrtv_width_text'].value,
                                                     "xanes2D_regparams_mrtv_subpixel_kernel": self.hs[
                                                         'L[0][1][1][1][4][3]_mrtv_subpixel_kernel_text'].value,
                                                     "xanes2D_regparams_mrtv_subpixel_width": self.hs[
                                                         'L[0][1][1][1][4][2]_mrtv_subpixel_wz_text'].value,
                                                     "xanes2D_regparams_configured": self.xanes_reg_params_configured},
                             "run registration": {"xanes2D_reg_done": self.xanes_reg_done},
                             "review registration": {"xanes2D_review_use_existing_reg_reviewed": self.hs[
                                 'L[0][1][2][0][1][1]_read_alignment_checkbox'].value,
                                                     "xanes2D_reviewed_reg_shift": tem,
                                                     "reg_pair_slider_min": self.hs[
                                                         'L[0][1][2][0][2][0]_reg_pair_slider'].min,
                                                     "reg_pair_slider_val": self.hs[
                                                         'L[0][1][2][0][2][0]_reg_pair_slider'].value,
                                                     "reg_pair_slider_max": self.hs[
                                                         'L[0][1][2][0][2][0]_reg_pair_slider'].max,
                                                     "xshift_text_val": self.hs[
                                                         'L[0][1][2][0][3][0]_x_shift_text'].value,
                                                     "yshift_text_val": self.hs[
                                                         'L[0][1][2][0][3][1]_y_shift_text'].value,
                                                     "xanes2D_reg_review_done": self.xanes_reg_review_done},
                             "align 2D recon": {"xanes2D_alignment_done": self.xanes_alignment_done,
                                                "xanes2D_analysis_edge_eng": self.xanes_fit_edge_eng,
                                                "xanes2D_analysis_wl_fit_eng_s": self.xanes_fit_wl_fit_eng_s,
    ...
    def set_xanes2D_variables(self):
        self.xanes_file_raw_h5_filename = self.xanes_config["filepath config"]["xanes2D_file_raw_h5_filename"]
        self.xanes_save_trial_reg_filename = self.xanes_config["filepath config"]["xanes_save_trial_reg_filename"]
        self.xanes_review_reg_best_match_filename = self.xanes_config["filepath config"][
            "xanes2D_review_reg_best_match_filename"]
        self.xanes_file_raw_h5_set = self.xanes_config["filepath config"]["xanes2D_file_raw_h5_set"]
        self.xanes_file_save_trial_set = self.xanes_config["filepath config"]["xanes2D_file_save_trial_set"]
        self.xanes_file_reg_file_set = self.xanes_config["filepath config"]["xanes2D_file_reg_file_set"]
        self.xanes_file_config_file_set = self.xanes_config["filepath config"]["xanes2D_file_config_file_set"]
        self.xanes_file_configured = self.xanes_config["filepath config"]["xanes2D_file_configured"]

        self.xanes_config_is_raw = self.xanes_config["data_config"]["xanes2D_config_is_raw"]
        self.xanes_config_img_scalar = self.xanes_config["data_config"]["xanes2D_config_img_scalar"]
        self.xanes_config_use_alternative_flat = self.xanes_config["data_config"]["xanes2D_config_use_alternative_flat"]
        self.xanes_config_use_smooth_flat = self.xanes_config["data_config"]["xanes2D_config_use_smooth_flat"]
        self.xanes_config_smooth_flat_sigma = self.xanes_config["data_config"]["xanes2D_config_smooth_flat_sigma"]
        self.xanes_config_alternative_flat_filename = self.xanes_config["data_config"][
            "xanes2D_config_alternative_flat_filename"]
        self.xanes_config_alternative_flat_set = self.xanes_config["data_config"]["xanes2D_config_alternative_flat_set"]
        self.xanes_eng_id_s = self.xanes_config["data_config"]["xanes2D_config_eng_points_range_s"]
        self.xanes_eng_id_e = self.xanes_config["data_config"]["xanes2D_config_eng_points_range_e"]
        self.xanes_config_raw_img_readed = self.xanes_config["data_config"]["xanes2D_config_raw_img_readed"]
        self.xanes_data_configured = self.xanes_config["data_config"]["xanes2D_data_configured"]

        self.xanes_reg_roi = self.xanes_config["roi_config"]["2D_roi"]
        self.xanes_roi_configured = self.xanes_config["roi_config"]["xanes2D_roi_configured"]
        self.xanes_reg_use_chunk = self.xanes_config["registration_config"]["xanes2D_regparams_use_chunk"]
        self.xanes_reg_anchor_idx = self.xanes_config["registration_config"]["xanes2D_regparams_anchor_id"]
        self.xanes_reg_use_mask = self.xanes_config["registration_config"]["xanes2D_regparams_use_mask"]
        self.xanes_reg_mask_thres = self.xanes_config["registration_config"]["xanes2D_regparams_mask_thres"]
        self.xanes_reg_mask_dilation_width = self.xanes_config["registration_config"]["xanes2D_regparams_mask_dilation"]
        self.xanes_reg_use_smooth_img = self.xanes_config["registration_config"]["xanes2D_regparams_use_smooth_img"]
        self.xanes_reg_smooth_img_sigma = self.xanes_config["registration_config"]["xanes2D_regparams_smooth_sigma"]
        self.xanes_reg_chunk_sz = self.xanes_config["registration_config"]["xanes2D_regparams_chunk_sz"]
        self.xanes_reg_method = self.xanes_config["registration_config"]["xanes2D_regparams_reg_method"]
        self.xanes_reg_ref_mode = self.xanes_config["registration_config"]["xanes2D_regparams_ref_mode"]

        self.xanes_reg_mrtv_level = self.xanes_config["registration_config"]["xanes2D_regparams_mrtv_level"]
        self.xanes_reg_mrtv_width = self.xanes_config["registration_config"]["xanes2D_regparams_mrtv_width"]
        ...
        self.xanes_reg_params_configured = self.xanes_config["registration_config"]["xanes2D_regparams_configured"]

        self.xanes_reg_done = self.xanes_config["run registration"]["xanes2D_reg_done"]

        self.xanes_review_read_alignment_option = self.xanes_config["review registration"][
        ...
        self.xanes_reg_review_done = self.xanes_config["review registration"]["xanes2D_reg_review_done"]

        self.xanes_alignment_done = self.xanes_config["align 2D recon"]["xanes2D_alignment_done"]
        self.xanes_fit_edge_eng = self.xanes_config["align 2D recon"]["xanes2D_analysis_edge_eng"]
        self.xanes_fit_wl_fit_eng_s = self.xanes_config["align 2D recon"]["xanes2D_analysis_wl_fit_eng_s"]
        self.xanes_fit_wl_fit_eng_e = self.xanes_config["align 2D recon"]["xanes2D_analysis_wl_fit_eng_e"]
        self.xanes_fit_pre_edge_e = self.xanes_config["align 2D recon"]["xanes2D_analysis_pre_edge_e"]
        self.xanes_fit_post_edge_s = self.xanes_config["align 2D recon"]["xanes2D_analysis_post_edge_s"]
        self.xanes_fit_edge_0p5_fit_s = self.xanes_config["align 2D recon"]["xanes2D_analysis_edge_0p5_fit_s"]
        self.xanes_fit_edge_0p5_fit_e = self.xanes_config["align 2D recon"]["xanes2D_analysis_edge_0p5_fit_e"]
        self.xanes_fit_type = self.xanes_config["align 2D recon"]["xanes2D_analysis_type"]

    def set_xanes2D_handles(self):
        self.hs['L[0][1][0][1][1][1][0]_is_raw_checkbox'].value = self.xanes_config_is_raw

        self.hs['L[0][1][0][1][1][1][1]_norm_scale_text'].value = self.xanes_config_img_scalar
        # self.hs['L[0][1][0][1][1][1][2]_smooth_flat_sigma_text'].value = self.xanes_config_smooth_flat_sigma
        self.hs['L[0][1][0][1][2][0]_eng_points_range_slider'].max = self.xanes_config["data_config"][
            "xanes2D_config_eng_points_range_slider_max"]
        self.hs['L[0][1][0][1][2][0]_eng_points_range_slider'].min = self.xanes_config["data_config"][
            "xanes2D_config_eng_points_range_slider_min"]
        self.hs['L[0][1][0][1][2][0]_eng_points_range_slider'].value = self.xanes_config["data_config"][
            "xanes2D_config_eng_points_range_slider_val"]
        self.hs['L[0][1][0][1][2][1]_eng_s_text'].max = self.xanes_config["data_config"][
            "xanes2D_config_eng_s_text_max"]
        self.hs['L[0][1][0][1][2][1]_eng_s_text'].min = self.xanes_config["data_config"][
            "xanes2D_config_eng_s_text_min"]
        self.hs['L[0][1][0][1][2][1]_eng_s_text'].value = self.xanes_config["data_config"][
            "xanes2D_config_eng_s_text_val"]
        self.hs['L[0][1][0][1][2][2]_eng_e_text'].max = self.xanes_config["data_config"][
            "xanes2D_config_eng_e_text_max"]
        self.hs['L[0][1][0][1][2][2]_eng_e_text'].min = self.xanes_config["data_config"][
            "xanes2D_config_eng_e_text_min"]
        self.hs['L[0][1][0][1][2][2]_eng_e_text'].value = self.xanes_config["data_config"][
            "xanes2D_config_eng_e_text_val"]
        self.hs['L[0][1][0][1][3][2]_fiji_eng_id_slider'].max = self.xanes_config["data_config"][
            "xanes2D_config_fiji_eng_id_slider_max"]
        self.hs['L[0][1][0][1][3][2]_fiji_eng_id_slider'].min = self.xanes_config["data_config"][
            "xanes2D_config_fiji_eng_id_slider_min"]
        self.hs['L[0][1][0][1][3][2]_fiji_eng_id_slider'].value = self.xanes_config["data_config"][
            "xanes2D_config_fiji_eng_id_slider_val"]

        self.hs['L[0][1][1][0][1][0]_2D_roi_x_slider'].max = self.xanes_config["roi_config"]["2D_roi_x_slider_max"]
        self.hs['L[0][1][1][0][1][0]_2D_roi_x_slider'].min = self.xanes_config["roi_config"]["2D_roi_x_slider_min"]
        self.hs['L[0][1][1][0][1][0]_2D_roi_x_slider'].value = self.xanes_config["roi_config"]["2D_roi_x_slider_val"]
        self.hs['L[0][1][1][0][1][1]_2D_roi_y_slider'].max = self.xanes_config["roi_config"]["2D_roi_y_slider_max"]
        self.hs['L[0][1][1][0][1][1]_2D_roi_y_slider'].min = self.xanes_config["roi_config"]["2D_roi_y_slider_min"]
        self.hs['L[0][1][1][0][1][1]_2D_roi_y_slider'].value = self.xanes_config["roi_config"]["2D_roi_y_slider_val"]

        self.hs['L[0][1][1][1][1][2]_anchor_id_slider'].max = self.xanes_config["registration_config"][
            "xanes2D_regparams_anchor_id_slider_max"]
        self.hs['L[0][1][1][1][1][2]_anchor_id_slider'].min = self.xanes_config["registration_config"][
            "xanes2D_regparams_anchor_id_slider_min"]
        self.hs['L[0][1][1][1][1][2]_anchor_id_slider'].value = self.xanes_config["registration_config"][
            "xanes2D_regparams_anchor_id_slider_val"]
        self.hs['L[0][1][1][1][2][0]_use_mask_checkbox'].value = self.xanes_config["registration_config"][
            "xanes2D_regparams_use_mask"]
        self.hs['L[0][1][1][1][2][1]_mask_thres_slider'].max = self.xanes_config["registration_config"][
            "xanes2D_regparams_mask_thres_slider_max"]
        self.hs['L[0][1][1][1][2][1]_mask_thres_slider'].min = self.xanes_config["registration_config"][
            "xanes2D_regparams_mask_thres_slider_min"]
        self.hs['L[0][1][1][1][2][1]_mask_thres_slider'].value = self.xanes_config["registration_config"][
            "xanes2D_regparams_mask_thres_slider_val"]
        self.hs['L[0][1][1][1][2][2]_mask_dilation_slider'].max = self.xanes_config["registration_config"][
            "xanes2D_regparams_mask_dilation_slider.max"]
        self.hs['L[0][1][1][1][2][2]_mask_dilation_slider'].min = self.xanes_config["registration_config"][
            "xanes2D_regparams_mask_dilation_slider.min"]
        self.hs['L[0][1][1][1][2][2]_mask_dilation_slider'].value = self.xanes_config["registration_config"][
            "xanes2D_regparams_mask_dilation_slider.val"]
        self.hs['L[0][1][1][1][3][0]_use_smooth_checkbox'].value = self.xanes_config["registration_config"][
            "xanes2D_regparams_use_smooth_img"]
        self.hs['L[0][1][1][1][3][1]_smooth_sigma_text'].max = self.xanes_config["registration_config"][
            "xanes2D_regparams_smooth_sigma_text.max"]
        self.hs['L[0][1][1][1][3][1]_smooth_sigma_text'].min = self.xanes_config["registration_config"][
            "xanes2D_regparams_smooth_sigma_text.min"]
        self.hs['L[0][1][1][1][3][1]_smooth_sigma_text'].value = self.xanes_config["registration_config"][
            "xanes2D_regparams_smooth_sigma_text.val"]
        self.hs['L[0][1][1][1][1][3]_chunk_sz_slider'].max = self.xanes_config["registration_config"][
            "xanes2D_regparams_chunk_sz_slider.max"]
        self.hs['L[0][1][1][1][1][3]_chunk_sz_slider'].min = self.xanes_config["registration_config"][
            "xanes2D_regparams_chunk_sz_slider.min"]
        self.hs['L[0][1][1][1][1][3]_chunk_sz_slider'].value = self.xanes_config["registration_config"][
            "xanes2D_regparams_chunk_sz_slider.val"]
        # self.hs['L[0][1][1][1][3][2]_reg_method_dropdown'].options = self.xanes_config["registration_config"]["xanes2D_regparams_reg_method_dropdown_options"]
        self.hs['L[0][1][1][1][3][2]_reg_method_dropdown'].value = self.xanes_config["registration_config"][
            "xanes2D_regparams_reg_method"]
        self.hs['L[0][1][1][1][3][3]_ref_mode_dropdown'].options = self.xanes_config["registration_config"][
            "xanes2D_regparams_ref_mode_dropdown_options"]
        self.hs['L[0][1][1][1][3][3]_ref_mode_dropdown'].value = self.xanes_config["registration_config"][
            "xanes2D_regparams_ref_mode"]
        self.hs['L[0][1][1][1][4][0]_mrtv_level_text'].value = self.xanes_config["registration_config"][
            "xanes2D_regparams_mrtv_level"]
        self.hs['L[0][1][1][1][4][1]_mrtv_width_text'].value = self.xanes_config["registration_config"][
            "xanes2D_regparams_mrtv_width"]
        self.hs['L[0][1][1][1][4][2]_mrtv_subpixel_wz_text'].value = self.xanes_config["registration_config"][
            "xanes2D_regparams_mrtv_subpixel_width"]
        self.hs['L[0][1][1][1][4][3]_mrtv_subpixel_kernel_text'].value = self.xanes_config["registration_config"][
            "xanes2D_regparams_mrtv_subpixel_kernel"]

        self.hs['L[0][1][2][0][2][0]_reg_pair_slider'].max = self.xanes_config["review registration"][
            "reg_pair_slider_max"]
        self.hs['L[0][1][2][0][2][0]_reg_pair_slider'].min = self.xanes_config["review registration"][
            "reg_pair_slider_min"]
        self.hs['L[0][1][2][0][2][0]_reg_pair_slider'].value = self.xanes_config["review registration"][
            "reg_pair_slider_val"]
        self.hs['L[0][1][2][0][3][0]_x_shift_text'].value = self.xanes_config["review registration"]["xshift_text_val"]
        self.hs['L[0][1][2][0][3][1]_y_shift_text'].value = self.xanes_config["review registration"]["yshift_text_val"]

        self.xanes_fit_gui_h.hs['L[0][x][3][0][1][0][0]_fit_eng_range_option_dropdown'].value = \
            self.xanes_config["align 2D recon"]["xanes2D_analysis_type"]
        self.xanes_fit_gui_h.hs['L[0][x][3][0][1][0][1]_fit_eng_range_edge_eng_text'].value = \
            self.xanes_config["align 2D recon"]["xanes2D_analysis_edge_eng"]
        self.xanes_fit_gui_h.hs['L[0][x][3][0][1][0][2]_fit_eng_range_pre_edge_e_text'].value = \
            self.xanes_config["align 2D recon"]["xanes2D_analysis_pre_edge_e"]
        self.xanes_fit_gui_h.hs['L[0][x][3][0][1][0][3]_fit_eng_range_post_edge_s_text'].value = \
            self.xanes_config["align 2D recon"]["xanes2D_analysis_post_edge_s"]
        self.xanes_fit_gui_h.hs['L[0][x][3][0][1][1][0]_fit_eng_range_wl_fit_s_text'].value = \
            self.xanes_config["align 2D recon"]["xanes2D_analysis_wl_fit_eng_s"]
        self.xanes_fit_gui_h.hs['L[0][x][3][0][1][1][1]_fit_eng_range_wl_fit_e_text'].value = \
            self.xanes_config["align 2D recon"]["xanes2D_analysis_wl_fit_eng_e"]
        self.xanes_fit_gui_h.hs['L[0][x][3][0][1][1][2]_fit_eng_range_edge0.5_fit_s_text'].value = \
            self.xanes_config["align 2D recon"]["xanes2D_analysis_edge_0p5_fit_s"]
        self.xanes_fit_gui_h.hs['L[0][x][3][0][1][1][3]_fit_eng_range_edge0.5_fit_e_text'].value = \
            self.xanes_config["align 2D recon"]["xanes2D_analysis_edge_0p5_fit_e"]
        ...
        def xanes2D_compound_logic():
            if self.xanes_file_analysis_option == 'Reg By Shift':
                if self.xanes_roi_configured:
                    ...
                    self.hs['L[0][1][2][0][1][0]_read_alignment_btn'].disabled = False
                else:
                    boxes = ['L[0][1][2][0]_review_reg_results_box']
                    enable_disable_boxes(self.hs, boxes, disabled=True, level=-1)
                if self.xanes_reg_file_readed:
                    self.hs['L[0][1][2][0][4][1]_confirm_review_results_btn'].disabled = False
            else:
                if (self.xanes_reg_done and (not self.xanes_reg_file_readed) and
                    ...
                    enable_disable_boxes(self.hs, boxes, disabled=True, level=-1)
                    self.hs['L[0][1][2][0][1][0]_read_alignment_btn'].disabled = True
            ...
            #     boxes = ['L[0][1][0][1][1][0][4]_alternative_flat_file_btn']
            #     enable_disable_boxes(self.hs, boxes, disabled=False, level=-1)
            # else:
            #     boxes = ['L[0][1][0][1][1][0][4]_alternative_flat_file_btn']
            #     enable_disable_boxes(self.hs, boxes, disabled=True, level=-1)
            ...
            if (self.hs['L[0][1][0][1][1][1][0]_is_raw_checkbox'].value &
                ...
                self.hs['L[0][1][0][1][1][1][1]_norm_scale_text'].disabled = False
            else:
                ...
                self.hs['L[0][1][0][1][1][1][1]_norm_scale_text'].disabled = True
            ...
            if self.hs['L[0][1][1][1][3][2]_reg_method_dropdown'].value in ['MPC', 'SR', 'PC']:
                ...
                self.hs['L[0][1][1][1][4][3]_mrtv_subpixel_kernel_text'].disabled = False
            ...
            if self.hs['L[0][1][1][1][4][4]_mrtv_subpixel_srch_dropdown'].value == 'analytical':
                self.hs['L[0][1][1][1][4][2]_mrtv_subpixel_wz_text'].disabled = True
            else:
                self.hs['L[0][1][1][1][4][2]_mrtv_subpixel_wz_text'].disabled = False
    ...
    def build_gui(self):
        ...
        layout = {'border': '3px solid #FFCC00', 'width': f'{self.form_sz[1] - 86}px',
        ...
        layout = {'border': '3px solid #8855AA', 'width': f'{self.form_sz[1] - 92}px',
                  'height': f'{0.25 * (self.form_sz[0] - 136)}px'}
        ...
        layout = {'border': '3px solid #FFCC00', 'width': f'{self.form_sz[1] - 98}px',
        ...
        self.hs['L[0][1][0][0][0][0]_select_file&path_title_box'] = widgets.HTML(
        ...
        self.hs['L[0][1][0][0][0]_select_file&path_title_box'].children = get_handles(self.hs,
                                                                                      'L[0][1][0][0][0]_select_file&path_title_box',
                                                                                      -1)
        ...
        self.hs['L[0][1][0][0][1][1]_select_raw_h5_path_text'] = widgets.Text(value='Choose raw h5 directory ...',
                                                                              description='', disabled=True)
        layout = {'width': '66%', 'display': 'inline_flex'}
        self.hs['L[0][1][0][0][1][1]_select_raw_h5_path_text'].layout = layout
        self.hs['L[0][1][0][0][1][0]_select_raw_h5_path_btn'] = SelectFilesButton(option='askopenfilename',
                                                                                  text_h=self.hs[
                                                                                      'L[0][1][0][0][1][1]_select_raw_h5_path_text'],
                                                                                  **{'open_filetypes': (
                                                                                  ('h5 files', '*.h5'),)})
        layout = {'width': '15%'}
        self.hs['L[0][1][0][0][1][0]_select_raw_h5_path_btn'].layout = layout
        self.hs['L[0][1][0][0][1][0]_select_raw_h5_path_btn'].description = 'XANES2D File'
        self.hs['L[0][1][0][0][1][0]_select_raw_h5_path_btn'].on_click(self.L0_1_0_0_1_0_select_raw_h5_path_btn_click)
        self.hs['L[0][1][0][0][1]_select_raw_box'].children = get_handles(self.hs, 'L[0][1][0][0][1]_select_raw_box',
                                                                          -1)
        ...
        self.hs['L[0][1][0][0][2][1]_select_save_trial_text'] = widgets.Text(value='Save trial registration as ...',
                                                                             description='', disabled=True)
        layout = {'width': '66%', 'display': 'inline_flex'}
        self.hs['L[0][1][0][0][2][1]_select_save_trial_text'].layout = layout
        self.hs['L[0][1][0][0][2][0]_select_save_trial_btn'] = SelectFilesButton(option='asksaveasfilename',
                                                                                 text_h=self.hs[
                                                                                     'L[0][1][0][0][2][1]_select_save_trial_text'],
                                                                                 **{'open_filetypes': (
                                                                                 ('h5 files', '*.h5'),),
                                                                                    'initialfile': '2D_trial_reg.h5'})
        self.hs['L[0][1][0][0][2][0]_select_save_trial_btn'].description = 'Save Reg File'
        layout = {'width': '15%'}
        self.hs['L[0][1][0][0][2][0]_select_save_trial_btn'].layout = layout
        self.hs['L[0][1][0][0][2][0]_select_save_trial_btn'].on_click(self.L0_1_0_0_3_0_select_save_trial_btn_click)
        self.hs['L[0][1][0][0][2]_select_save_trial_box'].children = get_handles(self.hs,
                                                                                 'L[0][1][0][0][2]_select_save_trial_box',
                                                                                 -1)
        ...
        self.hs['L[0][1][0][0][3][1]_confirm_file&path_text'] = widgets.Text(
            value='Save trial registration, or go directly review registration ...', description='', disabled=True)
        layout = {'width': '66%'}
        self.hs['L[0][1][0][0][3][1]_confirm_file&path_text'].layout = layout
        self.hs['L[0][1][0][0][3][0]_confirm_file&path_btn'] = widgets.Button(description='Confirm',
                                                                              tooltip='Confirm: Confirm after you finish file configuration')
        self.hs['L[0][1][0][0][3][0]_confirm_file&path_btn'].style.button_color = 'darkviolet'
        self.hs['L[0][1][0][0][3][0]_confirm_file&path_btn'].on_click(self.L0_1_0_0_4_0_confirm_file_path_btn_click)
        layout = {'width': '15%'}
        self.hs['L[0][1][0][0][3][0]_confirm_file&path_btn'].layout = layout
        ...
        self.hs['L[0][1][0][0][3][2]_file_path_options_dropdown'].observe(
            self.L0_1_0_0_3_2_file_path_options_dropdown_change, names='value')
        self.hs['L[0][1][0][0][3]_select_file&path_title_comfirm_box'].children = get_handles(self.hs,
                                                                                              'L[0][1][0][0][3]_select_file&path_title_comfirm_box',
                                                                                              -1)

        self.hs['L[0][1][0][0]_select_file&path_box'].children = get_handles(self.hs,
                                                                             'L[0][1][0][0]_select_file&path_box', -1)
        ...
        layout = {'justify-content': 'center', 'align-items': 'center', 'align-contents': 'center',
                  'border': '3px solid #FFCC00', 'width': f'{self.form_sz[1] - 98}px',
                  'height': f'{0.07 * (self.form_sz[0] - 136)}px'}
        self.hs['L[0][1][0][1][0]_config_data_title_box'] = widgets.HBox()
        self.hs['L[0][1][0][1][0]_config_data_title_box'].layout = layout
        self.hs['L[0][1][0][1][0][0]_config_data_title'] = widgets.HTML(
            '<span style="color:red; font-size: 150%; font-weight: bold; background-color:rgb(135,206,250);">' + 'Config Data & Preprocessing' + '</span>')
        layout = {'left': '35%', 'background-color': 'white', 'color': 'cyan'}
        self.hs['L[0][1][0][1][0][0]_config_data_title'].layout = layout
        self.hs['L[0][1][0][1][0]_config_data_title_box'].children = get_handles(self.hs,
                                                                                 'L[0][1][0][1][0]_config_data_title_box',
                                                                                 -1)

        ## ## ## ## ## data_preprocessing_options -- start
        layout = {'border': '3px solid #FFCC00', 'width': f'{self.form_sz[1] - 98}px',
                  'height': f'{0.6 * 0.23 * (self.form_sz[0] - 136)}px'}
        ...
        layout = {'border': '3px solid #FFCC00', 'width': f'{self.form_sz[1] - 104}px',
                  'height': f'{0.07 * (self.form_sz[0] - 136)}px'}
        ...
        #
        # layout = {'width':'15%'}
        # self.hs['L[0][1][0][1][1][0][4]_alternative_flat_file_btn'] = SelectFilesButton(option='askopenfilename',
        #                                                                                    **{'open_filetypes':(('h5 file', '*.h5'),)},
        #                                                                                    disabled=True)
        # self.hs['L[0][1][0][1][1][0][4]_alternative_flat_file_btn'].description = 'select alt flat'
        # self.hs['L[0][1][0][1][1][0][4]_alternative_flat_file_btn'].layout = layout
        # self.hs['L[0][1][0][1][1][0][4]_alternative_flat_file_btn'].disabled = True
        #
        ...
        # self.hs['L[0][1][0][1][1][0][4]_alternative_flat_file_btn'].on_click(self.L0_1_0_1_1_0_4_alternative_flat_file_btn_click)
        ...
        self.hs['L[0][1][0][1][1][1][0]_is_raw_checkbox'] = widgets.Checkbox(value=True, description='Is Raw',
                                                                             disabled=True,
                                                                             indent=False,
                                                                             description_tooltip='check it if the XANES data in the file is not normalized')
        layout = {'width': '20%'}
        self.hs['L[0][1][0][1][1][1][0]_is_raw_checkbox'].layout = layout
        layout = {'width': '20%'}
        self.hs['L[0][1][0][1][1][1][1]_norm_scale_text'] = widgets.BoundedFloatText(value=1,
                                                                                     min=1e-10,
                                                                                     max=100,
                                                                                     step=0.1,
                                                                                     ...
                                                                                     disabled=True,
                                                                                     description_tooltip='scale the XANES data with a factor if the normalized data is not in range [0, 1]')
        self.hs['L[0][1][0][1][1][1][1]_norm_scale_text'].layout = layout
        layout = {'left': '40.9%', 'width': '15%'}
        self.hs['L[0][1][0][1][1][1][2]_config_data_load_images_btn'] = widgets.Button(description='Load Images',
                                                                                       disabled=True)
        self.hs['L[0][1][0][1][1][1][2]_config_data_load_images_btn'].layout = layout
        self.hs['L[0][1][0][1][1][1][2]_config_data_load_images_btn'].style.button_color = 'darkviolet'
        ...
        self.hs['L[0][1][0][1][1][1][0]_is_raw_checkbox'].observe(self.L0_1_0_1_1_0_0_is_raw_checkbox_change,
                                                                  names='value')
        self.hs['L[0][1][0][1][1][1][1]_norm_scale_text'].observe(self.L0_1_0_1_1_1_1_norm_scale_text_chg,
                                                                  names='value')
        self.hs['L[0][1][0][1][1][1][2]_config_data_load_images_btn'].on_click(
            self.L0_1_0_1_1_1_1_config_data_load_images_btn_click)
        self.hs['L[0][1][0][1][1][1]_data_preprocessing_options_box1'].children = get_handles(self.hs,
                                                                                              'L[0][1][0][1][1][1]_data_preprocessing_options_box1',
                                                                                              -1)

        self.hs['L[0][1][0][1][1]_data_preprocessing_options_box'].children = get_handles(self.hs,
                                                                                          'L[0][1][0][1][1]_data_preprocessing_options_box',
                                                                                          -1)
        ...
        self.hs['L[0][1][0][1][2][0]_eng_points_range_slider'] = widgets.IntRangeSlider(value=0,
        ...
        self.hs['L[0][1][0][1][2][0]_eng_points_range_slider'].observe(self.L0_1_0_1_2_0_eng_points_range_slider_change,
                                                                       names='value')
        ...
        self.hs['L[0][1][0][1][3][0]_fiji_raw_img_preview_checkbox'] = widgets.Checkbox(value=False,
                                                                                        description='fiji view',
                                                                                        disabled=True,
                                                                                        indent=False)
        layout = {'width': '20%'}
        self.hs['L[0][1][0][1][3][0]_fiji_raw_img_preview_checkbox'].layout = layout
        self.hs['L[0][1][0][1][3][2]_fiji_eng_id_slider'] = widgets.IntSlider(value=False, description='img #',
                                                                              disabled=True, min=0)
        layout = {'width': '60.6%'}
        self.hs['L[0][1][0][1][3][2]_fiji_eng_id_slider'].layout = layout
        self.hs['L[0][1][0][1][3][1]_fiji_close_btn'] = widgets.Button(description='close all fiji viewers',
                                                                       disabled=True)
        layout = {'width': '15%'}
        self.hs['L[0][1][0][1][3][1]_fiji_close_btn'].layout = layout
        self.hs['L[0][1][0][1][3]_fiji_box'].children = get_handles(self.hs, 'L[0][1][0][1][3]_fiji_box', -1)
        self.hs['L[0][1][0][1][3][0]_fiji_raw_img_preview_checkbox'].observe(
            self.L0_1_0_1_3_0_fiji_virtural_stack_preview_checkbox_change, names='value')
        self.hs['L[0][1][0][1][3][2]_fiji_eng_id_slider'].observe(self.L0_1_0_1_3_2_fiji_eng_id_slider, names='value')
        self.hs['L[0][1][0][1][3][1]_fiji_close_btn'].on_click(self.L0_1_0_1_3_1_fiji_close_btn_click)
        ## ## ## ## ## fiji option -- end
        ...
        self.hs['L[0][1][0][1][4][1]_confirm_config_data_text'] = widgets.Text(
        ...
        self.hs['L[0][1][0][1][4][0]_confirm_config_data_btn'] = widgets.Button(description='Confirm',
                                                                                description_tooltip='Confirm: Confirm after you finish file configuration',
                                                                                disabled=True)
        self.hs['L[0][1][0][1][4][0]_confirm_config_data_btn'].style.button_color = 'darkviolet'
        layout = {'width': '15%'}
        self.hs['L[0][1][0][1][4][0]_confirm_config_data_btn'].layout = layout
        self.hs['L[0][1][0][1][4]_config_data_confirm_box'].children = get_handles(self.hs,
                                                                                   'L[0][1][0][1][4]_config_data_confirm_box',
                                                                                   -1)
        self.hs['L[0][1][0][1][4][0]_confirm_config_data_btn'].on_click(self.L0_1_0_1_4_0_confirm_config_data_btn_click)
        ...
        self.hs['L[0][1][1][0][0][0]_2D_roi_title_text'] = widgets.HTML(
            '<span style="color:red; font-size: 150%; font-weight: bold; background-color:rgb(135,206,250);">' + 'Config 2D ROI' + '</span>')
        ...
        self.hs['L[0][1][1][0][0]_2D_roi_title_box'].children = get_handles(self.hs,
                                                                            'L[0][1][1][0][0]_2D_roi_title_box', -1)
        ...
        layout = {'border': '3px solid #FFCC00', 'width': f'{self.form_sz[1] - 108}px',
                  'height': f'{0.07 * (self.form_sz[0] - 136)}px'}
        ...
        self.hs['L[0][1][1][0][1]_2D_roi_define_box'].children = get_handles(self.hs,
                                                                             'L[0][1][1][0][1]_2D_roi_define_box', -1)
        ...
        self.hs['L[0][1][1][0][2][1]_confirm_roi_btn'] = widgets.Button(description='Confirm',
                                                                        description_tooltip='Confirm the roi once you define the ROI ...',
                                                                        disabled=True)
        self.hs['L[0][1][1][0][2][1]_confirm_roi_btn'].style.button_color = 'darkviolet'
        self.hs['L[0][1][1][0][2][1]_confirm_roi_btn'].layout = layout
        self.hs['L[0][1][1][0][2]_2D_roi_confirm_box'].children = get_handles(self.hs,
                                                                              'L[0][1][1][0][2]_2D_roi_confirm_box', -1)
        self.hs['L[0][1][1][0][2][1]_confirm_roi_btn'].on_click(self.L0_1_1_0_2_1_confirm_roi_btn_click)
        ## ## ## ## ## confirm roi -- end
        ...
        self.hs['L[0][1][1][1][0][0]_config_reg_params_title_text'] = widgets.HTML(
            '<span style="color:red; font-size: 150%; font-weight: bold; background-color:rgb(135,206,250);">' + 'Config Reg Params' + '</span>')
        ...
        self.hs['L[0][1][1][1][0]_config_reg_params_title_box'].children = get_handles(self.hs,
                                                                                       'L[0][1][1][1][0]_config_reg_params_title_box',
                                                                                       -1)
        ...
        self.hs['L[0][1][1][1][1]_fiji&anchor_box'].children = get_handles(self.hs, 'L[0][1][1][1][1]_fiji&anchor_box',
                                                                           -1)
        self.hs['L[0][1][1][1][1][0]_fiji_mask_viewer_checkbox'].observe(
            self.L0_1_1_1_1_0_fiji_mask_viewer_checkbox_change, names='value')
        self.hs['L[0][1][1][1][1][1]_use_chunk_checkbox'].observe(self.L0_1_1_1_1_1_chunk_checkbox_change,
                                                                  names='value')
        self.hs['L[0][1][1][1][1][2]_anchor_id_slider'].observe(self.L0_1_1_1_1_2_anchor_id_slider_change,
                                                                names='value')
        ...
        self.hs['L[0][1][1][1][2]_mask_options_box'].children = get_handles(self.hs,
                                                                            'L[0][1][1][1][2]_mask_options_box', -1)
        self.hs['L[0][1][1][1][2][0]_use_mask_checkbox'].observe(self.L0_1_1_1_2_0_use_mask_checkbox_change,
                                                                 names='value')
        self.hs['L[0][1][1][1][2][1]_mask_thres_slider'].observe(self.L0_1_1_1_2_1_mask_thres_slider_change,
                                                                 names='value')
        self.hs['L[0][1][1][1][2][2]_mask_dilation_slider'].observe(self.L0_1_1_1_2_2_mask_dilation_slider_change,
                                                                    names='value')
        ...
        self.hs['L[0][1][1][1][3]_sli_search&chunk_size_box'].children = get_handles(self.hs,
                                                                                     'L[0][1][1][1][3]_sli_search&chunk_size_box',
                                                                                     -1)
        self.hs['L[0][1][1][1][3][0]_use_smooth_checkbox'].observe(self.L0_1_1_1_3_0_use_smooth_checkbox_change,
                                                                   names='value')
        self.hs['L[0][1][1][1][3][1]_smooth_sigma_text'].observe(self.L0_1_1_1_3_1_smooth_sigma_text_change,
                                                                 names='value')
        self.hs['L[0][1][1][1][3][2]_reg_method_dropdown'].observe(self.L0_1_1_1_3_2_reg_method_dropdown_change,
                                                                   names='value')
        self.hs['L[0][1][1][1][3][3]_ref_mode_dropdown'].observe(self.L0_1_1_1_3_3_ref_mode_dropdown_change,
                                                                 names='value')
        ...
        self.hs['L[0][1][1][1][4][4]_mrtv_subpixel_srch_dropdown'] = widgets.Dropdown(value='analytical',
                                                                                      options=['analytical', 'fitting'],
                                                                                      description='subpxl srch',
                                                                                      description_tooltip='subpxl srch: subpixel TV minization option',
                                                                                      disabled=True)
        layout = {'width': '19%'}
        self.hs['L[0][1][1][1][4][4]_mrtv_subpixel_srch_dropdown'].layout = layout

        self.hs['L[0][1][1][1][4][2]_mrtv_subpixel_wz_text'] = widgets.BoundedIntText(value=3,
                                                                                      min=2,
                                                                                      max=20,
                                                                                      step=0.1,
        ...
        self.hs['L[0][1][1][1][4][3]_mrtv_subpixel_kernel_text'] = widgets.BoundedIntText(value=3,
                                                                                          min=2,
                                                                                          max=20,
                                                                                          step=1,
                                                                                          ...
                                                                                          disabled=True)
        layout = {'width': '19%'}
        self.hs['L[0][1][1][1][4][3]_mrtv_subpixel_kernel_text'].layout = layout

        self.hs['L[0][1][1][1][4]_mrtv_options_box'].children = get_handles(self.hs,
                                                                            'L[0][1][1][1][4]_mrtv_options_box', -1)
        ...
        self.hs['L[0][1][1][1][4][2]_mrtv_subpixel_wz_text'].observe(self.L0_1_1_1_4_2_mrtv_subpixel_wz_text_change,
                                                                     names='value')
        self.hs['L[0][1][1][1][4][3]_mrtv_subpixel_kernel_text'].observe(
            self.L0_1_1_1_4_3_mrtv_subpixel_kernel_text_change, names='value')
        self.hs['L[0][1][1][1][4][4]_mrtv_subpixel_srch_dropdown'].observe(
            self.L0_1_1_1_4_4_mrtv_subpixel_srch_dropdown, names='value')
        ## ## ## ## ##  reg_options box -- end
        ...
        layout = {'width': '15%', 'height': '90%'}
        self.hs['L[0][1][1][1][5][1]_confirm_reg_params_btn'] = widgets.Button(description='Confirm',
                                                                               description_tooltip='Confirm the roi once you define the ROI ...',
                                                                               disabled=True)
        self.hs['L[0][1][1][1][5][1]_confirm_reg_params_btn'].style.button_color = 'darkviolet'
        self.hs['L[0][1][1][1][5][1]_confirm_reg_params_btn'].layout = layout
        self.hs['L[0][1][1][1][5]_config_reg_params_confirm_box'].children = get_handles(self.hs,
                                                                                         'L[0][1][1][1][5]_config_reg_params_confirm_box',
                                                                                         -1)
        self.hs['L[0][1][1][1][5][1]_confirm_reg_params_btn'].on_click(self.L0_1_1_1_5_1_confirm_reg_params_btn_click)
        ## ## ## ## ## confirm reg settings -- end

        self.hs['L[0][1][1][1]_config_reg_params_box'].children = get_handles(self.hs,
                                                                              'L[0][1][1][1]_config_reg_params_box', -1)
        ...
        self.hs['L[0][1][1][2][0][0]_run_reg_title_text'] = widgets.HTML(
            '<span style="color:red; font-size: 150%; font-weight: bold; background-color:rgb(135,206,250);">' + 'Run Registration' + '</span>')
        layout = {'background-color': 'white', 'color': 'cyan', 'left': '41%'}
        self.hs['L[0][1][1][2][0][0]_run_reg_title_text'].layout = layout
        self.hs['L[0][1][1][2][0]_run_reg_title_box'].children = get_handles(self.hs,
                                                                             'L[0][1][1][2][0]_run_reg_title_box', -1)
        ...
        layout = {'width': '15%', 'height': '90%'}
        self.hs['L[0][1][1][2][1][0]_run_reg_btn'] = widgets.Button(description='Run Reg',
                                                                    description_tooltip='run registration once you are ready ...',
                                                                    disabled=True)
        self.hs['L[0][1][1][2][1][0]_run_reg_btn'].style.button_color = 'darkviolet'
        self.hs['L[0][1][1][2][1][0]_run_reg_btn'].layout = layout
        self.hs['L[0][1][1][2][1]_run_reg_confirm_box'].children = get_handles(self.hs,
                                                                               'L[0][1][1][2][1]_run_reg_confirm_box',
                                                                               -1)
        self.hs['L[0][1][1][2][1][0]_run_reg_btn'].on_click(self.L0_1_1_2_1_0_run_reg_btn_click)
        ## ## ## ## ## run reg progress
        layout = {'border': '3px solid #FFCC00', 'width': f'{self.form_sz[1] - 98}px',
                  'height': f'{0.07 * (self.form_sz[0] - 136)}px'}
        ...
        self.hs['L[0][1][1][2][2]_run_reg_progress_box'].children = get_handles(self.hs,
                                                                                'L[0][1][1][2][2]_run_reg_progress_box',
                                                                                -1)
        ## ## ## ## ## run reg & status -- start
        ...
        self.hs['L[0][1][2][0][0][0]_review_reg_results_title_text'] = widgets.HTML(
            '<span style="color:red; font-size: 150%; font-weight: bold; background-color:rgb(135,206,250);">' + 'Review/Correct Reg Results' + '</span>')
        layout = {'background-color': 'white', 'color': 'cyan', 'left': '35.7%'}
        self.hs['L[0][1][2][0][0][0]_review_reg_results_title_text'].layout = layout
        self.hs['L[0][1][2][0][0]_review_reg_results_title_box'].children = get_handles(self.hs,
                                                                                        'L[0][1][2][0][0]_review_reg_results_title_box',
                                                                                        -1)
        ...
        layout = {'width': '15%', 'height': '90%'}
        self.hs['L[0][1][2][0][1][0]_read_alignment_btn'] = SelectFilesButton(option='askopenfilename')
        self.hs['L[0][1][2][0][1][0]_read_alignment_btn'].disabled = True
        self.hs['L[0][1][2][0][1][0]_read_alignment_btn'].layout = layout
        self.hs['L[0][1][2][0][1]_read_alignment_file_box'].children = get_handles(self.hs,
                                                                                   'L[0][1][2][0][1]_read_alignment_file_box',
                                                                                   -1)
        self.hs['L[0][1][2][0][1][1]_read_alignment_checkbox'].observe(self.L0_1_2_0_1_1_read_alignment_checkbox_change,
                                                                       names='value')
        self.hs['L[0][1][2][0][1][0]_read_alignment_btn'].on_click(self.L0_1_2_0_1_0_read_alignment_btn_click)
        ...
        layout = {'width': '15%', 'height': '90%'}
        self.hs['L[0][1][2][0][2][1]_reg_pair_bad_btn'] = widgets.Button(disabled=True,
                                                                         description='Bad')
        self.hs['L[0][1][2][0][2][1]_reg_pair_bad_btn'].layout = layout
        self.hs['L[0][1][2][0][2][1]_reg_pair_bad_btn'].style.button_color = 'darkviolet'
        ...
        self.hs['L[0][1][2][0][2][1]_reg_pair_bad_btn'].on_click(self.L0_1_2_0_2_1_reg_pair_bad_btn_click)
        ## ## ## ## ## reg pair box -- end
        ...
        self.hs['L[0][1][2][0][3][2]_record_btn'] = widgets.Button(description='Record',
                                                                   description_tooltip='Record',
                                                                   disabled=True)
        self.hs['L[0][1][2][0][3][2]_record_btn'].layout = layout
        self.hs['L[0][1][2][0][3][2]_record_btn'].style.button_color = 'darkviolet'
        ...
        self.hs['L[0][1][2][0][3][2]_record_btn'].on_click(self.L0_1_2_0_3_2_record_btn_click)
        ## ## ## ## ## zshift box -- end
        ...
        self.hs['L[0][1][2][0][4][1]_confirm_review_results_btn'] = widgets.Button(description='Confirm',
                                                                                   description_tooltip='Confirm after you finish reg review ...',
                                                                                   disabled=True)
        self.hs['L[0][1][2][0][4][1]_confirm_review_results_btn'].style.button_color = 'darkviolet'
        self.hs['L[0][1][2][0][4][1]_confirm_review_results_btn'].layout = layout
        self.hs['L[0][1][2][0][4]_review_reg_results_comfirm_box'].children = get_handles(self.hs,
                                                                                          'L[0][1][2][0][4]_review_reg_results_comfirm_box',
                                                                                          -1)
        self.hs['L[0][1][2][0][4][1]_confirm_review_results_btn'].on_click(
            self.L0_1_2_0_4_1_confirm_review_results_btn_click)
        ## ## ## ## ## confirm review results box -- end

        self.hs['L[0][1][2][0]_review_reg_results_box'].children = get_handles(self.hs,
                                                                               'L[0][1][2][0]_review_reg_results_box',
                                                                               -1)
        ...
        self.hs['L[0][1][2][1][0][0]_align_images_title_text'] = widgets.HTML(
            '<span style="color:red; font-size: 150%; font-weight: bold; background-color:rgb(135,206,250);">' + 'Align Images' + '</span>')
        layout = {'background-color': 'white', 'color': 'cyan', 'left': '41%'}
        self.hs['L[0][1][2][1][0][0]_align_images_title_text'].layout = layout
        self.hs['L[0][1][2][1][0]_align_images_title_box'].children = get_handles(self.hs,
                                                                                  'L[0][1][2][1][0]_align_images_title_box',
                                                                                  -1)
        ...
        layout = {'width': '15%', 'height': '90%'}
        self.hs['L[0][1][2][1][1][1]_align_btn'] = widgets.Button(description='Align',
                                                                  description_tooltip='This will perform xanes2D alignment according to your configurations ...',
                                                                  disabled=True)
        self.hs['L[0][1][2][1][1][1]_align_btn'].style.button_color = 'darkviolet'
        self.hs['L[0][1][2][1][1][1]_align_btn'].layout = layout
        self.hs['L[0][1][2][1][1]_align_recon_comfirm_box'].children = get_handles(self.hs,
                                                                                   'L[0][1][2][1][1]_align_recon_comfirm_box',
                                                                                   -1)
        self.hs['L[0][1][2][1][1][1]_align_btn'].on_click(self.L0_1_2_1_1_1_align_btn_click)
        ...
        self.hs['L[0][1][2][1][2]_align_progress_box'].children = get_handles(self.hs,
                                                                              'L[0][1][2][1][2]_align_progress_box', -1)
        ...
        self.hs['L[0][1][2][2][0][0]_visualize_images_title_text'] = widgets.HTML(
            '<span style="color:red; font-size: 150%; font-weight: bold; background-color:rgb(135,206,250);">' + 'Visualize Images' + '</span>')
        layout = {'background-color': 'white', 'color': 'cyan', 'left': '42%'}
        self.hs['L[0][1][2][2][0][0]_visualize_images_title_text'].layout = layout
        self.hs['L[0][1][2][2][0]_visualize_images_title_box'].children = get_handles(self.hs,
                                                                                      'L[0][1][2][2][0]_visualize_images_title_box',
                                                                                      -1)
        ...
        layout = {'width': '15%', 'height': '90%'}
        self.hs['L[0][1][2][2][1][1]_spec_in_roi_btn'] = widgets.Button(description='spec in roi',
                                                                        description_tooltip='This will perform xanes2D alignment according to your configurations ...',
                                                                        disabled=True)
        self.hs['L[0][1][2][2][1][1]_spec_in_roi_btn'].style.button_color = 'darkviolet'
        self.hs['L[0][1][2][2][1][1]_spec_in_roi_btn'].layout = layout
        self.hs['L[0][1][2][2][1]_visualization&comfirm_box'].children = get_handles(self.hs,
                                                                                     'L[0][1][2][2][1]_visualization&comfirm_box',
                                                                                     -1)
        self.hs['L[0][1][2][2][1][0]_visualization_slider'].observe(self.L0_1_2_2_1_0_visualization_slider_change,
                                                                    names='value')
        self.hs['L[0][1][2][2][1][2]_visualization_R&C_checkbox'].observe(
            self.L0_1_2_2_1_2_visualization_RC_checkbox_change, names='value')
        self.hs['L[0][1][2][2][1][1]_spec_in_roi_btn'].on_click(self.L0_1_2_2_1_1_spec_in_roi_btn_click)
        ## ## ## ## ## define visualization&confirm -- end
        self.hs['L[0][1][2][2]_visualize_images_box'].children = get_handles(self.hs,
                                                                             'L[0][1][2][2]_visualize_images_box', -1)
        ...
        self.hs['L[0][1][3]_fitting_form'].children = [self.xanes_fit_gui_h.hs['L[0][x][3]_fitting_form']]
        ## ## ## define 2D_XANES_tabs layout - visualization&analysis reg & align data -- end

        self.hs['L[0][1][4]_analysis_form'].children = [self.xanes_ana_gui_h.hs['L[0][x][4][0]_ana_box']]
        ## ## ## define 2D_XANES_tabs layout - analysis box -- end

        self.hs['L[0][1][0][0][1][0]_select_raw_h5_path_btn'].initialdir = self.global_h.cwd
        self.hs['L[0][1][0][0][2][0]_select_save_trial_btn'].initialdir = self.global_h.cwd
        # self.hs['L[0][1][0][1][1][0][4]_alternative_flat_file_btn'].initialdir = self.global_h.cwd
        self.hs['L[0][1][2][0][1][0]_read_alignment_btn'].initialdir = self.global_h.cwd

    def L0_1_0_0_1_0_select_raw_h5_path_btn_click(self, a):
        if len(a.files[0]) != 0:
            self.xanes_file_raw_h5_filename = os.path.abspath(a.files[0])
            self.hs['L[0][1][0][0][1][0]_select_raw_h5_path_btn'].initialdir = os.path.dirname(
                os.path.abspath(a.files[0]))
            self.hs['L[0][1][0][0][2][0]_select_save_trial_btn'].initialdir = os.path.dirname(
                os.path.abspath(a.files[0]))
    ...
    def L0_1_0_0_3_0_select_save_trial_btn_click(self, a):
        if self.xanes_file_analysis_option == 'Do New Reg':
            ...
            if len(a.files[0]) != 0:
                ...
                for ii in range(6):
                    b += str(t[ii]).zfill(2) + '-'
                self.xanes_file_save_trial_reg_config_filename = os.path.abspath(a.files[0]).split('config')[
                                                                     0] + 'config_' + b.strip('-') + '.json'
                self.hs['L[0][1][0][0][2][0]_select_save_trial_btn'].initialdir = os.path.dirname(
                    os.path.abspath(a.files[0]))
                self.hs['L[0][1][0][0][2][0]_select_save_trial_btn'].initialfile = os.path.basename(a.files[0])
                self.hs[
                    'L[0][1][0][0][2][1]_select_save_trial_text'].value = f'{self.xanes_file_save_trial_reg_config_filename} is Read ...'
                update_json_content(self.global_h.GUI_cfg_file, {'cwd': os.path.dirname(os.path.abspath(a.files[0]))})
                self.xanes_file_save_trial_set = False
                self.xanes_file_reg_file_set = False
            ...
            # restart(self, dtype='2D_XANES')
            # restart(self.xanes_fit_gui_h, dtype='XANES_FITTING')
            self.hs['L[0][1][0][0][2][0]_select_save_trial_btn'].style.button_color = "lightgreen"
            if len(a.files[0]) != 0:
                ...
                for ii in os.path.abspath(a.files[0]).split('_')[:-2]:
                    template += (ii + '_')
                self.xanes_file_save_trial_reg_config_filename = template + 'config_' + b.strip('-') + '.json'
                self.hs['L[0][1][0][0][2][0]_select_save_trial_btn'].initialdir = os.path.dirname(
                    os.path.abspath(a.files[0]))
                self.hs['L[0][1][0][0][2][0]_select_save_trial_btn'].initialfile = os.path.basename(a.files[0])
                update_json_content(self.global_h.GUI_cfg_file, {'cwd': os.path.dirname(os.path.abspath(a.files[0]))})
    ...
    def L0_1_0_0_3_2_file_path_options_dropdown_change(self, a):
        ...
        self.xanes_file_configured = False
        if self.xanes_file_analysis_option == 'Do New Reg':
            self.hs['L[0][1][0][0][1][0]_select_raw_h5_path_btn'].disabled = False
            self.hs['L[0][1][0][0][2][0]_select_save_trial_btn'].option = 'asksaveasfilename'
            self.hs['L[0][1][0][0][2][0]_select_save_trial_btn'].description = 'Save Reg File'
            self.hs['L[0][1][0][0][2][1]_select_save_trial_text'].value = 'Save trial registration as ...'
            self.hs['L[0][1][2][0][1][1]_read_alignment_checkbox'].value = False
        elif self.xanes_file_analysis_option == 'Read Config File':
            self.hs['L[0][1][0][0][1][0]_select_raw_h5_path_btn'].disabled = True
            self.hs['L[0][1][0][0][2][0]_select_save_trial_btn'].option = 'askopenfilename'
            self.hs['L[0][1][0][0][2][0]_select_save_trial_btn'].description = 'Read Config'
            self.hs['L[0][1][0][0][2][0]_select_save_trial_btn'].open_filetypes = (
            ...
            self.hs['L[0][1][0][0][1][0]_select_raw_h5_path_btn'].disabled = True
            self.hs['L[0][1][0][0][2][0]_select_save_trial_btn'].option = 'askopenfilename'
            self.hs['L[0][1][0][0][2][0]_select_save_trial_btn'].description = 'Read Reg File'
            self.hs['L[0][1][0][0][2][0]_select_save_trial_btn'].open_filetypes = (('h5 files', '*.h5'),)
            self.hs['L[0][1][0][0][2][1]_select_save_trial_text'].value = 'Read Existing Registration File ...'
        self.hs['L[0][1][0][0][2][0]_select_save_trial_btn'].icon = "square-o"
        self.hs['L[0][1][0][0][2][0]_select_save_trial_btn'].style.button_color = "orange"
        self.hs['L[0][1][2][0][4][0]_confirm_review_results_text'].value = 'Please comfirm your change ...'
        self.boxes_logic()

    def L0_1_0_0_4_0_confirm_file_path_btn_click(self, a):
        if self.xanes_file_analysis_option == 'Do New Reg':
            if not self.xanes_file_raw_h5_set:
                ...
                self.hs[
                    'L[0][1][0][0][3][1]_confirm_file&path_text'].value = 'Please specifiy where to save trial reg result ...'
                self.xanes_file_configured = False
            else:
                b = ''
                t = (time.strptime(time.asctime()))
                ...
                self.xanes_save_trial_reg_filename = os.path.join(
                    os.path.dirname(os.path.abspath(self.xanes_save_trial_reg_filename_template)),
                    os.path.basename(os.path.abspath(self.xanes_save_trial_reg_filename_template)).split('.')[0] +
                    '_' + os.path.basename(self.xanes_file_raw_h5_filename).split('.')[0] + '_' + b.strip('-') + '.h5')
                self.xanes_file_save_trial_reg_config_filename = os.path.join(
                    os.path.dirname(os.path.abspath(self.xanes_save_trial_reg_filename_template)),
                    os.path.basename(os.path.abspath(self.xanes_save_trial_reg_filename_template)).split('.')[0] +
                    '_' + os.path.basename(self.xanes_file_raw_h5_filename).split('.')[0] + '_config_' + b.strip(
                        '-') + '.json')

                self.xanes_config_eng_list = self.reader(self.xanes_file_raw_h5_filename,
                                                         dtype='eng', sli=[None],
                ...
                self.hs['L[0][1][0][1][2][0]_eng_points_range_slider'].max = self.xanes_config_eng_list.shape[0] - 1
                self.hs['L[0][1][0][1][2][1]_eng_s_text'].value = self.xanes_config_eng_list[0]
                self.hs['L[0][1][0][1][2][2]_eng_e_text'].value = self.xanes_config_eng_list[1]

                self.xanes_eng_id_s = self.hs['L[0][1][0][1][2][0]_eng_points_range_slider'].value[0]
                self.xanes_eng_id_e = self.hs['L[0][1][0][1][2][0]_eng_points_range_slider'].value[1]
                ...
                os.path.splitext(self.xanes_file_save_trial_reg_config_filename)[0].replace('config',
                                                                                            'reg_best_match') + '.json'
                self.xanes_file_configured = True
        elif self.xanes_file_analysis_option == 'Read Config File':
            if not self.xanes_file_config_file_set:
                self.hs[
                    'L[0][1][0][0][3][1]_confirm_file&path_text'].value = 'Please specifiy the configuration file to be read ...'
                self.xanes_file_configured = False
            else:
                ...
                if self.xanes_config_is_raw:
                    if self.xanes_config_use_alternative_flat:
                        if self.xanes_config_alternative_flat_set:
                            self.xanes_img = -np.log((self.reader(self.xanes_file_raw_h5_filename, dtype='data',
                                                                  sli=[None], cfg=self.global_h.io_xanes2D_cfg) -
                                                      self.reader(self.xanes_file_raw_h5_filename, dtype='dark',
                                                                  sli=[None], cfg=self.global_h.io_xanes2D_cfg)) /
                                                     (self.reader(self.xanes_config_alternative_flat_filename,
                                                                  dtype='flat', sli=[None],
                                                                  cfg=self.global_h.io_xanes2D_cfg) -
                                                      self.reader(self.xanes_config_alternative_flat_filename,
                                                                  dtype='dark', sli=[None],
                            ...
                            self.hs['L[0][1][0][1][2][0]_eng_points_range_slider'].value = (
                            0, self.xanes_img.shape[0] - 1)
                            self.xanes_config_raw_img_readed = True
                        else:
                            self.xanes_config_raw_img_readed = False
                    else:
                        self.xanes_img = -np.log((self.reader(self.xanes_file_raw_h5_filename, dtype='data', sli=[None],
                                                              cfg=self.global_h.io_xanes2D_cfg) -
                                                  self.reader(self.xanes_file_raw_h5_filename, dtype='dark', sli=[None],
                                                              cfg=self.global_h.io_xanes2D_cfg)) /
                                                 (self.reader(self.xanes_file_raw_h5_filename, dtype='flat', sli=[None],
                                                              cfg=self.global_h.io_xanes2D_cfg) -
                                                  self.reader(self.xanes_file_raw_h5_filename, dtype='dark', sli=[None],
                                                              cfg=self.global_h.io_xanes2D_cfg)))
                        self.xanes_img[np.isinf(self.xanes_img)] = 0
                    ...
                    self.xanes_img[np.isinf(self.xanes_img)] = 0
                    self.xanes_img[np.isnan(self.xanes_img)] = 0
                    self.hs['L[0][1][0][1][2][0]_eng_points_range_slider'].value = (0, self.xanes_img.shape[0] - 1)
                    self.xanes_config_raw_img_readed = True

                if self.xanes_data_configured:
                    self.xanes_fit_eng_list = self.reader(self.xanes_file_raw_h5_filename,
                                                          dtype='eng', sli=[None],
                                                          cfg=self.global_h.io_xanes2D_cfg)[
                ...
                if self.xanes_roi_configured:
                    self.xanes_img_roi = self.xanes_img[self.xanes_eng_id_s:self.xanes_eng_id_e + 1,
                ...
                if self.xanes_alignment_done:
                    with h5py.File(self.xanes_save_trial_reg_filename, 'r') as f:
                        self.xanes_fit_data_shape = f['/registration_results/reg_results/registered_xanes2D'].shape
                        self.xanes_img_roi = f['/registration_results/reg_results/registered_xanes2D'][:]
                        self.xanes_fit_eng_list = f['/registration_results/reg_results/eng_list'][:]

                    self.hs['L[0][1][2][2][1][0]_visualization_slider'].min = 1
                    self.hs['L[0][1][2][2][1][0]_visualization_slider'].max = self.xanes_fit_eng_list.shape[0]
                    ...
                    self.xanes_fit_gui_h.hs['L[0][x][3][0][1][0][0]_fit_eng_range_option_dropdown'].value = 'wl'
                    ...
                    if ((self.xanes_fit_eng_list.min() > (self.xanes_fit_edge_eng - 50)) and
                        ...
                        self.xanes_fit_gui_h.hs['L[0][x][3][0][1][0][0]_fit_eng_range_option_dropdown'].value = 'wl'
                        self.xanes_fit_gui_h.hs['L[0][x][3][0][1][0][0]_fit_eng_range_option_dropdown'].disabled = True
                        self.xanes_fit_type = 'wl'
                    else:
                        self.xanes_fit_gui_h.hs['L[0][x][3][0][1][0][0]_fit_eng_range_option_dropdown'].value = 'full'
                        self.xanes_fit_gui_h.hs['L[0][x][3][0][1][0][0]_fit_eng_range_option_dropdown'].disabled = False
            ...
            if not self.xanes_file_config_file_set:
                ...
                if self.xanes_reg_review_done:
                    ...
                    if self.xanes_config_is_raw:
                        if self.xanes_config_use_alternative_flat:
                            ...
                            self.xanes_img = -np.log((self.reader(self.xanes_file_raw_h5_filename, dtype='data',
                                                      ...
                                                      self.reader(self.xanes_file_raw_h5_filename, dtype='dark',
                                                                  sli=[None], cfg=self.global_h.io_xanes2D_cfg)) /
                                                     (self.reader(self.xanes_file_raw_h5_filename, dtype='flat',
                                                                  sli=[None], cfg=self.global_h.io_xanes2D_cfg) -
                                                      self.reader(self.xanes_file_raw_h5_filename, dtype='dark',
                                                                  sli=[None], cfg=self.global_h.io_xanes2D_cfg)))
                            self.xanes_img[np.isinf(self.xanes_img)] = 0
                    ...
                    self.xanes_file_configured = False
                    self.hs[
                        'L[0][1][0][0][3][1]_confirm_file&path_text'].value = 'To use this option, a config up to reg review is needed ...'
        elif self.xanes_file_analysis_option == 'Do Analysis':
            if not self.xanes_file_reg_file_set:
                self.hs[
                    'L[0][1][0][0][3][1]_confirm_file&path_text'].value = 'Please specifiy the aligned data to be read...'
                self.xanes_file_configured = False
                self.xanes_reg_review_done = False
                self.xanes_data_configured = False
                self.xanes_roi_configured = False
                ...
                self.global_h.xanes2D_fiji_windows['xanes2D_analysis_viewer']['ip'].setImage(
                    self.global_h.ij.convert().convert(
                        self.global_h.ij.dataset().create(self.global_h.ij.py.to_java(self.xanes_img_roi)),
    ...
    def L0_1_0_1_1_1_1_norm_scale_text_chg(self, a):
        self.xanes_config_img_scalar = a['owner'].value
        self.xanes_config_raw_img_readed = False
        self.boxes_logic()

    # def L0_1_0_1_1_0_3_use_alternative_flat_checkbox_change(self, a):
    #     self.xanes_config_use_alternative_flat = a['owner'].value
    #     self.xanes_config_raw_img_readed = False
    #     self.boxes_logic()

    # def L0_1_0_1_1_1_1_smooth_flat_checkbox_change(self, a):
    #     self.xanes_config_use_smooth_flat = a['owner'].value
    #     self.xanes_config_raw_img_readed = False
    #     self.boxes_logic()
    #
    #
    # def L0_1_0_1_1_1_2_smooth_flat_sigma_text_change(self, a):
    #     self.xanes_config_smooth_flat_sigma = a['owner'].value
    #     self.xanes_config_raw_img_readed = False
    #     self.boxes_logic()

    # def L0_1_0_1_1_0_4_alternative_flat_file_btn_click(self, a):
    #     if len(a.files) != 0:
    #         self.xanes_config_alternative_flat_filename = a.files[0]
    #         self.hs['L[0][1][0][1][1][0][4]_alternative_flat_file_btn'].description = 'selected'
    #         self.xanes_config_alternative_flat_set = True
    #     else:
    #         self.hs['L[0][1][0][1][1][0][4]_alternative_flat_file_btn'].description = 'select alt flat'
    #         self.xanes_config_alternative_flat_set = False
    #     self.xanes_config_raw_img_readed = False
    ...
    def L0_1_0_1_1_1_1_config_data_load_images_btn_click(self, a):
        self.xanes_config_is_raw = self.hs['L[0][1][0][1][1][1][0]_is_raw_checkbox'].value
        self.xanes_config_img_scalar = self.hs['L[0][1][0][1][1][1][1]_norm_scale_text'].value
        if self.xanes_config_is_raw:
            if self.xanes_config_use_alternative_flat:
                if self.xanes_config_alternative_flat_set:
                    self.xanes_img = -np.log((self.reader(self.xanes_file_raw_h5_filename, dtype='data', sli=[None],
                                              ...
                                              self.reader(self.xanes_file_raw_h5_filename, dtype='dark', sli=[None],
                                                          cfg=self.global_h.io_xanes2D_cfg)) /
                                             (self.reader(self.xanes_config_alternative_flat_filename, dtype='flat',
                                                          sli=[None], cfg=self.global_h.io_xanes2D_cfg) -
                                              self.reader(self.xanes_config_alternative_flat_filename, dtype='dark',
                                                          sli=[None], cfg=self.global_h.io_xanes2D_cfg)))
                    self.xanes_img[np.isinf(self.xanes_img)] = 0
                    self.xanes_img[np.isnan(self.xanes_img)] = 0
                    self.hs['L[0][1][0][1][2][0]_eng_points_range_slider'].value = (0, self.xanes_img.shape[0] - 1)
    ...
    def L0_1_0_1_2_0_eng_points_range_slider_change(self, a):
        ...
        self.hs['L[0][1][0][1][2][1]_eng_s_text'].value = self.xanes_config_eng_list[self.xanes_eng_id_s]
        self.hs['L[0][1][0][1][2][2]_eng_e_text'].value = self.xanes_config_eng_list[self.xanes_eng_id_e]
    ...
    def L0_1_0_1_3_2_fiji_eng_id_slider(self, a):
        ...
        if not data_state:
            ...
            self.hs['L[0][1][0][1][2][1]_eng_s_text'].value = self.xanes_config_eng_list[
                a['owner'].value + self.xanes_eng_id_s]

    def L0_1_0_1_3_1_fiji_close_btn_click(self, a):
        fiji_viewer_off(self.global_h, self, viewer_name='all')
        self.boxes_logic()

    def L0_1_0_1_4_0_confirm_config_data_btn_click(self, a):
        self.xanes_config_is_raw = self.hs['L[0][1][0][1][1][1][0]_is_raw_checkbox'].value

        self.xanes_config_img_scalar = self.hs['L[0][1][0][1][1][1][1]_norm_scale_text'].value
        # self.xanes_config_smooth_flat_sigma = self.hs['L[0][1][0][1][1][1][2]_smooth_flat_sigma_text'].value
        self.xanes_eng_id_s = self.hs['L[0][1][0][1][2][0]_eng_points_range_slider'].value[0]
        self.xanes_eng_id_e = self.hs['L[0][1][0][1][2][0]_eng_points_range_slider'].value[1]

        self.hs['L[0][1][1][0][1][0]_2D_roi_x_slider'].max = self.xanes_img.shape[2] - 100
        self.hs['L[0][1][1][0][1][0]_2D_roi_x_slider'].min = 100
        self.hs['L[0][1][1][0][1][0]_2D_roi_x_slider'].value = (100, self.xanes_img.shape[2] - 100)

        self.hs['L[0][1][1][0][1][1]_2D_roi_y_slider'].max = self.xanes_img.shape[1] - 100
        self.hs['L[0][1][1][0][1][1]_2D_roi_y_slider'].min = 100
        self.hs['L[0][1][1][0][1][1]_2D_roi_y_slider'].value = (100, self.xanes_img.shape[1] - 100)

        self.update_xanes2D_config()
        json.dump(self.xanes_config, open(self.xanes_file_save_trial_reg_config_filename, 'w'), cls=NumpyArrayEncoder)
        self.xanes_data_configured = True

        self.xanes_fit_eng_list = self.reader(self.xanes_file_raw_h5_filename,
                                              dtype='eng', sli=[[self.xanes_eng_id_s, self.xanes_eng_id_e + 1]],
                                              cfg=self.global_h.io_xanes2D_cfg)
        if self.xanes_fit_eng_list.max() < 70:
            self.xanes_fit_eng_list *= 1000
        self.boxes_logic()
    ...
    def L0_1_1_0_1_0_2D_roi_x_slider_change(self, a):
        ...
        self.global_h.xanes2D_fiji_windows['xanes2D_raw_img_viewer']['ip'].setRoi(
            self.hs['L[0][1][1][0][1][0]_2D_roi_x_slider'].value[0],
            self.hs['L[0][1][1][0][1][1]_2D_roi_y_slider'].value[0],
            self.hs['L[0][1][1][0][1][0]_2D_roi_x_slider'].value[1] -
            self.hs['L[0][1][1][0][1][0]_2D_roi_x_slider'].value[0],
            self.hs['L[0][1][1][0][1][1]_2D_roi_y_slider'].value[1] -
            self.hs['L[0][1][1][0][1][1]_2D_roi_y_slider'].value[0])
    ...
    def L0_1_1_0_2_1_confirm_roi_btn_click(self, a):
        data_state, viewer_state = fiji_viewer_state(self.global_h, self, viewer_name='xanes2D_raw_img_viewer')
        if viewer_state:
            fiji_viewer_off(self.global_h, self, viewer_name='xanes2D_raw_img_viewer')
        ...
        if self.xanes_roi_configured:
            ...
            self.xanes_reg_roi[0] = self.hs['L[0][1][1][0][1][1]_2D_roi_y_slider'].value[0]
            self.xanes_reg_roi[1] = self.hs['L[0][1][1][0][1][1]_2D_roi_y_slider'].value[1]
            self.xanes_reg_roi[2] = self.hs['L[0][1][1][0][1][0]_2D_roi_x_slider'].value[0]
            self.xanes_reg_roi[3] = self.hs['L[0][1][1][0][1][0]_2D_roi_x_slider'].value[1]
            self.hs['L[0][1][1][1][1][2]_anchor_id_slider'].max = self.xanes_eng_id_e - self.xanes_eng_id_s
            self.hs['L[0][1][1][1][1][2]_anchor_id_slider'].value = max(
            ...
            self.xanes_img_roi = self.xanes_img[self.xanes_eng_id_s:self.xanes_eng_id_e + 1,
                                 self.xanes_reg_roi[0]:self.xanes_reg_roi[1],
                                 self.xanes_reg_roi[2]:self.xanes_reg_roi[3]]
            self.xanes_reg_mask = (self.xanes_img[0,
                                   self.xanes_reg_roi[0]:self.xanes_reg_roi[1],
                                   self.xanes_reg_roi[2]:self.xanes_reg_roi[3]] >
                                   0).astype(np.int8)
            self.update_xanes2D_config()
            json.dump(self.xanes_config, open(self.xanes_file_save_trial_reg_config_filename, 'w'),
    ...
    def L0_1_1_1_2_0_use_mask_checkbox_change(self, a):
        ...
        if self.xanes_reg_use_mask:
            self.xanes_reg_mask = (self.xanes_img[self.xanes_reg_anchor_idx,
                                   self.xanes_reg_roi[0]:self.xanes_reg_roi[1],
                                   self.xanes_reg_roi[2]:self.xanes_reg_roi[3]] >
    ...
    def L0_1_1_1_2_1_mask_thres_slider_change(self, a):
        ...
        if self.xanes_reg_use_smooth_img:
            if self.xanes_reg_mask_dilation_width > 0:
                self.xanes_reg_mask[:] = skm.binary_dilation(((gaussian_filter(self.xanes_img[self.xanes_reg_anchor_idx,
                                                                               self.xanes_reg_roi[0]:self.xanes_reg_roi[
                                                                                   1],
                                                                               self.xanes_reg_roi[2]:self.xanes_reg_roi[
                                                                                   3]],
                ...
                self.xanes_reg_mask[:] = ((gaussian_filter(self.xanes_img[self.xanes_reg_anchor_idx,
                                                           self.xanes_reg_roi[0]:self.xanes_reg_roi[1],
                                                           self.xanes_reg_roi[2]:self.xanes_reg_roi[3]],
                                                           self.xanes_reg_smooth_img_sigma) >
                                           self.xanes_reg_mask_thres).astype(np.int8))[:]
            self.global_h.xanes2D_fiji_windows['xanes2D_mask_viewer']['ip'].setImage(self.global_h.ij.convert().convert(
                self.global_h.ij.dataset().create(self.global_h.ij.py.to_java(gaussian_filter(self.xanes_img[:,
                                                                                              self.xanes_reg_roi[0]:
                                                                                              self.xanes_reg_roi[1],
                                                                                              self.xanes_reg_roi[2]:
                                                                                              self.xanes_reg_roi[3]],
                                                                                              self.xanes_reg_smooth_img_sigma) * self.xanes_reg_mask)),
                self.global_h.ImagePlusClass))
        else:
            if self.xanes_reg_mask_dilation_width > 0:
                self.xanes_reg_mask[:] = skm.binary_dilation(((self.xanes_img[self.xanes_reg_anchor_idx,
                                                               self.xanes_reg_roi[0]:self.xanes_reg_roi[1],
                                                               self.xanes_reg_roi[2]:self.xanes_reg_roi[3]] >
                                                               self.xanes_reg_mask_thres).astype(np.int8)),
                                                             np.ones([self.xanes_reg_mask_dilation_width,
                ...
                self.xanes_reg_mask[:] = ((self.xanes_img[self.xanes_reg_anchor_idx,
                                           ...
                                           self.xanes_reg_mask_thres).astype(np.int8))[:]
            self.global_h.xanes2D_fiji_windows['xanes2D_mask_viewer']['ip'].setImage(self.global_h.ij.convert().convert(
                self.global_h.ij.dataset().create(self.global_h.ij.py.to_java(self.xanes_img[:,
                                                                              self.xanes_reg_roi[0]:self.xanes_reg_roi[
                                                                                  1],
                                                                              self.xanes_reg_roi[2]:self.xanes_reg_roi[
                                                                                  3]] * self.xanes_reg_mask)),
                self.global_h.ImagePlusClass))
        self.global_h.xanes2D_fiji_windows['xanes2D_mask_viewer']['ip'].setSlice(self.xanes_reg_anchor_idx)
        self.xanes_reg_params_configured = False
    ...
    def L0_1_1_1_4_3_mrtv_subpixel_kernel_text_change(self, a):
        self.xanes_reg_mrtv_subpixel_kernel = a['owner'].value
        self.xanes_reg_params_configured = False
        self.boxes_logic()

    def L0_1_1_1_4_4_mrtv_subpixel_srch_dropdown(self, a):
        if a['owner'].value == 'analytical':
            self.hs['L[0][1][1][1][4][2]_mrtv_subpixel_wz_text'].value = 3
        else:
            self.hs['L[0][1][1][1][4][2]_mrtv_subpixel_wz_text'].value = 5
        self.xanes_reg_params_configured = False
        self.boxes_logic()

    def L0_1_1_1_5_1_confirm_reg_params_btn_click(self, a):
        ...
        self.xanes_reg_use_chunk = self.hs['L[0][1][1][1][1][1]_use_chunk_checkbox'].value
        self.xanes_reg_anchor_idx = self.hs['L[0][1][1][1][1][2]_anchor_id_slider'].value + self.xanes_eng_id_s
        self.xanes_reg_use_mask = self.hs['L[0][1][1][1][2][0]_use_mask_checkbox'].value
        self.xanes_reg_mask_thres = self.hs['L[0][1][1][1][2][1]_mask_thres_slider'].value
        self.xanes_reg_mask_dilation_width = self.hs['L[0][1][1][1][2][2]_mask_dilation_slider'].value
        self.xanes_reg_use_smooth_img = self.hs['L[0][1][1][1][3][0]_use_smooth_checkbox'].value
        self.xanes_reg_smooth_img_sigma = self.hs['L[0][1][1][1][3][1]_smooth_sigma_text'].value
        self.xanes_reg_chunk_sz = self.hs['L[0][1][1][1][1][3]_chunk_sz_slider'].value
        self.xanes_reg_method = self.hs['L[0][1][1][1][3][2]_reg_method_dropdown'].value
        self.xanes_reg_ref_mode = self.hs['L[0][1][1][1][3][3]_ref_mode_dropdown'].value
        self.xanes_reg_mrtv_level = self.hs['L[0][1][1][1][4][0]_mrtv_level_text'].value
        self.xanes_reg_mrtv_width = self.hs['L[0][1][1][1][4][1]_mrtv_width_text'].value
        self.xanes_reg_mrtv_subpixel_kernel = self.hs['L[0][1][1][1][4][3]_mrtv_subpixel_kernel_text'].value
        self.xanes_reg_mrtv_subpixel_wz = self.hs['L[0][1][1][1][4][2]_mrtv_subpixel_wz_text'].value
        if self.hs['L[0][1][1][1][4][4]_mrtv_subpixel_srch_dropdown'].value == 'analytical':
        ...
        if self.xanes_reg_use_mask:
            if self.xanes_reg_use_smooth_img:
                self.xanes_img_roi[:] = gaussian_filter(self.xanes_img[self.xanes_eng_id_s:self.xanes_eng_id_e + 1,
                                                        self.xanes_reg_roi[0]:self.xanes_reg_roi[1],
                                                        self.xanes_reg_roi[2]:self.xanes_reg_roi[3]],
                                                        self.xanes_reg_smooth_img_sigma)[:]
                if self.xanes_reg_mask_dilation_width > 0:
                    self.xanes_reg_mask[:] = skm.binary_dilation(
                        ((gaussian_filter(self.xanes_img[self.xanes_reg_anchor_idx,
                                          self.xanes_reg_roi[0]:self.xanes_reg_roi[1],
                                          self.xanes_reg_roi[2]:self.xanes_reg_roi[3]],
                                          self.xanes_reg_smooth_img_sigma) >
                          self.xanes_reg_mask_thres).astype(np.int8)),
    ...
    def L0_1_1_2_1_0_run_reg_btn_click(self, a):
        tmp_file = os.path.join(self.global_h.tmp_dir, 'xanes2D_tmp.h5')
        with h5py.File(tmp_file, 'w') as f:
            f.create_dataset('analysis_eng_list', data=self.xanes_fit_eng_list.astype(np.float32))
            f.create_dataset('xanes2D_img', data=self.xanes_img.astype(np.float32))
            if self.xanes_reg_mask is not None:
                f.create_dataset('xanes2D_reg_mask', data=self.xanes_reg_mask.astype(np.float32))
            else:
        ...
        ln += 1
        code[ln] = f"    reg.set_xanes2D_raw_filename('{self.xanes_file_raw_h5_filename}')";
        ln += 1
        kwargs = {'raw_h5_filename': self.xanes_file_raw_h5_filename,
        ...
        if sig == 0:
            ...
            self.xanes_review_aligned_img_original = np.ndarray(self.xanes_img_roi[0].shape)
            ...
            self.hs['L[0][1][2][0][2][0]_reg_pair_slider'].max = self.xanes_alignment_pairs.shape[0] - 1
            ...
            json.dump(self.xanes_config, open(self.xanes_file_save_trial_reg_config_filename, 'w'),
                      cls=NumpyArrayEncoder)
            self.hs['L[0][1][2][0][2][0]_reg_pair_slider'].value = 0
        else:
    ...
    def L0_1_2_0_1_0_read_alignment_btn_click(self, a):
        if len(a.files[0]) != 0:
            try:
    ...
    def L0_1_2_0_2_0_reg_pair_slider_change(self, a):
        ...
        with h5py.File(self.xanes_save_trial_reg_filename, 'r') as f:
            ...
            self.xanes_review_fixed_img[:] = f['/trial_registration/trial_reg_results/{0}/trial_reg_fixed{0}'.format(
                str(self.xanes_review_alignment_pair_id).zfill(3))][:]
        ...
        self.global_h.xanes2D_fiji_windows['xanes2D_review_viewer']['ip'].setImage(self.global_h.ij.convert().convert(
            self.global_h.ij.dataset().create(self.global_h.ij.py.to_java(self.xanes_review_aligned_img_original -
                                                                          self.xanes_review_fixed_img)),
            self.global_h.ImagePlusClass))
        self.global_h.ij.py.run_macro("""run("Enhance Contrast", "saturated=0.35")""")
        self.xanes_review_bad_shift = False

    def L0_1_2_0_2_1_reg_pair_bad_btn_click(self, a):
        self.xanes_manual_xshift = 0
        self.xanes_manual_yshift = 0
    ...
    def L0_1_2_0_3_0_x_shift_text_change(self, a):
        ...
        self.xanes_review_aligned_img[:] = np.real(
            np.fft.ifftn(fourier_shift(np.fft.fftn(self.xanes_review_aligned_img_original),
        ...
        self.global_h.xanes2D_fiji_windows['xanes2D_review_viewer']['ip'].setImage(self.global_h.ij.convert().convert(
            self.global_h.ij.dataset().create(self.global_h.ij.py.to_java(self.xanes_review_aligned_img -
                                                                          self.xanes_review_fixed_img)),
            self.global_h.ImagePlusClass))
        self.global_h.ij.py.run_macro("""run("Enhance Contrast", "saturated=0.35")""")
    ...
    def L0_1_2_0_3_2_record_btn_click(self, a):
        with h5py.File(self.xanes_save_trial_reg_filename, 'r') as f:
            shift = f['/trial_registration/trial_reg_results/{0}/shift{0}'.format(
                str(self.xanes_review_alignment_pair_id).zfill(3))][:]
        if self.xanes_reg_method.upper() == 'SR':
            shift[0, 2] += self.xanes_manual_yshift
            shift[1, 2] += self.xanes_manual_xshift
            self.xanes_review_shift_dict["{}".format(self.xanes_review_alignment_pair_id)] = np.array(shift)
        else:
            self.xanes_review_shift_dict["{}".format(self.xanes_review_alignment_pair_id)] = np.array(
        ...
        json.dump(self.xanes_review_shift_dict, open(self.xanes_review_reg_best_match_filename, 'w'),
                  cls=NumpyArrayEncoder)
        self.xanes_review_bad_shift = False
        self.boxes_logic()

    def L0_1_2_0_4_1_confirm_review_results_btn_click(self, a):
        if len(self.xanes_review_shift_dict) != (self.hs['L[0][1][2][0][2][0]_reg_pair_slider'].max + 1):
    ...
    def L0_1_2_1_1_1_align_btn_click(self, a):
        tmp_file = os.path.join(self.global_h.tmp_dir, 'xanes2D_tmp.h5')
        tmp_dict = {}
        ...
        code[ln] = f"reg.set_roi({self.xanes_reg_roi})";
        ln += 1
        code[ln] = f"reg.set_indices({self.xanes_eng_id_s}, {self.xanes_eng_id_e + 1}, {self.xanes_reg_anchor_idx})";
        ln += 1
        code[ln] = f"reg.set_xanes2D_tmp_filename('{tmp_file}')";
        ln += 1
        ...
        self.hs['L[0][1][2][2][1][0]_visualization_slider'].min = 1
        self.hs['L[0][1][2][2][1][0]_visualization_slider'].max = self.xanes_fit_eng_list.shape[0]
        self.hs['L[0][1][2][2][1][0]_visualization_slider'].value = 2
    ...
    def L0_1_2_2_1_0_visualization_slider_change(self, a):
        self.hs['L[0][1][2][2][1][3]_visualization_eng_text'].value = self.xanes_fit_eng_list[a['owner'].value-1]
        data_state, viewer_state = fiji_viewer_state(self.global_h, self, viewer_name='xanes2D_analysis_viewer')
        if not viewer_state:
            fiji_viewer_on(self.global_h, self, viewer_name='xanes2D_analysis_viewer')
        self.global_h.xanes2D_fiji_windows['xanes2D_analysis_viewer']['ip'].setImage(self.global_h.ij.convert().convert(
    ...
    def L0_1_2_2_1_1_spec_in_roi_btn_click(self, a):
        data_state, viewer_state = fiji_viewer_state(self.global_h, self, viewer_name='xanes2D_analysis_viewer')
        if not viewer_state:
            fiji_viewer_on(self.global_h, self, viewer_name='xanes2D_analysis_viewer')
        width = self.global_h.xanes2D_fiji_windows['xanes2D_analysis_viewer']['ip'].getWidth()
        height = self.global_h.xanes2D_fiji_windows['xanes2D_analysis_viewer']['ip'].getHeight()
        ...
        self.global_h.xanes2D_fiji_windows['analysis_viewer_z_plot_viewer']['fiji_id'] = \
