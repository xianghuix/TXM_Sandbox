...
class xanes_regtools_gui():
    ...
    def fiji_viewer_on(self, viewer_name='virtural_stack_preview_viewer'):
        if viewer_name == 'virtural_stack_preview_viewer':
            ...
            if not data_state:
                ...
                if self.hs['L[0][2][3][0][1][0]_analysis_view_alignment_option_dropdown'].value == 'x-y-E':
                ...
                elif self.hs['L[0][2][3][0][1][0]_analysis_view_alignment_option_dropdown'].value == 'y-z-E':
                    self.xanes3D_aligned_data = 0
                    self.xanes3D_aligned_data = f['/registration_results/reg_results/registered_xanes3D'][:, :, :, self.xanes3D_analysis_slice]
                elif self.hs['L[0][2][3][0][1][0]_analysis_view_alignment_option_dropdown'].value == 'z-x-E':
                    self.xanes3D_aligned_data = 0
                    self.xanes3D_aligned_data = f['/registration_results/reg_results/registered_xanes3D'][:, :, self.xanes3D_analysis_slice, :]
                elif self.hs['L[0][2][3][0][1][0]_analysis_view_alignment_option_dropdown'].value == 'x-y-z':
                    self.xanes3D_aligned_data = 0
                    self.xanes3D_aligned_data = f['/registration_results/reg_results/registered_xanes3D'][self.xanes3D_analysis_slice, :, :, :]
                f.close()
            if not viewer_state:
                ...
                self.xanes3D_fiji_windows['analysis_viewer']['ip'].setSlice(self.hs['L[0][2][3][0][1][3]_analysis_view_alignment_slice_slider'].value)
    ...
    def gui_layout(self):
        ...
        ## ## ## ## define functional widgets each tab in each sub-tab - analysis&display TAB in 3D_xanes TAB -- start
        layout = {'border':'3px solid #8855AA', 'width':f'{self.form_sz[1]-92}px', 'height':f'{0.25*(self.form_sz[0]-128)}px'}
        ...
        self.hs['L[0][2][3][0][0][0]_analysis_title_text'] = widgets.HTML('<span style="color:red; font-size: 150%; font-weight: bold; background-color:rgb(135,206,250);">' + 'Visualize XANES3D' + '</span>')
        layout = {'background-color':'white', 'color':'cyan', 'left':'41%'}
        self.hs['L[0][2][3][0][0][0]_analysis_title_text'].layout = layout
        self.hs['L[0][2][3][0][0]_analysis_title_box'].children = self.get_handles('L[0][2][3][0][0]_analysis_title_box', -1)
        ## ## ## ## ## label the box -- end
        ...
        self.hs['L[0][2][3][0][1]_analysis_view_alignment_box'] = widgets.HBox()
        self.hs['L[0][2][3][0][1]_analysis_view_alignment_box'].layout = layout
        layout = {'width':'20%', 'height':'100%'}
        self.hs['L[0][2][3][0][1][0]_analysis_view_alignment_option_dropdown'] = widgets.Dropdown(description='view option',
                                                                                                  ...
                                                                                                  value ='x-y-E',
                                                                                                  disabled=True)
        self.hs['L[0][2][3][0][1][0]_analysis_view_alignment_option_dropdown'].layout = layout
        # layout = {'width':'10%', 'height':'100%'}
        # self.hs['L[0][2][3][0][1][1]_analysis_view_alignment_view_button'] = widgets.Button(description='View',
        #                                                                                     disabled=True)
        # self.hs['L[0][2][3][0][1][1]_analysis_view_alignment_view_button'].layout = layout
        layout = {'width':'40%', 'height':'100%'}
        self.hs['L[0][2][3][0][1][2]_analysis_view_alignment_4th_dim_slider'] = widgets.IntSlider(description='z',
                                                                                               description_tooltip='Select one slice in the fourth dimension',
                                                                                               value =0,
                                                                                               min = 0,
                                                                                               disabled=True)
        self.hs['L[0][2][3][0][1][2]_analysis_view_alignment_4th_dim_slider'].layout = layout
        layout = {'width':'40%', 'height':'100%'}
        self.hs['L[0][2][3][0][1][3]_analysis_view_alignment_slice_slider'] = widgets.IntSlider(description='E',
                                                                                                disabled=True)
        self.hs['L[0][2][3][0][1][3]_analysis_view_alignment_slice_slider'].layout = layout
        self.hs['L[0][2][3][0][1]_analysis_view_alignment_box'].children = self.get_handles('L[0][2][3][0][1]_analysis_view_alignment_box', -1)
        self.hs['L[0][2][3][0][1][0]_analysis_view_alignment_option_dropdown'].observe(self.L0_2_3_0_1_0_analysis_view_alignment_option_dropdown, names='value')
        self.hs['L[0][2][3][0][1][2]_analysis_view_alignment_4th_dim_slider'].observe(self.L0_2_3_0_1_2_analysis_view_alignment_4th_dim_slider, names='value')
        self.hs['L[0][2][3][0][1][3]_analysis_view_alignment_slice_slider'].observe(self.L0_2_3_0_1_3_analysis_view_alignment_slice_slider, names='value')
        ## ## ## ## ## define slice region and view slice cuts -- end

        ## ## ## ## ## basic spectroscopic visualization -- start
        layout = {'border':'3px solid #FFCC00', 'width':f'{1*self.form_sz[1]-98}px', 'height':f'{0.2*0.4*(self.form_sz[0]-128)}px'}
        self.hs['L[0][2][3][0][2]_analysis_spec_view_box'] = widgets.HBox()
        self.hs['L[0][2][3][0][2]_analysis_spec_view_box'].layout = layout
        layout = {'top': '5px','width':'70%', 'height':'100%'}
        self.hs['L[0][2][3][0][2][0]_analysis_spec_view_text'] = widgets.Text(description='',
                                                                   value='Confirm the roi once you define the ROI ...',
                                                                   disabled=True)
        self.hs['L[0][2][3][0][2][0]_analysis_spec_view_text'].layout = layout
        layout = {'width':'15%', 'height':'100%'}
        self.hs['L[0][2][3][0][2][1]_analysis_spec_view_mem_monitor_checkbox'] = widgets.Checkbox(description='mem monitor',
                                                                                                  description_tooltip='Check on this to monitor memmory usage',
                                                                                                  value=False,
                                                                                                  disabled=True)
        self.hs['L[0][2][3][0][2][1]_analysis_spec_view_mem_monitor_checkbox'].layout = layout
        layout = {'width':'15%', 'height':'100%'}
        self.hs['L[0][2][3][0][2][2]_analysis_spec_view_in_roi_button'] = widgets.Button(description='spec in roi',
                                                                                         description_tooltip='adjust the roi size and drag roi over in the particles',
                                                                                         disabled=True)
        self.hs['L[0][2][3][0][2][2]_analysis_spec_view_in_roi_button'].layout = layout
        self.hs['L[0][2][3][0][2]_analysis_spec_view_box'].children = self.get_handles('L[0][2][3][0][2]_analysis_spec_view_box', -1)
        self.hs['L[0][2][3][0][2][1]_analysis_spec_view_mem_monitor_checkbox'].observe(self.L0_2_3_0_2_1_analysis_spec_view_mem_monitor_checkbox, names='value')
        self.hs['L[0][2][3][0][2][2]_analysis_spec_view_in_roi_button'].on_click(self.L0_2_3_0_2_2_analysis_spec_view_in_roi_button)
        ## ## ## ## ## basic spectroscopic visualization -- end

        self.hs['L[0][2][3][0]_analysis_box'].children = self.get_handles('L[0][2][3][0]_analysis_box', -1)
        ## ## ## ## define functional widgets each tab in each sub-tab - analysis&display TAB in 3D_xanes TAB -- end
    ...
    def L0_2_0_0_4_0_confirm_file_path_button_click(self, a):
        if self.xanes3D_analysis_option == 'Do New Reg':
            ...
            if not self.xanes3D_reg_file_set:
                ...
                data_shape = f['/registration_results/reg_results/registered_xanes3D'].shape
                f.close()
                self.hs['L[0][2][3][0][1][3]_analysis_view_alignment_slice_slider'].description = 'E'
                self.hs['L[0][2][3][0][1][3]_analysis_view_alignment_slice_slider'].max = data_shape[0]
                self.hs['L[0][2][3][0][1][3]_analysis_view_alignment_slice_slider'].value = 0
                self.hs['L[0][2][3][0][1][3]_analysis_view_alignment_slice_slider'].min = 0
                self.hs['L[0][2][3][0][1][2]_analysis_view_alignment_4th_dim_slider'].description = 'z'
                self.hs['L[0][2][3][0][1][2]_analysis_view_alignment_4th_dim_slider'].max = data_shape[1]
                self.hs['L[0][2][3][0][1][2]_analysis_view_alignment_4th_dim_slider'].value = 0
                self.hs['L[0][2][3][0][1][2]_analysis_view_alignment_4th_dim_slider'].min = 0
                self.hs['L[0][2][0][0][4][1]_confirm_file&path_text'].value = 'XANES3D file config is done ...'
        self.boxes_logic()
    ...
    def L0_2_3_0_1_0_analysis_view_alignment_option_dropdown(self, a):
        f = h5py.File(self.xanes3D_save_trial_reg_filename, 'r')
        data_shape = f['/registration_results/reg_results/registered_xanes3D'].shape
        f.close()
        ...
        if self.xanes3D_analysis_view_option == 'x-y-E':
            ...
            self.hs['L[0][2][3][0][1][3]_analysis_view_alignment_slice_slider'].max = data_shape[0]
            self.hs['L[0][2][3][0][1][3]_analysis_view_alignment_slice_slider'].min = 0
            self.hs['L[0][2][3][0][1][2]_analysis_view_alignment_4th_dim_slider'].description = 'x'
            self.hs['L[0][2][3][0][1][2]_analysis_view_alignment_4th_dim_slider'].max = data_shape[1]
            self.hs['L[0][2][3][0][1][2]_analysis_view_alignment_4th_dim_slider'].min = 0
            ...
            self.hs['L[0][2][3][0][1][3]_analysis_view_alignment_slice_slider'].max = data_shape[0]
            self.hs['L[0][2][3][0][1][3]_analysis_view_alignment_slice_slider'].min = 0
            self.hs['L[0][2][3][0][1][2]_analysis_view_alignment_4th_dim_slider'].description = 'y'
            self.hs['L[0][2][3][0][1][2]_analysis_view_alignment_4th_dim_slider'].max = data_shape[1]
            self.hs['L[0][2][3][0][1][2]_analysis_view_alignment_4th_dim_slider'].min = 0
        elif self.xanes3D_analysis_view_option == 'x-y-z':
            self.hs['L[0][2][3][0][1][3]_analysis_view_alignment_slice_slider'].description = 'z'
            self.hs['L[0][2][3][0][1][3]_analysis_view_alignment_slice_slider'].max = data_shape[0]
            self.hs['L[0][2][3][0][1][3]_analysis_view_alignment_slice_slider'].min = 0
            self.hs['L[0][2][3][0][1][2]_analysis_view_alignment_4th_dim_slider'].description = 'E'
            self.hs['L[0][2][3][0][1][2]_analysis_view_alignment_4th_dim_slider'].max = data_shape[1]
            self.hs['L[0][2][3][0][1][2]_analysis_view_alignment_4th_dim_slider'].min = 0
        self.xanes3D_analysis_view_option_previous = self.xanes3D_analysis_view_option
        self.boxes_logic()

    def L0_2_3_0_1_3_analysis_view_alignment_slice_slider(self, a):
        self.fiji_viewer_on(viewer_name='analysis_viewer')
        self.boxes_logic()

    def L0_2_3_0_1_2_analysis_view_alignment_4th_dim_slider(self, a):
    ...
    def L0_2_3_0_2_1_analysis_spec_view_mem_monitor_checkbox(self, a):
        if a['owner'].value:
            ij.py.run_macro("""run("Monitor Memory...")""")

    def L0_2_3_0_2_2_analysis_spec_view_in_roi_button(self, a):
        data_state, viewer_state = self.fiji_viewer_state(viewer_name='analysis_viewer')
        if not viewer_state:
            self.fiji_viewer_on(viewer_name='analysis_viewer')
        ...
        self.hs['L[0][2][3][0][2][0]_analysis_spec_view_text'].value = 'drag the roi box to check the spectrum at different locations ...'
        self.boxes_logic()
