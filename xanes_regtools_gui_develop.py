...
class xanes_regtools_gui():
    ...
    def fiji_viewer_on(self, viewer_name='xanes3D_virtural_stack_preview_viewer'):
        if viewer_name == 'xanes3D_virtural_stack_preview_viewer':
            ...
            if not viewer_state:
                ijui.show(ij.py.to_java(self.trial_reg.astype(np.float32)))
                ij.py.run_macro("""run("Enhance Contrast", "saturated=0.35")""")
            ...
            if not viewer_state:
                ijui.show(ij.py.to_java((self.xanes3D_review_aligned_img-self.trial_reg_fixed).astype(np.float32)))
                ij.py.run_macro("""run("Enhance Contrast", "saturated=0.35")""")
    ...
    def L0_2_0_0_4_0_confirm_file_path_button_click(self, a):
        if self.xanes3D_analysis_option == 'Do New Reg':
            ...
            if not self.xanes3D_reg_file_set:
                ...
                self.xanes3D_review_aligned_img = self.trial_reg[0]
                ...
                self.hs['L[0][2][2][1][2][0]_reg_pair_slider'].max = self.xanes3D_scan_id_e-self.xanes3D_scan_id_s
    ...
    def L0_2_2_1_2_0_reg_pair_slider_change(self, a):
        ...
        f = h5py.File(fn, 'r')
        self.trial_reg[:] = (f['/trial_registration/trial_reg_results/{0}/trial_reg_img{0}'.format(str(self.xanes3D_alignment_pair_id).zfill(3))]).astype(np.float32)[:]
        self.trial_reg_fixed[:] = (f['/trial_registration/trial_reg_results/{0}/trial_fixed_img{0}'.format(str(self.xanes3D_alignment_pair_id).zfill(3))]).astype(np.float32)[:]
        f.close()
    ...
    def L0_2_2_1_3_0_zshift_slider_change(self, a):
        ...
        self.fiji_viewer_on(viewer_name='xanes3D_review_viewer')
        self.xanes3D_fiji_windows['xanes3D_review_viewer']['ip'].setSlice(np.int32(a['owner'].value))
        ...
        #     self.hs['L[0][2][2][1][4][0]_confirm_review_results_text'].value = 'Please slide "reg pair #" to open a viewer ...'
        # else:
        #     self.xanes3D_fiji_windows['xanes3D_review_viewer']['ip'].setSlice(self.hs['L[0][2][2][1][3][0]_zshift_slider'].value)
        #     self.hs['L[0][2][2][1][3][1]_best_match_text'].value = a['owner'].value
    ...
    def L0_2_2_1_5_0_review_manual_x_shift_text(self, a):
        ...
        # init_z = self.hs['L[0][2][2][1][3][1]_best_match_text'].value
        # f = h5py.File(self.xanes3D_save_trial_reg_filename, 'r')
        # shift = f['/trial_registration/trial_reg_results/{0}/shift{0}'.format(str(self.xanes3D_alignment_pair_id).zfill(3))][:]
        # f.close()
        xanes3D_review_aligned_img = (np.real(np.fft.ifftn(fourier_shift(np.fft.fftn(self.trial_reg[self.xanes3D_manual_zshift-1]),
                                                                                [self.xanes3D_manual_yshift, self.xanes3D_manual_xshift])))).astype(np.float32)
        # data_state, viewer_state = self.fiji_viewer_state(viewer_name='xanes3D_review_manual_viewer')
        # if not viewer_state:
        ...
        self.xanes3D_fiji_windows['xanes3D_review_manual_viewer']['ip'].setImage(ij.convert().convert(ij.dataset().create(ij.py.to_java((xanes3D_review_aligned_img-
                                                                                                                                        self.trial_reg_fixed).astype(np.float32))),
                                                                                                      ImagePlusClass))
        ij.py.run_macro("""run("Enhance Contrast", "saturated=0.35")""")
        # self.boxes_logic(tab='3D_XANES')
    ...
    def L0_2_2_1_5_1_review_manual_y_shift_text(self, a):
        ...
        # shift = f['/trial_registration/trial_reg_results/{0}/shift{0}'.format(str(self.xanes3D_alignment_pair_id).zfill(3))][:]
        # f.close()
        # self.xanes3D_review_aligned_img[:] = (np.real(np.fft.ifftn(fourier_shift(np.fft.fftn(self.trial_reg[self.xanes3D_manual_zshift]),
    ...
    def L0_2_2_1_5_2_review_manual_z_shift_text(self, a):
        # self.hs['L[0][2][2][1][3][1]_best_match_text'].value = self.hs['L[0][2][2][1][5][2]_review_manual_z_shift_text'].value
        self.xanes3D_manual_xshift = self.hs['L[0][2][2][1][5][0]_review_manual_x_shift_text'].value
        self.xanes3D_manual_yshift = self.hs['L[0][2][2][1][5][1]_review_manual_y_shift_text'].value
        self.xanes3D_manual_zshift = self.hs['L[0][2][2][1][5][2]_review_manual_z_shift_text'].value
        # f = h5py.File(self.xanes3D_save_trial_reg_filename, 'r')
    ...
    def L0_2_2_1_5_3_review_manual_shift_record_button(self, a):
        ...
        self.xanes3D_review_shift_dict["{}".format(self.xanes3D_alignment_pair_id)] = np.array([self.xanes3D_manual_zshift-1,
                                                                                                self.xanes3D_manual_yshift+shift[self.hs['L[0][2][2][1][3][1]_best_match_text'].value, 0],
                                                                                                self.xanes2D_manual_xshift+shift[self.hs['L[0][2][2][1][3][1]_best_match_text'].value, 1]])
