...
class xanes_analysis_gui():
    ...
    def build_gui(self):
        ...
        self.hs['L[0][x][3][0][4][1][0]_analysis_save_setting_gridlayout'] = \
            widgets.GridspecLayout(8, 200,
                                   layout = {"border":"3px solid #FFCC00",
                                             ...
                                             "align_items":"flex-start",
                                             "justify_items":"flex-start"})
        self.hs['L[0][x][3][0][4][1][0]_analysis_save_setting_gridlayout'][0:6, 0:100] = \
            widgets.SelectMultiple(options=['whiteline_pos', 
                                ...
                                description='Fruits',
                                disabled=False)
        self.hs['L[0][x][3][0][4][1][0][0]_analysis_save_setting_multiselection'] = \
            self.hs['L[0][x][3][0][4][1][0]_analysis_save_setting_gridlayout'][0:6, 0:100]

        self.hs['L[0][x][3][0][4][1][0]_analysis_save_setting_gridlayout'][0:6, 100:200] = \
            widgets.SelectMultiple(options=['',
                                ...
                                disabled=True)
        self.hs['L[0][x][3][0][4][1][0][1]_analysis_save_setting_selection_text'] = \
            self.hs['L[0][x][3][0][4][1][0]_analysis_save_setting_gridlayout'][0:6, 100:200]
            
        self.hs['L[0][x][3][0][4][1][0]_analysis_save_setting_gridlayout'][7:8, 40:60] = \
            widgets.Button(description = '==>',
                           description_tooltip = 'Select saving items',
                           disabled = True)
        self.hs['L[0][x][3][0][4][1][0][2]_analysis_save_setting_confirm_button'] = \
            self.hs['L[0][x][3][0][4][1][0]_analysis_save_setting_gridlayout'][7:8, 40:60]
        self.hs['L[0][x][3][0][4][1][0][2]_analysis_save_setting_confirm_button'].style.button_color = \
            'darkviolet'
        self.hs['L[0][x][3][0][4][1][0]_analysis_save_setting_gridlayout'][7:8, 140:160] = \
            widgets.Button(description = '<==',
                           description_tooltip = 'Remove saving items',
                           disabled = True)
        self.hs['L[0][x][3][0][4][1][0][3]_analysis_save_setting_remove_button'] = \
            self.hs['L[0][x][3][0][4][1][0]_analysis_save_setting_gridlayout'][7:8, 140:160]
        self.hs['L[0][x][3][0][4][1][0][3]_analysis_save_setting_remove_button'].style.button_color = \
            'darkviolet'
        self.hs['L[0][x][3][0][4][1][0][2]_analysis_save_setting_confirm_button'].on_click(self.L0_x_3_0_4_1_0_2_analysis_save_setting_confirm_button_click)
        self.hs['L[0][x][3][0][4][1][0][3]_analysis_save_setting_remove_button'].on_click(self.L0_x_3_0_4_1_0_3_analysis_save_setting_remove_button_click)
        self.hs['L[0][x][3][0][4][1]_analysis_save_setting_box'].children = \
            get_handles(self.hs, 'L[0][x][3][0][4][1]_analysis_save_setting_box', -1)
    ...
    def L0_x_3_0_4_1_0_2_analysis_save_setting_confirm_button_click(self, a):
        for ii in self.hs['L[0][x][3][0][4][1][0][0]_analysis_save_setting_multiselection'].value:
            self.analysis_saving_items.add(ii)
        self.hs['L[0][x][3][0][4][1][0][1]_analysis_save_setting_selection_text'].value = ['']
        tem = list(self.analysis_saving_items)
        tem.insert(0, '')
        self.hs['L[0][x][3][0][4][1][0][1]_analysis_save_setting_selection_text'].options = tem
        self.hs['L[0][x][3][0][4][1][0][1]_analysis_save_setting_selection_text'].value = \
            list(self.analysis_saving_items)
    def L0_x_3_0_4_1_0_3_analysis_save_setting_remove_button_click(self, a):
        for ii in self.hs['L[0][x][3][0][4][1][0][1]_analysis_save_setting_selection_text'].value:
            if ii != '':
    ...
    def L0_x_3_0_5_1_analysis_run_button(self, a):
        ...
        if self.analysis_optimizer == 'scipy':
            for ii in sorted(PEAK_FIT_PARAM_DICT[self.analysis_method].keys()):
                fvars.append(self.analysis_fit_func_arg_handles[ii].value)
            if self.analysis_fit_use_param_bnd :
                for ii in sorted(PEAK_FIT_PARAM_DICT[self.analysis_method].keys()):
                    bnds.append((self.analysis_fit_func_bnd_handles[2*ii].value,
                                 self.analysis_fit_func_bnd_handles[2*ii+1].value))
            else:
                bnds = None
            ...
            self.analysis_optimizer_arg_handles = [self.hs['L[0][x][3][0][4][0][0][9]_analysis_gridlayout_jac'],
                                                   ...
                                                   self.hs['L[0][x][3][0][4][0][0][13]_analysis_gridlayout_gtol'],
                                                   self.hs['L[0][x][3][0][4][0][0][14]_analysis_gridlayout_ufac']]
            jac=self.analysis_optimizer_arg_handles[0].value
            method=self.analysis_optimizer_arg_handles[1].value
            ftol=self.analysis_optimizer_arg_handles[2].value
            xtol=self.analysis_optimizer_arg_handles[3].value
            gtol=self.analysis_optimizer_arg_handles[4].value
            ufac=self.analysis_optimizer_arg_handles[5].value
        elif self.analysis_optimizer == 'numpy':
            order = self.hs['L[0][x][3][0][4][0][0][1]_analysis_gridlayout_fit_func'].value
        ...
        if self.parent_h.gui_name == 'xanes3D':
            with h5py.File(self.fn, 'r+') as f:
                ...
                g111.create_dataset('optimizer', data=str(self.analysis_optimizer))
                if self.analysis_optimizer == 'scipy':
                    g111.create_dataset('method', data=str(self.analysis_method))
            ...
            code[ln] = "    im`gs = f['/registration_results/reg_results/registered_xanes3D'][:, 0, :, :]"; ln += 1
            ...
            code[ln] = "        cnt = 0"; ln += 1  
            code[ln] = f"        for ii in {self.analysis_saving_items}:"; ln += 1   
            code[ln] = f"            g12{str(cnt)} = g12.create_dataset({ii}, shape=(xanes3D_analysis_data_shape[1:]), dtype=np.float32)"; ln += 1
            code[ln] = "            cnt += 1"; ln += 1              
            ...
            code[ln] = f"        if {self..analysis_optimizer} == 'scipy':"; ln += 1
            ...
            code[ln] = f"                xana.fit_whiteline_scipy(xanes3D_analysis_wl_fit_eng_s, xanes3D_analysis_wl_fit_eng_e, model={self.analysis_method}, fvars={fvars}, bnds={bnds}, ftol={ftol}, xtol={xtol}, gtol={gtol}, jac={jac}, method={method}, ufac={ufac})"; ln+=1
            ...
            code[ln] = f"        elif {self..analysis_optimizer} == 'numpy':"; ln += 1
            code[ln] = "            for ii in range(xanes3D_analysis_data_shape[1]):"; ln += 1
            code[ln] = "                imgs[:] = f['/registration_results/reg_results/registered_xanes3D'][:, ii, :, :]"; ln += 1
            code[ln] = "                xana.spectrum[:] = imgs[:]"; ln += 1
            ...
            code[ln] = f"        if {self..analysis_optimizer} == 'numpy':"; ln += 1
            code[ln] = "            for ii in range(xanes3D_analysis_data_shape[1]):"; ln += 1
            code[ln] = "                imgs[:] = f['/registration_results/reg_results/registered_xanes3D'][:, ii, :, :]"; ln += 1
            code[ln] = "                xana.spectrum[:] = imgs[:]"; ln += 1        
            code[ln] = "                xana.fit_pre_edge()"; ln+=1
