...
class xanes_regtools_gui():
    def __init__(self, form_sz=[650, 740]):
        ...
        # "xanes3D_available_recon_ids":self.xanes3D_available_recon_ids,
        # "xanes3D_available_raw_ids":self.xanes3D_available_raw_ids,
        # "xanes3D_available_recon_file_ids":self.xanes3D_available_recon_file_ids,
    ...
    def read_xanes3D_config(self):
        with open(self.xanes3D_save_trial_reg_config_filename, 'r') as f:
            self.xanes3D_config = json.load(f)
    
    def set_xanes3D(self):
    ...
    def L0_2_0_0_3_0_select_save_trial_button_click(self, a):
        if self.xanes3D_analysis_option == 'New Analysis':
            if len(a.files[0]) != 0:
                self.xanes3D_save_trial_reg_filename_template = os.path.abspath(a.files[0]).split('.')[0]+'scan_id_{0}-{1}.h5'
                self.xanes3D_save_trial_reg_config_filename_template = os.path.abspath(a.files[0]).split('.')[0]+'scan_id_{0}-{1}_config.json'
            ...
            if len(a.files[0]) != 0:
                self.xanes3D_save_trial_reg_config_filename = os.path.abspath(a.files[0])
                self.hs['L[0][2][0][0][3][0]_select_save_trial_button'].initialdir = os.path.dirname(os.path.abspath(a.files[0]))
                self.hs['L[0][2][0][0][3][0]_select_save_trial_button'].initialfile = os.path.basename(a.files[0])
    ...
    def L0_2_0_0_4_0_confirm_file_path_button_click(self, a):
        if self.xanes3D_analysis_option == 'Read Reg File':
            if not self.xanes3D_save_trial_set:
                ...
                try:
                    ...
                    self.hs['L[0][2][2][2][1][2]_align_recon_optional_slice_range_slider'].value = (min(self.xanes3D_available_recon_file_ids),
        ...
        elif self.xanes3D_analysis_option == 'New Analysis':
            if not self.xanes3D_raw_h5_path_set:
