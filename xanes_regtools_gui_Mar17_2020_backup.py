...
class xanes_regtools_gui():
    ...
    def gui_layout(self):
        ...
        layout = {'border':'3px solid #FFCC00', 'width':f'{self.form_sz[1]-98}px', 'height':f'{0.25*0.25*(self.form_sz[0]-128)}px'}
        ...
        layout = {'border':'3px solid #FFCC00', 'width':f'{1*self.form_sz[1]-98}px', 'height':f'{0.25*0.25*(self.form_sz[0]-128)}px'}
        ...
        layout = {'width':'19%', 'height':'100%', 'top':'0%'}
        ...
        # layout = {'width':'19%', 'height':'100%', 'top':'0%', 'visibility':'hidden'}
        # self.hs['L[0][2][3][1][1][3]_analysis_energy_range_pre_eng_e_text'] = widgets.BoundedFloatText(description='pre-edge_e',
        #                                                                                   description_tooltip='ending energy point (keV) of pre-edge for background removal',
        #                                                                                   value =-0.05,
        #                                                                                   max = 0,
        #                                                                                   min = -1,
        #                                                                                   step=0.01,
        #                                                                                   disabled=True)
        # self.hs['L[0][2][3][1][1][3]_analysis_energy_range_pre_eng_e_text'].layout = layout
        # layout = {'width':'19%', 'height':'100%', 'top':'0%', 'visibility':'hidden'}
        # self.hs['L[0][2][3][1][1][4]_analysis_energy_range_post_eng_s_text'] = widgets.BoundedFloatText(description='post-edge_s',
        #                                                                                    description_tooltip='starting energy point (keV) of post-edge for normalization',
        #                                                                                    value =0.1,
        #                                                                                    min = 0,
        #                                                                                    step=0.01,
        #                                                                                    disabled=True)
        # self.hs['L[0][2][3][1][1][4]_analysis_energy_range_post_eng_s_text'].layout = layout
        ...
        # self.hs['L[0][2][3][1][1][2]_analysis_config_4th_dim_slider'].observe(self.L0_2_3_0_1_2_visualize_view_alignment_4th_dim_slider, names='value')
        # self.hs['L[0][2][3][1][1][3]_analysis_config_slice_slider'].observe(self.L0_2_3_0_1_3_visualize_view_alignment_slice_slider, names='value')
        ...
        # layout = {'width':'19%', 'height':'100%', 'top':'0%', 'visibility':'hidden'}
        # self.hs['L[0][2][3][1][2][3]_analysis_energy_filter_fit_eng_s_text'] = widgets.BoundedFloatText(description='fit eng s',
        #                                                                                   description_tooltip='together with "fit eng e", it defines energy range for fitting. for "wl" option, "fit eng s" and "fit eng e" should be roughly symmetric to whiteline peak; for "edge0.5" option, "fit eng s" and "fit eng e" should be in the range of ascendant edge range',
        #                                                                                   value =0,
        #                                                                                   min = 0,
        #                                                                                   step=0.001,
        #                                                                                   disabled=True)
        # self.hs['L[0][2][3][1][2][3]_analysis_energy_filter_fit_eng_s_text'].layout = layout
        # layout = {'width':'19%', 'height':'100%', 'top':'0%', 'visibility':'hidden'}
        # self.hs['L[0][2][3][1][2][4]_analysis_energy_filter_fit_eng_e_text'] = widgets.BoundedFloatText(description='fit eng e',
        #                                                                                    description_tooltip='together with "fit eng s", it defines energy range for fitting. for "wl" option, "fit eng s" and "fit eng e" should be roughly symmetric to whiteline peak; for "edge0.5" option, "fit eng s" and "fit eng e" should be in the range of ascendant edge range',
        #                                                                                    value =0.1,
        #                                                                                    min = 0,
        #                                                                                    step=0.001,
        #                                                                                    disabled=True)
        # self.hs['L[0][2][3][1][2][4]_analysis_energy_filter_fit_eng_e_text'].layout = layout

        self.hs['L[0][2][3][1][2]_analysis_energy_filter_box'].children = self.get_handles('L[0][2][3][1][2]_analysis_energy_filter_box', -1)
        # self.hs['L[0][2][3][1][2][0]_analysis_energy_range_option_dropdown'].observe(self.L0_2_3_1_1_0_analysis_config_option_dropdown, names='value')
        # self.hs['L[0][2][3][1][1][2]_analysis_config_4th_dim_slider'].observe(self.L0_2_3_0_1_2_visualize_view_alignment_4th_dim_slider, names='value')
        # self.hs['L[0][2][3][1][1][3]_analysis_config_slice_slider'].observe(self.L0_2_3_0_1_3_visualize_view_alignment_slice_slider, names='value')
    ...
    def L0_2_0_0_4_0_confirm_file_path_button_click(self, a):
        if self.xanes3D_analysis_option == 'Do New Reg':
            ...
            if not self.xanes3D_reg_file_set:
                ...
                self.hs['L[0][2][3][0][1][3]_visualize_view_alignment_slice_slider'].max = data_shape[0]
                ...
                self.hs['L[0][2][3][0][1][2]_visualize_view_alignment_4th_dim_slider'].max = data_shape[1]
    ...
    #     if a['owner'].value == 'wl':
    #         self.hs['L[0][2][3][1][1][4]_analysis_energy_range_post_eng_s_text'].layout = widgets.Layout(width = '18%',
    #                                                                                         height = '100%',
    #                                                                                         top = '0%',
    #                                                                                         visibility='hidden')
    #         self.hs['L[0][2][3][1][1][3]_analysis_energy_range_pre_eng_e_text'].layout = widgets.Layout(width = '18%',
    #                                                                                        height = '100%',
    #                                                                                        top = '0%',
    #                                                                                        visibility='hidden')
    #         self.hs['L[0][2][3][1][2][3]_analysis_energy_filter_fit_eng_s_text'].layout = widgets.Layout(width = '19%',
    #                                                                                        height = '100%',
    #                                                                                        top = '0%',
    #                                                                                        visibility='hidden')
    #         self.hs['L[0][2][3][1][2][4]_analysis_energy_filter_fit_eng_e_text'].layout = widgets.Layout(width = '19%',
    #                                                                                        height = '100%',
    #                                                                                        top = '0%',
    #                                                                                        visibility='hidden')
    #     elif a['owner'].value == 'full':
    #         self.hs['L[0][2][3][1][1][4]_analysis_energy_range_post_eng_s_text'].layout = widgets.Layout(width = '19%',
    #                                                                                         height = '100%',
    #                                                                                         top = '0%',
    #                                                                                         visibility='visible')
    #         self.hs['L[0][2][3][1][1][3]_analysis_energy_range_pre_eng_e_text'].layout = widgets.Layout(width = '19%',
    #                                                                                        height = '100%',
    #                                                                                        top = '0%',
    #                                                                                        visibility='visible')
    #         self.hs['L[0][2][3][1][2][3]_analysis_energy_filter_fit_eng_s_text'].layout = widgets.Layout(width = '19%',
