...
class xanes3D_regtools_gui():
    ...
    def build_gui(self):
        ...
        self.hs['L[0][2][2][0][0]_run_reg_title_box'].children = get_handles(self.hs, 'L[0][2][2][0][0]_run_reg_title_box', -1)
        ...
        self.hs['L[0][2][2][0][1]_run_reg_confirm_box'].children = get_handles(self.hs, 'L[0][2][2][0][1]_run_reg_confirm_box', -1)
        ...
        self.hs['L[0][2][2][0][2]_run_reg_progress_box'].children = get_handles(self.hs, 'L[0][2][2][0][2]_run_reg_progress_box', -1)

        self.hs['L[0][2][2][0]_run_reg_box'].children = get_handles(self.hs, 'L[0][2][2][0]_run_reg_box', -1)
        ...
        self.hs['L[0][2][2][1][0]_review_reg_results_title_box'].children = get_handles(self.hs, 'L[0][2][2][1][0]_review_reg_results_title_box', -1)
        ...
        self.hs['L[0][2][2][1][1][0]_read_alignment_button'].disabled = True
        self.hs['L[0][2][2][1][1]_read_alignment_file_box'].children = get_handles(self.hs, 'L[0][2][2][1][1]_read_alignment_file_box', -1)
        ...
        self.hs['L[0][2][2][1][2]_reg_pair_box'].children = get_handles(self.hs, 'L[0][2][2][1][2]_reg_pair_box', -1)
        ...
        self.hs['L[0][2][2][1][3]_zshift_box'].children = get_handles(self.hs, 'L[0][2][2][1][3]_zshift_box', -1)
        ...
        self.hs['L[0][2][2][1][5]_review_manual_shift_box'].children = get_handles(self.hs, 'L[0][2][2][1][5]_review_manual_shift_box', -1)
        ...
        self.hs['L[0][2][2][1][4]_review_reg_results_comfirm_box'].children = get_handles(self.hs, 'L[0][2][2][1][4]_review_reg_results_comfirm_box', -1)
        self.hs['L[0][2][2][1][4][1]_confirm_review_results_button'].on_click(self.L0_2_2_1_4_1_confirm_review_results_button_click)

        self.hs['L[0][2][2][1]_review_reg_results_box'].children = get_handles(self.hs, 'L[0][2][2][1]_review_reg_results_box', -1)
        ...
        self.hs['L[0][2][2][2][0]_align_recon_title_box'].children = get_handles(self.hs, 'L[0][2][2][2][0]_align_recon_title_box', -1)
        ...
        self.hs['L[0][2][2][2][1]_align_recon_optional_slice_region_box'].children = get_handles(self.hs, 'L[0][2][2][2][1]_align_recon_optional_slice_region_box', -1)
        ...
        self.hs['L[0][2][2][2][2]_align_recon_comfirm_box'].children = get_handles(self.hs, 'L[0][2][2][2][2]_align_recon_comfirm_box', -1)
        ...
        self.hs['L[0][2][2][2][3]_align_progress_box'].children = get_handles(self.hs, 'L[0][2][2][2][3]_align_progress_box', -1)


        self.hs['L[0][2][2][2]_align_recon_box'].children = get_handles(self.hs, 'L[0][2][2][2]_align_recon_box', -1)
        ...
        self.hs['L[0][2][3][0][0]_visualize_title_box'].children = get_handles(self.hs, 'L[0][2][3][0][0]_visualize_title_box', -1)
        ...
        self.hs['L[0][2][3][0][3]_visualize_viewer_option_box'].children = get_handles(self.hs, 'L[0][2][3][0][3]_visualize_viewer_option_box', -1)
        ...
        self.hs['L[0][2][3][0][1]_visualize_view_alignment_box'].children = get_handles(self.hs, 'L[0][2][3][0][1]_visualize_view_alignment_box', -1)
        ...
        self.hs['L[0][2][3][0][2]_visualize_spec_view_box'].children = get_handles(self.hs, 'L[0][2][3][0][2]_visualize_spec_view_box', -1)
        ...
        self.hs['L[0][2][3][0]_visualize_box'].children = get_handles(self.hs, 'L[0][2][3][0]_visualize_box', -1)
        ...
        self.hs['L[0][2][3][1][0]_analysis_title_box'].children = get_handles(self.hs, 'L[0][2][3][1][0]_analysis_title_box', -1)
        ...
        self.hs['L[0][2][3][1][1][0]_analysis_energy_range_box1'].children = get_handles(self.hs, 'L[0][2][3][1][1][0]_analysis_energy_range_box1', -1)
        ...
        self.hs['L[0][2][3][1][1][1]_analysis_energy_range_box2'].children = get_handles(self.hs, 'L[0][2][3][1][1][1]_analysis_energy_range_box2', -1)
        ...
        self.hs['L[0][2][3][1][1]_analysis_energy_range_box'].children = get_handles(self.hs, 'L[0][2][3][1][1]_analysis_energy_range_box', -1)
        ...
        self.hs['L[0][2][3][1][2]_analysis_energy_filter_box'].children = get_handles(self.hs, 'L[0][2][3][1][2]_analysis_energy_filter_box', -1)
        ...
        self.hs['L[0][2][3][1][3]_analysis_image_mask_box'].children = get_handles(self.hs, 'L[0][2][3][1][3]_analysis_image_mask_box', -1)
        ...
        self.hs['L[0][2][3][1][4]_analysis_run_box'].children = get_handles(self.hs, 'L[0][2][3][1][4]_analysis_run_box', -1)
        ...
        self.hs['L[0][2][3][1][5]_analysis_progress_box'].children = get_handles(self.hs, 'L[0][2][3][1][5]_analysis_progress_box', -1)
        ## ## ## ## ## run analysis progress -- end

        self.hs['L[0][2][3][1]_analysis_box'].children = get_handles(self.hs, 'L[0][2][3][1]_analysis_box', -1)
    ...
    def L0_2_2_1_3_3_reg_pair_bad_button(self, a):
        ...
        self.hs['L[0][2][2][1][5][2]_review_manual_z_shift_text'].value = self.global_h.xanes3D_fiji_windows['xanes3D_review_viewer']['ip'].currentSlice
        self.global_h.ij.py.run_macro("""run("Enhance Contrast", "saturated=0.35")""")
        self.xanes3D_reg_review_done = False
        self.boxes_logic()
    ...
    def L0_2_2_2_2_1_align_button_click(self, a):
        ...
        #     reg_chunk_sz = f['/trial_registration/trial_reg_parameters/chunk_sz'][()]
        #     reg_eng_list = f['/trial_registration/trial_reg_parameters/eng_list'][:]
            
        #     reg_use_mask = f['/trial_registration/trial_reg_parameters/use_mask'][()]
        #     if reg_use_mask == 1:
        #         reg_use_mask = True
        #     else:
        #         reg_use_mask = False
        #     reg_mask_thres = f['/trial_registration/trial_reg_parameters/mask_thres'][()]
        #     reg_use_chunk = f['/trial_registration/trial_reg_parameters/use_chunk'][()]
        #     if reg_use_chunk == 1:
        #         reg_use_chunk = True
        #     else:
        #         reg_use_chunk = False
        #     reg_use_smooth_img = f['/trial_registration/trial_reg_parameters/use_smooth_img'][()]
        #     if reg_use_smooth_img == 1:
        #         reg_use_smooth_img = True
        #     else:
        #         reg_use_smooth_img = False
        #     reg_smooth_sigma = f['/trial_registration/trial_reg_parameters/img_smooth_sigma'][()]
        ...
        # reg.set_reg_options(use_mask=reg_use_mask, mask_thres=0,
        #                     use_chunk=reg_use_chunk, chunk_sz=reg_chunk_sz,
        #                     use_smooth_img=reg_use_smooth_img, smooth_sigma=reg_smooth_sigma)
        # reg.set_indices(scan_id_s, scan_id_e, fixed_scan_id)
        
        # reg.eng_list = reg_eng_list
        # reg.compose_dicts()
        ...
        if sig == 0:
            self.hs['L[0][2][2][2][2][0]_align_text'].value = 'XANES3D alignment is done ...'
        else:
            self.hs['L[0][2][2][2][2][0]_align_text'].value = 'something wrong in XANES3D alignment ...'
