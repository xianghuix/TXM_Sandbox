...
class xanes3D_tools_gui():
    def __init__(self, parent_h, form_sz=[650, 740]):
        ...
        self.xanes3D_reg_mrtv_step = 0.2 
        ...
        self.xanes3D_config = {"filepath config":{"xanes3D_raw_3D_h5_top_dir":self.xanes3D_raw_3D_h5_top_dir,
		       ...
		       "registration config":{"xanes3D_reg_use_chunk":self.xanes3D_reg_use_chunk,
                                      ...
                                      "xanes3D_reg_mrtv_step":self.xanes3D_reg_mrtv_step, 
    ...
    def set_xanes3D_variables(self):
        ...
        self.xanes3D_reg_mrtv_step = self.xanes3D_config["registration config"]["xanes3D_reg_mrtv_step"]
    ...
    def set_xanes3D_handles(self):
        ...
        self.hs['L[0][2][1][1][4][0]_reg_method_dropdown'].value = self.xanes3D_config["registration_config"]["xanes3D_regparams_reg_method"]
        self.hs['L[0][2][1][1][4][1]_ref_mode_dropdown'].value = self.xanes3D_config["registration_config"]["xanes3D_regparams_ref_mode"]        
        self.hs['L[0][2][1][1][4][2]_mrtv_level_text'].value = self.xanes3D_config["registration config"]["xanes3D_reg_mrtv_level"]
        self.hs['L[0][2][1][1][4][3]_mrtv_width_text'].value = self.xanes3D_config["registration config"]["xanes3D_reg_mrtv_width"]
        self.hs['L[0][2][1][1][4][4]_mrtv_step_text'].value = self.xanes3D_config["registration config"]["xanes3D_reg_mrtv_step"]
            ...
            if not self.xanes3D_filepath_configured:
                ...
                if not viewer_state:
                    ...
                    if self.xanes3D_reg_use_mask:
                        ...
                        enable_disable_boxes(self.hs, boxes, disabled=False, level=-1)
                        self.hs['L[0][2][1][1][4][0]_reg_method_dropdown'].options = ['MPC', 'SR']
                    else:
                        boxes = ['L[0][2][1][1][2][2]_mask_dilation_slider',
                                 'L[0][2][1][1][2][1]_mask_thres_slider']
                        enable_disable_boxes(self.hs, boxes, disabled=True, level=-1)
                        self.hs['L[0][2][1][1][4][0]_reg_method_dropdown'].options = ['MRTV', 'PC', 'SR']
                self.lock_message_text_boxes()
                xanes3D_compound_logic()
            elif ((self.xanes3D_filepath_configured & self.xanes3D_indices_configured) &
    ...
    def build_gui(self):
        ...
        self.hs['L[0][2][1][1][4][0]_reg_method_dropdown'] = widgets.Dropdown(value='MRTV', 
        ...
        self.hs['L[0][2][1][1][4][2]_mrtv_level_text'] = widgets.BoundedIntText(value=4,
                                                                                min=1,
                                                                                max=10,
                                                                                step=1,
                                                                                description='level',
                                                                                ...
                                                                                disabled=True)
        layout = {'width':'19%'}
        self.hs['L[0][2][1][1][4][2]_mrtv_level_text'].layout = layout
        
        self.hs['L[0][2][1][1][4][3]_mrtv_width_text'] = widgets.BoundedIntText(value=5,
                                                                                min=1,
                                                                                max=20,
                                                                                step=1,
                                                                                description='width',
                                                                                ...
                                                                                disabled=True)
        layout = {'width':'19%'}
        self.hs['L[0][2][1][1][4][3]_mrtv_width_text'].layout = layout
        
        self.hs['L[0][2][1][1][4][4]_mrtv_step_text'] = widgets.BoundedFloatText(value=0.2,
                                                                                 min=0.1,
                                                                                 max=1,
                                                                                 step=0.1,
                                                                                 description='step',
                                                                                 description_tooltip='step: multi-resolution final sub-pixel searching step size',
                                                                                 disabled=True)
        layout = {'width':'19%'}
        self.hs['L[0][2][1][1][4][4]_mrtv_step_text'].layout = layout
        ...
        self.hs['L[0][2][1][1][4][2]_mrtv_level_text'].observe(self.L0_2_1_1_4_2_mrtv_level_text_change, names='value')
        self.hs['L[0][2][1][1][4][3]_mrtv_width_text'].observe(self.L0_2_1_1_4_3_mrtv_width_text_change, names='value')
        self.hs['L[0][2][1][1][4][4]_mrtv_step_text'].observe(self.L0_2_1_1_4_4_mrtv_step_text_change, names='value')
    ...
    def L0_2_1_1_4_4_mrtv_step_text_change(self, a):
    ...
    def L0_2_1_1_5_1_confirm_reg_params_button_click(self, a):
        ...
        self.xanes3D_reg_mrtv_level = self.hs['L[0][2][1][1][4][2]_mrtv_level_text'].value
        self.xanes3D_reg_mrtv_width = self.hs['L[0][2][1][1][4][3]_mrtv_width_text'].value
        self.xanes3D_reg_mrtv_step = self.hs['L[0][2][1][1][4][4]_mrtv_step_text'].value
    ...
    def L0_2_1_2_1_0_run_reg_button_click(self, a):
        ...
        reg.set_indices(self.xanes3D_scan_id_s, self.xanes3D_scan_id_e+1, self.xanes3D_fixed_scan_id)
        reg.set_reg_options(use_mask=self.xanes3D_reg_use_mask, mask_thres=self.xanes3D_reg_mask_thres,
                        ...
                        mrtv_step=self.xanes3D_reg_mrtv_step)
