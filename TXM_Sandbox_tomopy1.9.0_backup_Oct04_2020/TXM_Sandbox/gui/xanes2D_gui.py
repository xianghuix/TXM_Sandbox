...
class xanes2D_tools_gui():
    def __init__(self, parent_h, form_sz=[650, 740]):
        ...
        self.xanes2D_reg_mrtv_step = 0.2
        ...
        self.xanes2D_config = {"filepath config":{"xanes2D_file_raw_h5_filename":self.xanes2D_file_raw_h5_filename,
                               ...
                               "registration_config":{"xanes2D_regparams_fiji_viewer":True,
                                                      ...
                                                      "xanes2D_regparams_mrtv_step":0.2,
    ...
    def update_xanes2D_config(self):
        ...
        self.xanes2D_config = {"filepath config":{"xanes2D_file_raw_h5_filename":self.xanes2D_file_raw_h5_filename,
                               ...
                               "registration_config":{"xanes2D_regparams_fiji_viewer":self.hs['L[0][1][1][1][1][0]_fiji_mask_viewer_checkbox'].value,
                                                      ...
                                                      "xanes2D_regparams_mrtv_level":self.hs['L[0][1][1][1][4][2]_mrtv_level_text'].value,
                                                      "xanes2D_regparams_mrtv_width":self.hs['L[0][1][1][1][4][3]_mrtv_width_text'].value,
                                                      "xanes2D_regparams_mrtv_step":self.hs['L[0][1][1][1][4][4]_mrtv_step_text'].value,
                                                      "xanes2D_regparams_configured":self.xanes2D_reg_params_configured},
                               "run registration":{"xanes2D_reg_done":self.xanes2D_reg_done},
    ...
    def set_xanes2D_variables(self):
        ...
        self.xanes2D_reg_mrtv_step = self.xanes2D_config["registration_config"]["xanes2D_regparams_mrtv_step"]
    ...
    def set_xanes2D_handles(self):
        ...
        self.hs['L[0][1][1][1][4][2]_mrtv_level_text'].value = self.xanes2D_config["registration_config"]["xanes2D_regparams_mrtv_level"]
        self.hs['L[0][1][1][1][4][3]_mrtv_width_text'].value = self.xanes2D_config["registration_config"]["xanes2D_regparams_mrtv_width"]
        self.hs['L[0][1][1][1][4][4]_mrtv_step_text'].value = self.xanes2D_config["registration_config"]["xanes2D_regparams_mrtv_step"]
    ...
    def boxes_logic(self):
        def xanes2D_compound_logic():
            ...
            if self.hs['L[0][1][1][1][2][0]_use_mask_checkbox'].value:
                ...
                self.hs['L[0][1][1][1][4][0]_reg_method_dropdown'].options = ['MPC', 'SR']
            else:
                self.hs['L[0][1][1][1][2][1]_mask_thres_slider'].disabled = True
                self.hs['L[0][1][1][1][2][2]_mask_dilation_slider'].disabled = True
                self.hs['L[0][1][1][1][4][0]_reg_method_dropdown'].options = ['MRTV', 'PC', 'SR']
    ...
    def build_gui(self):
        ...
        self.hs['L[0][1][1][1][4][0]_reg_method_dropdown'] = widgets.Dropdown(value='MRTV',
                                                                              options=['MRTV', 'MPC', 'PC', 'SR'],
                                                                              description='reg method',
                                                                              description_tooltip='reg method: MRTV: Multi-resolution Total Variantion, MPC: Masked Phase Correlation; PC: Phase Correlation; SR: StackReg',
                                                                              disabled=True)
        layout = {'width':'19%'}
        ...
        self.hs['L[0][1][1][1][4][2]_mrtv_level_text'] = widgets.BoundedIntText(value=4,
                                                                                min=1,
                                                                                max=10,
                                                                                step=1,
                                                                                description='level',
                                                                                ...
                                                                                disabled=True)
        layout = {'width':'19%'}
        self.hs['L[0][1][1][1][4][2]_mrtv_level_text'].layout = layout
        
        self.hs['L[0][1][1][1][4][3]_mrtv_width_text'] = widgets.BoundedIntText(value=5,
                                                                                min=1,
                                                                                max=20,
                                                                                step=1,
                                                                                description='width',
                                                                                ...
                                                                                disabled=True)
        layout = {'width':'19%'}
        self.hs['L[0][1][1][1][4][3]_mrtv_width_text'].layout = layout
        
        self.hs['L[0][1][1][1][4][4]_mrtv_step_text'] = widgets.BoundedFloatText(value=0.2,
                                                                                 min=0.1,
                                                                                 max=1,
                                                                                 step=0.1,
                                                                                 description='step',
                                                                                 ...
                                                                                 disabled=True)
        layout = {'width':'19%'}
        self.hs['L[0][1][1][1][4][4]_mrtv_step_text'].layout = layout
        ...
        self.hs['L[0][1][1][1][4][2]_mrtv_level_text'].observe(self.L0_1_1_1_4_2_mrtv_level_text_change, names='value')
        self.hs['L[0][1][1][1][4][3]_mrtv_width_text'].observe(self.L0_1_1_1_4_3_mrtv_width_text_change, names='value')
        self.hs['L[0][1][1][1][4][4]_mrtv_step_text'].observe(self.L0_1_1_1_4_4_mrtv_step_text_change, names='value')
        ## ## ## ## ##  reg_options box -- end
    ...
    def L0_1_1_1_4_2_mrtv_level_text_change(self, a):
        self.xanes2D_reg_mrtv_level = a['owner'].value
        self.xanes2D_reg_params_configured = False
        self.boxes_logic()
    
    def L0_1_1_1_4_3_mrtv_width_text_change(self, a):
        self.xanes2D_reg_mrtv_width = a['owner'].value
        self.xanes2D_reg_params_configured = False
        self.boxes_logic()
    
    def L0_1_1_1_4_4_mrtv_step_text_change(self, a):
        self.xanes2D_reg_mrtv_step = a['owner'].value
        self.xanes2D_reg_params_configured = False
        self.boxes_logic()
    ...
    def L0_1_1_1_5_1_confirm_reg_params_button_click(self, a):
        ...
        self.xanes2D_reg_mrtv_level = self.hs['L[0][1][1][1][4][2]_mrtv_level_text'].value
        self.xanes2D_reg_mrtv_width = self.hs['L[0][1][1][1][4][3]_mrtv_width_text'].value
        self.xanes2D_reg_mrtv_step = self.hs['L[0][1][1][1][4][4]_mrtv_step_text'].value
        if self.xanes2D_reg_use_mask:
            if self.xanes2D_reg_use_smooth_img:
    ...
    def L0_1_1_2_1_0_run_reg_button_click(self, a):
        ...
        reg.set_indices(self.xanes2D_eng_id_s, self.xanes2D_eng_id_e+1, self.xanes2D_reg_anchor_idx)
        reg.set_reg_options(use_mask=self.xanes2D_reg_use_mask, mask_thres=self.xanes2D_reg_mask_thres,
                        ...
                        mrtv_step=self.xanes2D_reg_mrtv_step)
