...
class xanes_regtools_gui():
    ...
    def gui_layout(self):
        ...
        # self.hs['L[0][2][0][0][4][2]_file_path_options_dropdown'].observe(self.L0_2_0_0_4_2_review_reg_result_checkbox_change, names='value')
        ...
        if self.xanes3D_use_existing_reg_file:
            if not self.xanes3D_save_trial_set:
                ...
                try:
                    ...
                    self.xanes3D_recon_path_set = True
                    self.hs['L[0][2][2][2][1][1]_align_recon_optional_slice_range_slider'].max = max(self.xanes3D_available_recon_file_ids)
                    self.hs['L[0][2][2][2][1][1]_align_recon_optional_slice_range_slider'].value = (min(self.xanes3D_available_recon_file_ids),
                                                                                                    min(self.xanes3D_available_recon_file_ids))
                    self.hs['L[0][2][2][2][1][1]_align_recon_optional_slice_range_slider'].min = min(self.xanes3D_available_recon_file_ids)
                    self.hs['L[0][2][2][2][1][2]_align_recon_optional_slice_end_text'].max = max(self.xanes3D_available_recon_file_ids)
                    self.hs['L[0][2][2][2][1][2]_align_recon_optional_slice_end_text'].value = min(self.xanes3D_available_recon_file_ids)
                    self.hs['L[0][2][2][2][1][2]_align_recon_optional_slice_end_text'].min = min(self.xanes3D_available_recon_file_ids)
                    self.hs['L[0][2][2][2][1][0]_align_recon_optional_slice_start_text'].max = max(self.xanes3D_available_recon_file_ids)
                    self.hs['L[0][2][2][2][1][0]_align_recon_optional_slice_start_text'].value = min(self.xanes3D_available_recon_file_ids)
                    self.hs['L[0][2][2][2][1][0]_align_recon_optional_slice_start_text'].min = min(self.xanes3D_available_recon_file_ids)
    ...
    def L0_2_0_1_4_0_confirm_config_indices_button_click(self, a):
        if WindowManager.getIDList() is None:
            ...
            # self.hs['L[0][2][1][0][1][2]_3D_roi_z_slider'].value = self.hs['L[0][2][0][1][2][1]_fixed_sli_id_slider'].value
    ...
    def L0_2_2_1_3_2_record_button_click(self, a):
        ...
        self.hs['L[0][2][2][1][4][0]_confirm_review_results_text'].value = str(self.alignment_best_match)
        self.xanes3D_reg_review_done = False
        self.boxes_logic()
