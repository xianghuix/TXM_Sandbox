...
class xanes_regtools_gui():
    ...
    def L0_2_2_0_1_0_run_reg_button_click(self, a):
        ...
        self.xanes3D_reg_best_match_filename = os.path.splitext(self.xanes3D_save_trial_reg_filename)[0].replace('config', 'reg_best_match') + '.json'
        self.update_xanes3D_config()
        json.dump(self.xanes3D_config, open(self.xanes3D_save_trial_reg_config_filename, 'w'))
        self.boxes_logic()
    ...
    def L0_2_3_1_4_1_analysis_run_button(self, a):
        ...
        # self.xana = xa.xanes_analysis(imgs,
        ...
        # if not self.xanes3D_analysis_use_mask:
        #     if self.xanes3D_analysis_type == 'wl':
        #         for ii in range(self.xanes3D_analysis_data_shape[0]):
        #             imgs[:] = f['/registration_results/reg_results/registered_xanes3D'][:, ii, :, :]
        #             self.xana.spectrum[:] = imgs[:]
        #             # xana.fit_whiteline(self.xanes3D_analysis_wl_fit_eng_s, self.xanes3D_analysis_wl_fit_eng_e)
        #             # self.xanes3D_analysis_spectrum[ii] = xana.whiteline_pos[:]
        #             print(ii)
        ...
        #         xana.fit_edge_pos(self.xanes3D_analysis_edge_0p5_fit_s, self.xanes3D_analysis_edge_0p5_fit_e)
        #         xana.fit_whiteline(self.xanes3D_analysis_wl_fit_eng_s, self.xanes3D_analysis_wl_eng_e)
