...
"""
### original code from https://codereview.stackexchange.com/questions/162920/file-selection-button-for-jupyter-notebook
    ...
    def select_files(b):
        ...
        if b.text_h is None:
            ...
            if len(files) == 0:
                ...
                if b.option == 'askopenfilename':
                    b.description = "File Selected"
                    b.text_h.value = os.path.abspath(b.selected)
                elif b.option == 'asksaveasfilename':
                    b.description = "Filename Chosen"
                    b.text_h.value = os.path.abspath(b.selected)
                elif b.option == 'askdirectory':
...
#        reg_params['3D_trial_reg'] = None
    ...
    def gui_layout(self):
        ...
        self.hs['[0]_top_tab_form'] = widgets.Tab()
        self.hs['[0]_top_tab_form'].layout = layout
        ...
        self.hs['[0][0]_tomo_recon_tabs'] = widgets.Tab()
        self.hs['[0][1]_2D_xanes_tabs'] =  widgets.Tab()
        self.hs['[0][2]_3D_xanes_tabs'] =  widgets.Tab()              
        self.hs['[0][0]_tomo_recon_tabs'].layout = layout
        self.hs['[0][1]_2D_xanes_tabs'].layout = layout
        self.hs['[0][2]_3D_xanes_tabs'].layout = layout
 
        self.hs['[0]_top_tab_form'].children = self.get_handles('[0]_top_tab_form', 3)       
        self.hs['[0]_top_tab_form'].set_title(0, 'TOMO RECON')
        self.hs['[0]_top_tab_form'].set_title(1, '2D XANES')
        self.hs['[0]_top_tab_form'].set_title(2, '3D XANES')
        
        # # # define functional tabs for each sub-tab
        layout = {'border':'3px solid #FFCC00', 'width':f'{self.form_sz[1]-86}px', 'height':f'{self.form_sz[0]-128}px'}
        self.hs['[0][2][0]_config_input_form'] = widgets.VBox()
        self.hs['[0][2][1]_reg_setting_form'] = widgets.VBox() 
        self.hs['[0][2][2]_reg&review_form'] = widgets.VBox()               
        self.hs['[0][2][0]_config_input_form'].layout = layout
        self.hs['[0][2][1]_reg_setting_form'].layout = layout
        self.hs['[0][2][2]_reg&review_form'].layout = layout
        
        # # # # define functional widgets each tab in each sub-tab       
        layout = {'border':'3px solid #FFCC00', 'width':f'{self.form_sz[1]-88}px', 'height':f'{0.32*(self.form_sz[0]-128)}px'}
        self.hs['[0][2][0][0]_select_file&path_box'] = widgets.VBox()
        self.hs['[0][2][0][0]_select_file&path_box'].layout = layout
        layout = {'border':'3px solid #FFCC00', 'width':f'{self.form_sz[1]-88}px', 'height':f'{0.25*0.32*(self.form_sz[0]-128)}px'}
        self.hs['[0][2][0][0][0]_select_raw_box'] = widgets.HBox()
        self.hs['[0][2][0][0][0]_select_raw_box'].layout = layout
        self.hs['[0][2][0][0][0][1]_select_raw_h5_path_text'] = widgets.Text(value='Choose raw h5 directory ...', description='', disabled=True)
        self.hs['[0][2][0][0][0][1]_select_raw_h5_path_text'].layout = {'width':f'{0.7*(self.form_sz[1]-88)}px'}
        self.hs['[0][2][0][0][0][0]_select_raw_h5_path_button'] = SelectFilesButton(option='askdirectory',
                                                                                    text_h=self.hs['[0][2][0][0][0][1]_select_raw_h5_path_text'])
        self.hs['[0][2][0][0][0]_select_raw_box'].children = self.get_handles('[0][2][0][0][0]_select_raw_box', 2) 
        
        self.hs['[0][2][0][0]_select_file&path_box'].children = self.get_handles('[0][2][0][0]_select_file&path_box', 1) 
        self.hs['[0][2][0]_config_input_form'].children = self.get_handles('[0][2][0]_config_input_form', 1)
        self.hs['[0][2]_3D_xanes_tabs'].children = self.get_handles('[0][2]_3D_xanes_tabs', 3)  
        self.hs['[0][2]_3D_xanes_tabs'].set_title(0, 'File Configurations')
        self.hs['[0][2]_3D_xanes_tabs'].set_title(1, 'Registration Settings')
        self.hs['[0][2]_3D_xanes_tabs'].set_title(2, 'Registration & reviews') 
            
        display(self.hs['[0]_top_tab_form'])
