...
class xanes_regtools_gui():
    ...
    def L0_1_3_1_4_1_analysis_run_button_click(self, a):
        ...
        code['064'] = "    g120[:] = np.float32(xana.whiteline_pos)[:]"
        code['065'] = "    g121[:] = np.float32(xana.whiteline_pos_direct)[:]"
        code['066'] = "    g122[:] = np.float32(xana.direct_whiteline_ph)[:]"
        ...
        code['071'] = "    g127[:] = np.float32(xana.edge_eng_pos)[:]"
        code['072'] = ""
        code['073'] = "f.close()"
