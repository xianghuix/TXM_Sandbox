...
import tifffile, h5py, time
import os, shutil, sys
import numpy as np
import multiprocess as mp
# minimize is a general minimizer, curve_fit is same as least_squares when its method='lm'
# lsq_linear and nnls are for solving linear equations with least squares
from scipy.optimize import minimize, curve_fit, least_squares as lsq, lsq_linear, nnls
from larch_packages.lineshapes import (gaussian, lorentzian, voigt, pvoigt, moffat, pearson7,
