...
class xanes3D_regtools_gui():
    ...
    def boxes_logic(self):
        def xanes3D_compound_logic():
            ...
            # if self.xanes_analysis_use_mask:
                # self.xanes_analysis_gui_h.hs['L[0][x][3][0][3][1]_analysis_image_mask_scan_id_slider'].disabled = False
                # self.xanes_analysis_gui_h.hs['L[0][x][3][0][3][1]_analysis_image_mask_thres_slider'].disabled = False
            # else:
                # self.xanes_analysis_gui_h.hs['L[0][x][3][0][3][1]_analysis_image_mask_scan_id_slider'].disabled = True
                # self.xanes_analysis_gui_h.hs['L[0][x][3][0][3][1]_analysis_image_mask_thres_slider'].disabled = True
            if self.xanes_analysis_eng_configured:
                self.xanes_analysis_gui_h.hs['L[0][x][3][0][5][1]_ana_run_button'].disabled = False
            else:
                self.xanes_analysis_gui_h.hs['L[0][x][3][0][5][1]_ana_run_button'].disabled = True
    ...
    def build_gui(self):
        ...
        self.hs['L[0][2][3]_analysis&display_form'].children = [self.xanes_analysis_gui_h.hs['L[0][x][3][0]_analysis_box']]
