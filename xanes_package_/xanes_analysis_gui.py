...
class xanes_analysis_gui():
    def __init__(self, parent_h, form_sz=[650, 740]):
        ...
        self.ana_wl_fit_use_param_bnd = False
        self.ana_wl_optimizer = 'scipy'
        self.ana_wl_fit_func = 'lorentzian'
        self.ana_edge_fit_use_param_bnd = False        
        self.ana_edge_optimizer = 'scipy'
        self.ana_edge_fit_func = 'lorentzian'
        self.analysis_saving_items = set(FULL_SAVE_DEFAULT)
        self.parent_h.xanes_analysis_type == 'full'
        
        self.ana_fit_wl = True
        self.ana_fit_edge = True
        self.ana_find_edge = True
        self.ana_find_edge0p5_dir = True
        self.ana_use_flt_spec = False        
    ...
    def set_xanes_analysis_eng_bounds(self):
        ...
        self.hs['L[0][x][3][0][1][1][1]_ana_eng_range_wl_fit_e_text'].max = \
            self.parent_h.xanes_analysis_eng_list.max()
        self.hs['L[0][x][3][0][1][1][1]_ana_eng_range_wl_fit_e_text'].min = \
            self.parent_h.xanes_analysis_eng_list.min()
        self.hs['L[0][x][3][0][1][1][0]_ana_eng_range_wl_fit_s_text'].max = \
            self.parent_h.xanes_analysis_eng_list.max()
        self.hs['L[0][x][3][0][1][1][0]_ana_eng_range_wl_fit_s_text'].min = \
            self.parent_h.xanes_analysis_eng_list.min()
            
        if self.hs['L[0][x][3][0][1][0][0]_ana_eng_range_option_dropdown'].value == 'full':            
            ...
            if self.parent_h.xanes_analysis_edge_0p5_fit_s < self.parent_h.xanes_analysis_eng_list.min():
                ...
                self.parent_h.xanes_analysis_edge_0p5_fit_s = \
                    self.parent_h.xanes_analysis_eng_list[int(eng_list_len/2)] - 1  
            self.hs['L[0][x][3][0][1][0][1]_ana_eng_range_edge_eng_text'].max = \
                self.parent_h.xanes_analysis_eng_list.max()
            self.hs['L[0][x][3][0][1][0][1]_ana_eng_range_edge_eng_text'].min = \
                self.parent_h.xanes_analysis_eng_list.min()
            self.hs['L[0][x][3][0][1][1][1]_ana_eng_range_wl_fit_e_text'].max = \
                self.parent_h.xanes_analysis_eng_list.max()
            self.hs['L[0][x][3][0][1][1][1]_ana_eng_range_wl_fit_e_text'].min = \
            ...
            self.hs['L[0][x][3][0][1][1][0]_ana_eng_range_wl_fit_s_text'].min = \
                self.parent_h.xanes_analysis_eng_list.min()
            self.hs['L[0][x][3][0][1][1][3]_ana_eng_range_edge0.5_fit_e_text'].max = \
                self.parent_h.xanes_analysis_eng_list.max()
            self.hs['L[0][x][3][0][1][1][3]_ana_eng_range_edge0.5_fit_e_text'].min = \
                self.parent_h.xanes_analysis_eng_list.min()
            self.hs['L[0][x][3][0][1][1][2]_ana_eng_range_edge0.5_fit_s_text'].max = \
                self.parent_h.xanes_analysis_eng_list.max()
            self.hs['L[0][x][3][0][1][1][2]_ana_eng_range_edge0.5_fit_s_text'].min = \
                self.parent_h.xanes_analysis_eng_list.min()
    ...
    def build_gui(self):
        ...
        self.hs['L[0][x][3][0][1][0][0]_ana_eng_range_option_dropdown'] = widgets.Dropdown(description='analysis type',
                                                                                                  ...
                                                                                                  value ='wl',
                                                                                                  disabled=True)
        self.hs['L[0][x][3][0][1][0][0]_ana_eng_range_option_dropdown'].layout = layout
        # layout = {'width':'19%', 'height':'100%', 'top':'0%', 'visibility':'hidden'}
        layout = {'width':'19%', 'height':'90%'}
        self.hs['L[0][x][3][0][1][0][1]_ana_eng_range_edge_eng_text'] = widgets.BoundedFloatText(description='edge eng',
                                                                                                      ...
                                                                                                      step=0.5,
                                                                                                      disabled=True)
        self.hs['L[0][x][3][0][1][0][1]_ana_eng_range_edge_eng_text'].layout = layout
        layout = {'width':'19%', 'height':'90%'}
        self.hs['L[0][x][3][0][1][0][2]_ana_eng_range_pre_edge_e_text'] = widgets.BoundedFloatText(description='pre edge e',
                                                                                                   ...
                                                                                                   step=0.5,
                                                                                                   disabled=True)
        self.hs['L[0][x][3][0][1][0][2]_ana_eng_range_pre_edge_e_text'].layout = layout
        layout = {'width':'19%', 'height':'90%'}
        self.hs['L[0][x][3][0][1][0][3]_ana_eng_range_post_edge_s_text'] = widgets.BoundedFloatText(description='post edge s',
                                                                                                   ...
                                                                                                   step=0.5,
                                                                                                   disabled=True)
        self.hs['L[0][x][3][0][1][0][3]_ana_eng_range_post_edge_s_text'].layout = layout
        layout = {'width':'19%', 'height':'90%'}
        ...
        self.hs['L[0][x][3][0][1][0][0]_ana_eng_range_option_dropdown'].observe(self.L0_x_3_0_1_0_0_ana_eng_range_option_dropdown, names='value')
        self.hs['L[0][x][3][0][1][0][1]_ana_eng_range_edge_eng_text'].observe(self.L0_x_3_0_1_0_1_ana_eng_range_edge_eng_text, names='value')
        self.hs['L[0][x][3][0][1][0][2]_ana_eng_range_pre_edge_e_text'].observe(self.L0_x_3_0_1_0_2_ana_eng_range_pre_edge_e_text, names='value')
        self.hs['L[0][x][3][0][1][0][3]_ana_eng_range_post_edge_s_text'].observe(self.L0_x_3_0_1_0_3_ana_eng_range_post_edge_s_text, names='value')
        ...
        layout = {'width':'19%', 'height':'90%'}
        self.hs['L[0][x][3][0][1][1][0]_ana_eng_range_wl_fit_s_text'] = widgets.BoundedFloatText(description='wl eng s',
                                                                                            ...
                                                                                            step=0.5,
                                                                                            disabled=True)
        self.hs['L[0][x][3][0][1][1][0]_ana_eng_range_wl_fit_s_text'].layout = layout
        layout = {'width':'19%', 'height':'90%'}
        self.hs['L[0][x][3][0][1][1][1]_ana_eng_range_wl_fit_e_text'] = widgets.BoundedFloatText(description='wl eng e',
                                                                                            ...
                                                                                            step=0.5,
                                                                                            disabled=True)
        self.hs['L[0][x][3][0][1][1][1]_ana_eng_range_wl_fit_e_text'].layout = layout
        layout = {'width':'19%', 'height':'90%'}
        self.hs['L[0][x][3][0][1][1][2]_ana_eng_range_edge0.5_fit_s_text'] = widgets.BoundedFloatText(description='edge0.5 s',
                                                                                                 ...
                                                                                                 step=0.5,
                                                                                                 disabled=True)
        self.hs['L[0][x][3][0][1][1][2]_ana_eng_range_edge0.5_fit_s_text'].layout = layout
        layout = {'width':'19%', 'height':'90%'}
        self.hs['L[0][x][3][0][1][1][3]_ana_eng_range_edge0.5_fit_e_text'] = widgets.BoundedFloatText(description='edge0.5 e',
                                                                                                   description_tooltip='absolute energy starting point (keV) for edge-0.5 fitting. "edge0.5 s" and "edge0.5 e" shoudl be close to the foot and the peak locations on the ascendent edge of the spectra.',
                                                                                                   value =0,
                                                                                                   min = 0,
                                                                                                   max = 50030,
                                                                                                   step=0.5,
                                                                                                   disabled=True)
        self.hs['L[0][x][3][0][1][1][3]_ana_eng_range_edge0.5_fit_e_text'].layout = layout
        ...
        self.hs['L[0][x][3][0][1][1][0]_ana_eng_range_wl_fit_s_text'].observe(self.L0_x_3_0_1_1_0_ana_eng_range_wl_fit_s_text, names='value')
        self.hs['L[0][x][3][0][1][1][1]_ana_eng_range_wl_fit_e_text'].observe(self.L0_x_3_0_1_1_1_ana_eng_range_wl_fit_e_text, names='value')
        self.hs['L[0][x][3][0][1][1][2]_ana_eng_range_edge0.5_fit_s_text'].observe(self.L0_x_3_0_1_1_2_ana_eng_range_edge0p5_fit_s_text, names='value')
        self.hs['L[0][x][3][0][1][1][3]_ana_eng_range_edge0.5_fit_e_text'].observe(self.L0_x_3_0_1_1_3_ana_eng_range_edge0p5_fit_e_text, names='value')
        self.hs['L[0][x][3][0][1][1][4]_analysis_energy_confirm_button'].on_click(self.L0_x_3_0_1_0_4_ana_eng_range_confirm_button)
        ...
        # self.hs['L[0][x][3][0][4][3][0][1]_ana_config_edge_jump_thres_slider'] = widgets.FloatSlider(description='edge jump thres',
        ...
        #                                                                                                       step=0.1,
        #                                                                                                       disabled=True)
        # self.hs['L[0][x][3][0][4][3][0][1]_ana_config_edge_jump_thres_slider'].layout = layout
        # layout = {'width':'48%', 'height':'90%'}
        # self.hs['L[0][x][3][0][4][3][0][2]_ana_config_edge_offset_thres_slider'] = widgets.FloatSlider(description='edge offset',
        ...
        #                                                                               step=0.1,
        #                                                                               disabled=True)
        # self.hs['L[0][x][3][0][4][3][0][2]_ana_config_edge_offset_thres_slider'].layout = layout
        # self.hs['L[0][x][3][0][4][3][0][1]_ana_config_edge_jump_thres_slider'].observe(self.L0_x_3_0_4_3_0_1_ana_config_edge_jump_thres_slider_change, names='value')
        # self.hs['L[0][x][3][0][4][3][0][2]_ana_config_edge_offset_thres_slider'].observe(self.L0_x_3_0_4_3_0_2_ana_config_edge_offset_thres_slider, names='value')
        ...
        # self.hs['L[0][x][3][0][3][0]_ana_img_use_mask_checkbox'] = widgets.Checkbox(description='use mask',
        #                                                                                       description_tooltip='use a mask based on gray value threshold to define sample region',
        #                                                                                       value =False,
        #                                                                                       disabled=True)
        # self.hs['L[0][x][3][0][3][0]_ana_img_use_mask_checkbox'].layout = layout
        # layout = {'width':'40%', 'height':'90%'}
        # self.hs['L[0][x][3][0][3][1]_ana_img_mask_scan_id_slider'] = widgets.IntSlider(description='mask scan id',
        #                                                                                          description_tooltip='scan id with which the mask is made',
        #                                                                                          value =1,
        #                                                                                          min = 0,
        #                                                                                          max = 10,
        #                                                                                          disabled=True)
        # self.hs['L[0][x][3][0][3][1]_ana_img_mask_scan_id_slider'].layout = layout
        # layout = {'width':'48%', 'height':'90%'}
        # self.hs['L[0][x][3][0][3][1]_ana_img_mask_thres_slider'] = widgets.FloatSlider(description='mask thres',
        ...
        #                                                                                     readout_format='.5f',
        #                                                                                     disabled=True)
        # self.hs['L[0][x][3][0][3][1]_ana_img_mask_thres_slider'].layout = layout

        # # self.hs['L[0][x][3][0][3]_analysis_image_mask_box'].children = get_handles(self.hs, 'L[0][x][3][0][3]_analysis_image_mask_box', -1)
        # self.hs['L[0][x][3][0][3][0]_ana_img_use_mask_checkbox'].observe(self.L0_x_3_0_3_0_ana_img_use_mask_checkbox, names='value')
        # self.hs['L[0][x][3][0][3][1]_ana_img_mask_scan_id_slider'].observe(self.L0_x_3_0_3_1_ana_img_mask_scan_id_slider, names='value')
        # self.hs['L[0][x][3][0][3][1]_ana_img_mask_thres_slider'].observe(self.L0_x_3_0_3_1_ana_img_mask_thres_slider, names='value')
        ...
        self.hs['L[0][x][3][0][4][3]_ana_config_box'] = widgets.HBox()
        self.hs['L[0][x][3][0][4][3]_ana_config_box'].layout = layout
        
        self.hs['L[0][x][3][0][4][3][0]_ana_config'] = widgets.GridspecLayout(8, 200,
        ...
        self.hs['L[0][x][3][0][4][3][0]_ana_config'][0, :40] = widgets.Checkbox(description='fit wl',
                                                                                description_tooltip="fit whiteline if it is checked",
                                                                                value =True,
                                                                                layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                indent = False,
                                                                                disabled=False)
        self.hs['L[0][x][3][0][4][3][0][0]_ana_config_fit_wl_checkbox'] = self.hs['L[0][x][3][0][4][3][0]_ana_config'][0, :40]
        self.hs['L[0][x][3][0][4][3][0]_ana_config'][0, 40:80] = widgets.Checkbox(description='fit edge',
                                                                                   description_tooltip='fit edge if it is checked',
                                                                                   value =True,
                                                                                   layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                   indent = False,
                                                                                   disabled=False)
        self.hs['L[0][x][3][0][4][3][0][1]_ana_config_fit_edge_checkbox'] = self.hs['L[0][x][3][0][4][3][0]_ana_config'][0, 40:80]
        self.hs['L[0][x][3][0][4][3][0]_ana_config'][0, 80:120] = widgets.Checkbox(description='filter spec',
                                                                                   description_tooltip='filter spec before fitting edge if it is checked',
                                                                                   value =False,
                                                                                   layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                   indent = False,
                                                                                   disabled=False)
        self.hs['L[0][x][3][0][4][3][0][2]_ana_config_filter_spec_checkbox'] = self.hs['L[0][x][3][0][4][3][0]_ana_config'][0, 80:120]
        self.hs['L[0][x][3][0][4][3][0]_ana_config'][0, 120:160] = widgets.Checkbox(description='find edge_direct',
                                                                                   description_tooltip='find edge by derivative if it is checked',
                                                                                   value =True,
                                                                                   layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                   indent = False,
                                                                                   disabled=False)
        self.hs['L[0][x][3][0][4][3][0][3]_ana_config_find_edge_checkbox'] = self.hs['L[0][x][3][0][4][3][0]_ana_config'][0, 120:160]
        self.hs['L[0][x][3][0][4][3][0]_ana_config'][0, 160:200] = widgets.Checkbox(description='edge0.5 direct',
                                                                                   description_tooltip='cal edge at 0.5 in normalized spectrum if it is checked',
                                                                                   value =True,
                                                                                   layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                   indent = False,
                                                                                   disabled=False)
        self.hs['L[0][x][3][0][4][3][0][3]_ana_config_cal_edge0.5_direct_checkbox'] = self.hs['L[0][x][3][0][4][3][0]_ana_config'][0, 160:200]
        
        
        self.hs['L[0][x][3][0][4][3][0]_ana_config'][1, :100] = widgets.FloatSlider(description='edge jump thres',
                                                                                    description_tooltip='edge jump in unit of the standard deviation of the signal in energy range pre to the edge. larger threshold enforces more restrict data quality validation on the data',
                                                                                    value =1,
                                                                                    min = 0,
                                                                                    max = 10,
                                                                                    step=0.1,
                                                                                    disabled=True)
        self.hs['L[0][x][3][0][4][3][0][1]_ana_config_edge_jump_thres_slider'] = self.hs['L[0][x][3][0][4][3][0]_ana_config'][1, :100]
        self.hs['L[0][x][3][0][4][3][0]_ana_config'][1, 100:200] = widgets.FloatSlider(description='edge offset thres',
                                                                                      description_tooltip='offset between pre-edge and post-edge in unit of the standard deviation of pre-edge. larger offser enforces more restrict data quality validation on the data',
                                                                                      value =1,
                                                                                      min = 0,
                                                                                      max = 10,
                                                                                      step=0.1,
                                                                                      disabled=True)
        self.hs['L[0][x][3][0][4][3][0][2]_ana_config_edge_offset_thres_slider'] = self.hs['L[0][x][3][0][4][3][0]_ana_config'][1, 100:200]
        
        self.hs['L[0][x][3][0][4][3][0][0]_ana_config_fit_wl_checkbox'].observe(self.L0_x_3_0_4_3_0_0_ana_config_fit_wl_checkbox_change, names='value')
        self.hs['L[0][x][3][0][4][3][0][1]_ana_config_fit_edge_checkbox'].observe(self.L0_x_3_0_4_3_0_1_ana_config_fit_edge_checkbox_change, names='value')
        self.hs['L[0][x][3][0][4][3][0][2]_ana_config_filter_spec_checkbox'].observe(self.L0_x_3_0_4_3_0_2_ana_config_filter_spec_checkbox_change, names='value')
        self.hs['L[0][x][3][0][4][3][0][3]_ana_config_find_edge_checkbox'].observe(self.L0_x_3_0_4_3_0_3_ana_config_find_edge_checkbox_change, names='value')
        self.hs['L[0][x][3][0][4][3][0][3]_ana_config_cal_edge0.5_direct_checkbox'].observe(self.L0_x_3_0_4_3_0_3_ana_config_cal_edge0p5_direct_checkbox_change, names='value')
        self.hs['L[0][x][3][0][4][3][0][1]_ana_config_edge_jump_thres_slider'].observe(self.L0_x_3_0_4_3_0_1_ana_config_edge_jump_thres_slider_change, names='value')
        self.hs['L[0][x][3][0][4][3][0][2]_ana_config_edge_offset_thres_slider'].observe(self.L0_x_3_0_4_3_0_2_ana_config_edge_offset_thres_slider, names='value')
        self.hs['L[0][x][3][0][4][3]_ana_config_box'].children = \
            get_handles(self.hs, 'L[0][x][3][0][4][3]_ana_config_box', -1)
        ## ## ## ## ## ## define analysis options parameters -- end
        
        ## ## ## ## ## ## define wl fitting parameters -- start
        layout = {'border':'3px solid #FFCC00', 'width':f'{0.96*self.form_sz[1]-98}px', 'height':f'{0.49*(self.form_sz[0]-128)}px'}
        self.hs['L[0][x][3][0][4][0]_ana_fit_wl_param_box'] = widgets.HBox()
        self.hs['L[0][x][3][0][4][0]_ana_fit_wl_param_box'].layout = layout
        
        self.hs['L[0][x][3][0][4][0][0]_ana_wl'] = widgets.GridspecLayout(8, 200,
                                                                        layout = {"border":"3px solid #FFCC00",
                                                                                  'width':f'{0.96*self.form_sz[1]-98}px',
                                                                                  "height":f"{0.48*(self.form_sz[0]-128)}px",
                                                                                  "align_items":"flex-start",
        ...
        self.hs['L[0][x][3][0][4][0][0]_ana_wl'][0, :50] = widgets.Dropdown(description='optimizer',
                                                                                         ...
                                                                                         layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                         disabled=True)
        self.hs['L[0][x][3][0][4][0][0][0]_ana_wl_optimizer'] = self.hs['L[0][x][3][0][4][0][0]_ana_wl'][0, :50]
        self.hs['L[0][x][3][0][4][0][0]_ana_wl'][0, 50:100] = widgets.Dropdown(description='peak func',
                                                                                            description_tooltip='peak fitting functions',
                                                                                            options = PEAK_LINE_SHAPES,
                                                                                            value ='lorentzian',
                                                                                            layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                            disabled=True)
        self.hs['L[0][x][3][0][4][0][0][1]_ana_wl_fit_func'] = self.hs['L[0][x][3][0][4][0][0]_ana_wl'][0, 50:100]
        self.hs['L[0][x][3][0][4][0][0]_ana_wl'][0, 100:150] = widgets.Checkbox(description='para bnd',
                                                                                             value = False,
                                                                                             description_tooltip = "if set boundaries to the peak fitting function's parameters",
                                                                                             layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                             disabled=True)
        self.hs['L[0][x][3][0][4][0][0][2]_ana_wl_fit_use_bnd'] = self.hs['L[0][x][3][0][4][0][0]_ana_wl'][0, 100:150]
        
        self.hs['L[0][x][3][0][4][0][0]_ana_wl'][1, 0:50] = widgets.BoundedFloatText(description = 'p0',
                                                                                           value = 0,
                                                                                           min = -1e5,
                                                                                           max = 1e5,
                                                                                           ...
                                                                                           layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                           disabled=True)
        self.hs['L[0][x][3][0][4][0][0][3]_ana_wl_p0'] = self.hs['L[0][x][3][0][4][0][0]_ana_wl'][1, 0:50]
        self.hs['L[0][x][3][0][4][0][0]_ana_wl'][1, 50:100] = widgets.BoundedFloatText(description = 'p1',
                                                                                             value = 0,
                                                                                             min = -1e5,
                                                                                             max = 1e5,
                                                                                             ...
                                                                                             layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                             disabled=True)
        self.hs['L[0][x][3][0][4][0][0][4]_ana_wl_p1'] = self.hs['L[0][x][3][0][4][0][0]_ana_wl'][1, 50:100]
        self.hs['L[0][x][3][0][4][0][0]_ana_wl'][1, 100:150] = widgets.BoundedFloatText(description = 'p2',
                                                                                              value = 0,
                                                                                              min = -1e5,
                                                                                              max = 1e5,
                                                                                              ...
                                                                                              layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                              disabled=True)
        self.hs['L[0][x][3][0][4][0][0][5]_ana_wl_p2'] = self.hs['L[0][x][3][0][4][0][0]_ana_wl'][1, 100:150]
        self.hs['L[0][x][3][0][4][0][0]_ana_wl'][1, 150:200] = widgets.BoundedFloatText(description = 'p3',
                                                                                              value = 0,
                                                                                              min = -1e5,
                                                                                              max = 1e5,
                                                                                              ...
                                                                                              layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                              disabled=True)
        self.hs['L[0][x][3][0][4][0][0][6]_ana_wl_p3'] = self.hs['L[0][x][3][0][4][0][0]_ana_wl'][1, 150:200]
        
        self.hs['L[0][x][3][0][4][0][0]_ana_wl'][2, 0:50] = widgets.BoundedFloatText(description = 'p4',
                                                                                           value = 0,
                                                                                           min = -1e5,
                                                                                           max = 1e5,
                                                                                           ...
                                                                                           layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                           disabled=True)
        self.hs['L[0][x][3][0][4][0][0][7]_ana_wl_p4'] = self.hs['L[0][x][3][0][4][0][0]_ana_wl'][2, 0:50]
        self.hs['L[0][x][3][0][4][0][0]_ana_wl'][2, 50:100] = widgets.Dropdown(description = 'p5',
                                                                                            value = 'linear',
                                                                                            options = ['linear'],
                                                                                            description_tooltip = "fitting function variable 5",
                                                                                            layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                            disabled=True)
        self.hs['L[0][x][3][0][4][0][0][8]_ana_wl_p5'] = self.hs['L[0][x][3][0][4][0][0]_ana_wl'][2, 50:100]
        
        self.hs['L[0][x][3][0][4][0][0]_ana_wl'][3, 0:50] = widgets.Dropdown(description = 'jac',
                                                                                          value = '3-point',
                                                                                          options = ['2-point', '3-point', 'cs'],
                                                                                          description_tooltip = "",
                                                                                          layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                          disabled=True)
        self.hs['L[0][x][3][0][4][0][0][9]_ana_wl_jac'] = self.hs['L[0][x][3][0][4][0][0]_ana_wl'][3, 0:50]
        self.hs['L[0][x][3][0][4][0][0]_ana_wl'][3, 50:100] = widgets.Dropdown(description = 'method',
                                                                                            value = 'trf',
                                                                                            options = ['trf', 'dogbox', 'lm'],
                                                                                            description_tooltip = "",
                                                                                            layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                            disabled=True)
        self.hs['L[0][x][3][0][4][0][0][10]_ana_wl_method'] = self.hs['L[0][x][3][0][4][0][0]_ana_wl'][3, 50:100]
        self.hs['L[0][x][3][0][4][0][0]_ana_wl'][3, 100:150] = widgets.BoundedFloatText(description = 'ftol',
                                                                                              value = 1e-7,
                                                                                              min = 0,
                                                                                              max = 1e-3,
                                                                                              ...
                                                                                              layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                              disabled=True)
        self.hs['L[0][x][3][0][4][0][0][11]_ana_wl_ftol'] = self.hs['L[0][x][3][0][4][0][0]_ana_wl'][3, 100:150]
        self.hs['L[0][x][3][0][4][0][0]_ana_wl'][3, 150:200] = widgets.BoundedFloatText(description = 'xtol',
                                                                                              value = 1e-7,
                                                                                              min = 0,
                                                                                              max = 1e-3,
                                                                                              ...
                                                                                              layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                              disabled=True)
        self.hs['L[0][x][3][0][4][0][0][12]_ana_wl_xtol'] = self.hs['L[0][x][3][0][4][0][0]_ana_wl'][3, 150:200]
        self.hs['L[0][x][3][0][4][0][0]_ana_wl'][4, 0:50] = widgets.BoundedFloatText(description = 'gtol',
                                                                                           value = 1e-7,
                                                                                           min = 0,
                                                                                           max = 1e-3,
                                                                                           ...
                                                                                           layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                           disabled=True)
        self.hs['L[0][x][3][0][4][0][0][13]_ana_wl_gtol'] = self.hs['L[0][x][3][0][4][0][0]_ana_wl'][4, 0:50]
        self.hs['L[0][x][3][0][4][0][0]_ana_wl'][4, 50:100] = widgets.BoundedIntText(description = 'ufac',
                                                                                           value = 50,
                                                                                           min = 1,
                                                                                           max = 100,
                                                                                           ...
                                                                                           layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                           disabled=True)
        self.hs['L[0][x][3][0][4][0][0][14]_ana_wl_ufac'] = self.hs['L[0][x][3][0][4][0][0]_ana_wl'][4, 50:100]
        
        self.hs['L[0][x][3][0][4][0][0]_ana_wl'][5, 0:50] = widgets.BoundedFloatText(description = 'p0 lb',
                                                                                           value = 0,
                                                                                           min = -1e5,
                                                                                           max = 1e5,
                                                                                           ...
                                                                                           layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                           disabled=True)
        self.hs['L[0][x][3][0][4][0][0][15]_ana_wl_p0_lb'] = self.hs['L[0][x][3][0][4][0][0]_ana_wl'][5, 0:50]
        self.hs['L[0][x][3][0][4][0][0]_ana_wl'][5, 50:100] = widgets.BoundedFloatText(description = 'p0 ub',
                                                                                             value = 0,
                                                                                             min = -1e5,
                                                                                             max = 1e5,
                                                                                             ...
                                                                                             layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                             disabled=True)
        self.hs['L[0][x][3][0][4][0][0][16]_ana_wl_p0_ub'] = self.hs['L[0][x][3][0][4][0][0]_ana_wl'][5, 50:100]
        self.hs['L[0][x][3][0][4][0][0]_ana_wl'][5, 100:150] = widgets.BoundedFloatText(description = 'p1 lb',
                                                                                              value = 0,
                                                                                              min = -1e5,
                                                                                              max = 1e5,
                                                                                              ...
                                                                                              layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                              disabled=True)
        self.hs['L[0][x][3][0][4][0][0][17]_ana_wl_p1_lb'] = self.hs['L[0][x][3][0][4][0][0]_ana_wl'][5, 100:150]
        self.hs['L[0][x][3][0][4][0][0]_ana_wl'][5, 150:200] = widgets.BoundedFloatText(description = 'p1 ub',
                                                                                              value = 0,
                                                                                              min = -1e5,
                                                                                              max = 1e5,
                                                                                              ...
                                                                                              layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                              disabled=True)
        self.hs['L[0][x][3][0][4][0][0][18]_ana_wl_p1_ub'] = self.hs['L[0][x][3][0][4][0][0]_ana_wl'][5, 150:200]
        
        self.hs['L[0][x][3][0][4][0][0]_ana_wl'][6, 0:50] = widgets.BoundedFloatText(description = 'p2 lb',
                                                                                           value = 0,
                                                                                           min = -1e5,
                                                                                           max = 1e5,
                                                                                           ...
                                                                                           layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                           disabled=True)
        self.hs['L[0][x][3][0][4][0][0][19]_ana_wl_p2_lb'] = self.hs['L[0][x][3][0][4][0][0]_ana_wl'][6, 0:50]
        self.hs['L[0][x][3][0][4][0][0]_ana_wl'][6, 50:100] = widgets.BoundedFloatText(description = 'p3 ub',
                                                                                             value = 0,
                                                                                             min = -1e5,
                                                                                             max = 1e5,
                                                                                             ...
                                                                                             layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                             disabled=True)
        self.hs['L[0][x][3][0][4][0][0][20]_ana_wl_p2_ub'] = self.hs['L[0][x][3][0][4][0][0]_ana_wl'][6, 50:100]
        self.hs['L[0][x][3][0][4][0][0]_ana_wl'][6, 100:150] = widgets.BoundedFloatText(description = 'p4 lb',
                                                                                              value = 0,
                                                                                              min = -1e5,
                                                                                              max = 1e5,
                                                                                              ...
                                                                                              layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                              disabled=True)
        self.hs['L[0][x][3][0][4][0][0][21]_ana_wl_p3_lb'] = self.hs['L[0][x][3][0][4][0][0]_ana_wl'][6, 100:150]
        self.hs['L[0][x][3][0][4][0][0]_ana_wl'][6, 150:200] = widgets.BoundedFloatText(description = 'p4 ub',
                                                                                             value = 0,
                                                                                             min = -1e5,
                                                                                             max = 1e5,
                                                                                             ...
                                                                                             layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                             disabled=True)
        self.hs['L[0][x][3][0][4][0][0][22]_ana_wl_p3_ub'] = self.hs['L[0][x][3][0][4][0][0]_ana_wl'][6, 150:200]
        
        self.hs['L[0][x][3][0][4][0][0]_ana_wl'][7, 0:50] = widgets.BoundedFloatText(description = 'p5 lb',
                                                                                           value = 0,
                                                                                           min = -1e5,
                                                                                           max = 1e5,
                                                                                           ...
                                                                                           layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                           disabled=True)
        self.hs['L[0][x][3][0][4][0][0][23]_ana_wl_p4_lb'] = self.hs['L[0][x][3][0][4][0][0]_ana_wl'][7, 0:50]
        self.hs['L[0][x][3][0][4][0][0]_ana_wl'][7, 50:100] = widgets.BoundedFloatText(description = 'p5 ub',
                                                                                             value = 0,
                                                                                             min = -1e5,
                                                                                             max = 1e5,
                                                                                             ...
                                                                                             layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                             disabled=True)
        self.hs['L[0][x][3][0][4][0][0][24]_ana_wl_p4_ub'] = self.hs['L[0][x][3][0][4][0][0]_ana_wl'][7, 50:100]
        
        self.hs['L[0][x][3][0][4][0][0][0]_ana_wl_optimizer'].observe(self.L0_x_3_0_4_0_0_0_ana_wl_optimizer, names='value')
        self.hs['L[0][x][3][0][4][0][0][1]_ana_wl_fit_func'].observe(self.L0_x_3_0_4_0_0_1_ana_wl_fit_func, names='value')
        self.hs['L[0][x][3][0][4][0][0][2]_ana_wl_fit_use_bnd'].observe(self.L0_x_3_0_4_0_0_2_ana_wl_fit_bnd, names='value')
        
        self.hs['L[0][x][3][0][4][0]_ana_fit_wl_param_box'].children = get_handles(self.hs, 'L[0][x][3][0][4][0]_ana_fit_wl_param_box', -1)
        ## ## ## ## ## ## define wl fitting parameters -- end
        
        ## ## ## ## ## ## define edge fitting parameters -- start
        layout = {'border':'3px solid #FFCC00', 'width':f'{0.96*self.form_sz[1]-98}px', 'height':f'{0.49*(self.form_sz[0]-128)}px'}
        self.hs['L[0][x][3][0][4][2]_ana_fit_edge_param_box'] = widgets.HBox()
        self.hs['L[0][x][3][0][4][2]_ana_fit_edge_param_box'].layout = layout
        
        self.hs['L[0][x][3][0][4][2][0]_ana_edge'] = widgets.GridspecLayout(8, 200,
                                                                            layout = {"border":"3px solid #FFCC00",
                                                                                      'width':f'{0.96*self.form_sz[1]-98}px',
                                                                                      "height":f"{0.48*(self.form_sz[0]-128)}px",
                                                                                      "align_items":"flex-start",
        ...
        # self.hs['L[0][x][3][0][4][2][0]_ana_edge'][0, 0:50] = widgets.Checkbox(description='refine edge',
        ...
        #                                                                        layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
        #                                                                        disabled=True)
        # self.hs['L[0][x][3][0][4][2][0][3]_ana_edge_refine'] = self.hs['L[0][x][3][0][4][2][0]_ana_edge'][0, :50]
        self.hs['L[0][x][3][0][4][2][0]_ana_edge'][0, 0:50] = widgets.Dropdown(description='optimizer',
                                                                            description_tooltip='use scipy.optimize or numpy.polyfit',
                                                                            options = ['scipy', 
                                                                                       'numpy'],
                                                                            value ='scipy',
                                                                            layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                            disabled=True)
        self.hs['L[0][x][3][0][4][2][0][0]_ana_edge_optimizer'] = self.hs['L[0][x][3][0][4][2][0]_ana_edge'][0, 0:50]
        self.hs['L[0][x][3][0][4][2][0]_ana_edge'][0, 50:100] = widgets.Dropdown(description='peak func',
                                                                                description_tooltip='peak fitting functions',
                                                                                options = EDGE_LINE_SHAPES,
                                                                                value ='lorentzian',
                                                                                layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                disabled=True)
        self.hs['L[0][x][3][0][4][2][0][1]_ana_edge_fit_func'] = self.hs['L[0][x][3][0][4][2][0]_ana_edge'][0, 50:100]
        self.hs['L[0][x][3][0][4][2][0]_ana_edge'][0, 100:150] = widgets.Checkbox(description='para bnd',
                                                                                value = False,
                                                                                description_tooltip = "if set boundaries to the peak fitting function's parameters",
                                                                                layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                disabled=True)
        self.hs['L[0][x][3][0][4][2][0][2]_ana_edge_fit_use_bnd'] = self.hs['L[0][x][3][0][4][2][0]_ana_edge'][0, 100:150]
        
        self.hs['L[0][x][3][0][4][2][0]_ana_edge'][1, 0:50] = widgets.BoundedFloatText(description = 'p0',
                                                                                    value = 0,
                                                                                    min = -1e5,
                                                                                    max = 1e5,
                                                                                    description_tooltip = "fitting function variable 0",
                                                                                    layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                    disabled=True)
        self.hs['L[0][x][3][0][4][2][0][3]_ana_edge_p0'] = self.hs['L[0][x][3][0][4][2][0]_ana_edge'][1, 0:50]
        self.hs['L[0][x][3][0][4][2][0]_ana_edge'][1, 50:100] = widgets.BoundedFloatText(description = 'p1',
                                                                                        value = 0,
                                                                                        min = -1e5,
                                                                                        max = 1e5,
                                                                                        description_tooltip = "fitting function variable 1",
                                                                                        layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                        disabled=True)
        self.hs['L[0][x][3][0][4][2][0][4]_ana_edge_p1'] = self.hs['L[0][x][3][0][4][2][0]_ana_edge'][1, 50:100]
        self.hs['L[0][x][3][0][4][2][0]_ana_edge'][1, 100:150] = widgets.BoundedFloatText(description = 'p2',
                                                                                        value = 0,
                                                                                        min = -1e5,
                                                                                        max = 1e5,
                                                                                        description_tooltip = "fitting function variable 2",
                                                                                        layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                        disabled=True)
        self.hs['L[0][x][3][0][4][2][0][5]_ana_edge_p2'] = self.hs['L[0][x][3][0][4][2][0]_ana_edge'][1, 100:150]
        self.hs['L[0][x][3][0][4][2][0]_ana_edge'][1, 150:200] = widgets.BoundedFloatText(description = 'p3',
                                                                                        value = 0,
                                                                                        min = -1e5,
                                                                                        max = 1e5,
                                                                                        description_tooltip = "fitting function variable 3",
                                                                                        layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                        disabled=True)
        self.hs['L[0][x][3][0][4][2][0][6]_ana_edge_p3'] = self.hs['L[0][x][3][0][4][2][0]_ana_edge'][1, 150:200]
        
        self.hs['L[0][x][3][0][4][2][0]_ana_edge'][2, 0:50] = widgets.BoundedFloatText(description = 'p4',
                                                                                    value = 0,
                                                                                    min = -1e5,
                                                                                    max = 1e5,
                                                                                    description_tooltip = "fitting function variable 4",
                                                                                    layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                    disabled=True)
        self.hs['L[0][x][3][0][4][2][0][7]_ana_edge_p4'] = self.hs['L[0][x][3][0][4][2][0]_ana_edge'][2, 0:50]
        self.hs['L[0][x][3][0][4][2][0]_ana_edge'][2, 50:100] = widgets.Dropdown(description = 'p5',
                                                                                value = 'linear',
                                                                                options = ['linear'],
                                                                                description_tooltip = "fitting function variable 5",
                                                                                layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                disabled=True)
        self.hs['L[0][x][3][0][4][2][0][8]_ana_edge_p5'] = self.hs['L[0][x][3][0][4][2][0]_ana_edge'][2, 50:100]
        
        self.hs['L[0][x][3][0][4][2][0]_ana_edge'][3, 0:50] = widgets.Dropdown(description = 'jac',
                                                                            value = '3-point',
                                                                            options = ['2-point', '3-point', 'cs'],
                                                                            description_tooltip = "",
                                                                            layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                            disabled=True)
        self.hs['L[0][x][3][0][4][2][0][9]_ana_edge_jac'] = self.hs['L[0][x][3][0][4][2][0]_ana_edge'][3, 0:50]
        self.hs['L[0][x][3][0][4][2][0]_ana_edge'][3, 50:100] = widgets.Dropdown(description = 'method',
                                                                                value = 'trf',
                                                                                options = ['trf', 'dogbox', 'lm'],
                                                                                description_tooltip = "",
                                                                                layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                disabled=True)
        self.hs['L[0][x][3][0][4][2][0][10]_ana_edge_method'] = self.hs['L[0][x][3][0][4][2][0]_ana_edge'][3, 50:100]
        self.hs['L[0][x][3][0][4][2][0]_ana_edge'][3, 100:150] = widgets.BoundedFloatText(description = 'ftol',
                                                                                        value = 1e-7,
                                                                                        min = 0,
                                                                                        max = 1e-3,
                                                                                        description_tooltip = "function value change tolerance for terminating the optimization process",
                                                                                        layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                        disabled=True)
        self.hs['L[0][x][3][0][4][2][0][11]_ana_edge_ftol'] = self.hs['L[0][x][3][0][4][2][0]_ana_edge'][3, 100:150]
        self.hs['L[0][x][3][0][4][2][0]_ana_edge'][3, 150:200] = widgets.BoundedFloatText(description = 'xtol',
                                                                                        value = 1e-7,
                                                                                        min = 0,
                                                                                        max = 1e-3,
                                                                                        description_tooltip = "function parameter change tolerance for terminating the optimization process",
                                                                                        layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                        disabled=True)
        self.hs['L[0][x][3][0][4][2][0][12]_ana_edge_xtol'] = self.hs['L[0][x][3][0][4][2][0]_ana_edge'][3, 150:200]
        self.hs['L[0][x][3][0][4][2][0]_ana_edge'][4, 0:50] = widgets.BoundedFloatText(description = 'gtol',
                                                                                    value = 1e-7,
                                                                                    min = 0,
                                                                                    max = 1e-3,
                                                                                    description_tooltip = "function gradient change tolerance for terminating the optimization process",
                                                                                    layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                    disabled=True)
        self.hs['L[0][x][3][0][4][2][0][13]_ana_edge_gtol'] = self.hs['L[0][x][3][0][4][2][0]_ana_edge'][4, 0:50]
        self.hs['L[0][x][3][0][4][2][0]_ana_edge'][4, 50:100] = widgets.BoundedIntText(description = 'ufac',
                                                                                    value = 50,
                                                                                    min = 1,
                                                                                    max = 100,
                                                                                    description_tooltip = "upsampling factor to energy points in peak fitting",
                                                                                    layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                    disabled=True)
        self.hs['L[0][x][3][0][4][2][0][14]_ana_edge_ufac'] = self.hs['L[0][x][3][0][4][2][0]_ana_edge'][4, 50:100]
        
        self.hs['L[0][x][3][0][4][2][0]_ana_edge'][5, 0:50] = widgets.BoundedFloatText(description = 'p0 lb',
                                                                                    value = 0,
                                                                                    min = -1e5,
                                                                                    max = 1e5,
                                                                                    description_tooltip = "p0 lower bound",
                                                                                    layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                    disabled=True)
        self.hs['L[0][x][3][0][4][2][0][15]_ana_edge_p0_lb'] = self.hs['L[0][x][3][0][4][2][0]_ana_edge'][5, 0:50]
        self.hs['L[0][x][3][0][4][2][0]_ana_edge'][5, 50:100] = widgets.BoundedFloatText(description = 'p0 ub',
                                                                                        value = 0,
                                                                                        min = -1e5,
                                                                                        max = 1e5,
                                                                                        description_tooltip = "p0 upper bound",
                                                                                        layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                        disabled=True)
        self.hs['L[0][x][3][0][4][2][0][16]_ana_edge_p0_ub'] = self.hs['L[0][x][3][0][4][2][0]_ana_edge'][5, 50:100]
        self.hs['L[0][x][3][0][4][2][0]_ana_edge'][5, 100:150] = widgets.BoundedFloatText(description = 'p1 lb',
                                                                                        value = 0,
                                                                                        min = -1e5,
                                                                                        max = 1e5,
                                                                                        description_tooltip = "p1 lower bound",
                                                                                        layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                        disabled=True)
        self.hs['L[0][x][3][0][4][2][0][17]_ana_edge_p1_lb'] = self.hs['L[0][x][3][0][4][2][0]_ana_edge'][5, 100:150]
        self.hs['L[0][x][3][0][4][2][0]_ana_edge'][5, 150:200] = widgets.BoundedFloatText(description = 'p1 ub',
                                                                                        value = 0,
                                                                                        min = -1e5,
                                                                                        max = 1e5,
                                                                                        description_tooltip = "p1 upper bound",
                                                                                        layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                        disabled=True)
        self.hs['L[0][x][3][0][4][2][0][18]_ana_edge_p1_ub'] = self.hs['L[0][x][3][0][4][2][0]_ana_edge'][5, 150:200]
        
        self.hs['L[0][x][3][0][4][2][0]_ana_edge'][6, 0:50] = widgets.BoundedFloatText(description = 'p2 lb',
                                                                                    value = 0,
                                                                                    min = -1e5,
                                                                                    max = 1e5,
                                                                                    description_tooltip = "p2 lower bound",
                                                                                    layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                    disabled=True)
        self.hs['L[0][x][3][0][4][2][0][19]_ana_edge_p2_lb'] = self.hs['L[0][x][3][0][4][2][0]_ana_edge'][6, 0:50]
        self.hs['L[0][x][3][0][4][2][0]_ana_edge'][6, 50:100] = widgets.BoundedFloatText(description = 'p3 ub',
                                                                                        value = 0,
                                                                                        min = -1e5,
                                                                                        max = 1e5,
                                                                                        description_tooltip = "p3 upper bound",
                                                                                        layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                        disabled=True)
        self.hs['L[0][x][3][0][4][2][0][20]_ana_edge_p2_ub'] = self.hs['L[0][x][3][0][4][2][0]_ana_edge'][6, 50:100]
        self.hs['L[0][x][3][0][4][2][0]_ana_edge'][6, 100:150] = widgets.BoundedFloatText(description = 'p4 lb',
                                                                                        value = 0,
                                                                                        min = -1e5,
                                                                                        max = 1e5,
                                                                                        description_tooltip = "p4 lower bound",
                                                                                        layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                        disabled=True)
        self.hs['L[0][x][3][0][4][2][0][21]_ana_edge_p3_lb'] = self.hs['L[0][x][3][0][4][2][0]_ana_edge'][6, 100:150]
        self.hs['L[0][x][3][0][4][2][0]_ana_edge'][6, 150:200] = widgets.BoundedFloatText(description = 'p4 ub',
                                                                                        value = 0,
                                                                                        min = -1e5,
                                                                                        max = 1e5,
                                                                                        description_tooltip = "p4 upper bound",
                                                                                        layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                        disabled=True)
        self.hs['L[0][x][3][0][4][2][0][22]_ana_edge_p3_ub'] = self.hs['L[0][x][3][0][4][2][0]_ana_edge'][6, 150:200]
        
        self.hs['L[0][x][3][0][4][2][0]_ana_edge'][7, 0:50] = widgets.BoundedFloatText(description = 'p5 lb',
                                                                                    value = 0,
                                                                                    min = -1e5,
                                                                                    max = 1e5,
                                                                                    description_tooltip = "p5 lower bound",
                                                                                    layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                    disabled=True)
        self.hs['L[0][x][3][0][4][2][0][23]_ana_edge_p4_lb'] = self.hs['L[0][x][3][0][4][2][0]_ana_edge'][7, 0:50]
        self.hs['L[0][x][3][0][4][2][0]_ana_edge'][7, 50:100] = widgets.BoundedFloatText(description = 'p5 ub',
                                                                                        value = 0,
                                                                                        min = -1e5,
                                                                                        max = 1e5,
                                                                                        description_tooltip = "p5 upper bound",
                                                                                        layout = {'width':f'{0.3*self.form_sz[1]-98}px'},
                                                                                        disabled=True)
        self.hs['L[0][x][3][0][4][2][0][24]_ana_edge_p4_ub'] = self.hs['L[0][x][3][0][4][2][0]_ana_edge'][7, 50:100]
        
        # self.hs['L[0][x][3][0][4][2][0][3]_ana_edge_refine'].observe(self.L0_x_3_0_4_2_0_3_ana_edge_refine, names='value')
        self.hs['L[0][x][3][0][4][2][0][0]_ana_edge_optimizer'].observe(self.L0_x_3_0_4_2_0_0_ana_edge_optimizer, names='value')
        self.hs['L[0][x][3][0][4][2][0][1]_ana_edge_fit_func'].observe(self.L0_x_3_0_4_2_0_1_ana_edge_fit_func, names='value')
        self.hs['L[0][x][3][0][4][2][0][2]_ana_edge_fit_use_bnd'].observe(self.L0_x_3_0_4_2_0_2_ana_edge_fit_use_bnd, names='value')
        
        self.hs['L[0][x][3][0][4][2]_ana_fit_edge_param_box'].children = get_handles(self.hs, 'L[0][x][3][0][4][2]_ana_fit_edge_param_box', -1)
        ## ## ## ## ## ## define edge fitting parameters -- end
        
        ## ## ## ## ## ## define saving setting -- start
        layout = {'border':'3px solid #FFCC00', 'width':f'{0.96*self.form_sz[1]-98}px', 'height':f'{0.49*(self.form_sz[0]-128)}px'}
        self.hs['L[0][x][3][0][4][1]_ana_save_setting_box'] = widgets.HBox()
        self.hs['L[0][x][3][0][4][1]_ana_save_setting_box'].layout = layout
        self.hs['L[0][x][3][0][4][1][0]_ana_save_setting_gridlayout'] = \
            widgets.GridspecLayout(8, 200,
                                   layout = {"border":"3px solid #FFCC00",
                                             ...
                                             "align_items":"flex-start",
                                             "justify_items":"flex-start"})
        self.hs['L[0][x][3][0][4][1][0]_ana_save_setting_gridlayout'][0:6, 0:100] = \
            widgets.SelectMultiple(options=FULL_SAVE_ITEM_OPTIONS,
                                   ...
                                   disabled=True)
        self.hs['L[0][x][3][0][4][1][0][0]_ana_save_setting_multiselection'] = \
            self.hs['L[0][x][3][0][4][1][0]_ana_save_setting_gridlayout'][0:6, 0:100]

        self.hs['L[0][x][3][0][4][1][0]_ana_save_setting_gridlayout'][0:6, 100:200] = \
            widgets.SelectMultiple(options=FULL_SAVE_DEFAULT,
                                   ...
                                   disabled=True)
        self.hs['L[0][x][3][0][4][1][0][1]_ana_save_setting_selection_text'] = \
            self.hs['L[0][x][3][0][4][1][0]_ana_save_setting_gridlayout'][0:6, 100:200]
            
        self.hs['L[0][x][3][0][4][1][0]_ana_save_setting_gridlayout'][7:8, 40:60] = \
            widgets.Button(description = '==>',
                           description_tooltip = 'Select saving items',
                           disabled = True)
        self.hs['L[0][x][3][0][4][1][0][2]_ana_save_setting_add_button'] = \
            self.hs['L[0][x][3][0][4][1][0]_ana_save_setting_gridlayout'][7:8, 40:60]
        self.hs['L[0][x][3][0][4][1][0][2]_ana_save_setting_add_button'].style.button_color = \
            'darkviolet'
        self.hs['L[0][x][3][0][4][1][0]_ana_save_setting_gridlayout'][7:8, 140:160] = \
            widgets.Button(description = '<==',
                           description_tooltip = 'Remove saving items',
                           disabled = True)
        self.hs['L[0][x][3][0][4][1][0][3]_ana_save_setting_remove_button'] = \
            self.hs['L[0][x][3][0][4][1][0]_ana_save_setting_gridlayout'][7:8, 140:160]
        self.hs['L[0][x][3][0][4][1][0][3]_ana_save_setting_remove_button'].style.button_color = \
            'darkviolet'
        self.hs['L[0][x][3][0][4][1][0][2]_ana_save_setting_add_button'].on_click(self.L0_x_3_0_4_1_0_2_ana_save_setting_add_button_click)
        self.hs['L[0][x][3][0][4][1][0][3]_ana_save_setting_remove_button'].on_click(self.L0_x_3_0_4_1_0_3_ana_save_setting_remove_button_click)
        self.hs['L[0][x][3][0][4][1]_ana_save_setting_box'].children = \
            get_handles(self.hs, 'L[0][x][3][0][4][1]_ana_save_setting_box', -1)
        ## ## ## ## ## ## define saving setting -- end
        
        self.hs['L[0][x][3][0][4]_analysis_tool_box'].children = [self.hs['L[0][x][3][0][4][3]_ana_config_box'],
                                                                  self.hs['L[0][x][3][0][4][0]_ana_fit_wl_param_box'],
                                                                  self.hs['L[0][x][3][0][4][2]_ana_fit_edge_param_box'],
                                                                  self.hs['L[0][x][3][0][4][1]_ana_save_setting_box']]
        ...
        layout = {'border':'3px solid #FFCC00', 'width':f'{1*self.form_sz[1]-98}px', 'height':f'{0.07*(self.form_sz[0]-128)}px'}
        self.hs['L[0][x][3][0][5]_ana_run_box'] = widgets.HBox()
        self.hs['L[0][x][3][0][5]_ana_run_box'].layout = layout
        layout = {'width':'85%', 'height':'90%'}
        self.hs['L[0][x][3][0][5][0]_ana_run_text'] = widgets.Text(description='please check your settings before run the analysis .. ',
                                                                        disabled=True)
        self.hs['L[0][x][3][0][5][0]_ana_run_text'].layout = layout
        layout = {'width':'15%', 'height':'90%'}
        self.hs['L[0][x][3][0][5][1]_ana_run_button'] = widgets.Button(description='run',
                                                                            disabled=True)
        self.hs['L[0][x][3][0][5][1]_ana_run_button'].layout = layout
        self.hs['L[0][x][3][0][5][1]_ana_run_button'].style.button_color = 'darkviolet'
        self.hs['L[0][x][3][0][5]_ana_run_box'].children = get_handles(self.hs, 'L[0][x][3][0][5]_ana_run_box', -1)
        self.hs['L[0][x][3][0][5][1]_ana_run_button'].on_click(self.L0_x_3_0_5_1_ana_run_button)
        ...
        self.hs['L[0][x][3][0][6][0]_ana_run_progress_bar'] = widgets.IntProgress(value=0,
                                                                                       min=0,
                                                                                       max=10,
                                                                                       step=1,
        ...
        self.hs['L[0][x][3][0][6][0]_ana_run_progress_bar'].layout = layout
        ...
        self.bundle_ana_var_handles()
        
    def bundle_ana_var_handles(self):
        self.ana_wl_fit_func_arg_handles = [self.hs['L[0][x][3][0][4][0][0][3]_ana_wl_p0'],
                                              self.hs['L[0][x][3][0][4][0][0][4]_ana_wl_p1'],
                                              self.hs['L[0][x][3][0][4][0][0][5]_ana_wl_p2'],
                                              self.hs['L[0][x][3][0][4][0][0][6]_ana_wl_p3'],
                                              self.hs['L[0][x][3][0][4][0][0][7]_ana_wl_p4'],
                                              self.hs['L[0][x][3][0][4][0][0][8]_ana_wl_p5']]
        
        self.ana_wl_optimizer_arg_handles = [self.hs['L[0][x][3][0][4][0][0][9]_ana_wl_jac'],
                                               self.hs['L[0][x][3][0][4][0][0][10]_ana_wl_method'],
                                               self.hs['L[0][x][3][0][4][0][0][11]_ana_wl_ftol'],
                                               self.hs['L[0][x][3][0][4][0][0][12]_ana_wl_xtol'],
                                               self.hs['L[0][x][3][0][4][0][0][13]_ana_wl_gtol'],
                                               self.hs['L[0][x][3][0][4][0][0][14]_ana_wl_ufac']]
        
        self.ana_wl_fit_func_bnd_handles = [self.hs['L[0][x][3][0][4][0][0][15]_ana_wl_p0_lb'],
                                              self.hs['L[0][x][3][0][4][0][0][16]_ana_wl_p0_ub'],
                                              self.hs['L[0][x][3][0][4][0][0][17]_ana_wl_p1_lb'],
                                              self.hs['L[0][x][3][0][4][0][0][18]_ana_wl_p1_ub'],
                                              self.hs['L[0][x][3][0][4][0][0][19]_ana_wl_p2_lb'],
                                              self.hs['L[0][x][3][0][4][0][0][20]_ana_wl_p2_ub'],
                                              self.hs['L[0][x][3][0][4][0][0][21]_ana_wl_p3_lb'],
                                              self.hs['L[0][x][3][0][4][0][0][22]_ana_wl_p3_ub'],
                                              self.hs['L[0][x][3][0][4][0][0][23]_ana_wl_p4_lb'],
                                              self.hs['L[0][x][3][0][4][0][0][24]_ana_wl_p4_ub']]
        
        self.ana_edge_fit_func_arg_handles = [self.hs['L[0][x][3][0][4][2][0][3]_ana_edge_p0'],
                                              self.hs['L[0][x][3][0][4][2][0][4]_ana_edge_p1'],
                                              self.hs['L[0][x][3][0][4][2][0][5]_ana_edge_p2'],
                                              self.hs['L[0][x][3][0][4][2][0][6]_ana_edge_p3'],
                                              self.hs['L[0][x][3][0][4][2][0][7]_ana_edge_p4'],
                                              self.hs['L[0][x][3][0][4][2][0][8]_ana_edge_p5']]
        
        self.ana_edge_optimizer_arg_handles = [self.hs['L[0][x][3][0][4][2][0][9]_ana_edge_jac'],
                                               self.hs['L[0][x][3][0][4][2][0][10]_ana_edge_method'],
                                               self.hs['L[0][x][3][0][4][2][0][11]_ana_edge_ftol'],
                                               self.hs['L[0][x][3][0][4][2][0][12]_ana_edge_xtol'],
                                               self.hs['L[0][x][3][0][4][2][0][13]_ana_edge_gtol'],
                                               self.hs['L[0][x][3][0][4][2][0][14]_ana_edge_ufac']]
        
        self.ana_edge_fit_func_bnd_handles = [self.hs['L[0][x][3][0][4][2][0][15]_ana_edge_p0_lb'],
                                              self.hs['L[0][x][3][0][4][2][0][16]_ana_edge_p0_ub'],
                                              self.hs['L[0][x][3][0][4][2][0][17]_ana_edge_p1_lb'],
                                              self.hs['L[0][x][3][0][4][2][0][18]_ana_edge_p1_ub'],
                                              self.hs['L[0][x][3][0][4][2][0][19]_ana_edge_p2_lb'],
                                              self.hs['L[0][x][3][0][4][2][0][20]_ana_edge_p2_ub'],
                                              self.hs['L[0][x][3][0][4][2][0][21]_ana_edge_p3_lb'],
                                              self.hs['L[0][x][3][0][4][2][0][22]_ana_edge_p3_ub'],
                                              self.hs['L[0][x][3][0][4][2][0][23]_ana_edge_p4_lb'],
                                              self.hs['L[0][x][3][0][4][2][0][24]_ana_edge_p4_ub']]
...
# self.ana_fit_wl
# self.ana_fit_edge
# self.ana_use_flt_spec
# self.ana_find_edge
# self.ana_find_edge0p5_dir
    ...
    def set_save_items(self):            
        if self.parent_h.xanes_analysis_type == 'wl':
            ...
            if self.ana_fit_wl: # ana_fit_wl=True
                if self.ana_fit_edge: # ana_fit_wl=True & ana_fit_edge=True
                    if self.ana_find_edge: # ana_fit_wl=True & ana_fit_edge=True & ana_find_edge=True
                        ...
                        for ii in ('edge_pos_direct', 'whiteline_pos_fit', 
                                   'edge_pos_fit'):
                            selects.add(ii)
                    else: # ana_fit_wl=True & ana_fit_edge=True & ana_find_edge=False
                        for ii in ('whiteline_pos_fit', 'edge_pos_fit', 
                                   'whiteline_fit_coef', 'edge_fit_coef'):
                            options.add(ii)
                        for ii in ('whiteline_pos_fit', 'edge_pos_fit'):
                            selects.add(ii)
                else: # ana_fit_wl=True & ana_fit_edge=False
                    if self.ana_find_edge: # ana_fit_wl=True & ana_fit_edge=False & ana_find_edge=True
                        for ii in ('edge_pos_direct', 'whiteline_pos_fit', 
                                   'whiteline_fit_coef'):
                            options.add(ii)
                        for ii in ('edge_pos_direct', 'whiteline_pos_fit'):
                            selects.add(ii)
                    else: # ana_fit_wl=True & ana_fit_edge=False & ana_find_edge=False
                        for ii in ('whiteline_pos_fit', 'whiteline_fit_coef'):
                            options.add(ii)
                        for ii in [('whiteline_pos_fit')]:
                            selects.add(ii)
            else: # ana_fit_wl=False
                if self.ana_fit_edge: # ana_fit_wl=False & ana_fit_edge=True
                    if self.ana_find_edge: # ana_fit_wl=False & ana_fit_edge=True & ana_find_edge=True
                        for ii in ('edge_pos_direct', 'edge_pos_fit', 
                                   'edge_fit_coef'):
                            options.add(ii)
                        for ii in ('edge_pos_direct', 'edge_pos_fit'):
                            selects.add(ii)
                    else: # ana_fit_wl=False & ana_fit_edge=True & ana_find_edge=False
                        for ii in ('edge_pos_fit', 'edge_fit_coef'):
                            options.add(ii)
                        for ii in [('edge_pos_fit')]:
                            selects.add(ii)
                else: # ana_fit_wl=False & ana_fit_edge=False
                    if self.ana_find_edge: # ana_fit_wl=False & ana_fit_edge=False & ana_find_edge=True
                        for ii in [('edge_pos_direct')]:
                            options.add(ii)
                        for ii in [('edge_pos_direct')]:
                            selects.add(ii)
                    else: # ana_fit_wl=False & ana_fit_edge=False & ana_find_edge=False
                        pass
            ...
            selects = set(['', 
                           ...
                           'post_edge_mean'])
            if self.ana_fit_wl:
                if self.ana_fit_edge:  
                    if self.ana_find_edge:
                        if self.ana_find_edge0p5_dir: # ana_fit_wl=True & ana_fit_edge=True & ana_find_edge=True & ana_find_edge0p5_dir=True
                            ...
                            for ii in ('edge_pos_direct', 'edge0.5_pos_direct',
                                       ...
                                       'edge0.5_pos_fit'):
                                selects.add(ii)
                        else: # ana_fit_wl=True & ana_fit_edge=True & ana_find_edge=True & ana_find_edge0p5_dir=False
                            for ii in ('edge_pos_direct', 'whiteline_pos_fit', 
                        ...
                        if self.ana_find_edge0p5_dir: # ana_fit_wl=True & ana_fit_edge=True & ana_find_edge=False & ana_find_edge0p5_dir=True
                            ...
                            for ii in ('edge0.5_pos_direct', 'whiteline_pos_fit', 
                                       'edge_pos_fit', 'edge0.5_pos_fit'):
                                selects.add(ii)
                        else: # ana_fit_wl=True & ana_fit_edge=True & ana_find_edge=False & ana_find_edge0p5_dir=False
                            for ii in ('whiteline_pos_fit', 'edge_pos_fit', 
                                       'edge0.5_pos_fit', 'whiteline_fit_coef', 
                                       'edge_fit_coef'):
                                options.add(ii)
                    ...
                    if self.ana_find_edge: # ana_fit_wl=True & ana_fit_edge=False & ana_find_edge=True
                        if self.ana_find_edge0p5_dir: # ana_fit_wl=True & ana_fit_edge=False & ana_find_edge=True & ana_find_edge0p5_dir=True
                            for ii in ('edge_pos_direct', 'edge0.5_pos_direct',
                            ...
                            for ii in ('edge_pos_direct', 'edge0.5_pos_direct',
                                       'whiteline_pos_fit'):
                                selects.add(ii)
                        else: # ana_fit_wl=True & ana_fit_edge=False & ana_find_edge=True & ana_find_edge0p5_dir=False
                            for ii in ('edge_pos_direct', 'whiteline_pos_fit', 
                                       'whiteline_fit_coef', 'edge_fit_coef'):
                                options.add(ii)
                            for ii in ('edge_pos_direct', 'whiteline_pos_fit'):
                        ...
                        if self.ana_find_edge0p5_dir: # ana_fit_wl=True & ana_fit_edge=False & ana_find_edge=False & ana_find_edge0p5_dir=True
                            for ii in ('edge0.5_pos_direct', 'whiteline_pos_fit', 
                                       'whiteline_fit_coef', 'edge_fit_coef'):
                                options.add(ii)
                            for ii in ('edge0.5_pos_direct', 'whiteline_pos_fit'):
                                selects.add(ii)
                        else: # ana_fit_wl=True & ana_fit_edge=False & ana_find_edge=False & ana_find_edge0p5_dir=False
                            for ii in ('whiteline_pos_fit', 'whiteline_fit_coef'):
                                options.add(ii)
                            for ii in [('whiteline_pos_fit')]:
                                selects.add(ii)
                ...
                if self.ana_fit_edge: # ana_fit_wl=False & ana_fit_edge=True
                    if self.ana_find_edge: # ana_fit_wl=False & ana_fit_edge=True & ana_find_edge=True
                        if self.ana_find_edge0p5_dir: # ana_fit_wl=False & ana_fit_edge=True & ana_find_edge=True & ana_find_edge0p5_dir=True
                            for ii in ('edge_pos_direct', 'edge0.5_pos_direct',
                                       'edge_pos_fit', 'edge0.5_pos_fit', 
                                       'edge_fit_coef'):
                                options.add(ii)
                            for ii in ('edge_pos_direct', 'edge0.5_pos_direct',
                                       'edge_pos_fit', 'edge0.5_pos_fit'):
                                selects.add(ii)
                        else: # ana_fit_wl=False & ana_fit_edge=True & ana_find_edge=True & ana_find_edge0p5_dir=False
                            for ii in ('edge_pos_direct', 'edge_pos_fit', 
                        ...
                        if self.ana_find_edge0p5_dir: # ana_fit_wl=False & ana_fit_edge=True & ana_find_edge=False & ana_find_edge0p5_dir=True
                            ...
                            for ii in ('edge0.5_pos_direct', 'edge_pos_fit', 
                                       'edge0.5_pos_fit'):
                                selects.add(ii)
                        else: # ana_fit_wl=False & ana_fit_edge=True & ana_find_edge=False & ana_find_edge0p5_dir=False
                    ...
                    if self.ana_find_edge: # ana_fit_wl=False & ana_fit_edge=False & ana_find_edge=True
                        if self.ana_find_edge0p5_dir: # ana_fit_wl=False & ana_fit_edge=False & ana_find_edge=True & ana_find_edge0p5_dir=True
                            for ii in ('edge_pos_direct', 'edge0.5_pos_direct'):
                                options.add(ii)
                            for ii in ('edge_pos_direct', 'edge0.5_pos_direct'):
                                selects.add(ii)
                        else: # ana_fit_wl=False & ana_fit_edge=False & ana_find_edge=True & ana_find_edge0p5_dir=False
                            for ii in [('edge_pos_direct')]:
                                options.add(ii)
                            for ii in [('edge_pos_direct')]:
                                selects.add(ii)
                    else: # ana_fit_wl=False & ana_fit_edge=False & ana_find_edge=False 
                        if self.ana_find_edge0p5_dir: # ana_fit_wl=False & ana_fit_edge=False & ana_find_edge=False & ana_find_edge0p5_dir=True
                            for ii in [('edge0.5_pos_direct')]:
                                options.add(ii)
                            for ii in [('edge0.5_pos_direct')]:
                                selects.add(ii)
                        else: # ana_fit_wl=False & ana_fit_edge=False & ana_find_edge=False & ana_find_edge0p5_dir=False
                            pass
        self.hs['L[0][x][3][0][4][1][0][0]_ana_save_setting_multiselection'].value = ['whiteline_pos_direct']
        self.hs['L[0][x][3][0][4][1][0][0]_ana_save_setting_multiselection'].options = list(options)   
        self.hs['L[0][x][3][0][4][1][0][1]_ana_save_setting_selection_text'].value = ['']
        self.hs['L[0][x][3][0][4][1][0][1]_ana_save_setting_selection_text'].options = list(selects)
        
    def L0_x_3_0_1_0_0_ana_eng_range_option_dropdown(self, a):
        self.parent_h.xanes_analysis_eng_configured = False
        self.parent_h.xanes_analysis_type = a['owner'].value
        self.hs['L[0][x][3][0][1][0][1]_ana_eng_range_edge_eng_text'].value = self.parent_h.xanes_analysis_edge_eng
        
        self.hs['L[0][x][3][0][1][1][1]_ana_eng_range_wl_fit_e_text'].value = self.parent_h.xanes_analysis_wl_fit_eng_e
        self.hs['L[0][x][3][0][1][1][0]_ana_eng_range_wl_fit_s_text'].value = self.parent_h.xanes_analysis_wl_fit_eng_s
        self.hs['L[0][x][3][0][1][1][3]_ana_eng_range_edge0.5_fit_e_text'].value = self.parent_h.xanes_analysis_edge_0p5_fit_e
        self.hs['L[0][x][3][0][1][1][2]_ana_eng_range_edge0.5_fit_s_text'].value = self.parent_h.xanes_analysis_edge_0p5_fit_s
        self.hs['L[0][x][3][0][1][0][2]_ana_eng_range_pre_edge_e_text'].value = self.parent_h.xanes_analysis_pre_edge_e
        self.hs['L[0][x][3][0][1][0][3]_ana_eng_range_post_edge_s_text'].value = self.parent_h.xanes_analysis_post_edge_s
        
        self.set_xanes_analysis_eng_bounds()
        self.hs['L[0][x][3][0][5][0]_ana_run_text'].value ='please check your settings before run the analysis ...'
        if a['owner'].value == 'wl':
            ...
            layout = {'width':'19%', 'height':'100%', 'top':'15%', 'visibility':'visible'}
            self.hs['L[0][x][3][0][1][0][2]_ana_eng_range_pre_edge_e_text'].layout = layout
            self.hs['L[0][x][3][0][1][0][2]_ana_eng_range_pre_edge_e_text'].max = 0
            self.hs['L[0][x][3][0][1][0][2]_ana_eng_range_pre_edge_e_text'].value = -50
            self.hs['L[0][x][3][0][1][0][2]_ana_eng_range_pre_edge_e_text'].min = -500
            layout = {'width':'19%', 'height':'100%', 'top':'15%', 'visibility':'visible'}
            self.hs['L[0][x][3][0][1][0][3]_ana_eng_range_post_edge_s_text'].layout = layout
            self.hs['L[0][x][3][0][1][0][3]_ana_eng_range_post_edge_s_text'].min = 0
            self.hs['L[0][x][3][0][1][0][3]_ana_eng_range_post_edge_s_text'].value = 100
            self.hs['L[0][x][3][0][1][0][3]_ana_eng_range_post_edge_s_text'].max = 500
    ...
    def L0_x_3_0_1_0_1_ana_eng_range_edge_eng_text(self, a):
        self.parent_h.xanes_analysis_eng_configured = False
        self.parent_h.xanes_analysis_edge_eng = self.hs['L[0][x][3][0][1][0][1]_ana_eng_range_edge_eng_text'].value
        self.hs['L[0][x][3][0][5][0]_ana_run_text'].description ='please check your settings before run the analysis ...'
        # self.parent_h.boxes_logic()

    def L0_x_3_0_1_0_2_ana_eng_range_pre_edge_e_text(self, a):
        self.parent_h.xanes_analysis_eng_configured = False
        self.parent_h.xanes_analysis_pre_edge_e = self.hs['L[0][x][3][0][1][0][2]_ana_eng_range_pre_edge_e_text'].value
        self.hs['L[0][x][3][0][5][0]_ana_run_text'].description ='please check your settings before run the analysis ...'
        self.parent_h.boxes_logic()

    def L0_x_3_0_1_0_3_ana_eng_range_post_edge_s_text(self, a):
        self.parent_h.xanes_analysis_eng_configured = False
        self.parent_h.xanes_analysis_post_edge_s = self.hs['L[0][x][3][0][1][0][3]_ana_eng_range_post_edge_s_text'].value
        self.hs['L[0][x][3][0][5][0]_ana_run_text'].description ='please check your settings before run the analysis ...'
        self.parent_h.boxes_logic()

    # def L0_x_3_0_1_0_4_analysis_filter_spec_checkbox(self, a):
    #     self.parent_h.xanes_analysis_eng_configured = False
    #     self.ana_use_flt_spec = a['owner'].value
    #     self.hs['L[0][x][3][0][5][0]_ana_run_text'].description ='please check your settings before run the analysis ...'
    #     self.parent_h.boxes_logic()

    def L0_x_3_0_1_1_0_ana_eng_range_wl_fit_s_text(self, a):
        self.parent_h.xanes_analysis_eng_configured = False
        # if a['owner'].value < self.xanes_analysis_edge_eng:
        #     a['owner'].value = self.xanes_analysis_edge_eng
        #     self.hs['L[0][x][3][0][5][0]_ana_run_text'].value = 'The whiteline fitting energy starting point might be too low. Reset it to the edge energy.'
        # elif (a['owner'].value+0.005) > self.hs['L[0][x][3][0][1][1][1]_ana_eng_range_wl_fit_e_text'].value:
        #     a['owner'].value = self.hs['L[0][x][3][0][1][1][1]_ana_eng_range_wl_fit_e_text'].value - 0.005
        #     self.hs['L[0][x][3][0][5][0]_ana_run_text'].value = 'The whiteline fitting energy starting point might be too high. Reset it to 0.005keV lower than whiteline fitting energy ending point.'
        # else:
        #     self.hs['L[0][x][3][0][5][0]_ana_run_text'].value ='please check your settings before run the analysis ...'
        self.hs['L[0][x][3][0][5][0]_ana_run_text'].value ='please check your settings before run the analysis ...'
        self.parent_h.xanes_analysis_wl_fit_eng_s = self.hs['L[0][x][3][0][1][1][0]_ana_eng_range_wl_fit_s_text'].value
        self.parent_h.boxes_logic()

    def L0_x_3_0_1_1_1_ana_eng_range_wl_fit_e_text(self, a):
        self.parent_h.xanes_analysis_eng_configured = False
        # if a['owner'].value < (self.hs['L[0][x][3][0][1][1][0]_ana_eng_range_wl_fit_s_text'].value + 0.005):
        #     a['owner'].value = (self.hs['L[0][x][3][0][1][1][0]_ana_eng_range_wl_fit_s_text'].value + 0.005)
        #     self.hs['L[0][x][3][0][5][0]_ana_run_text'].value = 'The whiteline fitting energy ending point might be too low. Reset it to 0.005keV higher than whiteline fitting energy starting point.'
        # else:
        #     self.hs['L[0][x][3][0][5][0]_ana_run_text'].value ='please check your settings before run the analysis ...'
        self.hs['L[0][x][3][0][5][0]_ana_run_text'].value ='please check your settings before run the analysis ...'
        self.parent_h.xanes_analysis_wl_fit_eng_e = self.hs['L[0][x][3][0][1][1][1]_ana_eng_range_wl_fit_e_text'].value
        self.parent_h.boxes_logic()

    def L0_x_3_0_1_1_2_ana_eng_range_edge0p5_fit_s_text(self, a):
        self.parent_h.xanes_analysis_eng_configured = False
        # if a['owner'].value > self.xanes_analysis_edge_eng:
        #     a['owner'].value = self.xanes_analysis_edge_eng
        #     self.hs['L[0][x][3][0][5][0]_ana_run_text'].value = 'The edge-0.5 fitting energy starting point might be too high. Reset it to edge energy.'
        # else:
        #     self.hs['L[0][x][3][0][5][0]_ana_run_text'].value ='please check your settings before run the analysis ...'
        self.hs['L[0][x][3][0][5][0]_ana_run_text'].value ='please check your settings before run the analysis ...'
        self.parent_h.xanes_analysis_edge_0p5_fit_s = self.hs['L[0][x][3][0][1][1][2]_ana_eng_range_edge0.5_fit_s_text'].value
        self.parent_h.boxes_logic()

    def L0_x_3_0_1_1_3_ana_eng_range_edge0p5_fit_e_text(self, a):
        self.parent_h.xanes_analysis_eng_configured = False
        # if a['owner'].value < self.xanes_analysis_edge_eng:
        #     a['owner'].value = self.xanes_analysis_edge_eng
        #     self.hs['L[0][x][3][0][5][0]_ana_run_text'].value = 'The edge-0.5 fitting energy ending point might be too low. Reset it to edge energy.'
        # else:
        #     self.hs['L[0][x][3][0][5][0]_ana_run_text'].value ='please check your settings before run the analysis ...'
        self.hs['L[0][x][3][0][5][0]_ana_run_text'].value ='please check your settings before run the analysis ...'
        self.parent_h.xanes_analysis_edge_0p5_fit_e = self.hs['L[0][x][3][0][1][1][3]_ana_eng_range_edge0.5_fit_e_text'].value
        self.parent_h.boxes_logic()

    def L0_x_3_0_1_0_4_ana_eng_range_confirm_button(self, a):
        # self.hs['L[0][x][3][0][4][3][0][0]_ana_config_fit_wl_checkbox']
        # self.hs['L[0][x][3][0][4][3][0][1]_ana_config_fit_edge_checkbox']
        # self.hs['L[0][x][3][0][4][3][0][2]_ana_config_filter_spec_checkbox']
        # self.hs['L[0][x][3][0][4][3][0][3]_ana_config_find_edge_checkbox']
        # self.hs['L[0][x][3][0][4][3][0][3]_ana_config_cal_edge0.5_direct_checkbox']
        self.parent_h.xanes_analysis_type = self.hs['L[0][x][3][0][1][0][0]_ana_eng_range_option_dropdown'].value
        if self.parent_h.xanes_analysis_type == 'wl':
            self.parent_h.xanes_analysis_wl_fit_eng_s = self.hs['L[0][x][3][0][1][1][0]_ana_eng_range_wl_fit_s_text'].value
            self.parent_h.xanes_analysis_wl_fit_eng_e = self.hs['L[0][x][3][0][1][1][1]_ana_eng_range_wl_fit_e_text'].value
            self.hs['L[0][x][3][0][4][3][0][3]_ana_config_cal_edge0.5_direct_checkbox'].disabled = True
            self.hs['L[0][x][3][0][4][3][0][3]_ana_config_cal_edge0.5_direct_checkbox'].value = False
            self.ana_find_edge0p5_dir = False
            self.hs['L[0][x][3][0][4][1][0][0]_ana_save_setting_multiselection'].value = ['whiteline_pos_direct']
            self.hs['L[0][x][3][0][4][1][0][0]_ana_save_setting_multiselection'].options = WL_SAVE_ITEM_OPTIONS
            self.hs['L[0][x][3][0][4][1][0][1]_ana_save_setting_selection_text'].value = ['']
            self.hs['L[0][x][3][0][4][1][0][1]_ana_save_setting_selection_text'].options = WL_SAVE_DEFAULT
            ...
            self.parent_h.xanes_analysis_edge_0p5_fit_s = self.hs['L[0][x][3][0][1][1][2]_ana_eng_range_edge0.5_fit_s_text'].value
            self.parent_h.xanes_analysis_edge_0p5_fit_e = self.hs['L[0][x][3][0][1][1][3]_ana_eng_range_edge0.5_fit_e_text'].value
            self.hs['L[0][x][3][0][4][3][0][3]_ana_config_cal_edge0.5_direct_checkbox'].disabled = False
            self.hs['L[0][x][3][0][4][3][0][3]_ana_config_cal_edge0.5_direct_checkbox'].value = True
            self.ana_find_edge0p5_dir = True
            self.hs['L[0][x][3][0][4][1][0][0]_ana_save_setting_multiselection'].value = ['whiteline_pos_direct']
            self.hs['L[0][x][3][0][4][1][0][0]_ana_save_setting_multiselection'].options = FULL_SAVE_ITEM_OPTIONS
            self.hs['L[0][x][3][0][4][1][0][1]_ana_save_setting_selection_text'].value = ['']
            self.hs['L[0][x][3][0][4][1][0][1]_ana_save_setting_selection_text'].options = FULL_SAVE_DEFAULT
        ...
        boxes = ['L[0][x][3][0][4][3]_ana_config_box',
                 # 'L[0][x][3][0][4][0]_ana_fit_wl_param_box',
                 # 'L[0][x][3][0][4][2]_ana_fit_edge_param_box',
                 'L[0][x][3][0][4][1]_ana_save_setting_box',
                 'L[0][x][3][0][5]_ana_run_box']
        enable_disable_boxes(self.hs, boxes, disabled=False, level=-1)
        
        cnt = 0
        for ii in self.ana_edge_fit_func_arg_handles:
            ii.disabled = True
            ii.description = 'p'+str(cnt)
            cnt += 1
        self.hs['L[0][x][3][0][4][0][0][0]_ana_wl_optimizer'].value = 'numpy'
        self.hs['L[0][x][3][0][4][0][0][0]_ana_wl_optimizer'].value = 'scipy'
        self.hs['L[0][x][3][0][4][0][0][1]_ana_wl_fit_func'].value = 'lorentzian'
        # self.hs['L[0][x][3][0][4][2][0][3]_ana_edge_refine'].value = True
        self.hs['L[0][x][3][0][4][2][0][0]_ana_edge_optimizer'].value = 'numpy'
        self.hs['L[0][x][3][0][4][2][0][1]_ana_edge_fit_func'].value = 3
        self.parent_h.xanes_analysis_eng_configured = True
        self.set_save_items()
        self.parent_h.boxes_logic()
 
    def L0_x_3_0_4_3_0_0_ana_config_fit_wl_checkbox_change(self, a):
        if a['owner'].value:
            self.ana_fit_wl = True
            ...
            self.ana_fit_wl = False
            boxes = ['L[0][x][3][0][4][0]_ana_fit_wl_param_box']
            enable_disable_boxes(self.hs, boxes, disabled=True, level=-1)
        self.set_save_items()
        self.parent_h.boxes_logic()
    
    def L0_x_3_0_4_3_0_1_ana_config_fit_edge_checkbox_change(self, a):
        if a['owner'].value:
            self.ana_fit_edge = True
            boxes = ['L[0][x][3][0][4][2]_ana_fit_edge_param_box']
            enable_disable_boxes(self.hs, boxes, disabled=False, level=-1)
            self.hs['L[0][x][3][0][4][2][0][0]_ana_edge_optimizer'].value = 'numpy'
            self.hs['L[0][x][3][0][4][2][0][1]_ana_edge_fit_func'].value = 3
        else:
            self.ana_fit_edge = False
            boxes = ['L[0][x][3][0][4][2]_ana_fit_edge_param_box']
            enable_disable_boxes(self.hs, boxes, disabled=True, level=-1)
        self.set_save_items()
        self.parent_h.boxes_logic()
    
    def L0_x_3_0_4_3_0_2_ana_config_filter_spec_checkbox_change(self, a):
        self.ana_use_flt_spec = a['owner'].value
        self.set_save_items()
        self.parent_h.boxes_logic()
    
    def L0_x_3_0_4_3_0_3_ana_config_find_edge_checkbox_change(self, a):
        self.ana_find_edge = a['owner'].value
        self.set_save_items()
        self.parent_h.boxes_logic()
        
    def L0_x_3_0_4_3_0_3_ana_config_cal_edge0p5_direct_checkbox_change(self, a):
        self.ana_find_edge0p5_dir = a['owner'].value
        self.set_save_items()
        self.parent_h.boxes_logic()

    def L0_x_3_0_4_3_0_1_ana_config_edge_jump_thres_slider_change(self, a):
        self.parent_h.xanes_analysis_edge_jump_thres = a['owner'].value
        self.parent_h.boxes_logic()

    def L0_x_3_0_4_3_0_2_ana_config_edge_offset_thres_slider(self, a):
        self.parent_h.xanes_analysis_edge_offset_thres = a['owner'].value
        self.parent_h.boxes_logic()

    def L0_x_3_0_3_0_ana_img_use_mask_checkbox(self, a):
        pass
        # if a['owner'].value:
        ...
        #     # f.close()
        #     self.hs['L[0][x][3][0][3][1]_ana_img_mask_scan_id_slider'].max = self.xanes_scan_id_e
        #     self.hs['L[0][x][3][0][3][1]_ana_img_mask_scan_id_slider'].value = self.xanes_scan_id_s
        #     self.hs['L[0][x][3][0][3][1]_ana_img_mask_scan_id_slider'].min = self.xanes_scan_id_s
    ...
    def L0_x_3_0_3_1_ana_img_mask_scan_id_slider(self, a):
        pass
        # self.parent_h.xanes_analysis_mask_scan_id = a['owner'].value
        # self.parent_h.xanes_analysis_mask_thres = self.hs['L[0][x][3][0][3][1]_ana_img_mask_thres_slider'].value
    ...
    def L0_x_3_0_3_1_ana_img_mask_thres_slider(self, a):
        pass
        # self.parent_h.xanes_analysis_mask_thres = a['owner'].value
        # self.parent_h.xanes_analysis_mask_scan_id = self.hs['L[0][x][3][0][3][1]_ana_img_mask_scan_id_slider'].value
    ...
    def L0_x_3_0_4_0_0_0_ana_wl_optimizer(self, a):
        self.ana_wl_optimizer = a['owner'].value
        if self.ana_wl_optimizer == 'scipy':
            for ii in self.ana_wl_fit_func_arg_handles:
                ii.disabled = False
            for ii in self.ana_wl_optimizer_arg_handles:
                ii.disabled = False
            if self.ana_wl_fit_use_param_bnd:
                for ii in self.ana_wl_fit_func_bnd_handles:
                    ii.disabled = False
            else:
                for ii in self.ana_wl_fit_func_bnd_handles:
                    ii.disabled = True
            self.hs['L[0][x][3][0][4][0][0][2]_ana_wl_fit_use_bnd'].disabled = False
            self.hs['L[0][x][3][0][4][0][0][1]_ana_wl_fit_func'].options = PEAK_LINE_SHAPES
            self.hs['L[0][x][3][0][4][0][0][1]_ana_wl_fit_func'].description = 'peak func'
            self.hs['L[0][x][3][0][4][0][0][1]_ana_wl_fit_func'].description_tooltip = 'peak fitting functions'
        elif self.ana_wl_optimizer == 'numpy':
            for ii in self.ana_wl_fit_func_arg_handles:
                ii.disabled = True
            for ii in self.ana_wl_optimizer_arg_handles:
                ii.disabled = True
            for ii in self.ana_wl_fit_func_bnd_handles:
                ii.disabled = True
            self.hs['L[0][x][3][0][4][2][0][14]_ana_edge_ufac'].disabled = False
            self.hs['L[0][x][3][0][4][0][0][2]_ana_wl_fit_use_bnd'].disabled = True
            self.hs['L[0][x][3][0][4][0][0][1]_ana_wl_fit_func'].options = NUMPY_FIT_ORDER
            self.hs['L[0][x][3][0][4][0][0][1]_ana_wl_fit_func'].description = 'order'
            self.hs['L[0][x][3][0][4][0][0][1]_ana_wl_fit_func'].description_tooltip = 'order of polynominal fitting function'
                
    def L0_x_3_0_4_0_0_1_ana_wl_fit_func(self, a):
        self.ana_wl_fit_func = a['owner'].value
        cnt = 0
        for ii in self.ana_wl_fit_func_arg_handles:
                ii.disabled = True
                ii.description = 'p'+str(cnt)
                cnt += 1
        if self.ana_wl_optimizer == 'scipy':
            for ii in sorted(PEAK_FIT_PARAM_DICT[self.ana_wl_fit_func].keys()):
                self.ana_wl_fit_func_arg_handles[ii].disabled = False
                self.ana_wl_fit_func_arg_handles[ii].description = \
                    PEAK_FIT_PARAM_DICT[self.ana_wl_fit_func][ii][0]
                self.ana_wl_fit_func_arg_handles[ii].value = \
                    PEAK_FIT_PARAM_DICT[self.ana_wl_fit_func][ii][1]
                self.ana_wl_fit_func_arg_handles[ii].description_tooltip = \
                    PEAK_FIT_PARAM_DICT[self.ana_wl_fit_func][ii][2]
        if self.ana_wl_fit_func == "rectangle":
            self.ana_wl_fit_func_arg_handles[5].options = \
                    ['linear', 'atan', 'erf', 'logisitic']
        if self.ana_wl_fit_func == "step":
            self.ana_wl_fit_func_arg_handles[5].options = \
                    ['linear', 'atan', 'erf', 'logisitic']
            
    def L0_x_3_0_4_0_0_2_ana_wl_fit_bnd(self, a):
        self.ana_wl_fit_use_param_bnd = a['owner'].value
        if self.ana_wl_fit_use_param_bnd:
            for ii in self.ana_wl_fit_func_bnd_handles:
                ii.disabled = False
    ...
    # def L0_x_3_0_4_2_0_3_ana_edge_refine(self, a):
    #     self.ana_fit_edge = a['owner'].value
    #     if self.ana_fit_edge:
    ...
    def L0_x_3_0_4_2_0_0_ana_edge_optimizer(self, a):
        self.ana_edge_optimizer = a['owner'].value
        if self.ana_edge_optimizer == 'scipy':
            for ii in self.ana_edge_fit_func_arg_handles:
                ii.disabled = False
            for ii in self.ana_edge_optimizer_arg_handles:
                ii.disabled = False
            if self.ana_edge_fit_use_param_bnd:
                for ii in self.ana_edge_fit_func_bnd_handles:
                    ii.disabled = False
            else:
                for ii in self.ana_edge_fit_func_bnd_handles:
                    ii.disabled = True        
            self.hs['L[0][x][3][0][4][2][0][2]_ana_edge_fit_use_bnd'].disabled = False
            self.hs['L[0][x][3][0][4][2][0][1]_ana_edge_fit_func'].options = EDGE_LINE_SHAPES
            self.hs['L[0][x][3][0][4][2][0][1]_ana_edge_fit_func'].description = 'peak func'
            self.hs['L[0][x][3][0][4][2][0][1]_ana_edge_fit_func'].description_tooltip = 'peak fitting functions'
        elif self.ana_edge_optimizer == 'numpy':
            for ii in self.ana_edge_fit_func_arg_handles:
                ii.disabled = True
            for ii in self.ana_edge_optimizer_arg_handles:
                ii.disabled = True
            for ii in self.ana_edge_fit_func_bnd_handles:
                ii.disabled = True
            self.hs['L[0][x][3][0][4][2][0][14]_ana_edge_ufac'].disabled = False
            self.hs['L[0][x][3][0][4][2][0][2]_ana_edge_fit_use_bnd'].disabled = True
            self.hs['L[0][x][3][0][4][2][0][1]_ana_edge_fit_func'].options = NUMPY_FIT_ORDER
            self.hs['L[0][x][3][0][4][2][0][1]_ana_edge_fit_func'].description = 'order'
            self.hs['L[0][x][3][0][4][2][0][1]_ana_edge_fit_func'].description_tooltip = 'order of polynominal fitting function'
                
    def L0_x_3_0_4_2_0_1_ana_edge_fit_func(self, a):
        self.ana_edge_fit_func = a['owner'].value
        cnt = 0
        for ii in self.ana_edge_fit_func_arg_handles:
                ii.disabled = True
                ii.description = 'p'+str(cnt)
                cnt += 1
        if self.ana_edge_optimizer == 'scipy':
            for ii in sorted(PEAK_FIT_PARAM_DICT[self.ana_edge_fit_func].keys()):
                self.ana_edge_fit_func_arg_handles[ii].disabled = False
                self.ana_edge_fit_func_arg_handles[ii].description = \
                    PEAK_FIT_PARAM_DICT[self.ana_edge_fit_func][ii][0]
                self.ana_edge_fit_func_arg_handles[ii].value = \
                    PEAK_FIT_PARAM_DICT[self.ana_edge_fit_func][ii][1]
                self.ana_edge_fit_func_arg_handles[ii].description_tooltip = \
                    PEAK_FIT_PARAM_DICT[self.ana_edge_fit_func][ii][2]
        if self.ana_edge_fit_func == "rectangle":
            self.ana_edge_fit_func_arg_handles[5].options = \
                    ['linear', 'atan', 'erf', 'logisitic']
        if self.ana_edge_fit_func == "step":
            self.ana_edge_fit_func_arg_handles[5].options = \
                    ['linear', 'atan', 'erf', 'logisitic']
    
    def L0_x_3_0_4_2_0_2_ana_edge_fit_use_bnd(self, a):
        self.ana_edge_fit_use_param_bnd = a['owner'].value
        if self.ana_edge_fit_use_param_bnd:
            for ii in self.ana_edge_fit_func_bnd_handles:
                ii.disabled = False
    ...
    def L0_x_3_0_4_1_0_2_ana_save_setting_add_button_click(self, a):
        for ii in self.hs['L[0][x][3][0][4][1][0][0]_ana_save_setting_multiselection'].value:
            self.analysis_saving_items.add(ii)
        self.hs['L[0][x][3][0][4][1][0][1]_ana_save_setting_selection_text'].value = ['']
        tem = list(self.analysis_saving_items)
        tem.insert(0, '')
        self.hs['L[0][x][3][0][4][1][0][1]_ana_save_setting_selection_text'].options = tem
        self.hs['L[0][x][3][0][4][1][0][1]_ana_save_setting_selection_text'].value = \
            list('')
    def L0_x_3_0_4_1_0_3_ana_save_setting_remove_button_click(self, a):
        for ii in self.hs['L[0][x][3][0][4][1][0][1]_ana_save_setting_selection_text'].value:
            if ii != '':
    ...
    def L0_x_3_0_5_1_ana_run_button(self, a):
        try:
        ...
        for ii in self.hs['L[0][x][3][0][4][1][0][1]_ana_save_setting_selection_text'].options:
            if ii != '':
                self.analysis_saving_items.add(ii) 
        ...
        if self.ana_wl_optimizer == 'scipy':
            for ii in sorted(PEAK_FIT_PARAM_DICT[self.ana_wl_fit_func].keys()):
                wl_fvars.append(self.ana_wl_fit_func_arg_handles[ii].value)
            if self.ana_wl_fit_use_param_bnd :
                for ii in sorted(PEAK_FIT_PARAM_DICT[self.ana_wl_fit_func].keys()):
                    wl_bnds.append((self.ana_wl_fit_func_bnd_handles[2*ii].value,
                                 self.ana_wl_fit_func_bnd_handles[2*ii+1].value))
            else:
                wl_bnds = None 
            wl_params['model'] = self.ana_wl_fit_func
            wl_params['fvars'] = wl_fvars
            wl_params['bnds'] = wl_bnds
            wl_params['jac']=self.ana_wl_optimizer_arg_handles[0].value
            wl_params['method']=self.ana_wl_optimizer_arg_handles[1].value
            wl_params['ftol']=self.ana_wl_optimizer_arg_handles[2].value
            wl_params['xtol']=self.ana_wl_optimizer_arg_handles[3].value
            wl_params['gtol']=self.ana_wl_optimizer_arg_handles[4].value
            wl_params['ufac']=self.ana_wl_optimizer_arg_handles[5].value
        elif self.ana_wl_optimizer == 'numpy':
            wl_order = self.hs['L[0][x][3][0][4][0][0][1]_ana_wl_fit_func'].value
            wl_params['order'] = wl_order
            wl_params['ufac'] = self.ana_wl_optimizer_arg_handles[5].value
            wl_params['flt_spec'] = self.ana_use_flt_spec
        ...
        if self.ana_fit_edge:
            if self.ana_edge_optimizer == 'scipy':
                for ii in sorted(EDGE_FIT_PARAM_DICT[self.ana_edge_fit_func].keys()):
                    edge_fvars.append(self.ana_edge_fit_func_arg_handles[ii].value)
                if self.ana_wl_fit_use_param_bnd :
                    for ii in sorted(EDGE_FIT_PARAM_DICT[self.ana_wdge_fit_func].keys()):
                        edge_bnds.append((self.ana_edge_fit_func_bnd_handles[2*ii].value,
                                     self.ana_edge_fit_func_bnd_handles[2*ii+1].value))
                else:
                    edge_bnds = None
                edge_params = {}
                edge_params['model'] = self.ana_edge_fit_func
                edge_params['fvars'] = edge_fvars
                edge_params['bnds'] = edge_bnds
                edge_params['jac']=self.ana_edge_optimizer_arg_handles[0].value
                edge_params['method']=self.ana_edge_optimizer_arg_handles[1].value
                edge_params['ftol']=self.ana_edge_optimizer_arg_handles[2].value
                edge_params['xtol']=self.ana_edge_optimizer_arg_handles[3].value
                edge_params['gtol']=self.ana_edge_optimizer_arg_handles[4].value
                edge_params['ufac']=self.ana_edge_optimizer_arg_handles[5].value
            elif self.ana_edge_optimizer == 'numpy':
                edge_order = self.hs['L[0][x][3][0][4][2][0][1]_ana_edge_fit_func'].value
                edge_params = {}
                edge_params['order'] = edge_order
                edge_params['ufac'] = self.ana_edge_optimizer_arg_handles[5].value
                edge_params['flt_spec'] = self.ana_use_flt_spec
        ...
        if self.parent_h.gui_name == 'xanes3D':
            with h5py.File(self.parent_h.xanes3D_save_trial_reg_filename, 'r+') as f:
                ...
                g11.create_dataset('flt_spec', 
                                   data=str(self.ana_use_flt_spec))
                
                g111 = g11.create_group('wl_fit method')
                g111.create_dataset('optimizer', data=str(self.ana_wl_optimizer))
                if self.ana_wl_optimizer == 'scipy':
                    g111.create_dataset('method', data=str(self.ana_wl_fit_func))
                ...
                if self.ana_fit_edge:
                    g112.create_dataset('optimizer', 
                                        data=str(self.ana_edge_optimizer))
                    if self.ana_edge_optimizer == 'scipy':
                        g112.create_dataset('method', 
                                            data=str(self.ana_edge_fit_func))
                    ...
                    g112.create_dataset('optimizer', 
                                        data=str(self.ana_wl_optimizer))
                    if self.ana_wl_optimizer == 'scipy':
                        g112.create_dataset('method', 
                                            data=str(self.ana_wl_fit_func))
                        g1121 = g112.create_group('params')
            ...
            code[ln] = f"            if {self.ana_fit_wl}:"; ln += 1           
            code[ln] = f"                xana.fit_whiteline(xanes3D_analysis_wl_fit_eng_s, xanes3D_analysis_wl_fit_eng_e, '{self.ana_wl_optimizer}', **{wl_params})"; ln += 1
            code[ln] = f"            if {self.ana_fit_edge}:"; ln += 1
            code[ln] = f"                xana.fit_edge(xanes3D_analysis_edge_0p5_fit_s, xanes3D_analysis_edge_0p5_fit_e, '{self.ana_edge_optimizer}', **{edge_params})"; ln += 1            
            code[ln] = f"            if {self.ana_find_edge}:"; ln += 1
            ...
            code[ln] = f"                xana.fit_edge_0p5(xanes3D_analysis_edge_0p5_fit_s, xanes3D_analysis_edge_0p5_fit_e, '{self.ana_edge_optimizer}', **tem)"; ln += 1
            ...
            code[ln] = f"                if (jj == 'edge_pos_fit') and {self.ana_fit_edge}:"; ln += 1
            code[ln] = f"                    _g12[jj][ii] = np.float32(xana.edge_pos_fit)[:]"; ln += 1
            code[ln] = f"                if jj == 'edge_pos_direct':"; ln += 1
            code[ln] = f"                    _g12[jj][ii] = np.float32(xana.edge_pos_direct)[:]"; ln += 1
            ...
            if sig == 0:
                self.hs['L[0][x][3][0][5][0]_ana_run_text'].value = 'XANES3D analysis is done ...'
            else:
                self.hs['L[0][x][3][0][5][0]_ana_run_text'].value = 'something wrong in analysis ...'
            self.parent_h.update_xanes3D_config()
        elif self.parent_h.gui_name == 'xanes2D':
            with h5py.File(self.parent_h.xanes2D_save_trial_reg_filename, 'r+') as f:
                ...
                g11.create_dataset('pre_post_edge_norm_fit_order', data=1)
                g11.create_dataset('flt_spec', data=str(self.ana_use_flt_spec))
            ...
            code[ln] = f"        xana.fit_whiteline(xanes2D_analysis_wl_fit_eng_s, xanes2D_analysis_wl_fit_eng_e, '{self.ana_wl_optimizer}', **{wl_params})"; ln += 1
            code[ln] = f"        if {self.ana_fit_edge}:"; ln += 1
            code[ln] = f"            xana.fit_edge(xanes2D_analysis_edge_0p5_fit_s, xanes2D_analysis_edge_0p5_fit_e, '{self.ana_edge_optimizer}', **{edge_params})"; ln += 1
            code[ln] = f"        if {self.ana_find_edge}:"; ln += 1
            code[ln] = f"            xana.find_edge()"; ln += 1  
            ...
            code[ln] = f"            tem = deepcopy({edge_params})"; ln += 1
            code[ln] = f"            tem['cal_deriv'] = True"; ln += 1
            code[ln] = f"            xana.fit_edge_0p5(xanes2D_analysis_edge_0p5_fit_s, xanes2D_analysis_edge_0p5_fit_e, '{self.ana_edge_optimizer}', **tem)"; ln += 1
            code[ln] = f"        elif ('edge0.5_pos_fit' in {self.analysis_saving_items}) and not ('edge_pos_fit' in {self.analysis_saving_items}):"; ln += 1            
            code[ln] = f"            xana.fit_edge(xanes2D_analysis_edge_0p5_fit_s, xanes2D_analysis_edge_0p5_fit_e, '{self.ana_edge_optimizer}', **{edge_params})"; ln += 1
            code[ln] = f"        elif not ('edge0.5_pos_fit' in {self.analysis_saving_items}) and ('edge_pos_fit' in {self.analysis_saving_items}):"; ln += 1
            code[ln] = f"            tem = deepcopy({edge_params})"; ln += 1
            ...
            # print(4)
            if sig == 0:
                self.hs['L[0][x][3][0][5][0]_ana_run_text'].value = 'XANES2D analysis is done ...'
            else:
                self.hs['L[0][x][3][0][5][0]_ana_run_text'].value = 'somthing wrong in analysis ...'   
            self.parent_h.update_xanes2D_config()
