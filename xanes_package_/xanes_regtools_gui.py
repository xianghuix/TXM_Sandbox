...
import os, glob, tifffile, h5py, json
import numpy as np
...
class xanes_regtools_gui():
        ...
        if viewer_name == 'all':
            for ii in WindowManager.getIDList():
                ...
                for jj in self.xanes2D_fiji_windows:
                    self.xanes2D_fiji_windows[jj]['ip'] = None
                    self.xanes2D_fiji_windows[jj]['fiji_id'] = None
                for jj in self.xanes3D_fiji_windows:
                    self.xanes3D_fiji_windows[jj]['ip'] = None
                    self.xanes3D_fiji_windows[jj]['fiji_id'] = None
        else:
    ...
    def fiji_viewer_on(self, viewer_name='xanes3D_virtural_stack_preview_viewer'):
        if viewer_name == 'xanes3D_virtural_stack_preview_viewer':
            ...
            data_state, viewer_state = self.fiji_viewer_state(viewer_name='xanes3D_review_viewer')
            if not viewer_state:
                ijui.show(ij.py.to_java(self.trial_reg-self.trial_reg_fixed))
                ij.py.run_macro("""run("Enhance Contrast", "saturated=0.35")""")
                self.xanes3D_fiji_windows['xanes3D_review_viewer']['ip'] = WindowManager.getCurrentImage()
                self.xanes3D_fiji_windows['xanes3D_review_viewer']['fiji_id'] = WindowManager.getIDList()[-1]
                self.xanes3D_fiji_windows['xanes3D_review_viewer']['ip'].setSlice(0)
                self.xanes3D_fiji_windows['xanes3D_review_viewer']['ip'].setTitle('reg review')
        elif viewer_name == 'xanes3D_review_manual_viewer':
            data_state, viewer_state = self.fiji_viewer_state(viewer_name='xanes3D_review_manual_viewer')
            if not viewer_state:
                ijui.show(ij.py.to_java(self.xanes3D_review_aligned_img-self.trial_reg_fixed))
                ij.py.run_macro("""run("Enhance Contrast", "saturated=0.35")""")
                self.xanes3D_fiji_windows['xanes3D_review_manual_viewer']['ip'] = WindowManager.getCurrentImage()
                self.xanes3D_fiji_windows['xanes3D_review_manual_viewer']['fiji_id'] = WindowManager.getIDList()[-1]
                self.xanes3D_fiji_windows['xanes3D_review_manual_viewer']['ip'].setSlice(0)
                self.xanes3D_fiji_windows['xanes3D_review_manual_viewer']['ip'].setTitle('reg manual review')
            ...
            if not data_state:
                ...
                with h5py.File(self.xanes3D_save_trial_reg_filename, 'r') as f:
                    if self.hs['L[0][2][3][0][3][1]_visualize_view_alignment_option_dropdown'].value == 'x-y-E':
                    ...
                    elif self.hs['L[0][2][3][0][3][1]_visualize_view_alignment_option_dropdown'].value == 'y-z-E':
                        self.xanes3D_aligned_data = 0
                        self.xanes3D_aligned_data = f['/registration_results/reg_results/registered_xanes3D'][:, :, :, self.xanes3D_analysis_slice]
                    elif self.hs['L[0][2][3][0][3][1]_visualize_view_alignment_option_dropdown'].value == 'z-x-E':
                        self.xanes3D_aligned_data = 0
                        self.xanes3D_aligned_data = f['/registration_results/reg_results/registered_xanes3D'][:, :, self.xanes3D_analysis_slice, :]
                    elif self.hs['L[0][2][3][0][3][1]_visualize_view_alignment_option_dropdown'].value == 'x-y-z':
                        self.xanes3D_aligned_data = 0
                        self.xanes3D_aligned_data = f['/registration_results/reg_results/registered_xanes3D'][self.xanes3D_analysis_slice, :, :, :]
                # f.close()
            if not viewer_state:
                ...
                self.xanes3D_fiji_windows['xanes3D_analysis_viewer']['ip'].setSlice(self.hs['L[0][2][3][0][1][3]_visualize_view_alignment_slice_slider'].value)
                self.hs['L[0][2][3][0][1][1]_visualize_alignment_eng_text'].value = self.xanes3D_analysis_eng_list[self.hs['L[0][2][3][0][1][3]_visualize_view_alignment_slice_slider'].value]
    ...
    def fiji_viewer_state(self, viewer_name='xanes3D_virtural_stack_preview_viewer'):
        if viewer_name == 'xanes3D_virtural_stack_preview_viewer':
            ...
            if (self.xanes3D_mask is None):
                data_state = False
            elif (self.xanes3D_mask.shape != (self.xanes3D_roi[1]-self.xanes3D_roi[0],
            ...
            if WindowManager.getIDList() is None:
                viewer_state = False
            elif not self.xanes3D_fiji_windows['xanes3D_review_viewer']['fiji_id'] in WindowManager.getIDList():
                viewer_state = False
            else:
                viewer_state = True
        elif viewer_name == 'xanes3D_review_manual_viewer':
            if self.xanes3D_review_aligned_img is None:
                data_state = False
            elif (self.xanes3D_review_aligned_img != (self.xanes3D_roi[1]-self.xanes3D_roi[0],
                                                      self.xanes3D_roi[3]-self.xanes3D_roi[2])):
                data_state = False
            else:
                data_state = True
            ...
            if WindowManager.getIDList() is None:
                viewer_state = False
            elif not self.xanes3D_fiji_windows['xanes3D_review_manual_viewer']['fiji_id'] in WindowManager.getIDList():
                viewer_state = False
            else:
                viewer_state = True
        elif viewer_name == 'xanes3D_analysis_viewer':
    ...
    def lock_message_text_boxes(self):
        boxes = ['L[0][2][0][0][1][1]_select_raw_h5_path_text',
                 ...
                 'L[0][2][3][0][1][1]_visualize_alignment_eng_text',
                 'L[0][2][3][0][2][0]_visualize_spec_view_text']
    ...
    def determine_element(self, dtype='3D_XANES'):
        if dtype == '3D_XANES':
            if ((self.xanes3D_analysis_eng_list.min()<9.669e3) & (self.xanes3D_analysis_eng_list.max()>9.669e3)):
                self.xanes_element = 'Zn'
            elif ((self.xanes3D_analysis_eng_list.min()<8.995e3) & (self.xanes3D_analysis_eng_list.max()>8.995e3)):
                self.xanes_element = 'Cu'
            elif ((self.xanes3D_analysis_eng_list.min()<8.353e3) & (self.xanes3D_analysis_eng_list.max()>8.353e3)):
                self.xanes_element = 'Ni'
            elif ((self.xanes3D_analysis_eng_list.min()<7.729e3) & (self.xanes3D_analysis_eng_list.max()>7.729e3)):
                self.xanes_element = 'Co'
            elif ((self.xanes3D_analysis_eng_list.min()<7.136e3) & (self.xanes3D_analysis_eng_list.max()>7.136e3)):
                self.xanes_element = 'Fe'
            elif ((self.xanes3D_analysis_eng_list.min()<6.561e3) & (self.xanes3D_analysis_eng_list.max()>6.561e3)):
                self.xanes_element = 'Mn'
            elif ((self.xanes3D_analysis_eng_list.min()<6.009e3) & (self.xanes3D_analysis_eng_list.max()>6.009e3)):
                self.xanes_element = 'Cr'
            elif ((self.xanes3D_analysis_eng_list.min()<5.495e3) & (self.xanes3D_analysis_eng_list.max()>5.495e3)):
                self.xanes_element = 'V'
            elif ((self.xanes3D_analysis_eng_list.min()<4.984e3) & (self.xanes3D_analysis_eng_list.max()>4.984e3)):
                self.xanes_element = 'Ti'
        else:
            if ((self.xanes2D_analysis_eng_list.min()<9.669e3) & (self.xanes2D_analysis_eng_list.max()>9.669e3)):
                self.xanes_element = 'Zn'
            elif ((self.xanes2D_analysis_eng_list.min()<8.995e3) & (self.xanes2D_analysis_eng_list.max()>8.995e3)):
                self.xanes_element = 'Cu'
            elif ((self.xanes2D_analysis_eng_list.min()<8.353e3) & (self.xanes2D_analysis_eng_list.max()>8.353e3)):
                self.xanes_element = 'Ni'
            elif ((self.xanes2D_analysis_eng_list.min()<7.729e3) & (self.xanes2D_analysis_eng_list.max()>7.729e3)):
                self.xanes_element = 'Co'
            elif ((self.xanes2D_analysis_eng_list.min()<7.136e3) & (self.xanes2D_analysis_eng_list.max()>7.136e3)):
                self.xanes_element = 'Fe'
            elif ((self.xanes2D_analysis_eng_list.min()<6.561e3) & (self.xanes2D_analysis_eng_list.max()>6.561e3)):
                self.xanes_element = 'Mn'
            elif ((self.xanes2D_analysis_eng_list.min()<6.009e3) & (self.xanes2D_analysis_eng_list.max()>6.009e3)):
                self.xanes_element = 'Cr'
            elif ((self.xanes2D_analysis_eng_list.min()<5.495e3) & (self.xanes2D_analysis_eng_list.max()>5.495e3)):
                self.xanes_element = 'V'
            elif ((self.xanes2D_analysis_eng_list.min()<4.984e3) & (self.xanes2D_analysis_eng_list.max()>4.984e3)):
                self.xanes_element = 'Ti'

    def determine_fitting_energy_range(self, dtype='3D_XANES'):
        if dtype == '3D_XANES':
            if self.xanes_element == 'Zn':
                self.xanes3D_analysis_edge_eng = 9.661e3
                self.xanes3D_analysis_wl_fit_eng_s = 9.664e3
                self.xanes3D_analysis_wl_fit_eng_e = 9.673e3
                self.xanes3D_analysis_pre_edge_e = 9.611e3
                self.xanes3D_analysis_post_edge_s = 9.761e3
                self.xanes3D_analysis_edge_0p5_fit_s = 9.659e3
                self.xanes3D_analysis_edge_0p5_fit_e = 9.669e3
            elif self.xanes_element == 'Cu':
                self.xanes3D_analysis_edge_eng = 8.989e3
                self.xanes3D_analysis_wl_fit_eng_s = 8.990e3
                self.xanes3D_analysis_wl_fit_eng_e = 9.000e3
                self.xanes3D_analysis_pre_edge_e = 8.939e3
                self.xanes3D_analysis_post_edge_s = 9.089e3
                self.xanes3D_analysis_edge_0p5_fit_s = 8.976e3
                self.xanes3D_analysis_edge_0p5_fit_e = 8.996e3
            elif self.xanes_element == 'Ni':
                self.xanes3D_analysis_edge_eng = 8.347e3
                # self.xanes3D_analysis_wl_fit_eng_s = 8.347
                # self.xanes3D_analysis_wl_fit_eng_e = 8.359
                self.xanes3D_analysis_wl_fit_eng_s = 8.342e3
                self.xanes3D_analysis_wl_fit_eng_e = 8.355e3
                self.xanes3D_analysis_pre_edge_e = 8.297e3
                self.xanes3D_analysis_post_edge_s = 8.447e3
                self.xanes3D_analysis_edge_0p5_fit_s = 8.340e3
                self.xanes3D_analysis_edge_0p5_fit_e = 8.352e3
            elif self.xanes_element == 'Co':
                self.xanes3D_analysis_edge_eng = 7.724e3
                self.xanes3D_analysis_wl_fit_eng_s = 7.725e3
                self.xanes3D_analysis_wl_fit_eng_e = 7.733e3
                self.xanes3D_analysis_pre_edge_e = 7.674e3
                self.xanes3D_analysis_post_edge_s = 7.824e3
                self.xanes3D_analysis_edge_0p5_fit_s = 7.717e3
                self.xanes3D_analysis_edge_0p5_fit_e = 7.728e3
            elif self.xanes_element == 'Fe':
                self.xanes3D_analysis_edge_eng = 7.126e3
                self.xanes3D_analysis_wl_fit_eng_s = 7.128e3
                self.xanes3D_analysis_wl_fit_eng_e = 7.144e3
                self.xanes3D_analysis_pre_edge_e = 7.076e3
                self.xanes3D_analysis_post_edge_s = 7.226e3
                self.xanes3D_analysis_edge_0p5_fit_s = 7.116e3
                self.xanes3D_analysis_edge_0p5_fit_e = 7.134e3
            elif self.xanes_element == 'Mn':
                self.xanes3D_analysis_edge_eng = 6.556e3
                self.xanes3D_analysis_wl_fit_eng_s = 6.556e3
                self.xanes3D_analysis_wl_fit_eng_e = 6.565e3
                self.xanes3D_analysis_pre_edge_e = 6.506e3
                self.xanes3D_analysis_post_edge_s = 6.656e3
                self.xanes3D_analysis_edge_0p5_fit_s = 6.547e3
                self.xanes3D_analysis_edge_0p5_fit_e = 6.560e3
            elif self.xanes_element == 'Cr':
                self.xanes3D_analysis_edge_eng = 6.002e3
                self.xanes3D_analysis_wl_fit_eng_s = 6.005e3
                self.xanes3D_analysis_wl_fit_eng_e = 6.012e3
                self.xanes3D_analysis_pre_edge_e = 5.952e3
                self.xanes3D_analysis_post_edge_s = 6.102e3
                self.xanes3D_analysis_edge_0p5_fit_s = 5.998e3
                self.xanes3D_analysis_edge_0p5_fit_e = 6.011e3
            elif self.xanes_element == 'V':
                self.xanes3D_analysis_edge_eng = 5.483e3
                self.xanes3D_analysis_wl_fit_eng_s = 5.490e3
                self.xanes3D_analysis_wl_fit_eng_e = 5.499e3
                self.xanes3D_analysis_pre_edge_e = 5.433e3
                self.xanes3D_analysis_post_edge_s = 5.583e3
                self.xanes3D_analysis_edge_0p5_fit_s = 5.474e3
                self.xanes3D_analysis_edge_0p5_fit_e = 5.487e3
            elif self.xanes_element == 'Ti':
                self.xanes3D_analysis_edge_eng = 4.979e3
                self.xanes3D_analysis_wl_fit_eng_s = 4.981e3
                self.xanes3D_analysis_wl_fit_eng_e = 4.986e3
                self.xanes3D_analysis_pre_edge_e = 4.929e3
                self.xanes3D_analysis_post_edge_s = 5.079e3
                self.xanes3D_analysis_edge_0p5_fit_s = 4.973e3
                self.xanes3D_analysis_edge_0p5_fit_e = 4.984e3
        else:
            if self.xanes_element == 'Zn':
                self.xanes2D_analysis_edge_eng = 9.661e3
                self.xanes2D_analysis_wl_fit_eng_s = 9.664e3
                self.xanes2D_analysis_wl_fit_eng_e = 9.673e3
                self.xanes2D_analysis_pre_edge_e = 9.611e3
                self.xanes2D_analysis_post_edge_s = 9.761e3
                self.xanes2D_analysis_edge_0p5_fit_s = 9.659e3
                self.xanes2D_analysis_edge_0p5_fit_e = 9.669e3
            elif self.xanes_element == 'Cu':
                self.xanes2D_analysis_edge_eng = 8.989e3
                self.xanes2D_analysis_wl_fit_eng_s = 8.990e3
                self.xanes2D_analysis_wl_fit_eng_e = 9.000e3
                self.xanes2D_analysis_pre_edge_e = 8.939e3
                self.xanes2D_analysis_post_edge_s = 9.089e3
                self.xanes2D_analysis_edge_0p5_fit_s = 8.976e3
                self.xanes2D_analysis_edge_0p5_fit_e = 8.996e3
            elif self.xanes_element == 'Ni':
                self.xanes2D_analysis_edge_eng = 8.347e3
                # self.xanes2D_analysis_wl_fit_eng_s = 8.347
                # self.xanes2D_analysis_wl_fit_eng_e = 8.359
                self.xanes2D_analysis_wl_fit_eng_s = 8.342e3
                self.xanes2D_analysis_wl_fit_eng_e = 8.355e3
                self.xanes2D_analysis_pre_edge_e = 8.297e3
                self.xanes2D_analysis_post_edge_s = 8.447e3
                self.xanes2D_analysis_edge_0p5_fit_s = 8.340e3
                self.xanes2D_analysis_edge_0p5_fit_e = 8.352e3
            elif self.xanes_element == 'Co':
                self.xanes2D_analysis_edge_eng = 7.724e3
                self.xanes2D_analysis_wl_fit_eng_s = 7.725e3
                self.xanes2D_analysis_wl_fit_eng_e = 7.733e3
                self.xanes2D_analysis_pre_edge_e = 7.674e3
                self.xanes2D_analysis_post_edge_s = 7.824e3
                self.xanes2D_analysis_edge_0p5_fit_s = 7.717e3
                self.xanes2D_analysis_edge_0p5_fit_e = 7.728e3
            elif self.xanes_element == 'Fe':
                self.xanes2D_analysis_edge_eng = 7.126e3
                self.xanes2D_analysis_wl_fit_eng_s = 7.128e3
                self.xanes2D_analysis_wl_fit_eng_e = 7.144e3
                self.xanes2D_analysis_pre_edge_e = 7.076e3
                self.xanes2D_analysis_post_edge_s = 7.226e3
                self.xanes2D_analysis_edge_0p5_fit_s = 7.116e3
                self.xanes2D_analysis_edge_0p5_fit_e = 7.134e3
            elif self.xanes_element == 'Mn':
                self.xanes2D_analysis_edge_eng = 6.556e3
                self.xanes2D_analysis_wl_fit_eng_s = 6.556e3
                self.xanes2D_analysis_wl_fit_eng_e = 6.565e3
                self.xanes2D_analysis_pre_edge_e = 6.506e3
                self.xanes2D_analysis_post_edge_s = 6.656e3
                self.xanes2D_analysis_edge_0p5_fit_s = 6.547e3
                self.xanes2D_analysis_edge_0p5_fit_e = 6.560e3
            elif self.xanes_element == 'Cr':
                self.xanes2D_analysis_edge_eng = 6.002e3
                self.xanes2D_analysis_wl_fit_eng_s = 6.005e3
                self.xanes2D_analysis_wl_fit_eng_e = 6.012e3
                self.xanes2D_analysis_pre_edge_e = 5.952e3
                self.xanes2D_analysis_post_edge_s = 6.102e3
                self.xanes2D_analysis_edge_0p5_fit_s = 5.998e3
                self.xanes2D_analysis_edge_0p5_fit_e = 6.011e3
            elif self.xanes_element == 'V':
                self.xanes2D_analysis_edge_eng = 5.483e3
                self.xanes2D_analysis_wl_fit_eng_s = 5.490e3
                self.xanes2D_analysis_wl_fit_eng_e = 5.499e3
                self.xanes2D_analysis_pre_edge_e = 5.433e3
                self.xanes2D_analysis_post_edge_s = 5.583e3
                self.xanes2D_analysis_edge_0p5_fit_s = 5.474e3
                self.xanes2D_analysis_edge_0p5_fit_e = 5.487e3
            elif self.xanes_element == 'Ti':
                self.xanes2D_analysis_edge_eng = 4.979e3
                self.xanes2D_analysis_wl_fit_eng_s = 4.981e3
                self.xanes2D_analysis_wl_fit_eng_e = 4.986e3
                self.xanes2D_analysis_pre_edge_e = 4.929e3
                self.xanes2D_analysis_post_edge_s = 5.079e3
                self.xanes2D_analysis_edge_0p5_fit_s = 4.973e3
                self.xanes2D_analysis_edge_0p5_fit_e = 4.984e3

    def gen_external_py_script(self, code, dtype='3D_XANES'):
        if dtype == '3D_XANES':
    ...
    def read_config_from_reg_file(self, dtype='2D_XANES'):
        if dtype == '2D_XANES':
            pass
        elif dtype == '3D_XANES':
            # f = h5py.File(self.xanes3D_save_trial_reg_filename, 'r')
            with h5py.File(self.xanes3D_save_trial_reg_filename, 'r') as f:
                ...
                self.xanes3D_reg_method = f['/trial_registration/trial_reg_parameters/reg_method'][()]
                self.xanes3D_reg_ref_mode = f['/trial_registration/trial_reg_parameters/reg_ref_mode'][()]
                self.xanes3D_reg_use_smooth_img = bool(f['/trial_registration/trial_reg_parameters/use_smooth_img'][()])
                self.xanes3D_reg_smooth_sigma = int(f['/trial_registration/trial_reg_parameters/img_smooth_sigma'][()])
                self.xanes3D_reg_use_chunk = bool(f['/trial_registration/trial_reg_parameters/use_chunk'][()])
                self.xanes3D_reg_chunk_sz = int(f['/trial_registration/trial_reg_parameters/chunk_sz'][()])
                self.xanes3D_reg_use_mask = bool(f['/trial_registration/trial_reg_parameters/use_mask'][()])
    ...
    def boxes_logic(self, tab='3D_XANES'):
        def xanes2D_compound_logic():
            ...
            if self.hs['L[0][1][0][1][1][1][0]_use_alternative_flat_checkbox'].value:
                boxes = ['L[0][1][0][1][1][2][1]_alternative_flat_file_button']
                self.enable_disable_boxes(boxes, disabled=False, level=-1)
            else:
                boxes = ['L[0][1][0][1][1][2][1]_alternative_flat_file_button']
                self.enable_disable_boxes(boxes, disabled=True, level=-1)
        ...
        def xanes3D_compound_logic():
            if self.xanes3D_reg_done:
                if (self.hs['L[0][2][2][1][1][1]_read_alignment_checkbox'].value &
                    ...
                    self.enable_disable_boxes(boxes, disabled=True, level=-1)
                    self.hs['L[0][2][2][1][1][0]_read_alignment_button'].disabled = False
                else:
            ...
            if self.xanes3D_reg_review_done:
                if self.hs['L[0][2][2][2][1][0]_align_recon_optional_slice_checkbox'].value:
                    boxes = ['L[0][2][2][2][1][1]_align_recon_optional_slice_start_text',
                            'L[0][2][2][2][1][2]_align_recon_optional_slice_range_slider',
                            'L[0][2][2][2][1][3]_align_recon_optional_slice_end_text']
                    self.enable_disable_boxes(boxes, disabled=False, level=-1)
                else:
                    boxes = ['L[0][2][2][2][1][1]_align_recon_optional_slice_start_text',
                            'L[0][2][2][2][1][2]_align_recon_optional_slice_range_slider',
            ...
            if self.xanes3D_alignment_done | (self.xanes3D_analysis_option == 'Do Analysis'):
                if self.xanes3D_visualization_viewer_option == 'fiji':
                    boxes = ['L[0][2][3][0][1]_visualize_view_alignment_box',
                             'L[0][2][3][0][2]_visualize_spec_view_box']
                    self.enable_disable_boxes(boxes, disabled=False, level=-1)
        ...
        if tab == '3D_XANES':
            ...
            if self.xanes2D_file_analysis_option == 'Do New Reg':
                ...
                xanes2D_compound_logic()
                self.lock_message_text_boxes()
        self.hs['L[0][2][2][1][3][0]_zshift_slider'].disabled = True
        self.hs['L[0][2][2][1][3][1]_best_match_text'] = True
    ...
    def gui_layout(self):
        ...
        self.hs['L[0][2][2][1][3][2]_record_button'].style.button_color = 'darkviolet'
        layout = {'width':'15%', 'height':'90%'}
        self.hs['L[0][2][2][1][3][3]_reg_pair_bad_button'] = widgets.Button(description='Bad',
                                                                       description_tooltip='Bad reg',
                                                                       disabled=True)
        self.hs['L[0][2][2][1][3][3]_reg_pair_bad_button'].layout = layout
        self.hs['L[0][2][2][1][3][3]_reg_pair_bad_button'].style.button_color = 'darkviolet'
        ...
        self.hs['L[0][2][2][1][3][3]_reg_pair_bad_button'].on_click(self.L0_2_2_1_3_3_reg_pair_bad_button)
        ...
        layout = {'border':'3px solid #FFCC00', 'width':f'{self.form_sz[1]-98}px', 'height':f'{0.07*(self.form_sz[0]-128)}px'}
        self.hs['L[0][2][2][1][5]_review_manual_shift_box'] = widgets.HBox()
        self.hs['L[0][2][2][1][5]_review_manual_shift_box'].layout = layout
        layout = {'width':'28%', 'height':'90%'}
        self.hs['L[0][2][2][1][5][0]_review_manual_x_shift_text'] = widgets.FloatText(value=0,
                                                                                        disabled=True,
                                                                                        min = -100,
                                                                                        max = 100,
                                                                                        step = 0.5,
                                                                                        description='x shift')
        self.hs['L[0][2][2][1][5][0]_review_manual_x_shift_text'].layout = layout
        layout = {'width':'28%', 'height':'90%'}
        self.hs['L[0][2][2][1][5][1]_review_manual_y_shift_text'] = widgets.FloatText(value=0,
                                                                                        disabled=True,
                                                                                        min = -100,
                                                                                        max = 100,
                                                                                        step = 0.5,
                                                                                        description='y shift')
        self.hs['L[0][2][2][1][5][1]_review_manual_y_shift_text'].layout = layout
        layout = {'width':'28%', 'height':'90%'}
        self.hs['L[0][2][2][1][5][2]_review_manual_z_shift_text'] = widgets.IntText(value=0,
                                                                                      disabled=True,
                                                                                      min = 1,
                                                                                      max = 100,
                                                                                      step = 1,
                                                                                      description='z shift')
        self.hs['L[0][2][2][1][5][2]_review_manual_z_shift_text'].layout = layout
        layout = {'width':'15%', 'height':'90%'}
        self.hs['L[0][2][2][1][5][3]_review_manual_shift_record_button'] = widgets.Button(disabled=True,
                                                                                          description='Record')
        self.hs['L[0][2][2][1][5][3]_review_manual_shift_record_button'].layout = layout
        self.hs['L[0][2][2][1][5][3]_review_manual_shift_record_button'].style.button_color = 'darkviolet'
        self.hs['L[0][2][2][1][5]_review_manual_shift_box'].children = self.get_handles('L[0][2][2][1][5]_review_manual_shift_box', -1)
        self.hs['L[0][2][2][1][5][0]_review_manual_x_shift_text'].observe(self.L0_2_2_1_5_0_review_manual_x_shift_text, names='value')
        self.hs['L[0][2][2][1][5][1]_review_manual_y_shift_text'].observe(self.L0_2_2_1_5_1_review_manual_y_shift_text, names='value')
        self.hs['L[0][2][2][1][5][2]_review_manual_z_shift_text'].observe(self.L0_2_2_1_5_2_review_manual_z_shift_text, names='value')
        self.hs['L[0][2][2][1][5][3]_review_manual_shift_record_button'].on_click(self.L0_2_2_1_5_3_review_manual_shift_record_button)
        ...
        self.hs['L[0][2][3][0][3]_visualize_viewer_option_box'] = widgets.HBox()
        self.hs['L[0][2][3][0][3]_visualize_viewer_option_box'].layout = layout
        layout = {'width':'80%', 'height':'90%'}
        self.hs['L[0][2][3][0][3][0]_visualize_viewer_option_togglebutton'] = widgets.ToggleButtons(description='viewer options',
                                                                                        description_tooltip='napari: provides better image preview functions; fiji: provides quick spectrum inspection functions',
                                                                                        options=['fiji', 'napari'],
                                                                                        value ='fiji',
                                                                                        disabled=True)
        self.hs['L[0][2][3][0][3][0]_visualize_viewer_option_togglebutton'].layout = layout
        layout = {'width':'20%', 'height':'90%'}
        self.hs['L[0][2][3][0][3][1]_visualize_view_alignment_option_dropdown'] = widgets.Dropdown(description='view option',
                                                                                                  ...
                                                                                                  value ='x-y-E',
                                                                                                  disabled=True)
        self.hs['L[0][2][3][0][3][1]_visualize_view_alignment_option_dropdown'].layout = layout
        self.hs['L[0][2][3][0][3][0]_visualize_viewer_option_togglebutton'].observe(self.L0_2_3_0_3_0_visualize_viewer_option_togglebutton_change, names='value')
        self.hs['L[0][2][3][0][3][1]_visualize_view_alignment_option_dropdown'].observe(self.L0_2_3_0_3_1_visualize_view_alignment_option_dropdown, names='value')
        self.hs['L[0][2][3][0][3]_visualize_viewer_option_box'].children = self.get_handles('L[0][2][3][0][3]_visualize_viewer_option_box', -1)
        ...
        layout = {'width':'20%', 'height':'90%'}
        self.hs['L[0][2][3][0][1][1]_visualize_alignment_eng_text'] = widgets.FloatText(value=0,
                                                                                             description='E',
                                                                                             disabled=True)
        self.hs['L[0][2][3][0][1][1]_visualize_alignment_eng_text'].layout = layout
        ...
        layout = {'border':'3px solid #FFCC00', 'width':f'{self.form_sz[1]-108}px', 'height':f'{0.07*(self.form_sz[0]-128)}px'}
        ...
        #                                                                                                               #
        #################################################################################################################
        self.tomo_recon_gui = trg.tomo_recon_gui(form_sz=self.form_sz)
    ...
    def L0_2_0_0_1_0_select_raw_h5_path_button_click(self, a):
        ...
        if len(a.files[0]) != 0:
            ...
            self.hs['L[0][2][2][1][1][0]_read_alignment_button'].initialdir = os.path.abspath(a.files[0])
    ...
    def L0_2_0_0_3_0_select_save_trial_button_click(self, a):
        ...
        if self.xanes3D_analysis_option == 'Do New Reg':
            if len(a.files[0]) != 0:
                ...
                self.hs['L[0][2][2][1][1][0]_read_alignment_button'].initialdir = os.path.dirname(os.path.abspath(a.files[0]))
    ...
    def L0_2_0_0_4_0_confirm_file_path_button_click(self, a):
        if self.xanes3D_analysis_option == 'Do New Reg':
            ...
            if not self.xanes3D_reg_file_set:
                ...
                self.hs['L[0][2][2][1][2][0]_reg_pair_slider'].max = self.xanes3D_alignment_pairs.shape[0]-1
                self.hs['L[0][2][2][1][2][0]_reg_pair_slider'].value = 0
                self.hs['L[0][2][2][1][2][0]_reg_pair_slider'].min = 0
                self.hs['L[0][2][2][1][3][0]_zshift_slider'].max = self.xanes3D_reg_sli_search_half_width*2
                self.hs['L[0][2][2][1][3][0]_zshift_slider'].value = 1
            ...
            if not self.xanes3D_config_file_set:
                ...
                if self.xanes3D_alignment_done:
                    ...
                    self.hs['L[0][2][3][0][3][1]_visualize_view_alignment_option_dropdown'].value = 'x-y-E'
                    self.hs['L[0][2][3][0][1][3]_visualize_view_alignment_slice_slider'].description = 'E'
                    self.hs['L[0][2][3][0][1][3]_visualize_view_alignment_slice_slider'].max = self.xanes3D_analysis_data_shape[0]-1
                    ...
                    self.hs['L[0][2][3][0][1][2]_visualize_view_alignment_4th_dim_slider'].max = self.xanes3D_analysis_data_shape[1]-1
    ...
    def L0_2_2_0_1_0_run_reg_button_click(self, a):
        ...
        self.hs['L[0][2][2][1][3][0]_zshift_slider'].value = 1
        self.hs['L[0][2][2][1][3][0]_zshift_slider'].min = 1
        self.hs['L[0][2][2][1][5][2]_review_manual_z_shift_text'].max = self.xanes3D_reg_sli_search_half_width*2
    ...
    def L0_2_2_1_2_0_reg_pair_slider_change(self, a):
        ...
        # f.close()
        self.fiji_viewer_off(viewer_name='xanes3D_review_viewer')
        ij.py.run_macro("""call("java.lang.System.gc")""")
        self.fiji_viewer_on(viewer_name='xanes3D_review_viewer')
        self.xanes3D_fiji_windows['xanes3D_review_viewer']['ip'].setTitle('reg pair: '+str(self.xanes3D_alignment_pair_id).zfill(3))
        ij.py.run_macro("""run("Enhance Contrast", "saturated=0.35")""")
    ...
    def L0_2_2_1_3_0_zshift_slider_change(self, a):
        # self.fiji_viewer_on(viewer_name='xanes3D_review_viewer')
        # sliid = a['owner'].value
        # self.xanes3D_fiji_windows['xanes3D_review_viewer']['ip'].setSlice(sliid)
        # self.xanes3D_reg_review_done = False
        # self.boxes_logic(tab='3D_XANES')
        pass
    ...
    def L0_2_2_1_3_2_record_button_click(self, a):
        ...
        best_match = self.xanes3D_fiji_windows['xanes3D_review_viewer']['ip'].currentSlice - 1
        self.xanes3D_review_shift_dict[str(self.xanes3D_alignment_pair_id)] = np.array([best_match - self.xanes3D_reg_sli_search_half_width,
                                                                                        shift[best_match][0],
                                                                                        shift[best_match][1]])
        self.hs['L[0][2][2][1][4][0]_confirm_review_results_text'].value = str(self.xanes3D_review_shift_dict)
        json.dump(self.xanes3D_review_shift_dict, open(self.xanes3D_reg_best_match_filename, 'w'), cls=NumpyArrayEncoder)
        self.xanes3D_reg_review_done = False
        self.boxes_logic(tab='3D_XANES')

    def L0_2_2_1_3_3_reg_pair_bad_button(self, a):
        self.xanes3D_review_bad_shift = True
        self.xanes3D_manual_xshift = 0
        self.xanes3D_manual_yshift = 0
        # self.xanes3D_manual_zshift = self.hs['L[0][2][2][1][3][1]_best_match_text'].value
        # self.hs['L[0][2][2][1][5][2]_review_manual_z_shift_text'].value = self.hs['L[0][2][2][1][3][1]_best_match_text'].value
        self.xanes3D_manual_zshift = self.xanes3D_fiji_windows['xanes3D_review_viewer']['ip'].currentSlice
        self.fiji_viewer_on(viewer_name='xanes3D_review_manual_viewer')
        self.hs['L[0][2][2][1][5][2]_review_manual_z_shift_text'].value = self.xanes3D_fiji_windows['xanes3D_review_viewer']['ip'].currentSlice
        ij.py.run_macro("""run("Enhance Contrast", "saturated=0.35")""")
        self.xanes3D_reg_review_done = False
        self.boxes_logic(tab='3D_XANES')

    def L0_2_2_1_5_0_review_manual_x_shift_text(self, a):
        self.xanes3D_manual_xshift = self.hs['L[0][2][2][1][5][0]_review_manual_x_shift_text'].value
        self.xanes3D_manual_yshift = self.hs['L[0][2][2][1][5][1]_review_manual_y_shift_text'].value
        self.xanes3D_manual_zshift = self.hs['L[0][2][2][1][5][2]_review_manual_z_shift_text'].value
        ...
        # self.fiji_viewer_on(viewer_name='xanes3D_review_manual_viewer')
        self.xanes3D_fiji_windows['xanes3D_review_manual_viewer']['ip'].setImage(ij.convert().convert(ij.dataset().create(ij.py.to_java(xanes3D_review_aligned_img-
    ...
    def L0_2_2_1_5_1_review_manual_y_shift_text(self, a):
        self.xanes3D_manual_xshift = self.hs['L[0][2][2][1][5][0]_review_manual_x_shift_text'].value
        self.xanes3D_manual_yshift = self.hs['L[0][2][2][1][5][1]_review_manual_y_shift_text'].value
        self.xanes3D_manual_zshift = self.hs['L[0][2][2][1][5][2]_review_manual_z_shift_text'].value
        xanes3D_review_aligned_img = (np.real(np.fft.ifftn(fourier_shift(np.fft.fftn(self.trial_reg[self.xanes3D_manual_zshift-1]),
    ...
    def L0_2_2_1_5_2_review_manual_z_shift_text(self, a):
        self.xanes3D_manual_xshift = self.hs['L[0][2][2][1][5][0]_review_manual_x_shift_text'].value
        self.xanes3D_manual_yshift = self.hs['L[0][2][2][1][5][1]_review_manual_y_shift_text'].value
        self.xanes3D_manual_zshift = self.hs['L[0][2][2][1][5][2]_review_manual_z_shift_text'].value
        xanes3D_review_aligned_img = (np.real(np.fft.ifftn(fourier_shift(np.fft.fftn(self.trial_reg[self.xanes3D_manual_zshift-1]),
    ...
    def L0_2_2_1_5_3_review_manual_shift_record_button(self, a):
        """
        ...
        self.hs['L[0][2][2][1][5][0]_review_manual_x_shift_text'].value = 0
        self.hs['L[0][2][2][1][5][1]_review_manual_y_shift_text'].value = 0
        self.hs['L[0][2][2][1][5][2]_review_manual_z_shift_text'].value = 1
        self.fiji_viewer_off(viewer_name='xanes3D_review_manual_viewer')
        json.dump(self.xanes3D_review_shift_dict, open(self.xanes3D_reg_best_match_filename, 'w'), cls=NumpyArrayEncoder)
        self.xanes3D_reg_review_done = False
        self.boxes_logic(tab='3D_XANES')

    def L0_2_2_1_4_1_confirm_review_results_button_click(self, a):
        if len(self.xanes3D_review_shift_dict) != (self.hs['L[0][2][2][1][2][0]_reg_pair_slider'].max+1):
    ...
    def L0_2_2_2_2_1_align_button_click(self, a):
        ...
        reg.set_saving(save_path=os.path.dirname(self.xanes3D_save_trial_reg_filename),
                       fn=os.path.basename(self.xanes3D_save_trial_reg_filename))
        reg.compose_dicts()
        reg.apply_xanes3D_chunk_shift(self.xanes3D_review_shift_dict,
                                      roi[4],
                                      roi[5],
    ...
    def L0_2_3_0_3_0_visualize_viewer_option_togglebutton_change(self, a):
    ...
    def L0_2_3_0_3_1_visualize_view_alignment_option_dropdown(self, a):
        ...
        with h5py.File(self.xanes3D_save_trial_reg_filename, 'r') as f:
            if self.xanes3D_analysis_view_option == 'x-y-E':
                ...
                self.hs['L[0][2][3][0][1][2]_visualize_view_alignment_4th_dim_slider'].max = self.xanes3D_analysis_data_shape[3]-1
                self.hs['L[0][2][3][0][1][2]_visualize_view_alignment_4th_dim_slider'].min = 0
                self.xanes3D_aligned_data = 0
                ...
                self.hs['L[0][2][3][0][1][2]_visualize_view_alignment_4th_dim_slider'].max = self.xanes3D_analysis_data_shape[2]-1
                self.hs['L[0][2][3][0][1][2]_visualize_view_alignment_4th_dim_slider'].min = 0
                self.xanes3D_aligned_data = 0
                ...
                self.hs['L[0][2][3][0][1][3]_visualize_view_alignment_slice_slider'].max = self.xanes3D_analysis_data_shape[1]-1
                self.hs['L[0][2][3][0][1][3]_visualize_view_alignment_slice_slider'].min = 0
                self.hs['L[0][2][3][0][1][2]_visualize_view_alignment_4th_dim_slider'].value = 0
                self.hs['L[0][2][3][0][1][2]_visualize_view_alignment_4th_dim_slider'].description = 'E'
                self.hs['L[0][2][3][0][1][2]_visualize_view_alignment_4th_dim_slider'].max = self.xanes3D_analysis_data_shape[0]-1
                self.hs['L[0][2][3][0][1][2]_visualize_view_alignment_4th_dim_slider'].min = 0
                self.xanes3D_aligned_data = 0
                self.xanes3D_aligned_data = f['/registration_results/reg_results/registered_xanes3D'][:, 0, :, :]
        # f.close()
    ...
    def L0_2_3_0_1_2_visualize_view_alignment_4th_dim_slider(self, a):
        ...
        with h5py.File(self.xanes3D_save_trial_reg_filename, 'r') as f:
            if self.hs['L[0][2][3][0][3][1]_visualize_view_alignment_option_dropdown'].value == 'x-y-E':
                self.xanes3D_aligned_data = 0
                self.xanes3D_aligned_data = f['/registration_results/reg_results/registered_xanes3D'][:, self.xanes3D_analysis_slice, :, :]
                self.hs['L[0][2][3][0][1][1]_visualize_alignment_eng_text'].value = self.xanes3D_analysis_eng_list[self.xanes3D_analysis_slice]
            elif self.hs['L[0][2][3][0][3][1]_visualize_view_alignment_option_dropdown'].value == 'y-z-E':
                self.xanes3D_aligned_data = 0
                self.xanes3D_aligned_data = f['/registration_results/reg_results/registered_xanes3D'][:, :, :, self.xanes3D_analysis_slice]
                self.hs['L[0][2][3][0][1][1]_visualize_alignment_eng_text'].value = self.xanes3D_analysis_eng_list[self.xanes3D_analysis_slice]
    ...
    def L0_2_3_1_3_0_analysis_image_use_mask_checkbox(self, a):
        if a['owner'].value:
            ...
            self.hs['L[0][2][3][0][3][1]_visualize_view_alignment_option_dropdown'].value = 'x-y-z'
            # f = h5py.File(self.xanes3D_save_trial_reg_filename, 'r')
            with h5py.File(self.xanes3D_save_trial_reg_filename, 'r') as f:
                self.xanes3D_aligned_data = 0
                self.xanes3D_aligned_data = f['/registration_results/reg_results/registered_xanes3D'][0, :, :, :]
    ...
    def L0_2_3_1_4_1_analysis_run_button(self, a):
        self.fiji_viewer_off(viewer_name='xanes3D_analysis_viewer')
        # f = h5py.File(self.xanes3D_save_trial_reg_filename, 'r+')
        with h5py.File(self.xanes3D_save_trial_reg_filename, 'r+') as f:
            ...
            g11.create_dataset('eng_list', data=self.xanes3D_analysis_eng_list*1000)
        ...
        code[ln] = "            xana.fit_whiteline(xanes3D_analysis_wl_fit_eng_s, xanes3D_analysis_wl_fit_eng_e, order=3, flt_spec=xanes3D_analysis_use_flt_spec)"; ln += 1
        ...
        code[ln] = "            imgs[:] = f['/registration_results/reg_results/registered_xanes3D'][:, ii, :, :]"; ln += 1
        code[ln] = "            xana.spectrum[:] = imgs[:]"; ln += 1
        code[ln] = "            xana.edge_jump_map()"; ln += 1
        ...
        code[ln] = "            g128[ii] = np.float32(xana.fitted_edge_mask)[:]"; ln += 1
        code[ln] = "            print(str(ii)+'/'+str(xanes3D_analysis_data_shape[1]))"; ln += 1
        # code[ln] = "f.close()"; ln += 1

        self.gen_external_py_script(code, dtype='3D_XANES')
                    ...
                    if self.xanes2D_config_use_alternative_flat:
                        if self.xanes2D_config_alternative_flat_set:
                            ...
                            # f2 = h5py.File(self.xanes2D_config_alternative_flat_filename, 'r')
                                    self.xanes2D_img = -np.log(f1['img_xanes'][:]-f1['img_dark'][:])/(f2['img_bkg'][:]-f2['img_dark'][:])
                        ...
                        # f = h5py.File(self.xanes2D_file_raw_h5_filename, 'r')
                        with h5py.File(self.xanes2D_config_alternative_flat_filename, 'r') as f:
                            self.xanes2D_img = -np.log(f['img_xanes'][:]-f['img_dark'][:])/(f['img_bkg'][:]-f['img_dark'][:])
                            self.xanes2D_img[np.isinf(self.xanes2D_img)] = 0
                            self.xanes2D_img[np.isnan(self.xanes2D_img)] = 0
                        # f.close()
                        self.hs['L[0][1][0][1][2][0]_eng_points_range_slider'].value = (0, self.xanes2D_img.shape[0]-1)
    ...
    def L0_1_3_1_4_1_analysis_run_button_click(self, a):
        ...
        code[ln] = "import xanes_analysis as xa"; ln+=1
        code[ln] = ""; ln+=1
        # code[ln] = f"f = h5py.File('{self.xanes2D_file_save_trial_reg_filename}', 'r+')"; ln+=1
        code[ln] = f"with h5py.File('{self.xanes2D_file_save_trial_reg_filename}', 'r+') as f:"; ln+=1
        ...
        code[ln] = f"        g12.create_dataset('img_mask', data={np.int8(self.xanes2D_analysis_mask)}, dtype=np.int8)"; ln+=1
        code[ln] = "        xana.fit_whiteline(xanes2D_analysis_wl_fit_eng_s, xanes2D_analysis_wl_fit_eng_e, order=3, flt_spec=xanes2D_analysis_use_flt_spec)"; ln+=1
        code[ln] = "        xana.calc_direct_whiteline(xanes2D_analysis_wl_fit_eng_s, xanes2D_analysis_wl_fit_eng_e)"; ln+=1
        code[ln] = "        g120[0] = xana.whiteline_pos[:]"; ln+=1
        code[ln] = "        g121[0] = xana.whiteline_pos_direct[:]"; ln+=1
        code[ln] = ""; ln+=1
        code[ln] = ""; ln+=1
        code[ln] = "    else:"; ln+=1
        code[ln] = "        g120 = g12.create_dataset('spectrum_whiteline_pos', shape=(xanes2D_analysis_data_shape[1:]), dtype=np.float32)"; ln+=1
        ...
        code[ln] = "        xana.normalize_xanes(xanes2D_analysis_edge_eng, order=xanes2D_analysis_norm_fitting_order, save_pre_post=True)"; ln+=1
        ...
        code[ln] = "        g128[:] = np.float32(xana.fitted_edge_mask)[:]"; ln+=1
        code[ln] = ""; ln+=1
        # code[ln] = "f.close()"; ln+=1
