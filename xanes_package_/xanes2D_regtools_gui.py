...
class xanes2D_regtools_gui():
    ...
    def lock_message_text_boxes(self):
        ...
        self.xanes_analysis_gui_h.hs['L[0][x][3][0][5][0]_ana_run_text'].disabled=True
    ...
    def set_xanes2D_handles(self):
        ...
        self.xanes_analysis_gui_h.hs['L[0][x][3][0][1][0][0]_ana_eng_range_option_dropdown'].value = \
            self.xanes2D_config["align 2D recon"]["xanes2D_analysis_type"]
        self.xanes_analysis_gui_h.hs['L[0][x][3][0][1][0][1]_ana_eng_range_edge_eng_text'].value = \
            self.xanes2D_config["align 2D recon"]["xanes2D_analysis_edge_eng"] 
        self.xanes_analysis_gui_h.hs['L[0][x][3][0][1][0][2]_ana_eng_range_pre_edge_e_text'].value = \
            self.xanes2D_config["align 2D recon"]["xanes2D_analysis_pre_edge_e"]
        self.xanes_analysis_gui_h.hs['L[0][x][3][0][1][0][3]_ana_eng_range_post_edge_s_text'].value = \
            self.xanes2D_config["align 2D recon"]["xanes2D_analysis_post_edge_s"]
        self.xanes_analysis_gui_h.hs['L[0][x][3][0][1][1][0]_ana_eng_range_wl_fit_s_text'].value = \
            self.xanes2D_config["align 2D recon"]["xanes2D_analysis_wl_fit_eng_s"]
        self.xanes_analysis_gui_h.hs['L[0][x][3][0][1][1][1]_ana_eng_range_wl_fit_e_text'].value = \
            self.xanes2D_config["align 2D recon"]["xanes2D_analysis_wl_fit_eng_e"]
        self.xanes_analysis_gui_h.hs['L[0][x][3][0][1][1][2]_ana_eng_range_edge0.5_fit_s_text'].value = \
            self.xanes2D_config["align 2D recon"]["xanes2D_analysis_edge_0p5_fit_s"]
        self.xanes_analysis_gui_h.hs['L[0][x][3][0][1][1][3]_ana_eng_range_edge0.5_fit_e_text'].value = \
    ...
    def boxes_logic(self):
        ...
        if self.xanes2D_file_analysis_option in ['Do New Reg', 'Read Config File']:
            if not self.xanes2D_file_configured:
                ...
                enable_disable_boxes(self.hs, boxes, disabled=True, level=-1)
                # self.xanes_analysis_gui_h.disable_xanes_analysis_gui()
                boxes = ['L[0][x][3][0]_analysis_box']
                enable_disable_boxes(self.xanes_analysis_gui_h.hs, 
        ...
        #                  'L[0][1][2][2]_visualize_images_box']
        #         enable_disable_boxes(self.hs, boxes, disabled=False, level=-1)
        #         # self.xanes_analysis_gui_h.enable_xanes_analysis_gui()
        #         # boxes = ['L[0][x][3][0]_analysis_box']
        #         boxes = ['L[0][x][3][0][1]_analysis_energy_range_box',
        #                  'L[0][x][3][0][4]_analysis_tool_box']
        #         enable_disable_boxes(self.xanes_analysis_gui_h.hs, 
    ...
    def build_gui(self):
        ...
        self.hs['L[0][1][3]_analysis&display_form'].children = [self.xanes_analysis_gui_h.hs['L[0][x][3][0]_analysis_box']]
        ...
        self.hs['L[0][1][0][1][1][2][1]_alternative_flat_file_button'].initialdir = self.global_h.cwd
    ...
    def L0_1_0_0_4_0_confirm_file_path_button_click(self, a):
        if self.xanes2D_file_analysis_option == 'Do New Reg':
            ...
            if not self.xanes2D_file_config_file_set:
                ...
                # read_config_from_reg_file(dtype='2D_XANES')
                ...
                if self.xanes2D_alignment_done:
                    ...
                    self.xanes_analysis_gui_h.hs['L[0][x][3][0][1][0][0]_ana_eng_range_option_dropdown'].value = 'full'                
                self.set_xanes2D_handles()
                self.set_xanes2D_variables()
