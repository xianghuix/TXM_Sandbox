...
from gui_components import SelectFilesButton, get_handles, enable_disable_boxes, check_file_availability, get_raw_img_info
from tomo_recon_tools import FILTERLIST, TOMO_RECON_PARAM_DICT, run_engine
...
class tomo_recon_gui():
    def __init__(self, form_sz=[650, 740]):
        ...
        self.tomo_wedge_blankat = 90
        self.tomo_wedge_missing_s = 500
        self.tomo_wedge_missing_e = 600
        self.tomo_wedge_ang_auto_det_thres = 500
    ...
    def build_gui(self):
        ...
        self.hs["L[0][0][0][1][0][1][0][1]_rot_cen_text"] = widgets.BoundedFloatText(value=1280.0, min=0, description="Center", disabled=True)
        layout = {"width":"19%", "height":"90%"}
        self.hs["L[0][0][0][1][0][1][0][1]_rot_cen_text"].layout = layout
        self.hs["L[0][0][0][1][0][1][0][2]_cen_win_left_text"] = widgets.BoundedIntText(value=1240, min=0, description="Cen Win L", disabled=True)
        layout = {"width":"19%", "height":"90%"}
        self.hs["L[0][0][0][1][0][1][0][2]_cen_win_left_text"].layout = layout
        self.hs["L[0][0][0][1][0][1][0][3]_cen_win_wz_text"] = widgets.BoundedIntText(value=80, min=1, description="Cen Win W", disabled=True)
        layout = {"width":"19%", "height":"90%"}
        ...
        # layout = {"left":"-46.7%", "width":"24%", "height":"90%", "visibility":"hidden"}
        layout = {"width":"19%", "height":"90%", "visibility":"hidden"}
        self.hs["L[0][0][0][1][0][1][0][4]_cen_list_button"].layout = layout
        self.hs["L[0][0][0][1][0][1][0][4]_cen_list_button"].disabled = True
        # self.hs["L[0][0][0][1][0][1][0][5]_cen_win_wz_text"] = widgets.IntText(value=80, description="Cen Win W", disabled=True)
        # layout = {"width":"24%", "height":"90%"}
        # self.hs["L[0][0][0][1][0][1][0][5]_cen_win_wz_text"].layout = layout
        ...
        self.hs["L[0][0][0][1][0][1][0][4]_cen_list_button"].on_click(self.L0_0_0_1_0_1_0_4_cen_list_button_change)

        layout = {"border":"3px solid #FFCC00", "width":f"{self.form_sz[1]-126}px", "height":f"{0.07*(self.form_sz[0]-128)}px"}
        self.hs["L[0][0][0][1][0][1][3]_chunk_config_box3"] = widgets.HBox()
        self.hs["L[0][0][0][1][0][1][3]_chunk_config_box3"].layout = layout
        self.hs["L[0][0][0][1][0][1][3][0]_sli_start_text"] = widgets.BoundedIntText(value=1280, min=0, description="Sli Start", disabled=True)
        layout = {"width":"19%", "height":"90%"}
        self.hs["L[0][0][0][1][0][1][3][0]_sli_start_text"].layout = layout
        self.hs["L[0][0][0][1][0][1][3][1]_sli_end_text"] = widgets.BoundedIntText(value=1300, min=0, description="Sli End", disabled=True)
        layout = {"width":"19%", "height":"90%"}
        self.hs["L[0][0][0][1][0][1][3][1]_sli_end_text"].layout = layout
        self.hs["L[0][0][0][1][0][1][3][2]_chunk_sz_text"] = widgets.BoundedIntText(value=200, min=0, description="Chunk Sz", disabled=True)
        layout = {"width":"19%", "height":"90%"}
        self.hs["L[0][0][0][1][0][1][3][2]_chunk_sz_text"].layout = layout
        self.hs["L[0][0][0][1][0][1][3][3]_margin_sz_text"] = widgets.BoundedIntText(value=15, min=0, description="Margin Sz", disabled=True)
        layout = {"width":"19%", "height":"90%"}
        ...
        layout = {"width":"20%"}
        self.hs["L[0][0][0][1][0][1][6][1]_auto_thres_text"] = widgets.BoundedFloatText(value=500.0,
                                                                                 min=100,
        ...
        self.hs["L[0][0][0][1][0][1][6][0]_auto_detect_checkbox"].observe(self.L0_0_1_0_0_1_1_0_auto_detect_checkbox_change, names="value")
        self.hs["L[0][0][0][1][0][1][6][1]_auto_thres_text"].observe(self.L0_0_1_0_0_1_1_1_auto_thres_text_change, names="value")
        self.hs["L[0][0][0][1][0][1][6][2]_auto_ref_fn_button"].on_click(self.L0_0_1_0_0_1_1_2_auto_ref_fn_button_change)
        self.hs["L[0][0][0][1][0][1][6][3]_fiji_viewer_checkbox"].observe(self.L0_0_1_0_0_1_1_3_fiji_viewer_checkbox_change, names="value")
        self.hs["L[0][0][0][1][0][1][6][4]_sli_range_slider"].observe(self.L0_0_1_0_0_1_1_4_sli_range_slider_change, names="value")
        ...
        layout = {"border":"3px solid #8855AA", "width":f"{self.form_sz[1]-122}px", "height":f"{0.84*(self.form_sz[0]-122)}px"}
        ...
        layout = {"border":"3px solid #8855AA", "width":f"{self.form_sz[1]-128}px", "height":f"{0.7*(self.form_sz[0]-128)}px"}
        ...
        layout = {"justify-content":"center", "align-items":"center","align-contents":"center","border":"3px solid #FFCC00", "width":f"{self.form_sz[1]-134}px", "height":f"{0.07*(self.form_sz[0]-128)}px"}
        ...
        self.hs["L[0][0][1][0][0][1]_filter_config_box"] = GridspecLayout(2, 200,
                                                                       layout = {"border":"3px solid #FFCC00",
                                                                                 "height":f"{0.63*(self.form_sz[0]-122)}px",
        ...
        self.hs["L[0][0][1][0][0][1]_filter_config_box"][1, :140] = widgets.Text(value="Confirm to proceed after you finish data and algorithm configuration...",
                                                                              layout={"width":f"{int(0.696*(self.form_sz[1]-128))}px", "height":"90%"},
                                                                              disabled=True)
        ...
        self.hs["L[0][0][1][0][0][1]_filter_config_box"][1, 141:171] = widgets.Button(description="Confirm",
                                                                                   disabled=True,
                                                                                   layout={"width":f"{int(0.15*(self.form_sz[1]-128))}px", "height":"90%"})
        ...
        layout = {"border":"3px solid #8855AA", "width":f"{self.form_sz[1]-128}px", "height":f"{0.14*(self.form_sz[0]-128)}px"}
        self.hs["L[0][0][1][0][1]_recon_box"] = widgets.VBox()
        self.hs["L[0][0][1][0][1]_recon_box"].layout = layout

        ## ## ## ## ## ## label recon_box -- start
        layout = {"justify-content":"center", "align-items":"center","align-contents":"center","border":"3px solid #FFCC00", "width":f"{self.form_sz[1]-134}px", "height":f"{0.07*(self.form_sz[0]-128)}px"}
        self.hs["L[0][0][1][0][1][0]_reecon_title_box"] = widgets.HBox()
        self.hs["L[0][0][1][0][1][0]_reecon_title_box"].layout = layout
        self.hs["L[0][0][1][0][1][0][0]_reecon_title"] = widgets.HTML("<span style='color:red; font-size: 150%; font-weight: bold; background-color:rgb(135,206,250);'>" + "recon" + "</span>")
        layout = {"left":"46.5%", "background-color":"white", "color":"cyan"}
        self.hs["L[0][0][1][0][1][0][0]_reecon_title"].layout = layout
        self.hs["L[0][0][1][0][1][0]_reecon_title_box"].children = get_handles(self.hs, "L[0][0][1][0][1][0]_reecon_title_box", -1)
        ## ## ## ## ## ## label recon_box -- end

        ## ## ## ## ## ## ## config widgets in recon_box -- start
        layout = {"justify-content":"center", "align-items":"center","align-contents":"center","border":"3px solid #FFCC00", "width":f"{self.form_sz[1]-134}px", "height":f"{0.07*(self.form_sz[0]-128)}px"}
        self.hs["L[0][0][1][0][1][1]_reecon_box"] = widgets.HBox()
        self.hs["L[0][0][1][0][1][1]_reecon_box"].layout = layout
        layout = {"width":"70%", "height":"90%"}
        self.hs["L[0][0][1][0][1][1][0]_reecon_progress_bar"] = widgets.IntProgress(value=0,
                                                                                 min=0,
                                                                                 max=10,
                                                                                 step=1,
        ...
        self.hs["L[0][0][1][0][1][1][0]_reecon_progress_bar"].layout = layout
        layout = {"width":"15%", "height":"90%"}
        self.hs["L[0][0][1][0][1][1][1]_reecon_button"] = widgets.Button(description="Recon",
                                                                            disabled=True)
        self.hs["L[0][0][1][0][1][1][1]_reecon_button"].style.button_color = "darkviolet"
        self.hs["L[0][0][1][0][1][1][1]_reecon_button"].layout = layout
        self.hs["L[0][0][1][0][1][1]_reecon_box"].children = get_handles(self.hs, "L[0][0][1][0][1][1]_reecon_box", -1)
        self.hs["L[0][0][1][0][1][1][1]_reecon_button"].on_click(self.L0_0_1_0_1_1_1_reecon_button_change)
        ...
        ## ## ## ## config filter&recon tab -- start
        layout = {"border":"3px solid #8855AA", "width":f"{self.form_sz[1]-128}px", "height":f"{0.84*(self.form_sz[0]-122)}px"}
    ...
    def L0_0_0_0_1_0_select_raw_h5_top_dir_button_click(self, a):
        ...
        if len(a.files[0]) != 0:
            ...
            self.tomo_raw_data_file_template = os.path.join(self.tomo_raw_data_top_dir, "fly_scan_id_{}.h5")
    ...
    def L0_0_0_0_5_2_file_path_options_dropdown_change(self, a):
        ...
        if self.tomo_recon_type == "Trial Center":
            layout = {"width":"19%", "height":"90%", "visibility":"hidden"}
            self.hs["L[0][0][0][1][0][1][0][4]_cen_list_button"].layout = layout
            layout = {"width":"19%", "height":"90%", "visibility":"visible"}
            self.hs["L[0][0][0][1][0][1][0][2]_cen_win_left_text"].layout = layout
            self.hs["L[0][0][0][1][0][1][0][3]_cen_win_wz_text"].layout = layout
    ...
    def L0_0_0_0_5_0_confirm_file_path_button_click(self, a):
        self.tomo_available_raw_idx = check_file_availability(self.tomo_raw_data_top_dir, scan_id=None, signature="fly_scan", return_idx=True)
        if len(self.tomo_available_raw_idx) == 0:
            ...
            # self.hs["L[0][0][0][1][0][1][0][0]_scan_id_dropdown"].max = self.tomo_available_raw_idx[-1]
            # self.hs["L[0][0][0][1][0][1][0][0]_scan_id_dropdown"].value = self.tomo_available_raw_idx[-1]
            # self.hs["L[0][0][0][1][0][1][0][0]_scan_id_dropdown"].min = self.tomo_available_raw_idx[0]
            if self.tomo_recon_type == "Trial Center":
    ...
    def L0_0_0_1_0_1_0_0_scan_id_dropdown_change(self, a):
        ...
        self.data_info = get_raw_img_info(self.tomo_raw_data_file_template.format(self.tomo_scan_id[0]))
        if self.data_info is not None:
            ...
            self.hs["L[0][0][0][1][0][1][3][1]_sli_end_text"].value = 0
            ...
            self.hs["L[0][0][0][1][0][1][3][0]_sli_start_text"].max = self.data_info["img_dim"][1] - 1
    ...
    def L0_0_0_1_0_1_0_4_cen_list_button_change(self, a):
        if len(a.files[0]) != 0:
    ...
    def L0_0_0_1_0_1_3_2_chunk_sz_text_change(self, a):
        if a['owner'].value < self.hs['L[0][0][0][1][0][1][3][3]_margin_sz_text'].value*2:
            a['owner'].value = self.hs['L[0][0][0][1][0][1][3][3]_margin_sz_text'].value*2 + 1
    ...
    def L0_0_0_1_0_1_3_3_margin_sz_text_change(self, a):
        if 2*a['owner'].value > self.hs['L[0][0][0][1][0][1][3][2]_chunk_sz_text']:
            a['owner'].value = int(self.hs['L[0][0][0][1][0][1][3][2]_chunk_sz_text']/2) - 1
    ...
    def L0_0_1_0_0_1_0_1_blankat_dropdown_change(self, a):
    ...
    def L0_0_1_0_0_1_1_0_auto_detect_checkbox_change(self, a):
        self.tomo_use_wedge_ang_auto_det = a["owner"].value
        self.tomo_data_configured = False
        self.boxes_logic()
        self.tomo_compound_logic()

    def L0_0_1_0_0_1_1_1_auto_thres_text_change(self, a):
    ...
    def L0_0_1_0_0_1_1_3_fiji_viewer_checkbox_change(self, a):
        pass

    def L0_0_1_0_0_1_1_4_sli_range_slider_change(self, a):
        pass
    ...
    def L0_0_1_0_0_1_0_1_filter_config_box_left_box_move_button_change(self, a):
        ...
        if ((len(self.hs["L[0][0][1][0][0][1][1][0]_filter_config_right_box_selectmultiple"].options) == 1) &
            ...
            self.tomo_right_filter_dict[0] = {'filter_name':self.tomo_left_box_selected_flt, 'params':self.filter_param_dict}
        else:
            ...
            idx = len(a) - 1
            self.tomo_right_filter_dict[idx] = {'filter_name':self.tomo_left_box_selected_flt, 'params':self.filter_param_dict}
        self.tomo_data_configured = False
        self.boxes_logic()
        self.tomo_compound_logic()
    ...
    def L0_0_1_0_0_1_3_filter_config_box_confirm_button(self, a):
        ...
        self.tomo_recon_param_dict["data_params"]["wedge_blankat"]=self.tomo_wedge_blankat
    ...
    def L0_0_1_0_1_1_1_reecon_button_change(self, a):
        run_engine(**self.tomo_recon_param_dict)
