...
class xanes3D_tools_gui():
    def __init__(self, parent_h, form_sz=[650, 740]):
        ...
        self.xanes3D_fit_external_command_name = os.path.join(os.path.abspath(os.path.curdir), 'xanes3D_fit_external_command.py')
        self.xanes3D_reg_external_command_name = os.path.join(os.path.abspath(os.path.curdir), 'xanes3D_reg_external_command.py')
        self.xanes3D_align_external_command_name = os.path.join(os.path.abspath(os.path.curdir), 'xanes3D_align_external_command.py')
        ...
        self.xanes3D_reg_mrtv_level = 4
        self.xanes3D_reg_mrtv_width = 10
        self.xanes3D_reg_mrtv_subpixel_wz = 8
        self.xanes3D_reg_mrtv_subpixel_step = 0.2 
        self.xanes3D_img_roi = None
        self.xanes3D_roi = [0, 10, 0, 10, 0, 10]
        self.xanes3D_reg_mask = None
        self.xanes3D_aligned_data = None
        self.xanes_analysis_4th_dim_idx = 0
        self.xanes3D_raw_fn_temp = self.global_h.io_xanes3D_cfg['tomo_raw_fn_template']
        ...
        self.xanes3D_config = {"filepath config":{"xanes3D_raw_3D_h5_top_dir":self.xanes3D_raw_3D_h5_top_dir,
		       ...
		       "registration config":{"xanes3D_reg_use_chunk":self.xanes3D_reg_use_chunk,
                                      ...
                                      "xanes3D_reg_mrtv_level":self.xanes3D_reg_mrtv_level,
                                      "xanes3D_reg_mrtv_width":self.xanes3D_reg_mrtv_width,
                                      "xanes3D_reg_mrtv_subpixel_step":self.xanes3D_reg_mrtv_subpixel_step, 
                                      "xanes3D_reg_mrtv_subpixel_width":self.xanes3D_reg_mrtv_subpixel_wz,
    ...
    def update_xanes3D_config(self):
        self.xanes3D_config = {"filepath config":{"xanes3D_raw_3D_h5_top_dir":self.xanes3D_raw_3D_h5_top_dir,
		       ...
		       "registration config":{"xanes3D_reg_use_chunk":self.hs['L[0][2][1][1][1][1]_chunk_checkbox'].value,
                                      ...
                                      "xanes3D_reg_mask_dilation_width":self.hs['L[0][2][1][1][2][2]_mask_dilation_slider'].value,
    ...
    def set_xanes3D_variables(self):
        ...
        b = glob.glob(os.path.join(self.xanes3D_raw_3D_h5_top_dir, self.xanes3D_raw_3D_h5_temp.split('{')[0]+'*.h5'))
        self.xanes3D_available_raw_ids = sorted([int(ii.split('.')[0].split('_')[-1]) for ii in b])
        b = glob.glob(os.path.join(self.xanes3D_recon_3D_top_dir, self.xanes3D_recon_3D_dir_temp.split('{')[0]+'*'))
        ...
        self.xanes3D_reg_mrtv_level = self.xanes3D_config["registration config"]["xanes3D_reg_mrtv_level"]
        self.xanes3D_reg_mrtv_width = self.xanes3D_config["registration config"]["xanes3D_reg_mrtv_width"]
        self.xanes3D_reg_mrtv_subpixel_step = self.xanes3D_config["registration config"]["xanes3D_reg_mrtv_subpixel_step"]
        self.xanes3D_reg_mrtv_subpixel_wz = self.xanes3D_config["registration config"]["xanes3D_reg_mrtv_subpixel_width"]
    ...
    def set_xanes3D_handles(self):
        ...
        self.hs['L[0][2][1][1][1][3]_sli_search_slider'].max = self.xanes3D_config["registration config"]["sli_search_slider_max"]
        self.hs['L[0][2][1][1][1][3]_sli_search_slider'].min = self.xanes3D_config["registration config"]["sli_search_slider_min"]
        self.hs['L[0][2][1][1][1][3]_sli_search_slider'].value = self.xanes3D_config["registration config"]["sli_search_slider_val"]
        self.hs['L[0][2][1][1][1][2]_chunk_sz_slider'].max = self.xanes3D_config["registration config"]["chunk_sz_slider_max"]
        self.hs['L[0][2][1][1][1][2]_chunk_sz_slider'].min = self.xanes3D_config["registration config"]["chunk_sz_slider_min"]
        self.hs['L[0][2][1][1][1][2]_chunk_sz_slider'].value = self.xanes3D_config["registration config"]["chunk_sz_slider_val"]
        
        self.hs['L[0][2][1][1][3][0]_reg_method_dropdown'].value = self.xanes3D_config["registration config"]["xanes3D_reg_method"]
        self.hs['L[0][2][1][1][3][1]_ref_mode_dropdown'].value = self.xanes3D_config["registration config"]["xanes3D_reg_ref_mode"]        
        self.hs['L[0][2][1][1][4][0]_mrtv_level_text'].value = self.xanes3D_config["registration config"]["xanes3D_reg_mrtv_level"]
        self.hs['L[0][2][1][1][4][1]_mrtv_width_text'].value = self.xanes3D_config["registration config"]["xanes3D_reg_mrtv_width"]
        self.hs['L[0][2][1][1][4][3]_mrtv_subpixel_step_text'].value = self.xanes3D_config["registration config"]["xanes3D_reg_mrtv_subpixel_step"]
    ...
    def boxes_logic(self):
        def xanes3D_compound_logic():
            if self.xanes_analysis_option == 'Reg By Shift':
                if self.xanes3D_roi_configured:
                    ...
                    boxes = ['L[0][2][2][0]_review_reg_results_box']
                    enable_disable_boxes(self.hs, boxes, disabled=True, level=-1)
                if self.xanes3D_reg_file_readed:
                    self.hs['L[0][2][2][0][4][1]_confirm_review_results_button'].disabled = False
            else:
            ...
            elif self.hs['L[0][2][1][1][3][0]_reg_method_dropdown'].value in ['MRTV', 'PC']:
            ...
            if self.hs['L[0][2][1][1][3][0]_reg_method_dropdown'].value in ['MPC', 'SR', 'PC']:
                ...
                self.hs['L[0][2][1][1][4][3]_mrtv_subpixel_step_text'].disabled = False
            elif self.hs['L[0][2][1][1][3][0]_reg_method_dropdown'].value == 'MRTV':
                self.hs['L[0][2][1][1][4][0]_mrtv_level_text'].value = 5
                boxes = ['L[0][2][1][1][4]_mrtv_option_box']
                enable_disable_boxes(self.hs, boxes, disabled=False, level=-1)
                
            if self.hs['L[0][2][1][1][3][0]_reg_method_dropdown'].value in ['PC', 'MRTV']:
        ...
        if self.xanes_analysis_option in ['Do New Reg', 'Read Config File']:
            if not self.xanes3D_filepath_configured:
                ...
                if not viewer_state:
                    ...
                    if self.xanes3D_reg_use_mask:
                        ...
                        enable_disable_boxes(self.hs, boxes, disabled=False, level=-1)
                        self.hs['L[0][2][1][1][3][0]_reg_method_dropdown'].options = ['MPC', 'SR']
                    else:
                        boxes = ['L[0][2][1][1][2][2]_mask_dilation_slider',
                                 'L[0][2][1][1][2][1]_mask_thres_slider']
                        enable_disable_boxes(self.hs, boxes, disabled=True, level=-1)
                        self.hs['L[0][2][1][1][3][0]_reg_method_dropdown'].options = ['MRTV', 'PC', 'SR']
            elif ((self.xanes3D_filepath_configured & self.xanes3D_indices_configured) &
                ...
                enable_disable_boxes(self.xanes_fitting_gui_h.hs, 
                                      boxes, disabled=False, level=-1)
        elif self.xanes_analysis_option == 'Reg By Shift': 
            boxes = ['L[0][2][0][1]_config_data_box',
                     'L[0][2][1][1]_config_reg_params_box',
                     'L[0][2][1][2]_run_reg_box']
            enable_disable_boxes(self.hs, boxes, disabled=True, level=-1) 
            ...
            if not self.xanes3D_filepath_configured:
                ...
                enable_disable_boxes(self.xanes_fitting_gui_h.hs, 
                                     boxes, disabled=True, level=-1)
            elif (self.xanes3D_filepath_configured & (not self.xanes3D_roi_configured)):
                boxes = ['L[0][2][1][0]_3D_roi_box']
                enable_disable_boxes(self.hs, boxes, disabled=False, level=-1)            
                boxes = ['L[0][2][2][2]_visualize_box',
                         'L[0][2][2][1]_align_recon_box',
                ...
                enable_disable_boxes(self.xanes_fitting_gui_h.hs, 
                                     boxes, disabled=True, level=-1)
            elif ((self.xanes3D_filepath_configured & self.xanes3D_roi_configured) &
    ...
    def build_gui(self):
        ...
        self.hs['L[0][2][1][1][4][2]_mrtv_subpixel_wz_text'] = widgets.BoundedIntText(value=8,
                                                                                 min=2,
                                                                                 max=20,
                                                                                 step=0.1,
        ...
        self.hs['L[0][2][1][1][4][3]_mrtv_subpixel_step_text'] = widgets.BoundedFloatText(value=0.5,
                                                                                 min=0.1,
                                                                                 max=1,
                                                                                 step=0.1,
                                                                                 ...
                                                                                 disabled=True)
        layout = {'width':'19%'}
        self.hs['L[0][2][1][1][4][3]_mrtv_subpixel_step_text'].layout = layout
        ...
        self.hs['L[0][2][1][1][4][3]_mrtv_subpixel_step_text'].observe(self.L0_2_1_1_4_3_mrtv_subpixel_step_text_change, names='value')
        ...
        layout = {'width':'15%', 'height':'90%'}
        self.hs['L[0][2][2][0][2][1]_record_button'] = widgets.Button(description='Record',
                                                                       description_tooltip='Record',
                                                                       disabled=True)
        self.hs['L[0][2][2][0][2][1]_record_button'].layout = layout
        self.hs['L[0][2][2][0][2][1]_record_button'].style.button_color = 'darkviolet'
        layout = {'width':'15%', 'height':'90%'}
        self.hs['L[0][2][2][0][2][2]_reg_pair_bad_button'] = widgets.Button(description='Bad',
                                                                       description_tooltip='Bad reg',
                                                                       disabled=True)
        self.hs['L[0][2][2][0][2][2]_reg_pair_bad_button'].layout = layout
        self.hs['L[0][2][2][0][2][2]_reg_pair_bad_button'].style.button_color = 'darkviolet'
        ...
        self.hs['L[0][2][2][0][2][1]_record_button'].on_click(self.L0_2_2_0_3_2_record_button_click)
        self.hs['L[0][2][2][0][2][2]_reg_pair_bad_button'].on_click(self.L0_2_2_0_3_3_reg_pair_bad_button)
    ...
    def L0_2_0_0_1_0_select_raw_h5_path_button_click(self, a):
        if len(a.files[0]) != 0:
            ...
            self.xanes3D_raw_3D_h5_temp = os.path.join(self.xanes3D_raw_3D_h5_top_dir, self.xanes3D_raw_fn_temp)
    ...
    def L0_2_0_0_3_0_select_save_trial_button_click(self, a):
        if self.xanes_analysis_option == 'Do New Reg':
            if len(a.files[0]) != 0:
                ...
                for ii in range(6):
                    b +=str(t[ii]).zfill(2)+'-'
                self.xanes3D_save_trial_reg_filename_template = os.path.abspath(a.files[0]).split('.')[0]+f'_{self.xanes3D_raw_fn_temp.split("_")[1]}'+'_id_{0}-{1}_'+b.strip('-')+'.h5'
                self.xanes3D_save_trial_reg_config_filename_template = os.path.abspath(a.files[0]).split('.')[0]+f'_{self.xanes3D_raw_fn_temp.split("_")[1]}'+'_id_{0}-{1}_config_'+b.strip('-')+'.json'
    ...
    def L0_2_0_0_4_0_confirm_file_path_button_click(self, a):
        if self.xanes_analysis_option == 'Do New Reg':
            if not self.xanes3D_raw_h5_path_set:
                ...
                b = glob.glob(os.path.join(self.xanes3D_raw_3D_h5_top_dir, self.xanes3D_raw_3D_h5_temp.split('{')[0]+'*.h5'))
                # self.xanes3D_available_raw_ids = sorted([int(ii.split('.')[0].split('_')[-1]) for ii in b])
                ran = set([int(ii.split('.')[0].split('_')[-1]) for ii in b])
                b = glob.glob(os.path.join(self.xanes3D_recon_3D_top_dir, self.xanes3D_recon_3D_dir_temp.split('{')[0]+'*'))
                # self.xanes3D_available_recon_ids = sorted([int(ii.split('.')[0].split('_')[-1]) for ii in b])
                ren = set([int(ii.split('.')[0].split('_')[-1]) for ii in b])
                n = sorted(list(ran & ren))    
                
                if n:
                    self.xanes3D_available_recon_ids = self.xanes3D_available_raw_ids = n    
            ...
            if not self.xanes3D_config_file_set:
                ...
                if self.xanes3D_roi_configured:
                    ...
                    self.xanes3D_reg_mask = np.ndarray([self.xanes3D_roi[1]-self.xanes3D_roi[0],
                                                    self.xanes3D_roi[3]-self.xanes3D_roi[2]])
            ...
            if not self.xanes3D_config_file_set:
                ...
                if self.xanes3D_reg_review_done:                    
                    ...
                    self.xanes3D_reg_review_done = False
                    self.xanes3D_alignment_done = False
                    self.xanes_analysis_option =  'Reg By Shift'
                    fiji_viewer_off(self.global_h, self,viewer_name='all')
                    self.hs['L[0][2][0][0][4][1]_confirm_file&path_text'].value = 'XANES3D file config is done ...'
                else:
    ...
    def L0_2_0_1_4_0_confirm_config_data_button_click(self, a):
        ...
        if not self.xanes3D_indices_configured:
            ...
            self.hs['L[0][2][2][0][2][0]_reg_pair_slider'].max = self.xanes3D_scan_id_e - self.xanes3D_scan_id_s 
            if self.xanes_analysis_option == 'Do New Reg':
    ...
    def L0_2_1_0_2_1_confirm_roi_button_click(self, a):
        ...
        if not self.xanes3D_roi_configured:
            ...
            self.hs['L[0][2][1][1][1][3]_sli_search_slider'].max = min(abs(self.hs['L[0][2][1][0][1][2]_3D_roi_z_slider'].value[1]-self.xanes3D_fixed_sli_id),
    ...
    def L0_2_1_1_2_1_mask_thres_slider_change(self, a):
        ...
        if self.xanes3D_reg_mask_dilation_width == 0:
            self.xanes3D_reg_mask[:] = (self.xanes3D_img_roi[self.xanes3D_fixed_sli_id-self.xanes3D_roi[4]]>self.xanes3D_reg_mask_thres).astype(np.uint8)[:]
        else:
            self.xanes3D_reg_mask[:] = skm.binary_dilation((self.xanes3D_img_roi[self.xanes3D_fixed_sli_id-self.xanes3D_roi[4]]>self.xanes3D_reg_mask_thres).astype(np.uint8),
        ...
        self.global_h.xanes3D_fiji_windows['xanes3D_mask_viewer']['ip'].setImage(self.global_h.ij.convert().convert(
            self.global_h.ij.dataset().create(self.global_h.ij.py.to_java(self.xanes3D_img_roi*self.xanes3D_reg_mask)), self.global_h.ImagePlusClass))
    ...
    def L0_2_1_1_4_3_mrtv_subpixel_step_text_change(self, a):        
        self.xanes3D_reg_params_configured = False
        self.boxes_logic()
    ...
    def L0_2_1_1_5_1_confirm_reg_params_button_click(self, a):
        ...
        self.hs['L[0][2][1][1][1][0]_fiji_mask_viewer_checkbox'].value = False
        self.xanes3D_reg_sli_search_half_width = self.hs['L[0][2][1][1][1][3]_sli_search_slider'].value
        self.xanes3D_reg_chunk_sz = self.hs['L[0][2][1][1][1][2]_chunk_sz_slider'].value
        self.xanes3D_reg_method = self.hs['L[0][2][1][1][3][0]_reg_method_dropdown'].value
        self.xanes3D_reg_ref_mode = self.hs['L[0][2][1][1][3][1]_ref_mode_dropdown'].value
        ...
        self.xanes3D_reg_mrtv_level = self.hs['L[0][2][1][1][4][0]_mrtv_level_text'].value
        self.xanes3D_reg_mrtv_width = self.hs['L[0][2][1][1][4][1]_mrtv_width_text'].value
        self.xanes3D_reg_mrtv_subpixel_wz = self.hs['L[0][2][1][1][4][2]_mrtv_subpixel_wz_text'].value
        self.xanes3D_reg_mrtv_subpixel_step = self.hs['L[0][2][1][1][4][3]_mrtv_subpixel_step_text'].value
    ...
    def L0_2_1_2_1_0_run_reg_button_click(self, a):
        ...
        with h5py.File(tmp_file, 'w') as f:
            f.create_dataset('analysis_eng_list', data=self.xanes3D_eng_list.astype(np.float32))
            if self.xanes3D_reg_mask is not None:
                f.create_dataset('xanes3D_reg_mask', data=self.xanes3D_reg_mask.astype(np.float32))
            else:
        ...
        code[ln] = f"reg = xr.regtools(dtype='3D_XANES', method='{self.xanes3D_reg_method}', mode='TRANSLATION')"; ln+=1
        ...
        kwargs = {'raw_h5_top_dir':self.xanes3D_raw_3D_h5_top_dir, 'recon_top_dir':self.xanes3D_recon_3D_top_dir}
        code[ln] = f"    reg.set_raw_data_info(**{kwargs})"; ln+=1
        code[ln] = f"    reg.set_method('{self.xanes3D_reg_method}')"; ln+=1
        code[ln] = f"    reg.set_ref_mode('{self.xanes3D_reg_ref_mode}')"; ln+=1
        code[ln] = f"    reg.set_xanes3D_tmp_filename('{tmp_file}')"; ln+=1
        code[ln] = f"    reg.read_xanes3D_tmp_file()"; ln+=1
        code[ln] = f"    reg.set_xanes3D_raw_h5_top_dir('{self.xanes3D_raw_3D_h5_top_dir}')"; ln+=1
        code[ln] = f"    reg.set_indices({self.xanes3D_scan_id_s}, {self.xanes3D_scan_id_e+1}, {self.xanes3D_fixed_scan_id})"; ln+=1
        code[ln] = f"    reg.set_reg_options(use_mask={self.xanes3D_reg_use_mask}, mask_thres={self.xanes3D_reg_mask_thres},\
                     ...
                     mrtv_level={self.xanes3D_reg_mrtv_level}, mrtv_width={self.xanes3D_reg_mrtv_width}, \
                     mrtv_sp_wz={self.xanes3D_reg_mrtv_subpixel_wz}, mrtv_sp_step={self.xanes3D_reg_mrtv_subpixel_step})"; ln+=1
        code[ln] = f"    reg.set_roi({self.xanes3D_roi})"; ln+=1
        code[ln] = f"    reg.set_xanes3D_recon_path_template('{self.xanes3D_recon_3D_tiff_temp}')"; ln+=1
        code[ln] = f"    reg.set_saving(os.path.dirname('{self.xanes3D_save_trial_reg_filename}'), \
                     fn=os.path.basename('{self.xanes3D_save_trial_reg_filename}'))"; ln+=1
        code[ln] = f"    reg.xanes3D_sli_search_half_range = {self.xanes3D_reg_sli_search_half_width}"; ln+=1
        code[ln] = f"    reg.xanes3D_recon_fixed_sli = {self.xanes3D_fixed_sli_id}"; ln+=1
        code[ln] = f"    reg.compose_dicts()"; ln+=1
        code[ln] = f"    reg.reg_xanes3D_chunk()"; ln+=1
  
        gen_external_py_script(self.xanes3D_reg_external_command_name, code)
        sig = os.system(f'python {self.xanes3D_reg_external_command_name}')
    ...
    def L0_2_2_1_2_1_align_button_click(self, a):
        ...
        tmp_dict = {}
        for key in self.xanes3D_review_shift_dict.keys():
            tmp_dict[key] = tuple(self.xanes3D_review_shift_dict[key])
        ...
        code[ln] = f"reg.set_xanes3D_recon_path_template('{self.xanes3D_recon_3D_tiff_temp}')"; ln+=1
        code[ln] = f"reg.set_roi({self.xanes3D_roi})"; ln+=1
        code[ln] = f"reg.apply_xanes3D_chunk_shift({tmp_dict}, {self.xanes3D_roi[4]}, {self.xanes3D_roi[5]}, trialfn='{self.xanes3D_save_trial_reg_filename}', savefn='{self.xanes3D_save_trial_reg_filename}')"; ln+=1
        
        gen_external_py_script(self.xanes3D_align_external_command_name, code)
        sig = os.system(f"python '{self.xanes3D_align_external_command_name}'")
        if sig == 0:
    ...
    def L0_2_2_2_1_3_visualize_view_alignment_slice_slider(self, a):
        ...
        self.hs['L[0][2][2][2][1][1]_visualize_alignment_eng_text'].value = round(self.xanes_analysis_eng_list[a['owner'].value], 1)

    def L0_2_2_2_1_2_visualize_view_alignment_4th_dim_slider(self, a):  
        self.xanes_analysis_4th_dim_idx = a['owner'].value
        with h5py.File(self.xanes3D_save_trial_reg_filename, 'r') as f:
            if self.hs['L[0][2][2][2][3][1]_visualize_view_alignment_option_dropdown'].value == 'x-y-E':
                self.xanes3D_aligned_data = 0
                self.xanes3D_aligned_data = f['/registration_results/reg_results/registered_xanes3D'][:, self.xanes_analysis_4th_dim_idx, :, :]
