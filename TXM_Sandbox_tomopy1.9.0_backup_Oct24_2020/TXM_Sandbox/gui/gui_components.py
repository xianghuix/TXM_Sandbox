        ...
        if not data_state:
            with h5py.File(gui_h.xanes3D_save_trial_reg_filename, 'r') as f:
                if gui_h.hs['L[0][2][2][2][3][1]_visualize_view_alignment_option_dropdown'].value == 'x-y-E':
                    ...
                    gui_h.xanes3D_aligned_data = f['/registration_results/reg_results/registered_xanes3D'][:, gui_h.hs['L[0][2][2][2][1][2]_visualize_view_alignment_4th_dim_slider'].value, :, :]
...
def fiji_viewer_state(global_h, gui_h, viewer_name='xanes3D_virtural_stack_preview_viewer'):
    if viewer_name == 'xanes3D_virtural_stack_preview_viewer':
        ...
        if (gui_h.xanes3D_reg_mask is None):
            data_state = False
        elif (gui_h.xanes3D_reg_mask.shape != (gui_h.xanes3D_roi[1]-gui_h.xanes3D_roi[0],
        ...
        if gui_h.recon_finish & (gui_h.tomo_recon_type=="Trial Center"):
            data_state = True
        else:
            data_state = False
        if global_h.WindowManager.getIDList() is None:
        ...
        if gui_h.recon_finish & (gui_h.tomo_recon_type=="Vol Recon: Single"):
            data_state = True
        else:
            data_state = False
        if global_h.WindowManager.getIDList() is None:
...
def restart(gui_h, dtype='2D_XANES'):
    if dtype == '2D_XANES':
        ...
        gui_h.hs["L[0][0][0][1][0][1][0][3]_cen_win_wz_text"].value = 80
        
        gui_h.hs["L[0][0][1][0][0][2][1]_recon_chunk_sz_text"].value = 200
        gui_h.hs["L[0][0][1][0][0][2][2]_recon_margin_sz_text"].value = 15
        gui_h.hs["L[0][0][0][1][0][1][3][4]_downsample_ratio_text"].value = 1

        gui_h.hs["L[0][0][0][1][0][1][1][0]_use_alt_flat_checkbox"].value = False
        gui_h.hs["L[0][0][0][1][0][1][1][2]_use_alt_dark_checkbox"].value = False
        gui_h.hs["L[0][0][0][1][0][1][1][1]_alt_flat_file_button"].style.button_color = "orange"
        gui_h.hs["L[0][0][0][1][0][1][1][3]_alt_dark_file_button"].style.button_color = "orange"
        gui_h.hs["L[0][0][0][1][0][1][1][1]_alt_flat_file_button"].description = "Alt Flat File"
        gui_h.hs["L[0][0][0][1][0][1][1][3]_alt_dark_file_button"].description = "Alt Dark File"
        ...
        gui_h.hs["L[0][0][0][1][0][1][6][2]_auto_ref_fn_button"].style.button_color = "orange"
...
def save_io_config(gui_h):
    ...
    io_data_structure_tomo['tomo_raw_fn_template'] = gui_h.hs['L[0][3][2][0][0][1]_fn_tomo_def_raw_patt_text'].value
    ...
    io_data_structure_xanes2D['xanes2D_raw_fn_template'] = gui_h.hs['L[0][3][2][0][0][2]_fn_xanes2D_def_raw_patt_text'].value
    ...
    io_data_structure_xanes3D['tomo_raw_fn_template'] = gui_h.hs['L[0][3][2][0][0][3]_fn_xanes3D_def_tomo_raw_patt_text'].value
    io_data_structure_xanes3D['xanes3D_recon_dir_template'] = gui_h.hs['L[0][3][2][0][0][4]_fn_xanes3D_def_tomo_recon_dir_patt_text'].value
    io_data_structure_xanes3D['xanes3D_recon_fn_template'] = gui_h.hs['L[0][3][2][0][0][5]_fn_xanes3D_def_tomo_recon_fn_patt_text'].value
...
def set_io_config(gui_h, cfg_dict, cfg_type='tomo'):
    if cfg_type == 'tomo':
        ...
        gui_h.hs['L[0][3][2][0][0][1]_fn_tomo_def_raw_patt_text'].value = cfg_dict['tomo_raw_fn_template'] 
        ...
        gui_h.hs['L[0][3][2][0][0][2]_fn_xanes2D_def_raw_patt_text'].value = cfg_dict['xanes2D_raw_fn_template'] 
        ...
        gui_h.hs['L[0][3][2][0][0][3]_fn_xanes3D_def_tomo_raw_patt_text'].value = cfg_dict['tomo_raw_fn_template'] 
        gui_h.hs['L[0][3][2][0][0][4]_fn_xanes3D_def_tomo_recon_dir_patt_text'].value = cfg_dict['xanes3D_recon_dir_template'] 
        gui_h.hs['L[0][3][2][0][0][5]_fn_xanes3D_def_tomo_recon_fn_patt_text'].value = cfg_dict['xanes3D_recon_fn_template'] 
