...
class xanes_regtools_gui():
    ...
    def determine_fitting_energy_range(self):
    ...
    def gen_external_py_script(self, **kwargs):
    ...
    def gui_layout(self):
        ...
        layout = {'border':'3px solid #8855AA', 'width':f'{self.form_sz[1]-92}px', 'height':f'{0.33*(self.form_sz[0]-128)}px'}
        ...
        self.hs['L[0][1][0][0][1][0]_select_raw_h5_path_button'] = SelectFilesButton(option='askdirectory',
        ...
        ## ## ## ## ## trial save file
        layout = {'border':'3px solid #FFCC00', 'width':f'{self.form_sz[1]-98}px', 'height':f'{0.2*0.32*(self.form_sz[0]-128)}px'}
        self.hs['L[0][1][0][0][3]_select_save_trial_box'] = widgets.HBox()
        self.hs['L[0][1][0][0][3]_select_save_trial_box'].layout = layout
        self.hs['L[0][1][0][0][3][1]_select_save_trial_text'] = widgets.Text(value='Save trial registration as ...', description='', disabled=True)
        layout = {'width':'66%', 'display':'inline_flex'}
        self.hs['L[0][1][0][0][3][1]_select_save_trial_text'].layout = layout
        self.hs['L[0][1][0][0][3][0]_select_save_trial_button'] = SelectFilesButton(option='asksaveasfilename',
                                                                                    text_h=self.hs['L[0][1][0][0][3][1]_select_save_trial_text'])
        self.hs['L[0][1][0][0][3][0]_select_save_trial_button'].description = 'Save Reg File'
        layout = {'width':'15%'}
        self.hs['L[0][1][0][0][3][0]_select_save_trial_button'].layout = layout
        self.hs['L[0][1][0][0][3][0]_select_save_trial_button'].on_click(self.L0_1_0_0_3_0_select_save_trial_button_click)
        self.hs['L[0][1][0][0][3]_select_save_trial_box'].children = self.get_handles('L[0][1][0][0][3]_select_save_trial_box', -1)

        ## ## ## ## ## confirm file configuration
        layout = {'border':'3px solid #FFCC00', 'width':f'{self.form_sz[1]-98}px', 'height':f'{0.2*0.32*(self.form_sz[0]-128)}px'}
        self.hs['L[0][1][0][0][4]_select_file&path_title_comfirm_box'] = widgets.HBox()
        self.hs['L[0][1][0][0][4]_select_file&path_title_comfirm_box'].layout = layout
        self.hs['L[0][1][0][0][4][1]_confirm_file&path_text'] = widgets.Text(value='Save trial registration, or go directly review registration ...', description='', disabled=True)
        layout = {'width':'66%'}
        self.hs['L[0][1][0][0][4][1]_confirm_file&path_text'].layout = layout
        self.hs['L[0][1][0][0][4][0]_confirm_file&path_button'] = widgets.Button(description='Confirm',
                                                                                 tooltip='Confirm: Confirm after you finish file configuration')
        self.hs['L[0][1][0][0][4][0]_confirm_file&path_button'].style.button_color = 'darkviolet'
        self.hs['L[0][1][0][0][4][0]_confirm_file&path_button'].on_click(self.L0_1_0_0_4_0_confirm_file_path_button_click)
        layout = {'width':'15%'}
        self.hs['L[0][1][0][0][4][0]_confirm_file&path_button'].layout = layout

        self.hs['L[0][1][0][0][4][2]_file_path_options_dropdown'] = widgets.Dropdown(value='Do New Reg',
                                                                              options=['Do New Reg',
                                                                                       'Read Reg File',
                                                                                       'Read Config File',
                                                                                       'Do Analysis'],
                                                                              ...
                                                                              disabled=False)
        layout = {'width':'15%', 'top':'0%'}
        self.hs['L[0][1][0][0][4][2]_file_path_options_dropdown'].layout = layout

        self.hs['L[0][1][0][0][4][2]_file_path_options_dropdown'].observe(self.L0_1_0_0_4_2_file_path_options_dropdown, names='value')
        self.hs['L[0][1][0][0][4]_select_file&path_title_comfirm_box'].children = self.get_handles('L[0][1][0][0][4]_select_file&path_title_comfirm_box', -1)
        ...
        ## ## ## ## define functional widgets in each box in each sub-tab  - define indices -- start
        layout = {'border':'3px solid #8855AA', 'width':f'{self.form_sz[1]-92}px', 'height':f'{0.32*(self.form_sz[0]-128)}px'}
        self.hs['L[0][1][0][1]_config_indices_box'] = widgets.VBox()
        self.hs['L[0][1][0][1]_config_indices_box'].layout = layout
        ## ## ## ## ## label define indices box
        layout = {'justify-content':'center', 'align-items':'center','align-contents':'center','border':'3px solid #FFCC00', 'width':f'{self.form_sz[1]-98}px', 'height':f'{0.2*0.32*(self.form_sz[0]-128)}px'}
        self.hs['L[0][1][0][1][0]_config_indices_title_box'] = widgets.HBox()
        self.hs['L[0][1][0][1][0]_config_indices_title_box'].layout = layout
        self.hs['L[0][1][0][1][0][0]_config_indices_title'] = widgets.Text(value='Config Files', disabled=True)
        self.hs['L[0][1][0][1][0][0]_config_indices_title'] = widgets.HTML('<span style="color:red; font-size: 150%; font-weight: bold; background-color:rgb(135,206,250);">' + 'Config Scan & Slice Indices' + '</span>')
        layout = {'left':'35%', 'background-color':'white', 'color':'cyan'}
        self.hs['L[0][1][0][1][0][0]_config_indices_title'].layout = layout
        self.hs['L[0][1][0][1][0]_config_indices_title_box'].children = self.get_handles('L[0][1][0][1][0]_select_file&path_title_box', -1)

        ## ## ## ## ## scan id range
        layout = {'border':'3px solid #FFCC00', 'width':f'{self.form_sz[1]-98}px', 'height':f'{0.2*0.32*(self.form_sz[0]-128)}px'}
        self.hs['L[0][1][0][1][1]_scan_id_range_box'] = widgets.HBox()
        self.hs['L[0][1][0][1][1]_scan_id_range_box'].layout = layout
        self.hs['L[0][1][0][1][1][0]_select_scan_id_start_text'] = widgets.BoundedIntText(value=0, description='scan_id start', disabled=True)
        layout = {'width':'40%'}
        self.hs['L[0][1][0][1][1][0]_select_scan_id_start_text'].layout = layout
        self.hs['L[0][1][0][1][1][1]_select_scan_id_end_text'] = widgets.BoundedIntText(value=0, description='scan_id end', disabled=True)
        layout = {'width':'40%'}
        self.hs['L[0][1][0][1][1][1]_select_scan_id_end_text'].layout = layout
        self.hs['L[0][1][0][1][1]_scan_id_range_box'].children = self.get_handles('L[0][1][0][1][1]_scan_id_range_box', -1)
        self.hs['L[0][1][0][1][1][0]_select_scan_id_start_text'].observe(self.L0_1_0_1_1_0_select_scan_id_start_text_change, names='value')
        self.hs['L[0][1][0][1][1][1]_select_scan_id_end_text'].observe(self.L0_1_0_1_1_1_select_scan_id_end_text_change, names='value')

        ## ## ## ## ## fixed scan and slice ids
        layout = {'border':'3px solid #FFCC00', 'width':f'{self.form_sz[1]-98}px', 'height':f'{0.2*0.32*(self.form_sz[0]-128)}px'}
        self.hs['L[0][1][0][1][2]_fixed_id_box'] = widgets.HBox()
        self.hs['L[0][1][0][1][2]_fixed_id_box'].layout = layout
        self.hs['L[0][1][0][1][2][0]_fixed_scan_id_slider'] = widgets.IntSlider(value=0, description='fixed scan id', disabled=True)
        layout = {'width':'40%'}
        self.hs['L[0][1][0][1][2][0]_fixed_scan_id_slider'].layout = layout
        self.hs['L[0][1][0][1][2][1]_fixed_sli_id_slider'] = widgets.IntSlider(value=0, description='fixed sli id', disabled=True)
        layout = {'width':'40%'}
        self.hs['L[0][1][0][1][2][1]_fixed_sli_id_slider'].layout = layout
        self.hs['L[0][1][0][1][2]_fixed_id_box'].children = self.get_handles('L[0][1][0][1][2]_fixed_id_box', -1)
        self.hs['L[0][1][0][1][2][0]_fixed_scan_id_slider'].observe(self.L0_1_0_1_2_0_fixed_scan_id_slider_change, names='value')
        self.hs['L[0][1][0][1][2][1]_fixed_sli_id_slider'].observe(self.L0_1_0_1_2_1_fixed_sli_id_slider_change, names='value')

        ## ## ## ## ## fiji option
        layout = {'border':'3px solid #FFCC00', 'width':f'{self.form_sz[1]-98}px', 'height':f'{0.2*0.32*(self.form_sz[0]-128)}px'}
        self.hs['L[0][1][0][1][3]_fiji_box'] = widgets.HBox()
        self.hs['L[0][1][0][1][3]_fiji_box'].layout = layout
        self.hs['L[0][1][0][1][3][0]_fiji_virtural_stack_preview_checkbox'] = widgets.Checkbox(value=False, description='fiji view', disabled=True)
        layout = {'width':'40%'}
        self.hs['L[0][1][0][1][3][0]_fiji_virtural_stack_preview_checkbox'].layout = layout
        ...
        self.hs['L[0][1][0][1][3][0]_fiji_virtural_stack_preview_checkbox'].observe(self.L0_1_0_1_3_0_fiji_virtural_stack_preview_checkbox_change, names='value')
        self.hs['L[0][1][0][1][3][1]_fiji_close_button'].on_click(self.L0_1_0_1_3_1_fiji_close_button_click)

        ## ## ## ## ## confirm indices configuration
        layout = {'border':'3px solid #FFCC00', 'width':f'{self.form_sz[1]-98}px', 'height':f'{0.2*0.32*(self.form_sz[0]-128)}px'}
        self.hs['L[0][1][0][1][4]_config_indices_confirm_box'] = widgets.HBox()
        self.hs['L[0][1][0][1][4]_config_indices_confirm_box'].layout = layout
        self.hs['L[0][1][0][1][4][1]_confirm_config_indices_text'] = widgets.Text(value='Confirm setting once you are done ...', description='', disabled=True)
        layout = {'width':'66%'}
        self.hs['L[0][1][0][1][4][1]_confirm_config_indices_text'].layout = layout
        self.hs['L[0][1][0][1][4][0]_confirm_config_indices_button'] = widgets.Button(description='Confirm',
                                                                                description_tooltip='Confirm: Confirm after you finish file configuration')
        self.hs['L[0][1][0][1][4][0]_confirm_config_indices_button'].style.button_color = 'darkviolet'
        layout = {'width':'15%'}
        self.hs['L[0][1][0][1][4][0]_confirm_config_indices_button'].layout = layout
        self.hs['L[0][1][0][1][4]_config_indices_confirm_box'].children = self.get_handles('L[0][1][0][1][4]_config_indices_confirm_box', -1)
        self.hs['L[0][1][0][1][4][0]_confirm_config_indices_button'].on_click(self.L0_1_0_1_4_0_confirm_config_indices_button_click)

        self.hs['L[0][1][0][1]_config_indices_box'].children = self.get_handles('L[0][1][0][1]_config_indices_box', -1)
        ## ## ## ## bin widgets in hs['L[0][1][0][1]_config_indices_box']  - define indices -- end

        self.hs['L[0][1][0]_config_input_form'].children = self.get_handles('L[0][1][0]_config_input_form', -1)
        ## ## ## define 2D_XANES_tabs layout -- end
    ...
    def L0_2_0_1_3_1_fiji_close_button_click(self, a):
        ...
        self.xanes3D_fiji_windows['mask_viewer']['ip'] = None
        self.xanes3D_fiji_windows['mask_viewer']['fiji_id'] = None
        self.xanes3D_fiji_windows['analysis_viewer']['ip'] = None
        self.xanes3D_fiji_windows['analysis_viewer']['fiji_id'] = None
    ...
    def L0_2_2_0_1_0_run_reg_button_click(self, a):
        ...
        reg.set_xanes3D_raw_data_info(**{'raw_h5_top_dir':self.xanes3D_raw_3D_h5_top_dir})
        ...
        reg.set_cal_anchor(self.xanes3D_scan_id_s, self.xanes3D_scan_id_e, self.xanes3D_fixed_scan_id)
    ...
    def L0_1_0_0_4_2_file_path_options_dropdown(self,a ):
        pass

    def L0_1_0_1_1_0_select_scan_id_start_text_change(self,a ):
        pass

    def L0_1_0_1_1_1_select_scan_id_end_text_change(self,a ):
        pass

    def L0_1_0_1_2_0_fixed_scan_id_slider_change(self, a):
        pass

    def L0_1_0_1_2_1_fixed_sli_id_slider_change(self, a):
        pass
    ...
    def L0_1_0_1_4_0_confirm_config_indices_button_click(self, a):
        pass
