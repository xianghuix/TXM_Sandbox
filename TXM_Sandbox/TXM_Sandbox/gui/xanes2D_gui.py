...
class xanes2D_tools_gui():
    ...
    def set_xanes2D_handles(self):
        ...
        self.hs['MrtvSubpixelWz text'].value = self.xanes_config["registration_config"][
            "xanes2D_regparams_mrtv_subpixel_width"]
        self.hs['MrtvSubpixelKernel text'].value = self.xanes_config["registration_config"][
            "xanes2D_regparams_mrtv_subpixel_kernel"]
    ...
    def build_gui(self):
        ...
        self.hs['MrtvLevel text'] = widgets.BoundedIntText(value=5, min=1, max=10,
        ...
        self.hs['MrtvWz text'] = widgets.BoundedIntText(value=10, min=1, max=20,
        ...
        self.hs['MrtvSubpixelWz text'] = widgets.BoundedIntText(value=3, min=2, max=20,
        ...
        self.hs['MrtvSubpixelKernel text'] = widgets.BoundedIntText(value=3, min=2, max=20,
                                                                    step=1, description='kernel wz',
        ...
        self.hs['MrtvSubpixelWz text'].observe(self.MrtvSubpixelWz_text_chg, names='value')
        self.hs['MrtvSubpixelKernel text'].observe(self.MrtvSubpixelKernel_text_chg, names='value')
