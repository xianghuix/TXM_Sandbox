...
class xanes3D_tools_gui():
    ...
    def L0_2_2_0_2_0_reg_pair_slider_change(self, a):
        ...
        with h5py.File(self.xanes3D_save_trial_reg_filename, 'r') as f:
            ...
            if self.xanes3D_reg_method == 'MRTV':
                best_match = f['/trial_registration/trial_reg_results/{0}/mrtv_best_shift_id{0}'.format(str(self.xanes3D_alignment_pair_id).zfill(3))][()]
            else:
                best_match = 0
