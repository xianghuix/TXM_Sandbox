...
class tomo_recon_gui():
    ...
    def build_gui(self):
        ...
        self.hs['L[0][0][0][1][0][1][3][0]_sli_start_text'] = widgets.IntText(value=1280, description='Sli Start', disabled=True)
        layout = {'width':'24%', 'height':'90%'}
        self.hs['L[0][0][0][1][0][1][3][0]_sli_start_text'].layout = layout
        self.hs['L[0][0][0][1][0][1][3][1]_sli_end_text'] = widgets.IntText(value=1300, description='Sli End', disabled=True)
        layout = {'width':'24%', 'height':'90%'}
        ...
        layout = {'width':'20%'}
        self.hs['L[0][0][0][1][0][1][5][2]_missing_start_text'] = widgets.IntText(value=500,
                                                                               description='Miss S',
                                                                               disabled=True)
        self.hs['L[0][0][0][1][0][1][5][2]_missing_start_text'].layout = layout
        layout = {'width':'20%'}
        self.hs['L[0][0][0][1][0][1][5][3]_missing_end_text'] =  widgets.IntText(value=600,
                                                                              description='Miss E',
                                                                              disabled=True)
    ...
    def L0_0_0_0_5_0_confirm_file_path_button_click(self, a):
        self.tomo_available_raw_idx = check_tomo_file_availability(self.tomo_raw_data_top_dir, scan_id=None, signature='fly_scan', return_idx=True)
        if len(self.tomo_available_raw_idx) == 0:
            self.tomo_filepath_configured = False
            return
        else:
            self.hs['L[0][0][0][1][0][1][0][0]_scan_id_text'].max = self.tomo_available_raw_idx[-1]
            self.hs['L[0][0][0][1][0][1][0][0]_scan_id_text'].value = self.tomo_available_raw_idx[-1]
            self.hs['L[0][0][0][1][0][1][0][0]_scan_id_text'].min = self.tomo_available_raw_idx[0]
            if self.tomo_recon_type == 'Trial Center':
