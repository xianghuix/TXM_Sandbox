...
class xanes_regtools_gui():
    ...
    def L0_1_1_2_1_0_run_reg_button_click(self, a):
        ...
        self.xanes2D_review_aligned_img_original = self.xanes2D_img_roi[0]
        self.xanes2D_review_aligned_img = self.xanes2D_img_roi[0]
        self.xanes2D_review_fixed_img = self.xanes2D_img_roi[0]
        self.xanes2D_review_shift_dict = {}
        f = h5py.File(self.xanes2D_file_save_trial_reg_filename, 'r')
        for ii in range(self.xanes2D_eng_id_e-self.xanes2D_eng_id_s+1):
            self.xanes2D_review_shift_dict["{}".format(ii)] = self.xanes2D_review_aligned_img_original[:] = f['/trial_registration/trial_reg_results/{0}/shift{0}'.format(str(ii).zfill(3))][:]
        f.close()
