...
import xanes_analysis_gui as xag
import time, gc
...
class xanes2D_regtools_gui():
    def __init__(self, parent_h, form_sz=[650, 740]):
        ...
        self.xanes2D_config = {"filepath config":{"xanes2D_file_raw_h5_filename":self.xanes2D_file_raw_h5_filename,
                               ...
                               "align 2D recon":{"xanes2D_alignment_done":self.xanes2D_alignment_done,
                                                 "xanes2D_analysis_edge_eng":self.xanes2D_analysis_edge_eng, 
                                                 "xanes2D_analysis_wl_fit_eng_s":self.xanes2D_analysis_wl_fit_eng_s,
                                                 "xanes2D_analysis_wl_fit_eng_e":self.xanes2D_analysis_wl_fit_eng_e,
                                                 "xanes2D_analysis_pre_edge_e":self.xanes2D_analysis_pre_edge_e,
                                                 "xanes2D_analysis_post_edge_s":self.xanes2D_analysis_post_edge_s, 
                                                 "xanes2D_analysis_edge_0p5_fit_s":self.xanes2D_analysis_edge_0p5_fit_s,
                                                 "xanes2D_analysis_edge_0p5_fit_e":self.xanes2D_analysis_edge_0p5_fit_e,
                                                 "xanes2D_analysis_type":self.xanes2D_analysis_type}
                               }
    ...
    def build_gui(self):
        ...
        self.hs['L[0][1][3][0]_analysis_box'] = widgets.VBox()
        self.hs['L[0][1][3][0]_analysis_box'].layout = layout
        ## ## ## ## ## define analysis title -- start
        layout = {'border':'3px solid #FFCC00', 'width':f'{self.form_sz[1]-98}px', 'height':f'{0.07*(self.form_sz[0]-128)}px'}
        self.hs['L[0][1][3][0][0]_analysis_title_box'] = widgets.HBox()
        self.hs['L[0][1][3][0][0]_analysis_title_box'].layout = layout
        self.hs['L[0][1][3][0][0][0]_analysis_title_text'] = widgets.HTML('<span style="color:red; font-size: 150%; font-weight: bold; background-color:rgb(135,206,250);">' + 'Analyze 2D XANES' + '</span>')
        layout = {'background-color':'white', 'color':'cyan', 'left':'41%'}
        self.hs['L[0][1][3][0][0][0]_analysis_title_text'].layout = layout
        self.hs['L[0][1][3][0][0]_analysis_title_box'].children = get_handles(self.hs, 'L[0][1][3][0][0]_analysis_title_box', -1)
        ...
        self.hs['L[0][1][3][0][1]_analysis_energy_range_box'] = widgets.VBox()
        self.hs['L[0][1][3][0][1]_analysis_energy_range_box'].layout = layout
        layout = {'border':'none', 'width':f'{1*self.form_sz[1]-106}px', 'height':f'{0.07*(self.form_sz[0]-128)}px'}
        self.hs['L[0][1][3][0][1][0]_analysis_energy_range_box1'] = widgets.HBox()
        self.hs['L[0][1][3][0][1][0]_analysis_energy_range_box1'].layout = layout
        layout = {'width':'19%', 'height':'90%'}
        self.hs['L[0][1][3][0][1][0][0]_analysis_energy_range_option_dropdown'] = widgets.Dropdown(description='analysis type',
                                                                                                  ...
                                                                                                  value ='wl',
                                                                                                  disabled=True)
        self.hs['L[0][1][3][0][1][0][0]_analysis_energy_range_option_dropdown'].layout = layout
        # layout = {'width':'19%', 'height':'100%', 'top':'0%', 'visibility':'hidden'}
        layout = {'width':'19%', 'height':'90%'}
        self.hs['L[0][1][3][0][1][0][1]_analysis_energy_range_edge_eng_text'] = widgets.BoundedFloatText(description='edge eng',
                                                                                                      ...
                                                                                                      step=0.5,
                                                                                                      disabled=True)
        self.hs['L[0][1][3][0][1][0][1]_analysis_energy_range_edge_eng_text'].layout = layout
        layout = {'width':'19%', 'height':'90%'}
        self.hs['L[0][1][3][0][1][0][2]_analysis_energy_range_pre_edge_e_text'] = widgets.BoundedFloatText(description='pre edge e',
                                                                                                   ...
                                                                                                   step=0.5,
                                                                                                   disabled=True)
        self.hs['L[0][1][3][0][1][0][2]_analysis_energy_range_pre_edge_e_text'].layout = layout
        layout = {'width':'19%', 'height':'90%'}
        self.hs['L[0][1][3][0][1][0][3]_analysis_energy_range_post_edge_s_text'] = widgets.BoundedFloatText(description='post edge s',
                                                                                                   ...
                                                                                                   step=0.5,
                                                                                                   disabled=True)
        self.hs['L[0][1][3][0][1][0][3]_analysis_energy_range_post_edge_s_text'].layout = layout
        layout = {'width':'19%', 'height':'90%'}
        self.hs['L[0][1][3][0][1][0][4]_analysis_filter_spec_checkbox'] = widgets.Checkbox(description='flt spec',
                                                                                           description_tooltip='relative starting energy point (keV) of post-edge from edge energy for normalization',
                                                                                           value = False,
                                                                                           disabled=True)
        self.hs['L[0][1][3][0][1][0][4]_analysis_filter_spec_checkbox'].layout = layout

        self.hs['L[0][1][3][0][1][0]_analysis_energy_range_box1'].children = get_handles(self.hs, 'L[0][1][3][0][1][0]_analysis_energy_range_box1', -1)
        self.hs['L[0][1][3][0][1][0][0]_analysis_energy_range_option_dropdown'].observe(self.L0_1_3_0_1_0_0_analysis_energy_range_option_dropdown_change, names='value')
        self.hs['L[0][1][3][0][1][0][1]_analysis_energy_range_edge_eng_text'].observe(self.L0_1_3_0_1_0_1_analysis_energy_range_edge_eng_text_change, names='value')
        self.hs['L[0][1][3][0][1][0][2]_analysis_energy_range_pre_edge_e_text'].observe(self.L0_1_3_0_1_0_2_analysis_energy_range_pre_edge_e_text_change, names='value')
        self.hs['L[0][1][3][0][1][0][3]_analysis_energy_range_post_edge_s_text'].observe(self.L0_1_3_0_1_0_3_analysis_energy_range_post_edge_s_text_change, names='value')
        self.hs['L[0][1][3][0][1][0][4]_analysis_filter_spec_checkbox'].observe(self.L0_1_3_0_1_0_4_analysis_filter_spec_checkbox, names='value')

        layout = {'border':'none', 'width':f'{1*self.form_sz[1]-106}px', 'height':f'{0.07*(self.form_sz[0]-128)}px'}
        self.hs['L[0][1][3][0][1][1]_analysis_energy_range_box2'] = widgets.HBox()
        self.hs['L[0][1][3][0][1][1]_analysis_energy_range_box2'].layout = layout
        layout = {'width':'19%', 'height':'90%'}
        self.hs['L[0][1][3][0][1][1][0]_analysis_energy_range_wl_fit_s_text'] = widgets.BoundedFloatText(description='wl eng s',
                                                                                            ...
                                                                                            step=0.5,
                                                                                            disabled=True)
        self.hs['L[0][1][3][0][1][1][0]_analysis_energy_range_wl_fit_s_text'].layout = layout
        layout = {'width':'19%', 'height':'90%'}
        self.hs['L[0][1][3][0][1][1][1]_analysis_energy_range_wl_fit_e_text'] = widgets.BoundedFloatText(description='wl eng e',
                                                                                            ...
                                                                                            step=0.5,
                                                                                            disabled=True)
        self.hs['L[0][1][3][0][1][1][1]_analysis_energy_range_wl_fit_e_text'].layout = layout
        layout = {'width':'19%', 'height':'90%'}
        self.hs['L[0][1][3][0][1][1][2]_analysis_energy_range_edge0.5_fit_s_text'] = widgets.BoundedFloatText(description='edge0.5 s',
                                                                                                 ...
                                                                                                 step=0.5,
                                                                                                 disabled=True)
        self.hs['L[0][1][3][0][1][1][2]_analysis_energy_range_edge0.5_fit_s_text'].layout = layout
        layout = {'width':'19%', 'height':'90%'}
        self.hs['L[0][1][3][0][1][1][3]_analysis_energy_range_edge0.5_fit_e_text'] = widgets.BoundedFloatText(description='edge0.5 e',
                                                                                                   description_tooltip='absolute energy starting point (keV) for edge-0.5 fitting. "edge0.5 s" and "edge0.5 e" shoudl be close to the foot and the peak locations on the ascendent edge of the spectra.',
                                                                                                   value =0,
                                                                                                   min = 0,
                                                                                                   max = 50030,
                                                                                                   step=0.5,
                                                                                                   disabled=True)
        self.hs['L[0][1][3][0][1][1][3]_analysis_energy_range_edge0.5_fit_e_text'].layout = layout

        layout = {'width':'15%', 'height':'90%', 'left':'7%'}
        self.hs['L[0][1][3][0][1][1][4]_analysis_energy_confirm_button'] = widgets.Button(description='Confirm',
                                                                                             description_tooltip='Confirm energy range settings',
                                                                                             disabled=True)
        self.hs['L[0][1][3][0][1][1][4]_analysis_energy_confirm_button'].layout = layout
        self.hs['L[0][1][3][0][1][1][4]_analysis_energy_confirm_button'].style.button_color = 'darkviolet'

        self.hs['L[0][1][3][0][1][1]_analysis_energy_range_box2'].children = get_handles(self.hs, 'L[0][1][3][0][1][1]_analysis_energy_range_box2', -1)
        self.hs['L[0][1][3][0][1][1][0]_analysis_energy_range_wl_fit_s_text'].observe(self.L0_1_3_0_1_1_0_analysis_energy_range_wl_fit_s_text_change, names='value')
        self.hs['L[0][1][3][0][1][1][1]_analysis_energy_range_wl_fit_e_text'].observe(self.L0_1_3_0_1_1_1_analysis_energy_range_wl_fit_e_text_change, names='value')
        self.hs['L[0][1][3][0][1][1][2]_analysis_energy_range_edge0.5_fit_s_text'].observe(self.L0_1_3_0_1_1_2_analysis_energy_range_edge0p5_fit_s_text_change, names='value')
        self.hs['L[0][1][3][0][1][1][3]_analysis_energy_range_edge0.5_fit_e_text'].observe(self.L0_1_3_0_1_1_3_analysis_energy_range_edge0p5_fit_e_text_change, names='value')
        self.hs['L[0][1][3][0][1][1][4]_analysis_energy_confirm_button'].on_click(self.L0_1_3_0_1_0_4_analysis_energy_range_confirm_button_click)

        self.hs['L[0][1][3][0][1]_analysis_energy_range_box'].children = get_handles(self.hs, 'L[0][1][3][0][1]_analysis_energy_range_box', -1)
        ...
        self.hs['L[0][1][3][0][2]_analysis_energy_filter_box'] = widgets.HBox()
        self.hs['L[0][1][3][0][2]_analysis_energy_filter_box'].layout = layout
        layout = {'width':'48%', 'height':'90%'}
        self.hs['L[0][1][3][0][2][0]_analysis_energy_filter_edge_jump_thres_slider'] = widgets.FloatSlider(description='edge jump thres',
                                                                                                              ...
                                                                                                              step=0.1,
                                                                                                              disabled=True)
        self.hs['L[0][1][3][0][2][0]_analysis_energy_filter_edge_jump_thres_slider'].layout = layout
        layout = {'width':'48%', 'height':'90%'}
        self.hs['L[0][1][3][0][2][1]_analysis_energy_filter_edge_offset_slider'] = widgets.FloatSlider(description='edge offset',
                                                                                      ...
                                                                                      step=0.1,
                                                                                      disabled=True)
        self.hs['L[0][1][3][0][2][1]_analysis_energy_filter_edge_offset_slider'].layout = layout
        self.hs['L[0][1][3][0][2][0]_analysis_energy_filter_edge_jump_thres_slider'].observe(self.L0_1_3_0_2_0_analysis_energy_filter_edge_jump_thres_slider_change, names='value')
        self.hs['L[0][1][3][0][2][1]_analysis_energy_filter_edge_offset_slider'].observe(self.L0_1_3_0_2_1_analysis_energy_filter_edge_offset_slider_change, names='value')

        self.hs['L[0][1][3][0][2]_analysis_energy_filter_box'].children = get_handles(self.hs, 'L[0][1][3][0][2]_analysis_energy_filter_box', -1)
        ## ## ## ## ## define analysis filters -- end

        ## ## ## ## ## define analysis mask -- start
        layout = {'border':'3px solid #FFCC00', 'width':f'{1*self.form_sz[1]-98}px', 'height':f'{0.07*(self.form_sz[0]-128)}px'}
        self.hs['L[0][1][3][0][3]_analysis_image_mask_box'] = widgets.HBox()
        self.hs['L[0][1][3][0][3]_analysis_image_mask_box'].layout = layout
        layout = {'width':'20%', 'height':'90%'}
        self.hs['L[0][1][3][0][3][0]_analysis_image_use_mask_checkbox'] = widgets.Checkbox(description='use mask',
                                                                                              description_tooltip='use a mask based on gray value threshold to define sample region',
                                                                                              value =False,
                                                                                              disabled=True)
        self.hs['L[0][1][3][0][3][0]_analysis_image_use_mask_checkbox'].layout = layout
        layout = {'width':'40%', 'height':'90%'}
        self.hs['L[0][1][3][0][3][1]_analysis_image_mask_scan_id_slider'] = widgets.IntSlider(description='mask scan id',
                                                                                                 description_tooltip='scan id with which the mask is made',
                                                                                                 value =1,
                                                                                                 min = 0,
                                                                                                 max = 10,
                                                                                                 disabled=True)
        self.hs['L[0][1][3][0][3][1]_analysis_image_mask_scan_id_slider'].layout = layout
        layout = {'width':'48%', 'height':'90%'}
        self.hs['L[0][1][3][0][3][1]_analysis_image_mask_thres_slider'] = widgets.FloatSlider(description='mask thres',
                                                                                            ...
                                                                                            readout_format='.5f',
                                                                                            disabled=True)
        self.hs['L[0][1][3][0][3][1]_analysis_image_mask_thres_slider'].layout = layout

        self.hs['L[0][1][3][0][3]_analysis_image_mask_box'].children = get_handles(self.hs, 'L[0][1][3][0][3]_analysis_image_mask_box', -1)
        self.hs['L[0][1][3][0][3][0]_analysis_image_use_mask_checkbox'].observe(self.L0_1_3_0_3_0_analysis_image_use_mask_checkbox_change, names='value')
        self.hs['L[0][1][3][0][3][1]_analysis_image_mask_scan_id_slider'].observe(self.L0_1_3_0_3_1_analysis_image_mask_scan_id_slider_change, names='value')
        self.hs['L[0][1][3][0][3][1]_analysis_image_mask_thres_slider'].observe(self.L0_1_3_0_3_1_analysis_image_mask_thres_slider_change, names='value')
        ## ## ## ## ## define analysis mask -- end

        ## ## ## ## ## define run analysis -- start
        layout = {'border':'3px solid #FFCC00', 'width':f'{1*self.form_sz[1]-98}px', 'height':f'{0.07*(self.form_sz[0]-128)}px'}
        self.hs['L[0][1][3][0][4]_analysis_run_box'] = widgets.HBox()
        self.hs['L[0][1][3][0][4]_analysis_run_box'].layout = layout
        layout = {'width':'70%', 'height':'90%'}
        self.hs['L[0][1][3][0][4][0]_analysis_run_text'] = widgets.Text(description='please check your settings before run the analysis .. ',
                                                                        disabled=True)
        self.hs['L[0][1][3][0][4][0]_analysis_run_text'].layout = layout
        layout = {'width':'15%', 'height':'90%'}
        self.hs['L[0][1][3][0][4][1]_analysis_run_button'] = widgets.Button(description='run',
                                                                            disabled=True)
        self.hs['L[0][1][3][0][4][1]_analysis_run_button'].layout = layout
        self.hs['L[0][1][3][0][4][1]_analysis_run_button'].style.button_color = 'darkviolet'
        self.hs['L[0][1][3][0][4]_analysis_run_box'].children = get_handles(self.hs, 'L[0][1][3][0][4]_analysis_run_box', -1)
        self.hs['L[0][1][3][0][4][1]_analysis_run_button'].on_click(self.L0_1_3_0_4_1_analysis_run_button_click)
        ## ## ## ## ## define run analysis -- end

        ## ## ## ## ## define run analysis status -- start
        layout = {'border':'3px solid #FFCC00', 'width':f'{self.form_sz[1]-98}px', 'height':f'{0.07*(self.form_sz[0]-128)}px'}
        self.hs['L[0][1][3][0][5]_analysis_progress_box'] = widgets.HBox()
        self.hs['L[0][1][3][0][5]_analysis_progress_box'].layout = layout
        layout = {'width':'100%', 'height':'90%'}
        self.hs['L[0][1][3][0][5][0]_analysis_run_progress_bar'] = widgets.IntProgress(value=0,
                                                                                       min=0,
                                                                                       max=10,
                                                                                       step=1,
                                                                                       description='Completing:',
                                                                                       bar_style='info', # 'success', 'info', 'warning', 'danger' or ''
                                                                                       orientation='horizontal')
        self.hs['L[0][1][3][0][5][0]_analysis_run_progress_bar'].layout = layout
        self.hs['L[0][1][3][0][5]_analysis_progress_box'].children = get_handles(self.hs, 'L[0][1][3][0][5]_analysis_progress_box', -1)
        ## ## ## ## ## define run analysis status -- end
        self.hs['L[0][1][3][0]_analysis_box'].children = get_handles(self.hs, 'L[0][1][3][0]_analysis_box', -1)
        ## ## ## ## define functional widgets in each sub-tab - analysis TAB -- end
        self.hs['L[0][1][3]_analysis&display_form'].children = get_handles(self.hs, 'L[0][1][3]_analysis&display_form', -1)
        ## ## ## define 2D_XANES_tabs layout - visualization&analysis reg & align data -- end

        # self.hs['L[0][1]_2D_xanes_tabs'].children = get_handles(self.hs, 'L[0][1]_2D_xanes_tabs', -1)
    ...
    def lock_message_text_boxes(self):
        boxes = ['L[0][1][0][0][1][1]_select_raw_h5_path_text',
                 ...
                 'L[0][1][3][0][4][0]_analysis_run_text']
    ...
    def set_xanes2D_variables(self):
        ...
        self.xanes2D_analysis_edge_eng = self.xanes2D_config["align 2D recon"]["xanes2D_analysis_edge_eng"] 
        self.xanes2D_analysis_wl_fit_eng_s = self.xanes2D_config["align 2D recon"]["xanes2D_analysis_wl_fit_eng_s"]
        self.xanes2D_analysis_wl_fit_eng_e = self.xanes2D_config["align 2D recon"]["xanes2D_analysis_wl_fit_eng_e"]
        self.xanes2D_analysis_pre_edge_e = self.xanes2D_config["align 2D recon"]["xanes2D_analysis_pre_edge_e"]
        self.xanes2D_analysis_post_edge_s = self.xanes2D_config["align 2D recon"]["xanes2D_analysis_post_edge_s"]
        self.xanes2D_analysis_edge_0p5_fit_s = self.xanes2D_config["align 2D recon"]["xanes2D_analysis_edge_0p5_fit_s"]
        self.xanes2D_analysis_edge_0p5_fit_e = self.xanes2D_config["align 2D recon"]["xanes2D_analysis_edge_0p5_fit_e"]
        self.xanes2D_analysis_type = self.xanes2D_config["align 2D recon"]["xanes2D_analysis_type"]
        ...
        if self.xanes2D_file_analysis_option == 'Do New Reg':
            ...
            if not self.xanes2D_file_config_file_set:
                ...
                if self.xanes2D_alignment_done:
                    ...
                    self.hs['L[0][1][2][2][1][0]_visualization_slider'].max = self.xanes2D_analysis_eng_list.shape[0]-1

                    self.xanes2D_review_reg_best_match_filename = os.path.splitext(self.xanes2D_file_save_trial_reg_config_filename)[0].replace('config', 'reg_best_match') + '.json'
                    self.xanes_element = determine_element(self.xanes2D_analysis_eng_list)
                    tem = determine_fitting_energy_range(self.xanes_element)
                    self.xanes2D_analysis_edge_eng = tem[0] 
                    self.xanes2D_analysis_wl_fit_eng_s = tem[1]
                    self.xanes2D_analysis_wl_fit_eng_e = tem[2]
                    self.xanes2D_analysis_pre_edge_e = tem[3]
                    self.xanes2D_analysis_post_edge_s = tem[4] 
                    self.xanes2D_analysis_edge_0p5_fit_s = tem[5]
                    self.xanes2D_analysis_edge_0p5_fit_e = tem[6]
                    self.xanes2D_analysis_type = 'full'
                    self.hs['L[0][1][3][0][1][0][0]_analysis_energy_range_option_dropdown'].value = 'full'
            self.boxes_logic()
        elif self.xanes2D_file_analysis_option == 'Do Analysis':
    ...
    def L0_1_2_2_1_0_visualization_slider_change(self, a):
        self.hs['L[0][1][2][2][1][3]_visualization_eng_text'].value = self.xanes2D_analysis_eng_list[a['owner'].value]
        data_state, viewer_state = fiji_viewer_state(self.global_h, self, viewer_name='xanes2D_analysis_viewer')
        if not viewer_state:
            fiji_viewer_on(self.global_h, self, viewer_name='xanes2D_analysis_viewer')
        self.global_h.xanes2D_fiji_windows['xanes2D_analysis_viewer']['ip'].setImage(self.global_h.ij.convert().convert(
    ...
    def L0_1_3_0_1_0_0_analysis_energy_range_option_dropdown_change(self, a):
        self.xanes2D_analysis_eng_configured = False
        self.xanes2D_analysis_type = a['owner'].value
        self.hs['L[0][1][3][0][1][0][1]_analysis_energy_range_edge_eng_text'].value = self.xanes2D_analysis_edge_eng
        self.hs['L[0][1][3][0][1][1][1]_analysis_energy_range_wl_fit_e_text'].value = self.xanes2D_analysis_wl_fit_eng_e
        self.hs['L[0][1][3][0][1][1][0]_analysis_energy_range_wl_fit_s_text'].value = self.xanes2D_analysis_wl_fit_eng_s
        self.hs['L[0][1][3][0][1][1][3]_analysis_energy_range_edge0.5_fit_e_text'].value = self.xanes2D_analysis_edge_0p5_fit_e
        self.hs['L[0][1][3][0][1][1][2]_analysis_energy_range_edge0.5_fit_s_text'].value = self.xanes2D_analysis_edge_0p5_fit_s
        self.hs['L[0][1][3][0][1][0][2]_analysis_energy_range_pre_edge_e_text'].value = self.xanes2D_analysis_pre_edge_e
        self.hs['L[0][1][3][0][1][0][3]_analysis_energy_range_post_edge_s_text'].value = self.xanes2D_analysis_post_edge_s
        self.hs['L[0][1][3][0][4][0]_analysis_run_text'].value ='please check your settings before run the analysis ...'
        if a['owner'].value == 'wl':
            ...
            layout = {'width':'19%', 'height':'100%', 'top':'15%', 'visibility':'visible'}
            self.hs['L[0][1][3][0][1][0][2]_analysis_energy_range_pre_edge_e_text'].layout = layout
            self.hs['L[0][1][3][0][1][0][2]_analysis_energy_range_pre_edge_e_text'].max = 0
            self.hs['L[0][1][3][0][1][0][2]_analysis_energy_range_pre_edge_e_text'].value = -50
            self.hs['L[0][1][3][0][1][0][2]_analysis_energy_range_pre_edge_e_text'].min = -500
            layout = {'width':'19%', 'height':'100%', 'top':'15%', 'visibility':'visible'}
            self.hs['L[0][1][3][0][1][0][3]_analysis_energy_range_post_edge_s_text'].layout = layout
            self.hs['L[0][1][3][0][1][0][3]_analysis_energy_range_post_edge_s_text'].min = 0
            self.hs['L[0][1][3][0][1][0][3]_analysis_energy_range_post_edge_s_text'].value = 100
            self.hs['L[0][1][3][0][1][0][3]_analysis_energy_range_post_edge_s_text'].max = 500
    ...
    def L0_1_3_0_1_0_1_analysis_energy_range_edge_eng_text_change(self, a):
        self.xanes2D_analysis_eng_configured = False
        self.xanes2D_analysis_edge_eng = self.hs['L[0][1][3][0][1][0][1]_analysis_energy_range_edge_eng_text'].value
        self.hs['L[0][1][3][0][4][0]_analysis_run_text'].description ='please check your settings before run the analysis ...'
        self.boxes_logic()

    def L0_1_3_0_1_0_2_analysis_energy_range_pre_edge_e_text_change(self, a):
        self.xanes2D_analysis_eng_configured = False
        self.xanes2D_analysis_pre_edge_e = self.hs['L[0][1][3][0][1][0][2]_analysis_energy_range_pre_edge_e_text'].value
        self.hs['L[0][1][3][0][4][0]_analysis_run_text'].description ='please check your settings before run the analysis ...'
        self.boxes_logic()

    def L0_1_3_0_1_0_3_analysis_energy_range_post_edge_s_text_change(self, a):
        self.xanes2D_analysis_eng_configured = False
        self.xanes2D_analysis_post_edge_s = self.hs['L[0][1][3][0][1][0][3]_analysis_energy_range_post_edge_s_text'].value
        self.hs['L[0][1][3][0][4][0]_analysis_run_text'].description ='please check your settings before run the analysis ...'
        self.boxes_logic()

    def L0_1_3_0_1_0_4_analysis_filter_spec_checkbox(self, a):
        self.xanes2D_analysis_eng_configured = False
        self.xanes2D_analysis_use_flt_spec = a['owner'].value
        self.hs['L[0][1][3][0][4][0]_analysis_run_text'].description ='please check your settings before run the analysis ...'
        self.boxes_logic()

    def L0_1_3_0_1_1_0_analysis_energy_range_wl_fit_s_text_change(self, a):
        self.xanes2D_analysis_eng_configured = False
        ...
        #     self.hs['L[0][1][3][0][4][0]_analysis_run_text'].value = 'The whiteline fitting energy starting point might be too low. Reset it to the edge energy.'
        # elif (a['owner'].value+0.005) > self.hs['L[0][1][3][0][1][1][1]_analysis_energy_range_wl_fit_e_text'].value:
        #     a['owner'].value = self.hs['L[0][1][3][0][1][1][1]_analysis_energy_range_wl_fit_e_text'].value - 0.005
        #     self.hs['L[0][1][3][0][4][0]_analysis_run_text'].value = 'The whiteline fitting energy starting point might be too high. Reset it to 0.005keV lower than whiteline fitting energy ending point.'
        # else:
        #     self.hs['L[0][1][3][0][4][0]_analysis_run_text'].value ='please check your settings before run the analysis ...'
        self.hs['L[0][1][3][0][4][0]_analysis_run_text'].value ='please check your settings before run the analysis ...'
        self.xanes2D_analysis_wl_fit_eng_s = a['owner'].value
        self.boxes_logic()

    def L0_1_3_0_1_1_1_analysis_energy_range_wl_fit_e_text_change(self, a):
        self.xanes2D_analysis_eng_configured = False
        # if a['owner'].value < (self.hs['L[0][1][3][0][1][1][0]_analysis_energy_range_wl_fit_s_text'].value + 0.005):
        #     a['owner'].value = (self.hs['L[0][1][3][0][1][1][0]_analysis_energy_range_wl_fit_s_text'].value + 0.005)
        #     self.hs['L[0][1][3][0][4][0]_analysis_run_text'].value = 'The whiteline fitting energy ending point might be too low. Reset it to 0.005keV higher than whiteline fitting energy starting point.'
        # else:
        #     self.hs['L[0][1][3][0][4][0]_analysis_run_text'].value ='please check your settings before run the analysis ...'
        self.hs['L[0][1][3][0][4][0]_analysis_run_text'].value ='please check your settings before run the analysis ...'
        self.xanes2D_analysis_wl_fit_eng_e = a['owner'].value
        self.boxes_logic()

    def L0_1_3_0_1_1_2_analysis_energy_range_edge0p5_fit_s_text_change(self, a):
        self.xanes2D_analysis_eng_configured = False
        # if a['owner'].value > self.xanes2D_analysis_edge_eng:
        #     a['owner'].value = self.xanes2D_analysis_edge_eng
        #     self.hs['L[0][1][3][0][4][0]_analysis_run_text'].value = 'The edge-0.5 fitting energy starting point might be too high. Reset it to edge energy.'
        # else:
        #     self.hs['L[0][1][3][0][4][0]_analysis_run_text'].value ='please check your settings before run the analysis ...'
        self.hs['L[0][1][3][0][4][0]_analysis_run_text'].value ='please check your settings before run the analysis ...'
        self.xanes2D_analysis_edge_0p5_fit_s = a['owner'].value
        self.boxes_logic()

    def L0_1_3_0_1_1_3_analysis_energy_range_edge0p5_fit_e_text_change(self, a):
        self.xanes2D_analysis_eng_configured = False
        # if a['owner'].value < self.xanes2D_analysis_edge_eng:
        #     a['owner'].value = self.xanes2D_analysis_edge_eng
        #     self.hs['L[0][1][3][0][4][0]_analysis_run_text'].value = 'The edge-0.5 fitting energy ending point might be too low. Reset it to edge energy.'
        # else:
        #     self.hs['L[0][1][3][0][4][0]_analysis_run_text'].value ='please check your settings before run the analysis ...'
        self.hs['L[0][1][3][0][4][0]_analysis_run_text'].value ='please check your settings before run the analysis ...'
        self.xanes2D_analysis_edge_0p5_fit_e = a['owner'].value
        self.boxes_logic()

    def L0_1_3_0_1_0_4_analysis_energy_range_confirm_button_click(self, a):
        if self.xanes2D_analysis_type == 'wl':
            self.xanes2D_analysis_wl_fit_eng_s = self.hs['L[0][1][3][0][1][1][0]_analysis_energy_range_wl_fit_s_text'].value
            self.xanes2D_analysis_wl_fit_eng_e = self.hs['L[0][1][3][0][1][1][1]_analysis_energy_range_wl_fit_e_text'].value
            self.xanes2D_analysis_use_flt_spec = self.hs['L[0][1][3][0][1][0][4]_analysis_filter_spec_checkbox'].value
            ...
            self.xanes2D_analysis_wl_fit_eng_s = self.hs['L[0][1][3][0][1][1][0]_analysis_energy_range_wl_fit_s_text'].value
            self.xanes2D_analysis_wl_fit_eng_e = self.hs['L[0][1][3][0][1][1][1]_analysis_energy_range_wl_fit_e_text'].value
            self.xanes2D_analysis_edge_0p5_fit_s = self.hs['L[0][1][3][0][1][1][2]_analysis_energy_range_edge0.5_fit_s_text'].value
            self.xanes2D_analysis_edge_0p5_fit_e = self.hs['L[0][1][3][0][1][1][3]_analysis_energy_range_edge0.5_fit_e_text'].value
            self.xanes2D_analysis_use_flt_spec = self.hs['L[0][1][3][0][1][0][4]_analysis_filter_spec_checkbox'].value
    ...
    def L0_1_3_0_2_0_analysis_energy_filter_edge_jump_thres_slider_change(self, a):
        self.xanes2D_analysis_edge_jump_thres = a['owner'].value
        self.boxes_logic()

    def L0_1_3_0_2_1_analysis_energy_filter_edge_offset_slider_change(self, a):
        self.xanes2D_analysis_edge_offset_thres = a['owner'].value
        self.boxes_logic()

    def L0_1_3_0_3_0_analysis_image_use_mask_checkbox_change(self, a):
        pass

    def L0_1_3_0_3_1_analysis_image_mask_scan_id_slider_change(self, a):
        pass

    def L0_1_3_0_3_1_analysis_image_mask_thres_slider_change(self, a):
        pass

    def L0_1_3_0_4_1_analysis_run_button_click(self, a):
        """
        ...
        data_state, viewer_state = fiji_viewer_state(self.global_h, self, viewer_name='xanes2D_analysis_viewer')
        if not viewer_state:
            fiji_viewer_off(self.global_h, self, viewer_name='xanes2D_analysis_viewer')
        ...
        with h5py.File(self.xanes2D_file_save_trial_reg_filename, 'r+') as f:
            ...
            g11.create_dataset('eng_list', 
                               data=scale_eng_list(self.xanes2D_analysis_eng_list).astype(np.float32))
            g11.create_dataset('edge_eng', 
                               data=self.xanes2D_analysis_edge_eng)
            g11.create_dataset('pre_edge_e', 
                               data=self.xanes2D_analysis_pre_edge_e)
            g11.create_dataset('post_edge_s', 
                               data=self.xanes2D_analysis_post_edge_s)
            g11.create_dataset('edge_jump_threshold', 
                               data=self.xanes2D_analysis_edge_jump_thres)
            g11.create_dataset('edge_offset_threshold', 
                               data=self.xanes2D_analysis_edge_offset_thres)
            g11.create_dataset('use_mask', 
                               data=str(self.xanes2D_analysis_use_mask))
            g11.create_dataset('analysis_type', 
                               data=self.xanes2D_analysis_type)
            g11.create_dataset('data_shape', data=self.xanes2D_img_roi.shape)
            g11.create_dataset('edge_0p5_fit_s', 
                               data=self.xanes2D_analysis_edge_0p5_fit_s)
            g11.create_dataset('edge_0p5_fit_e', 
                               data=self.xanes2D_analysis_edge_0p5_fit_e)
            g11.create_dataset('wl_fit_eng_s', 
                               data=self.xanes2D_analysis_wl_fit_eng_s)
            g11.create_dataset('wl_fit_eng_e', 
                               data=self.xanes2D_analysis_wl_fit_eng_e)
            g11.create_dataset('normalized_fitting_order', data=1)
            g11.create_dataset('flt_spec', 
                               data=str(self.xanes2D_analysis_use_flt_spec))
        # f.close()
        ...
        gen_external_py_script(self.xanes2D_external_command_name, code)
        sig = os.system(f'python {self.xanes2D_external_command_name}')
        print(4)
        if sig == 0:
            self.hs['L[0][1][3][0][4][0]_analysis_run_text'].value = 'XANES2D analysis is done ...'
            print(100)
        else:
            self.hs['L[0][1][3][0][4][0]_analysis_run_text'].value = 'somthing wrong in analysis ...'
            print(-100)
