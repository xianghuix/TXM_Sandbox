...
SAVE_ITEMS_DICT = {'whiteline_pos':'wl_pos)[:]',
                   'whiteline_direct_pos':'wl_pos_direct',
                   'whiteline_peak_height_direct':'direct_wl_ph',
                   'centroid_of_eng':'centroid_of_eng',
                   'centroid_of_eng_relative_to_wl':'centroid_of_eng_rel_wl',
                   'weighted_attenuation':'weighted_atten',
                   'weighted_eng':'weighted_eng',
                   'edge0.5_pos':'edge_pos',
                   'edge_pos_direct':'',
                   'edge_pos_fit':'',
                   'edge_jump_filter':'edge_jump_mask',
                   'edge_offset_filter':'fitted_edge_mask',
                   'pre_edge_sd':'pre_edge_sd_map',
                   'post_edge_sd':'post_edge_sd_map',
                   'pre_edge_mean':'pre_edge_mean_map',
                   'post_edge_mean':'post_edge_mean_map',
                   'pre_edge_fit_coef':'',
                   'pre_edge_fit_coef':'',
                   'post_edge_fit_coef':'',
                   'peak_fit_coef':''}
...
class xanes_analysis_gui():
    def __init__(self, parent_h, form_sz=[650, 740]):
        ...
        self.ana_wl_fit_method = 'lorentzian'
        self.ana_edge_fit_use_param_bnd = False        
        self.ana_edge_optimizer = 'scipy'
        self.ana_edge_fit_method = 'lorentzian'
        self.analysis_saving_items = set(['whiteline_pos',
    ...
    def build_gui(self):
        ...
        self.hs['L[0][x][3][0][4][1][0]_ana_save_setting_gridlayout'][0:6, 0:100] = \
            widgets.SelectMultiple(options=['whiteline_pos', 
                                            'whiteline_direct_pos', 
                                            'whiteline_peak_height_direct',
                                            'centroid_of_eng',
                                            'centroid_of_eng_relative_to_wl',
        ...
        self.hs['L[0][x][3][0][4][1][0]_ana_save_setting_gridlayout'][7:8, 40:60] = \
            widgets.Button(description = '==>',
                           ...
                           disabled = True)
        self.hs['L[0][x][3][0][4][1][0][2]_ana_save_setting_confirm_button'] = \
            self.hs['L[0][x][3][0][4][1][0]_ana_save_setting_gridlayout'][7:8, 40:60]
        self.hs['L[0][x][3][0][4][1][0][2]_ana_save_setting_confirm_button'].style.button_color = \
            'darkviolet'
        ...
        self.hs['L[0][x][3][0][4][1][0][3]_ana_save_setting_remove_button'].style.button_color = \
            'darkviolet'
        self.hs['L[0][x][3][0][4][1][0][2]_ana_save_setting_confirm_button'].on_click(self.L0_x_3_0_4_1_0_2_ana_save_setting_confirm_button_click)
        ...
        self.hs['L[0][x][3][0][4]_analysis_tool_box'].children = [self.hs['L[0][x][3][0][4][0]_ana_fit_wl_param_box'],
                                                                  self.hs['L[0][x][3][0][4][2]_ana_fit_edge_param_box'],
                                                                  self.hs['L[0][x][3][0][4][1]_ana_save_setting_box']]
        self.hs['L[0][x][3][0][4]_analysis_tool_box'].set_title(0, 'fit whiteline params')
        self.hs['L[0][x][3][0][4]_analysis_tool_box'].set_title(1, 'fit edge params')
        self.hs['L[0][x][3][0][4]_analysis_tool_box'].set_title(2, 'saving setting')
    ...
    def L0_x_3_0_4_0_0_1_ana_wl_fit_func(self, a):
        self.ana_wl_fit_method = a['owner'].value
        cnt = 0
        for ii in self.ana_wl_fit_func_arg_handles:
                ii.disabled = True
                ...
                cnt += 1
        if self.ana_wl_optimizer == 'scipy':
            for ii in sorted(PEAK_FIT_PARAM_DICT[self.ana_wl_fit_method].keys()):
                self.ana_wl_fit_func_arg_handles[ii].disabled = False
                self.ana_wl_fit_func_arg_handles[ii].description = \
                    PEAK_FIT_PARAM_DICT[self.ana_wl_fit_method][ii][0]
                self.ana_wl_fit_func_arg_handles[ii].value = \
                    PEAK_FIT_PARAM_DICT[self.ana_wl_fit_method][ii][1]
                self.ana_wl_fit_func_arg_handles[ii].description_tooltip = \
                    PEAK_FIT_PARAM_DICT[self.ana_wl_fit_method][ii][2]
        if self.ana_wl_fit_method == "rectangle":
            self.ana_wl_fit_func_arg_handles[5].options = \
                    ['linear', 'atan', 'erf', 'logisitic']
        if self.ana_wl_fit_method == "step":
            self.ana_wl_fit_func_arg_handles[5].options = \
                    ['linear', 'atan', 'erf', 'logisitic']
    ...
    def L0_x_3_0_4_2_0_1_ana_edge_fit_func(self, a):
        self.ana_edge_fit_method = a['owner'].value
        cnt = 0
        for ii in self.ana_edge_fit_func_arg_handles:
                ii.disabled = True
                ii.description = 'p'+str(cnt)
                cnt += 1
        if self.ana_edge_optimizer == 'scipy':
            for ii in sorted(PEAK_FIT_PARAM_DICT[self.ana_edge_fit_method].keys()):
                self.ana_edge_fit_func_arg_handles[ii].disabled = False
                self.ana_edge_fit_func_arg_handles[ii].description = \
                    PEAK_FIT_PARAM_DICT[self.ana_edge_fit_method][ii][0]
                self.ana_edge_fit_func_arg_handles[ii].value = \
                    PEAK_FIT_PARAM_DICT[self.ana_edge_fit_method][ii][1]
                self.ana_edge_fit_func_arg_handles[ii].description_tooltip = \
                    PEAK_FIT_PARAM_DICT[self.ana_edge_fit_method][ii][2]
        if self.ana_edge_fit_method == "rectangle":
            self.ana_edge_fit_func_arg_handles[5].options = \
                    ['linear', 'atan', 'erf', 'logisitic']
        if self.ana_edge_fit_method == "step":
            self.ana_edge_fit_func_arg_handles[5].options = \
                    ['linear', 'atan', 'erf', 'logisitic']
        
        # if self.ana_wl_fit_method == "exponential":
        #     self.ana_wl_fit_func_arg_handles[0].description = 'amp'
        # elif self.ana_wl_fit_method == "powerlaw":
        #     pass
        # elif self.ana_wl_fit_method == "parabolic":
        #     pass
        # elif self.ana_wl_fit_method == 'gaussian':
        #     pass
        # elif self.ana_wl_fit_method == 'lorentzian':
        #     pass
        # elif self.ana_wl_fit_method == "damped_oscillator":
        #     pass
        # elif self.ana_wl_fit_method == "logistic":
        #     pass
        # elif self.ana_wl_fit_method == "students_t":
        #     pass
        # elif self.ana_wl_fit_method == "sine":
        #     pass
        # elif self.ana_wl_fit_method == "voigt":
        #     pass
        # elif self.ana_wl_fit_method == "split_lorentzian":
        #     pass
        # elif self.ana_wl_fit_method == "pvoigt":
        #     pass
        # elif self.ana_wl_fit_method == "moffat":
        #     pass
        # elif self.ana_wl_fit_method == "pearson7":
        #     pass
        # elif self.ana_wl_fit_method == "breit_wigner":
        #     pass
        # elif self.ana_wl_fit_method == "dho":
        #     pass
        # elif self.ana_wl_fit_method == "expgaussian":
        #     pass
        # elif self.ana_wl_fit_method == "donaich":
        #     pass
        # elif self.ana_wl_fit_method == "skewed_gaussian":
        #     pass
        # elif self.ana_wl_fit_method == "expsine":
        #     pass
        # elif self.ana_wl_fit_method == "step":
        #     pass
        # elif self.ana_wl_fit_method == "skewed_voigt":
        #     pass
        # elif self.ana_wl_fit_method == "rectangle":
        #     pass
    ...
    def L0_x_3_0_4_1_0_2_ana_save_setting_confirm_button_click(self, a):
    ...
    def L0_x_3_0_5_1_analysis_run_button(self, a):
        ...
        if self.ana_wl_optimizer == 'scipy':
            for ii in sorted(PEAK_FIT_PARAM_DICT[self.ana_wl_fit_method].keys()):
                fvars.append(self.ana_wl_fit_func_arg_handles[ii].value)
            if self.ana_wl_fit_use_param_bnd :
                for ii in sorted(PEAK_FIT_PARAM_DICT[self.ana_wl_fit_method].keys()):
                    bnds.append((self.ana_wl_fit_func_bnd_handles[2*ii].value,
            ...
            self.ana_wl_optimizer_arg_handles = [self.hs['L[0][x][3][0][4][0][0][9]_ana_wl_jac'],
                                                   ...
                                                   self.hs['L[0][x][3][0][4][0][0][13]_ana_wl_gtol'],
                                                   self.hs['L[0][x][3][0][4][0][0][14]_ana_wl_ufac']]
            jac=self.ana_wl_optimizer_arg_handles[0].value
            method=self.ana_wl_optimizer_arg_handles[1].value
            ftol=self.ana_wl_optimizer_arg_handles[2].value
            xtol=self.ana_wl_optimizer_arg_handles[3].value
            gtol=self.ana_wl_optimizer_arg_handles[4].value
            ufac=self.ana_wl_optimizer_arg_handles[5].value
        elif self.ana_wl_optimizer == 'numpy':
            order = self.hs['L[0][x][3][0][4][0][0][1]_ana_wl_fit_func'].value
        ...
        if self.parent_h.gui_name == 'xanes3D':
            with h5py.File(self.fn, 'r+') as f:
                ...
                g111 = g11.create_group('fitting method')
                g111.create_dataset('optimizer', data=str(self.ana_wl_optimizer))
                if self.ana_wl_optimizer == 'scipy':
                    g111.create_dataset('method', data=str(self.ana_wl_fit_method))
                    g1111 = g111.create_group('params')
                    g1111.create_dataset('jac', data=str(jac))
                    g1111.create_dataset('method', data=str(method))
                    g1111.create_dataset('ftol', data=ftol)
                    g1111.create_dataset('xtol', data=xtol)
                    g1111.create_dataset('gtol', data=gtol)
                    g1111.create_dataset('ufac', data=ufac)
                    g1111.create_dataset('fvars_init', data=fvars)
                    g1111.create_dataset('ufac', data=ufac)
                    if bnds is None:
                        g1111.create_dataset('bnds', data='None')
                    else:
                        g1111.create_dataset('bnds', data=bnds)
                else:
                    g111.create_dataset('method', data='polynimial')
                    g1111 = g111.create_group('params')
                    g1111.create_dataset('order', data=order)
            ...
            code[ln] = f"    im`gs = f['/registration_results/reg_results/registered_xanes3D'][:, 0, :, :]"; ln += 1
            ...
            code[ln] = f"            if jj in ['pre_edge_fit_coef', 'post_edge_fit_coef', 'peak_fit_coef']:"; ln += 1  
            code[ln] = f"                _g12[jj] = g12.create_dataset(jj, shape=(list(len(fvars)) + list(xanes3D_analysis_data_shape[1:])), dtype=np.float32)"; ln += 1
            code[ln] = f"            else:"; ln += 1  
            code[ln] = f"                _g12[jj] = g12.create_dataset(jj, shape=(xanes3D_analysis_data_shape[1:]), dtype=np.float32)"; ln += 1             
            code[ln] = f"        if {self.ana_wl_optimizer} == 'scipy':"; ln += 1
            ...
            code[ln] = f"                xana.fit_whiteline_scipy(xanes3D_analysis_wl_fit_eng_s, xanes3D_analysis_wl_fit_eng_e, model={self.ana_wl_fit_method}, fvars={fvars}, bnds={bnds}, ftol={ftol}, xtol={xtol}, gtol={gtol}, jac={jac}, method={method}, ufac={ufac})"; ln+=1
            code[ln] = f"                if {self.ana_refine_edge}:"; ln += 1
            code[ln] = f"                    xana.fit_edge_scipy(xanes3D_analysis_wl_fit_eng_s, xanes3D_analysis_wl_fit_eng_e, model={self.ana_wl_fit_method}, fvars={fvars}, bnds={bnds}, ftol={ftol}, xtol={xtol}, gtol={gtol}, jac={jac}, method={method}, ufac={ufac})"; ln+=1
            ...
            code[ln] = f"        elif {self.ana_wl_optimizer} == 'numpy':"; ln += 1
            code[ln] = f"            for ii in range(xanes3D_analysis_data_shape[1]):"; ln += 1
            code[ln] = f"                imgs[:] = f['/registration_results/reg_results/registered_xanes3D'][:, ii, :, :]"; ln += 1
            code[ln] = f"                xana.spectrum[:] = imgs[:]"; ln += 1
            code[ln] = f"                xana.fit_whiteline_polynomial(xanes3D_analysis_wl_fit_eng_s, xanes3D_analysis_wl_fit_eng_e, order={order}, flt_spec=xanes3D_analysis_use_flt_spec)"; ln += 1
            code[ln] = f"                xana.calc_direct_whiteline(xanes3D_analysis_wl_fit_eng_s, xanes3D_analysis_wl_fit_eng_e)"; ln += 1
            code[ln] = f"                for jj in {self.analysis_saving_items}:"; ln += 1  
            code[ln] = f"                    if jj in ['pre_edge_fit_coef', 'post_edge_fit_coef', 'peak_fit_coef']:"; ln += 1  
            code[ln] = f"                        _g12[jj] = g12.create_dataset(jj, shape=(list(len(fvars)) + list(xanes3D_analysis_data_shape[1:])), dtype=np.float32)"; ln += 1
            ...
            code[ln] = f"                xana.normalize_xanes(xanes3D_analysis_edge_eng, order=xanes3D_analysis_norm_fitting_order)"; ln += 1
            code[ln] = f"                xana.fit_edge_pos(xanes3D_analysis_edge_0p5_fit_s, xanes3D_analysis_edge_0p5_fit_e, order=3, flt_spec=xanes3D_analysis_use_flt_spec)"; ln += 1
            code[ln] = f"                xana.fit_whiteline_scipy(xanes3D_analysis_wl_fit_eng_s, xanes3D_analysis_wl_fit_eng_e, model={self.ana_wl_fit_method}, fvars={fvars}, bnds={bnds}, ftol={ftol}, xtol={xtol}, gtol={gtol}, jac={jac}, method={method}, ufac={ufac})"; ln+=1
            ...
            code[ln] = f"                for jj in {self.analysis_saving_items}:"; ln += 1  
            code[ln] = f"                    if jj in ['pre_edge_fit_coef', 'post_edge_fit_coef', 'peak_fit_coef']:"; ln += 1  
            code[ln] = f"                        _g12[jj] = g12.create_dataset(ii, shape=(list(len(fvars)) + list(xanes3D_analysis_data_shape[1:])), dtype=np.float32)"; ln += 1
            code[ln] = f"                    else:"; ln += 1  
            code[ln] = f"                        _g12[jj] = g12.create_dataset(ii, shape=(xanes3D_analysis_data_shape[1:]), dtype=np.float32)"; ln += 1 
            
            code[ln] = f"                g120[ii] = np.float32(xana.wl_pos)[:]"; ln += 1
            code[ln] = f"                g121[ii] = np.float32(xana.wl_pos_direct)[:]"; ln += 1
            code[ln] = f"                g122[ii] = np.float32(xana.direct_wl_ph)[:]"; ln += 1
            code[ln] = f"                g123[ii] = np.float32(xana.centroid_of_eng)[:]"; ln += 1
            code[ln] = f"                g124[ii] = np.float32(xana.centroid_of_eng_rel_wl)[:]"; ln += 1
            code[ln] = f"                g125[ii] = np.float32(xana.weighted_atten)[:]"; ln += 1
            code[ln] = f"                g126[ii] = np.float32(xana.weighted_eng)[:]"; ln += 1
            code[ln] = f"                g127[ii] = np.float32(xana.edge_pos)[:]"; ln += 1
            code[ln] = f"                g128[ii] = np.float32(xana.edge_jump_mask)[:]"; ln += 1
            code[ln] = f"                g129[ii] = np.float32(xana.fitted_edge_mask)[:]"; ln += 1
            code[ln] = f"                g1210[:] = np.float32(xana.pre_edge_sd_map)[:]"; ln+=1
            code[ln] = f"                g1211[:] = np.float32(xana.post_edge_sd_map)[:]"; ln+=1
            code[ln] = f"                g1212[:] = np.float32(xana.pre_edge_mean_map)[:]"; ln+=1
            code[ln] = f"                g1213[:] = np.float32(xana.post_edge_mean_map)[:]"; ln+=1
            code[ln] = f"                print(str(ii)+'/'+str(xanes3D_analysis_data_shape[1]))"; ln += 1
            code[ln] = f"        if {self.ana_wl_optimizer} == 'numpy':"; ln += 1
            code[ln] = f"            for ii in range(xanes3D_analysis_data_shape[1]):"; ln += 1
            code[ln] = f"                imgs[:] = f['/registration_results/reg_results/registered_xanes3D'][:, ii, :, :]"; ln += 1
            code[ln] = f"                xana.spectrum[:] = imgs[:]"; ln += 1        
            code[ln] = f"                xana.fit_pre_edge()"; ln+=1
            ...
            code[ln] = f"        g120 = g12.create_dataset('spectrum_whiteline_pos', shape=(xanes2D_analysis_data_shape[1:]), dtype=np.float32)"; ln+=1
            code[ln] = f"        g121 = g12.create_dataset('spectrum_whiteline_pos_direct', shape=(xanes2D_analysis_data_shape[1:]), dtype=np.float32)"; ln+=1
            code[ln] = f"        g12.create_dataset('img_mask', data={np.int8(self.parent_h.xanes2D_analysis_mask)}, dtype=np.int8)"; ln+=1
            code[ln] = f"        xana.fit_whiteline(xanes2D_analysis_wl_fit_eng_s, xanes2D_analysis_wl_fit_eng_e, model='lorentzian', fvars=(0.5, xanes2D_analysis_wl_fit_eng_s, 1), bnds=None, ftol=1e-7, xtol=1e-7, gtol=1e-7, jac='3-point', method='trf', ufac=100)"; ln+=1
            code[ln] = f"        xana.calc_direct_whiteline(xanes2D_analysis_wl_fit_eng_s, xanes2D_analysis_wl_fit_eng_e)"; ln+=1
            code[ln] = f"        g120[0] = xana.wl_pos[:]"; ln+=1
            code[ln] = f"        g121[0] = xana.wl_pos_direct[:]"; ln+=1
            code[ln] = f""; ln+=1
            code[ln] = f""; ln+=1
            code[ln] = f"    else:"; ln+=1
            code[ln] = f"        g120 = g12.create_dataset('spectrum_whiteline_pos', shape=(xanes2D_analysis_data_shape[1:]), dtype=np.float32)"; ln+=1
            code[ln] = f"        g121 = g12.create_dataset('spectrum_whiteline_pos_direct', shape=(xanes2D_analysis_data_shape[1:]), dtype=np.float32)"; ln+=1
            code[ln] = f"        g122 = g12.create_dataset('spectrum_direct_whiteline_peak_height', shape=(xanes2D_analysis_data_shape[1:]), dtype=np.float32)"; ln+=1
            code[ln] = f"        g123 = g12.create_dataset('spectrum_centroid_of_eng', shape=(xanes2D_analysis_data_shape[1:]), dtype=np.float32)"; ln+=1
            code[ln] = f"        g124 = g12.create_dataset('spectrum_centroid_of_eng_relative_to_wl', shape=(xanes2D_analysis_data_shape[1:]), dtype=np.float32)"; ln+=1
            code[ln] = f"        g125 = g12.create_dataset('spectrum_weighted_atten', shape=(xanes2D_analysis_data_shape[1:]), dtype=np.float32)"; ln+=1
            code[ln] = f"        g126 = g12.create_dataset('spectrum_weighted_eng', shape=(xanes2D_analysis_data_shape[1:]), dtype=np.float32)"; ln+=1
            code[ln] = f"        g127 = g12.create_dataset('spectrum_edge0.5_pos', shape=(xanes2D_analysis_data_shape[1:]), dtype=np.float32)"; ln+=1
            code[ln] = f"        g128 = g12.create_dataset('spectrum_edge_jump_filter', shape=(xanes2D_analysis_data_shape[1:]), dtype=np.float32)"; ln+=1
            code[ln] = f"        g129 = g12.create_dataset('spectrum_edge_offset_filter', shape=(xanes2D_analysis_data_shape[1:]), dtype=np.float32)"; ln+=1
            code[ln] = f"        g1210 = g12.create_dataset('spectrum_pre_edge_sd', shape=(xanes2D_analysis_data_shape[1:]), dtype=np.float32)"; ln+=1
            code[ln] = f"        g1211 = g12.create_dataset('spectrum_pre_edge_mean', shape=(xanes2D_analysis_data_shape[1:]), dtype=np.float32)"; ln+=1
            code[ln] = f"        g1212 = g12.create_dataset('spectrum_post_edge_sd', shape=(xanes2D_analysis_data_shape[1:]), dtype=np.float32)"; ln+=1
            code[ln] = f"        g1213 = g12.create_dataset('spectrum_post_edge_mean', shape=(xanes2D_analysis_data_shape[1:]), dtype=np.float32)"; ln+=1
            code[ln] = f"        g12.create_dataset('img_mask', data={np.int8(self.parent_h.xanes2D_analysis_mask)}, dtype=np.int8)"; ln+=1
            code[ln] = f"        xana.fit_pre_edge()"; ln+=1
            code[ln] = f"        xana.fit_post_edge()"; ln+=1
            code[ln] = f"        xana.cal_edge_jump_map()"; ln+=1
            ...
            code[ln] = f"        xana.normalize_xanes(xanes2D_analysis_edge_eng, order=xanes2D_analysis_norm_fitting_order)"; ln+=1
            code[ln] = f"        xana.fit_edge_pos(xanes2D_analysis_edge_0p5_fit_s, xanes2D_analysis_edge_0p5_fit_e, order=3, flt_spec=xanes2D_analysis_use_flt_spec)"; ln+=1
            code[ln] = f"        xana.fit_whiteline(xanes2D_analysis_wl_fit_eng_s, xanes2D_analysis_wl_fit_eng_e, model='lorentzian', fvars=(0.5, xanes2D_analysis_wl_fit_eng_s, 1), bnds=None, ftol=1e-7, xtol=1e-7, gtol=1e-7, jac='3-point', method='trf', ufac=100)"; ln+=1
            code[ln] = f"        xana.calc_direct_whiteline(xanes2D_analysis_wl_fit_eng_s, xanes2D_analysis_wl_fit_eng_e)"; ln+=1
            ...
            code[ln] = f"        g120[:] = np.float32(xana.wl_pos)[:]"; ln+=1
            code[ln] = f"        g121[:] = np.float32(xana.wl_pos_direct)[:]"; ln+=1
            code[ln] = f"        g122[:] = np.float32(xana.direct_wl_ph)[:]"; ln+=1
            code[ln] = f"        g123[:] = np.float32(xana.centroid_of_eng)[:]"; ln+=1
            code[ln] = f"        g124[:] = np.float32(xana.centroid_of_eng_rel_wl)[:]"; ln+=1
            code[ln] = f"        g125[:] = np.float32(xana.weighted_atten)[:]"; ln+=1
            code[ln] = f"        g126[:] = np.float32(xana.weighted_eng)[:]"; ln+=1
            code[ln] = f"        g127[:] = np.float32(xana.edge_pos)[:]"; ln+=1
            code[ln] = f"        g128[:] = np.float32(xana.edge_jump_mask)[:]"; ln+=1
            code[ln] = f"        g129[:] = np.float32(xana.fitted_edge_mask)[:]"; ln+=1
            code[ln] = f"        g1210[:] = np.float32(xana.pre_edge_sd_map)[:]"; ln+=1
            code[ln] = f"        g1211[:] = np.float32(xana.post_edge_sd_map)[:]"; ln+=1
            code[ln] = f"        g1212[:] = np.float32(xana.pre_edge_mean_map)[:]"; ln+=1
            code[ln] = f"        g1213[:] = np.float32(xana.post_edge_mean_map)[:]"; ln+=1
