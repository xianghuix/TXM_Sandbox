...
class xanes_regtools_gui():
    ...
    def L0_2_3_1_3_0_analysis_image_use_mask_checkbox(self, a):
        if a['owner'].value:
            ...
            if self.xanes3D_analysis_mask is None:
                self.hs['L[0][2][3][1][3][1]_analysis_image_mask_scan_id_slider'].value = self.xanes3D_scan_id_s+1
        else:
            self.xanes3D_analysis_use_mask = False
        self.boxes_logic()
    ...
    def L0_2_3_1_4_1_analysis_run_button(self, a):
        ...
        code['052'] = f"g12.create_dataset('img_mask', data={np.float32(self.xanes3D_analysis_mask)}, dtype=np.float32)"
        code['053'] = "f.close()"
