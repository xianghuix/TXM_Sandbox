...
class xanes3D_tools_gui():
    ...
    def set_xanes3D_handles(self):
        ...
        self.hs['MRTVSubpixelWz text'].value = self.xanes_config["registration config"]["xanes3D_reg_mrtv_subpixel_width"]
        self.hs['MRTVSubpixelKernel text'].value = self.xanes_config["registration config"]["xanes3D_reg_mrtv_subpixel_kernel"]
    ...
    def build_gui(self):
        ...
        self.hs['SelRawH5Path btn'].on_click(self.L0_2_0_0_1_0_select_raw_h5_path_btn_click)
        ...
        self.hs['SelReconPath btn'].on_click(self.L0_2_0_0_2_0_select_recon_path_btn_click)
        ...
        self.hs['SelSavTrial btn'].on_click(self.L0_2_0_0_3_0_select_save_trial_btn_click)
        ...
        self.hs['SelFile&PathCfm btn'].on_click(self.L0_2_0_0_4_0_confirm_file_path_btn_click)
        layout = {'width':'15%'}
        ...
        self.hs['File&PathOptn drpdn'].observe(self.L0_2_0_0_4_2_file_path_options_dropdown_change, names='value')
        ...
        self.hs['SelScanIdStart drpdn'].observe(self.L0_2_0_1_1_0_select_scan_id_start_text_change, names='value')
        self.hs['SelScanIdEnd drpdn'].observe(self.L0_2_0_1_1_1_select_scan_id_end_text_change, names='value')
        ...
        self.hs['FixedSliId sldr'] = widgets.IntSlider(value=0, description='fixed sli id', disabled=True)
        layout = {'width':'40%'}
        self.hs['FixedSliId sldr'].layout = layout

        self.hs['FixedScanId drpdn'].observe(self.L0_2_0_1_2_0_fixed_scan_id_dpd_chg, names='value')
        self.hs['FixedSliId sldr'].observe(self.L0_2_0_1_2_1_fixed_sli_id_slider_change, names='value')
        ...
        self.hs['FijiRawImgPrev chbx'].observe(self.L0_2_0_1_3_0_fiji_virtural_stack_preview_checkbox_change,
                                               names='value')
        self.hs['FijiClose btn'].on_click(self.L0_2_0_1_3_1_fiji_close_btn_click)
        ...
        self.hs['ConfigDataCfm btn'].on_click(self.L0_2_0_1_4_0_confirm_config_data_btn_click)
        ...
        self.hs['3DRoiX sldr'].observe(self.L0_2_1_0_1_0_3D_roi_x_slider_change, names='value')
        self.hs['3DRoiY sldr'].observe(self.L0_2_1_0_1_1_3D_roi_y_slider_change, names='value')
        self.hs['3DRoiZ sldr'].observe(self.L0_2_1_0_1_2_3D_roi_z_slider_change, names='value')
        self.hs['3DRoiZ sldr'].observe(self.L0_2_1_0_1_2_3D_roi_z_slider_lower_change, names='mylower')
        self.hs['3DRoiZ sldr'].observe(self.L0_2_1_0_1_2_3D_roi_z_slider_upper_change, names='myupper')
        ...
        self.hs['3DRoiCfm btn'].on_click(self.L0_2_1_0_2_1_confirm_roi_btn_click)
        ...
        self.hs['ChunkSz sldr'] = widgets.IntSlider(value=7, disabled=True, description='chunk size')
        layout = {'width':'29%', 'height':'90%'}
        self.hs['ChunkSz sldr'].layout = layout
        self.hs['SliSrch sldr'] = widgets.IntSlider(value=10, disabled=True, description='z search half width')
        layout = {'width':'29%', 'height':'90%'}
        self.hs['SliSrch sldr'].layout = layout

        self.hs['FijiMaskViewer chbx'].observe(self.L0_2_1_1_1_0_fiji_mask_viewer_checkbox_change, names='value')
        self.hs['ChunkSz chbx'].observe(self.L0_2_1_1_1_1_chunk_checkbox_change, names='value')
        self.hs['ChunkSz sldr'].observe(self.L0_2_1_1_1_2_chunk_sz_slider_change, names='value')
        self.hs['SliSrch sldr'].observe(self.L0_2_1_1_1_3_sli_search_slider_change, names='value')
        ...
        self.hs['MaskDilation sldr'] = widgets.IntSlider(value=False, disabled=True, description='mask dilation',
                                                         min=0, max=30, step=1)
        layout = {'width':'40%', 'left':'2.5%', 'height':'90%'}
        self.hs['MaskDilation sldr'].layout = layout

        self.hs['UseMask chbx'].observe(self.L0_2_1_1_2_0_use_mask_checkbox_change, names='value')
        self.hs['MaskThres sldr'].observe(self.L0_2_1_1_2_1_mask_thres_slider_change, names='value')
        self.hs['MaskDilation sldr'].observe(self.L0_2_1_1_2_2_mask_dilation_slider_change, names='value')
        ...
        self.hs['RegMethod drpdn'].observe(self.L0_2_1_1_4_0_reg_method_dropdown_change, names='value')
        self.hs['RefMode drpdn'].observe(self.L0_2_1_1_4_1_ref_mode_dropdown_change, names='value')
        ...
        self.hs['MRTVLevel text'] = widgets.BoundedIntText(value=5, min=1, max=10, step=1, description='level',
                                                           description_tooltip='level: multi-resolution level',
                                                           disabled=True)
        layout = {'width':'19%'}
        self.hs['MRTVLevel text'].layout = layout

        self.hs['MRTVWz text'] = widgets.BoundedIntText(value=10, min=1, max=20, step=1, description='width',
        ...
        self.hs['MRTVSubpixelWz text'] = widgets.BoundedIntText(value=3, min=2, max=20, step=0.1,
        ...
        self.hs['MRTVLevel text'].observe(self.L0_2_1_1_4_2_mrtv_level_text_change, names='value')
        self.hs['MRTVWz text'].observe(self.L0_2_1_1_4_3_mrtv_width_text_change, names='value')
        self.hs['MRTVSubpixelWz text'].observe(self.L0_2_1_1_4_2_mrtv_subpixel_wz_text_change, names='value')
        self.hs['MRTVSubpixelKernel text'].observe(self.L0_2_1_1_4_3_mrtv_subpixel_kernel_text_change, names='value')
        self.hs['MRTVSubpixelSrch drpdn'].observe(self.L0_2_1_1_4_4_mrtv_subpixel_srch_dropdown, names='value')
        ...
        self.hs['ConfigRegParamsCfm btn'].on_click(self.L0_2_1_1_5_1_confirm_reg_params_btn_click)
        ...
        self.hs['RunRegCfm btn'].on_click(self.L0_2_1_2_1_0_run_reg_btn_click)
        ...
        self.hs['ReadAlign chbx'].observe(self.L0_2_2_0_1_0_read_alignment_checkbox_change, names='value')
        self.hs['ReadAlign btn'].on_click(self.L0_2_2_0_1_1_read_alignment_btn_click)
        ...
        layout = {'width':'85%', 'height':'90%'}
        self.hs['RegPair sldr'] = widgets.IntSlider(value=False, disabled=True, description='reg pair #')
        ...
        self.hs['RegPair sldr'].observe(self.L0_2_2_0_2_0_reg_pair_slider_change, names='value')
        self.hs['RegPairBad btn'].on_click(self.L0_2_2_0_3_3_reg_pair_bad_btn)
        ...
        self.hs['CorrXShift text'].observe(self.L0_2_2_0_5_0_review_manual_x_shift_text, names='value')
        self.hs['CorrYShift text'].observe(self.L0_2_2_0_5_1_review_manual_y_shift_text, names='value')
        self.hs['CorrZShift text'].observe(self.L0_2_2_0_5_2_review_manual_z_shift_text, names='value')
        self.hs['CorrShftRecord btn'].on_click(self.L0_2_2_0_5_3_review_manual_shift_record_btn)
        ...
        self.hs['RevRegRltCfm btn'].on_click(self.L0_2_2_0_4_1_confirm_review_results_btn_click)
        ...
        self.hs['AlignReconOptnSli chbx'].observe(self.L0_2_2_1_1_0_align_recon_optional_slice_checkbox, names='value')
        self.hs['AlignReconOptnSliStart text'].observe(self.L0_2_2_1_1_1_align_recon_optional_slice_start_text, names='value')
        self.hs['AlignReconOptnSliEnd text'].observe(self.L0_2_2_1_1_3_align_recon_optional_slice_end_text, names='value')
        self.hs['AlignReconOptnSliRange sldr'].observe(self.L0_2_2_1_1_2_align_recon_optional_slice_range_slider, names='value')
        ...
        self.hs['AlignReconCfm btn'].on_click(self.L0_2_2_1_2_1_align_btn_click)
        ...
        self.hs['VisImgViewerOptn tgbtn'].observe(self.L0_2_2_2_3_0_visualize_viewer_option_togglebutton_change, names='value')
        self.hs['VisImgViewAlignOptn drpdn'].observe(self.L0_2_2_2_3_1_visualize_view_alignment_option_dropdown, names='value')
        ...
        self.hs['VisSpecViewMemMnt chbx'].observe(self.L0_2_2_2_2_1_visualize_spec_view_mem_monitor_checkbox, names='value')
        self.hs['VisSpecViewInRoi btn'].on_click(self.L0_2_2_2_2_2_visualize_spec_view_in_roi_btn)
